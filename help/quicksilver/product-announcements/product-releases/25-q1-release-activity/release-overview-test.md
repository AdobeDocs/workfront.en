...
<tbody>
    ...
    <tr>
        ...
        <td><p>Dec 5</p></td>
          <td><p>Dec 15</p><p> [!BADGE Available ]{type=Positive}</p></td>
        <td><p>Dec 15</p> <p> [!BADGE Available ]{type=Positive}</p> <p>[!BADGE Out-of-cycle ]{type=Caution}</p></td>
    </tr>
    <tr>
        <td>
            <p><a href="/help/quicksilver/product-announcements/product-releases/25-q1-release-activity/25-q1-administrator-enhancements.md" class="MCXref xref" xrefformat="{para}">
        ...
        <td><p>Dec 5</p><p>[!BADGE Out-of-cycle ]{type=Caution}</p></td>
          <td><p>Dec 15</p><p> [!BADGE Available ]{type=Positive}</p></td>
        <td><p>Dec 15</p> <p> [!BADGE Available ]{type=Positive}</p></td>
    </tr>
    <tr>
