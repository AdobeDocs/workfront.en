...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/goals-release-activity/goals-21.1-release/goals-nov-16.md#top" class="MCXref xref" xrefformat="{para}">Visualize Workfront Goals license count in the Setup area</a> </p> <p>As a Workfront administrator, you can now view the number of Workfront Goals licenses in the System area of Setup. You can view the following information:</p> <p>The total number of Workfront Goals licenses that your company has purchased</p> <p>The number of Workfront Goals licenses associated with users. This is the number of users to whom to have granted at least View access to Goals in their access level.</p> </td> 
