...
>[!IMPORTANT]
>
>The 23.3 release included the option to move your organization to monthly releases. Therefore, Workfront is changing the numbering scheme of releases to account for both monthly and quarterly release tracks.
>
>* If you are on the **fast release (monthly)** track, the release after 23.3 is **23.8**, on August 31, 2023. 
> * If you are on the **quarterly** release track, the release after 23.3 is **23.10**, in the week of October 26, 2023.
> 
                 ...
                 <tr>
                    ...
                    <td><p><b>Available on these dates:</b></p>
                        <ul>
                            ...
                            <li>
                                <p><span class="preview">Production for all customers: October 12, 2023</span></p>
                            </li>
                        </ul>
                    </td>
                </tr>            
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        <p>A commonly requested feature of the old home page, we've now added a delegate button to the My Work, My Tasks, and My Issues widgets so that you can easily delegate work when you're out of the office. Note that work delegation must be enabled in your Workfront environment for the button to appear.</p>
                    </td>
                    <td><p><b>Available on these dates:</b></p>
                        <ul>
                            <li>
                 ...
                 <tr>
                    ...
                    <td><p><b>Available on these dates:</b></p>
                        <ul>
                            ...
                            <li>
                                <p><span class="preview">Production for all customers: After the 23.10 release</span></p>
                            </li>
                        </ul>
                    </td>
                </tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><p><b>Available on these dates:</b></p>
                        <ul>
                            <li>
                                <p>Preview release: July 26, 2023<br /></p>
                            </li>
                            <li>
                                <p>Production for fast release: With the 23.8 release</p>
                            </li>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><p><b>Available on these dates:</b></p>
                        <ul>
                            <li>
                                <p>Preview release: Throughout the Fourth Quarter 2023 release timeframe</p>
                            </li>
                            <li>
...
API version 17 was released on October 12, 2023. For API version 17, we've modified some resources and endpoints. Some of the changes support new functionality, and others make it easier for you to use the information available through the API.
