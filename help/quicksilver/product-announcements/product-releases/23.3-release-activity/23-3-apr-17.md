---
title: 23.3 release activity week of April 17, 2023
description: 23.3 release activity week of April 17, 2023
author: Courtney
draft: Probably
...
[View a video demonstration of this feature](https://video.tv.adobe.com/v/3418599/){target=_blank}
...
To make it easier to find specific users within large lists or without profile pictures, profiles without customized avatars now display the user's initials on a colored background in lists and legacy reports. This is a minor cosmetic change, and does not apply if an avatar photo is already being used or the user is deactivated.
