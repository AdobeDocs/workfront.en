...
## API Enhancement: Event Subscriptions
...
## Unsubscribe from Items from Email
...
For more information about Resource Pools, see [Resource pools overview in Adobe Workfront](../../../../resource-mgmt/resource-planning/resource-pools/work-with-resource-pools.md)```<font color="#000000" face="Arial">&nbsp;</font>```
...
## View Versions of Proofed Documents within Workfront
