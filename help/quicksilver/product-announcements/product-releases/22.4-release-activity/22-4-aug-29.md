...
## Updated names for the user- and role- assignment fields

>[!NOTE]
>
>This feature was released directly to the Production September 1, 2022. 

We've updated the name of two assignment fields in Workfront. The fields still function the same and retrieve the same data:
