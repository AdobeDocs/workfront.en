---
title: Second Quarter 2026 Project enhancements
description: Second Quarter 2026 Project enhancements
author: Becky
...
This page describes Project enhancements made with the Second Quarter 2026 release to the Preview environment. These enhancements will be made available in the Production environment as noted.
...
## Updated experience when and single- or bulk-assigning template tasks 

>[!NOTE]
>
>Preview: February 5, 2026 
>Production: Starting on February 5, 2026  
>[!BADGE Off schedule]{type=Neutral}

We have updated the Assignments section in the Edit Template Tasks box when editing single template tasks or editing them in bulk.   
The following changes are included in this update:  

* There is a new experience for assigning resources to template tasks. This is now available both when editing one template task or editing several template tasks in bulk. We have added the following fields to the Assignments section: 
