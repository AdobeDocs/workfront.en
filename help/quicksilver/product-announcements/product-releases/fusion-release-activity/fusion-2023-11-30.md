...
With the new Adobe Experience Manager Forms > Watch form module, you can trigger a scenario when a Submit action occurs on an Adobe Experience Manager Form.
