...
Any configurations that users had already set up on existing reports prior to migration (filters, groupings, column visibility) are preserved and converted into a view in the **My Views** category. Anyone with access to the report will have that view shared with them automatically.
