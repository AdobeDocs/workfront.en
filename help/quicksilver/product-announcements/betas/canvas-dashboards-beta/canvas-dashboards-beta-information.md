...
1. In the top-right corner of the page, click the **Join the Canvas Dashboards beta** beta button. 
    
    >[!NOTE]
    >
    > The **Join the Canvas Dashboards beta** button will only be available if your organization has been invited to the closed beta.
...
1. Click the **Send Feedback** button in the bottom-right corner of the page, then enter your feedback in the form that appears.
