...
1. Delete the folder that stores the domain for the plugin.
   ...
   >[!TIP]
   >
   >On a Mac, Go to Finder, press **Command+Shift+.** to display hidden folders, navigate to **/Users/username/Library/Application Support**, then delete the **Workfront** folder. You must replace `username` with your Mac user name.
