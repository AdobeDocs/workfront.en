...
1. Enter your domain, then click **[!UICONTROL Log in]**. A browser page opens.
   ...
   >
   > * If your Workfront instance in integrated with Experience Cloud, ask your admin to provide you with the Workfront domain found under Product > Workfront in the Admin Console.
