...
title: Install [!DNL Workfront] for Adobe Photoshop
description: You can install the [!DNL Workfront for Adobe Photoshop] plugin from the Adobe Marketplace.
author: Courtney
...
1. When [!DNL Workfront for Adobe Photoshop] plugin appears in the search results, click **[!UICONTROL Get]**.
