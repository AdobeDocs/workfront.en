...
1. To open a **New task** card:
   ...
   * If you are in a chat channel other than the Workfront bot chat channel:
      ...
      * Start typing **@workfront** in the conversation field, then select the Workfront bot channel you want.
      * Continue typing&nbsp;**New task** in the conversation field to create a new task.
