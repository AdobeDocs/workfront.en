...
1. Start typing the name of a project, task, or issue.
   ...
   For information about searching for items, see the section [Search for and share [!DNL Adobe Workfront] items in [!DNL Microsoft Teams]](../../workfront-integrations-and-apps/using-workfront-with-microsoft-teams/search-for-and-share-wf-items-in-ms-teams.md) in the article [Search for and share [!DNL Adobe Workfront] items in [!DNL Microsoft Teams]](../../workfront-integrations-and-apps/using-workfront-with-microsoft-teams/search-for-and-share-wf-items-in-ms-teams.md).
...
1. Do one of the following:
   ...
   * Click **[!UICONTROL What can I do?]**, then **[!UICONTROL Log in]** or **[!UICONTROL Log out]** of [!DNL Workfront], create a **[!UICONTROL New task]** (personal task) in [!DNL Workfront], or get **[!UICONTROL Help]** by listing available commands.
...
1. Click **[!UICONTROL Search]** to search for a project, task, or issue.
   ...
   For information about searching for items, see the [Search for and share [!DNL Adobe Workfront] items in [!DNL Microsoft Teams]](../../workfront-integrations-and-apps/using-workfront-with-microsoft-teams/search-for-and-share-wf-items-in-ms-teams.md) section in the [Search for and share [!DNL Adobe Workfront] items in [!DNL Microsoft Teams]](../../workfront-integrations-and-apps/using-workfront-with-microsoft-teams/search-for-and-share-wf-items-in-ms-teams.md) article.

1. Type any of the following commands to perform these actions in Workfront.\
   Commands are not case sensitive:

   * **[!UICONTROL Log in]** to log in to [!DNL Workfront]
