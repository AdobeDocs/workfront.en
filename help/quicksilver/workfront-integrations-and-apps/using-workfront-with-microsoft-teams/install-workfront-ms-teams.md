...
You must be a team owner in Microsoft Teams to install [!DNL Workfront] for Microsoft Teams.

## Install [!DNL Workfront] for Microsoft Teams {#install-workfront-for-microsoft-teams}

As a team owner in [!DNL Microsoft Teams], you can install the [!DNL Workfront for Microsoft Teams] app for each of your teams either from the Microsoft Store or from a file provided by [!DNL Workfront].
...
* [Install [!DNL Workfront] for Microsoft Team from a private file](#install-workfront-for-microsoft-team-from-a-private-file)
...
1. In the **[!UICONTROL Search] all** box, type *Workfront*.

1. Click the **[!UICONTROL Workfront]** card and follow the instructions in the wizard.
1. (Recommended) Select a team from the **[!UICONTROL Add to a team]** drop-down menu and enable the **Yes** option to add the app to a team.
...
1. (Optional) Pin your [!DNL Workfront] app for easier access:
   ...
   1. Click the **[!UICONTROL More]** icon under the message field in the General channel.

   1. Mouse over the Workfront app in the list, then click the **[!UICONTROL More]** icon to the right of it.

      ![teams_pin_workfront_link.PNG](assets/teams-pin-workfront-link-350x80.png)

   1. Click **Pin**.

      This adds a [!DNL Workfront] icon under the chat field. You can quickly access the Search area from here.
...
1. Click **[!UICONTROL Log in] to [!DNL Workfront]** to access Workfront from Microsoft Teams.
...
If your organization restricts the access to downloading apps from the Microsoft Store, you must contact our Support Team and request a private file of the [!DNL Workfront for Microsoft Teams] app to install the app.
...
To install [!DNL Workfront] for [!DNL Microsoft Teams] from a private file:

1. Save the private file that you have received from [!DNL Workfront] on your computer.
1. Log in to [!DNL Microsoft Teams] as a Microsoft team owner.
...
1. (Optional) Click **Pin**.
   ...
   This adds a [!DNL Workfront] icon under the [!UICONTROL Type your questions here] field. You can quickly access the Search area from here.\
   For information about searching for Workfront items, see [Search for and share [!DNL Adobe Workfront] items in [!DNL Microsoft] Teams](../../workfront-integrations-and-apps/using-workfront-with-microsoft-teams/search-for-and-share-wf-items-in-ms-teams.md).

## Log in to [!DNL Workfront] from [!DNL Microsoft] Teams {#log-in-to-workfront-from-microsoft-teams}

As a Microsoft Teams team owner, you must install the [!DNL Workfront for Microsoft Teams] app for your team before you or anyone on the team can log in to [!DNL Workfront] from Microsoft Teams.

When you are logged in to [!DNL Workfront] from Microsoft Teams, you can receive [!DNL Workfront] notifications in the Workfront bot channel or you can perform certain actions in Workfront from Microsoft Teams.&nbsp;

For information about installing the [!DNL Workfront] app, see the [[!DNL Install] Workfront for Microsoft Teams](#install-workfront-for-microsoft-teams) section in this article.
...
To log in to [!DNL Workfront] from Microsoft Teams:

1. Go to the **General** channel of the team where the [!DNL Workfront] for Microsoft Teams app has been installed and click **Log in to Workfront**.
...
1. Go to the Workfront bot chat channel in [!DNL Microsoft Teams] and type *log in* in the **[!UICONTROL Type your questions here]** field.
