...
---
# Create an [!DNL Adobe Workfront] issue in G Suite using email content

You can convert an external email (not generated by [!DNL Adobe Workfront)] to a [!DNL Workfront] issue.

You can also convert an external email to an update on an existing issue. For more information, see [Update an [!DNL Adobe Workfront] item from G Suite using email content](../../workfront-integrations-and-apps/workfront-for-g-suite/update-wf-item-using-email-content.md).
...
## Create a [!DNL Adobe Workfront] issue in G Suite using email content
...
1. With the email message open in G Suite, click an option in [!DNL Workfront] for G Suite to convert the email to a new [!DNL Workfront] issue.
...
1. Click **Create Issue**.
   ...
   The **Details** tab for the new issue displays in the [!DNL Workfront for G Suite] panel. You can click **[!UICONTROL Updates]** and start communicating with collaborators right away without leaving your in box.

   At the bottom of the **[!UICONTROL Details]** tab, you can also click **View in Workfront** to go to the new issue in Workfront.
