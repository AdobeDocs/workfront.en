...
1. In the **[!UICONTROL Search] All Plugins** box, type *[!DNL Workfront]*, then press **[!UICONTROL Enter]**.
...
1. Ensure the [!UICONTROL Plugin] panel is open, then click **[!UICONTROL Workfront for Adobe XD]**.
