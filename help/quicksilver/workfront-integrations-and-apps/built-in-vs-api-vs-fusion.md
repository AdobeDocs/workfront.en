...
You can integrate [!DNL Adobe Workfront] with third-party applications. These integrations can extend the utility of [!DNL Workfront] and tailor it to the needs of your organization. You can use any or all of these integrations, depending on which is most useful for a given task.
...
* Built-in integrations cover many of the most common apps used by businesses, such as Slack, [!DNL Google Drive], or Adobe products such as the [!DNL Adobe Creative Cloud] or [!DNL Adobe Experience Manager] Assets. If your company uses these apps already, the integration will go smoothly into your users' existing workflow.
