...
title: Create an Anaplan list item from an [!DNL Adobe Workfront] campaign request
description: This integration scenario links an [!DNL Adobe Workfront] project with an Anaplan budget list item.
author: Becky
feature: Workfront Integrations and Apps, Workfront Fusion
exl-id: daf6a18d-a3df-497d-a612-8a4645b1a8c9
---
# Create an Anaplan list item from an [!DNL Adobe Workfront] campaign request

This integration scenario links an [!DNL Adobe Workfront] project with an Anaplan budget list item.
...
1. Navigate to the [!UICONTROL Templates] menu in [!DNL Workfront Fusion] and click the **[!UICONTROL Create an Anaplan list] item from a Workfront campaign request** scenario template.
