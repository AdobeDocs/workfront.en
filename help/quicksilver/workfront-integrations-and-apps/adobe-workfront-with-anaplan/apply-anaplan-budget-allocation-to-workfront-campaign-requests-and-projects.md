...
title: Apply an Anaplan budget allocation to an [!DNL Adobe Workfront] campaign request or campaign project
...
---
# Apply an Anaplan budget allocation to an [!DNL Adobe Workfront] campaign request or campaign project
...
1. Navigate to the [!UICONTROL Templates] menu in [!DNL Workfront Fusion] and click the **Apply Anaplan budget allocations to Workfront campaign requests & projects** scenario template.
