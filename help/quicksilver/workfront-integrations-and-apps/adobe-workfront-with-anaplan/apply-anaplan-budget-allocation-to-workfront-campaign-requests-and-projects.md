...
title: Apply an [!DNL Anaplan] budget allocation to an [!DNL Adobe Workfront] campaign request or campaign project
...
* A view in [!DNL Anaplan] called **[!UICONTROL Campaigns.Update Campaigns in Adobe Workfront]**.
   ...
   The view should be filtered to display items that have a [!UICONTROL [!DNL Workfront] Project GUID] and some indicator that budget allocations should be transmitted to Workfront.
...
1. Navigate to the [!UICONTROL Templates] menu in [!DNL Workfront Fusion] and click the **[!UICONTROL Apply [!DNL Anaplan] budget allocations to Workfront campaign requests & projects]** scenario template.
