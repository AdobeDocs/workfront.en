...
1. Navigate to a message that includes a link to a Workfront project.
...
1. Navigate to a message that includes a link to a Workfront task.
...
1. Navigate to a message that includes a link to a Workfront issue.
...
1. Navigate to a message that includes a link to a Workfront portfolio.
...
1. Navigate to a message that includes a link to a Workfront program.
...
1. Navigate to a message that includes a link to a Workfront report.
