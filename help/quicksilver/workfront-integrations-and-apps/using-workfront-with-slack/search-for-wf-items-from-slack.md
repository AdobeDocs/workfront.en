...
You can search for [!DNL Adobe Workfront] items from Slack, if your instance of Slack has had the [!DNL Workfront] app installed.&nbsp;
...
## Search for [!DNL Workfront] items from Slack:
