...
---
# Enable Outlook for Office for use with [!DNL Adobe Workfront] and SAML 2.0

If your [!DNL Adobe Workfront] system is integrated with SAML 2.0, you must enable SAML 2.0 authentication for Office add-ins in order for users to be able to authenticate using their SAML 2.0 credentials.&nbsp;
