...
In an Adobe Workfront Fusion scenario, you can automate workflows that use Adobe Photoshop, as well as connect it to multiple third-party applications and services. Adobe Photoshop modules allow you to ,reate, read, update, or delete records,list all records of a given type, search records based on criteria you specify, or perform a custom API call to the Adobe Photoshop API.
