...
---
# HTTP >[!UICONTROL Make a request] module
...
## HTTP >[!UICONTROL Make a request] module configuration
...
>[!NOTE]
>
>To make sure your [!UICONTROL JSON] is valid, you can use one of the available online services such as [https://jsonlint.com/](https://jsonlint.com/). You can also use JSON >[!UICONTROL Create JSON module] to create the JSON dynamically and take care of all the necessary escaping.
>
