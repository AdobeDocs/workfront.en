 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Enter the values that will be entered instead of the variables to the new document.</p> 
    <ul> 
     <li><strong>Tags</strong> <br>Enter the tags that are contained in the document template. Do not use <strong>&lbrace;&lbrace;&rbrace;&rbrace;</strong>. Example: use <strong>name </strong>instead of <strong>&lbrace;&lbrace;name&rbrace;&rbrace;</strong>.</li> 
