...
* [Call the MS Graph REST API via the [!DNL Adobe Workfront] Fusion HTTP > Make an OAuth 2.0 request module](../../workfront-fusion/connections/call-the-ms-graph-rest-api-.md)
