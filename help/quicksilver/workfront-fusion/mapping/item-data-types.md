...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>This type is used for items with only two possible values: true or false. </p> <p>When setting modules, the [!DNL Boolean] type can appear in two different forms:</p> 
    <ul> 
