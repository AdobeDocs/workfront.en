    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td> <p>A data structure is a list of the columns for a table. This list indicates the column name and data type.</p> <p>Do one of the following:</p> 
       <ul> 
        <li style="font-weight: bold;">Select a [!UICONTROL data structure] that has been already created</li> 
        <li> <p style="font-weight: bold;">Add a new data structure</p> <p>Click the <strong>Add</strong> button to create a new data structure.</p> <p>For more information, see the <a href="#set-up-the-data-structure" class="MCXref xref">[!UICONTROL Set up the data structure]</a> section in this article.</p> </li> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td> <p>Do one of the following to set up your data store's columns.</p> 
       <ul> 
        <li> <p>Click <strong>[!UICONTROL Add item]</strong> to specify the properties of one column manually.</p> <p>Enter the <strong>Name</strong> and <strong>Type</strong> for the data store column and define corresponding properties.</p> </li> 
...
You can edit the properties and contents of an existing [!UICONTROL Data Store] in the Data Store area of Workfront Fusion.
...
1. (Optional) If you want to change the data structure used by this data store to another existing data structure, select it from the **[!UICONTROL Data structure]** drop-down.
   ...
   (Optional) If you want to change the data structure used by this data store to an entirely new data structure, see [[!UICONTROL Set up the data structure]](#set-up-the-data-structure) in this article.
...
1. (Optional) [!UICONTROL Edit] a single cell by clicking the **Edit** icon ![](assets/data-store-edit.png)in that cell, then entering the desired value.
