...
title: Create and Manage Custom Profiles using [!DNL Workfront Proof]
...
topic_v2:
  ...
  - id: eddd9b14-83bd-4ff4-9072-54a4a484abb7
    internal-label: Administration
---
# Create and Manage Custom Profiles using [!DNL Workfront Proof]
...
The [!UICONTROL Data administration] section determines rights users have over items owned by other users in the account.
...
* Files
   For more information, see [Upload Files and Web Content to [!DNL Workfront Proof]](../../../workfront-proof/wp-work-proofsfiles/create-proofs-and-files/upload-files-web-content.md).

* Public Folders
   For more information, see [Understand Folder Permissions in [!DNL Workfront Proof]](../../../workfront-proof/wp-work-proofsfiles/organize-your-work/folder-permissions.md).
...
* Tags
   For more information, see [Create and Manage Tags in [!DNL Workfront Proof]](../../../workfront-proof/wp-work-proofsfiles/organize-your-work/create-and-manage-tags.md).

* Custom Views
   For more information, see [Create and Manage Custom Views in [!DNL Workfront Proof]](../../../workfront-proof/wp-work-proofsfiles/manage-your-work/create-and-manage-custom-views.md).
...
* Manage custom fields
   For information, see [Create and manage custom fields in [!DNL Workfront Proof]](../../../workfront-proof/wp-acct-admin/account-settings/create-and-manage-custom-fields.md).
...
* Manage SSO
   For information, see [Single Sign-On in [!DNL Workfront Proof]](../../../workfront-proof/wp-acct-admin/managing-security/single-sign-on-overview.md).

* View account history
   For information, see [Understanding the [!DNL Workfront Proof] Activity Audit Trail](../../../workfront-proof/wp-work-proofsfiles/basic-features/activity-audit-trail.md).

* View account backups
   For information, see [Back Up Your [!DNL Workfront Proof] Data](../../../workfront-proof/wp-work-proofsfiles/organize-your-work/back-up-data.md).
...
* Create satellite accounts
   For information, see [Configure a satellite account in [!DNL Workfront Proof]](../../../workfront-proof/wp-acct-admin/satellite-accounts/configure-sat-acct-in-wp.md).

* Empty trash
   For information, see [Restore and Empty the Trash in [!DNL Workfront Proof]](../../../workfront-proof/wp-work-proofsfiles/manage-your-work/restore-and-empty-trash.md).

* Manage permission profiles
   For information, see [Proof Permissions Profiles in [!DNL Workfront Proof]](../../../workfront-proof/wp-acct-admin/account-settings/proof-perm-profiles-in-wp.md).
...
1. Navigate to **[!UICONTROL Account Settings]**, then click the **[!UICONTROL Profiles]** tab.

1. Click **[!UICONTROL Create New Profile]**.

1. In the **[!UICONTROL Profile Details]** section:

   1. In the **[!UICONTROL Name]** field, specify a name for the custom profile.
   1. Select **[!UICONTROL Enable profile]**. ![Screenshot_2018-04-06_12-25-09.png](assets/screenshot-2018-04-06-12-25-09.png)

1. In the **[!UICONTROL Module permissions]** section:
...
1. In the **[!UICONTROL Administrative permissions]** section, select permissions for administrative functions.

   For more information, see [Administrative Permissions](#administrative-permissions).

1. Click **[!UICONTROL Create]**.
   The new profile is now available on the **[!UICONTROL Users]** tab.
...
1. Navigate to **[!UICONTROL Account Settings]**, then click on the **[!UICONTROL Profiles]** tab.

1. Select the profile you want to enable or disable.
   Or
   To enable or disable multiple profiles simultaneously, select the profiles manually, or select **[!UICONTROL Name]** to select all custom profiles.
   ![Screenshot_2018-04-06_12-31-53.png](assets/screenshot-2018-04-06-12-31-53.png)

1. Click the **[!UICONTROL More]** drop-down menu, then click either of the following options, depending on whether you want to enable or disable the profile:

   * **Enable profiles:** The profile becomes active and visible in the [!DNL Workfront Proof] menus.
   * **Disable profiles:** A confirmation box appears. Select **[!UICONTROL Yes]** to confirm. The profile becomes inactive and is removed from the [!DNL Workfront Proof] menus.
...
1. Click the name of the profile and click the **[!UICONTROL Copy profile]** button.
...
>[!NOTE]
>
>Default [!DNL Workfront Proof] profiles are visible in the list of profiles but cannot be modified.
...
1. Click **[!UICONTROL Yes]** in the **[!UICONTROL Confirm dialog]** box that appears.

1. If the profile is assigned to a user, use the drop-down menu in the dialog box to select a different profile to assign to this user. Click **[!UICONTROL Yes]** to confirm.
