...
* Custom Views\
   For more information, see [Create and Manage Custom Views in [!DNL Workfront] Proof Proof](../../../workfront-proof/wp-work-proofsfiles/manage-your-work/create-and-manage-custom-views.md).
...
1. Click the **[!UICONTROL More]**&#x200B;drop-down menu, then click either of the following options, depending on whether you want to enable or disable the profile:&nbsp;&nbsp;
   ...
   * **Disable profiles:** A&nbsp;confirmation box appears. Select&nbsp;**Yes**&#x200B;to confirm. The profile becomes inactive and is removed from the [!DNL Workfront] Proof menus.
...
1. Click the name of the profile and click the **[!UICONTROL Copy profile]** button.
   ...
   The copied profile now appears on the [!UICONTROL profiles] list. It has the original profiles name with the word "Copy" before it.
...
1. Navigate to&nbsp;**Account settings**, then&nbsp;click the&nbsp;**[!UICONTROL Profiles]**&#x200B;tab.&nbsp;
