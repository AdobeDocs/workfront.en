...
1. `<font size="2">(Optional) Delete a group member from the proof by hovering over the user's information and clicking the&nbsp;<span class="bold">X.&nbsp;</span><br>Or<br>Delete all members from the proof by clicking <span class="bold">Delete all</span>.</font>` 
