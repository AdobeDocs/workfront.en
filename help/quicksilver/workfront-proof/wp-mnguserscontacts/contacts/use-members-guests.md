...
* **Users**
   ...
   Users have a [!DNL Workfront Proof] login in your organization's account. If you are a [!DNL Workfront Proof] administrator, you can add a new user. See [Create Users using [!DNL Workfront Proof]](../../../workfront-proof/wp-mnguserscontacts/users/create-users.md) for more information.
...
* **Guests**
   ...
   Guests do not have their own [!DNL Workfront Proof] login in your organization's account, but you have added their details to your account (for example, guest reviewers on proofs). You can convert guests to users. For more information, see [Create Users using [!DNL Workfront Proof]](../../../workfront-proof/wp-mnguserscontacts/users/create-users.md).
