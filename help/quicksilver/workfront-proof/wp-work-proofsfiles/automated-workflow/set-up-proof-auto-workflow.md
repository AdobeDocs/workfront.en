...
1. In the **[!UICONTROL Share]** section, click **[!UICONTROL Use Automated Workflow]**.
...
1. Specify the following information to configure the first stage of the Automated Workflow:
   ...
   * **[!UICONTROL Name]:** The stage name appears on the Workflow diagram and is included in the email notifications sent to reviewers.
   * **[!UICONTROL Deadline]:** The functionality of this field differs depending on what option you select in the **[!UICONTROL Deadline calculated from]** drop-down list.

   * **[!UICONTROL From proof creation]:** Select the deadline date for the proof.
   * **[!UICONTROL From stage activation]:** Select the number of business days that will be added to the stage activation date to automatically set a deadline on the proof.
   * **[!UICONTROL Activate stage]:** For each stage of your Workflow, you can decide when it should be activated. For your first stage, the following options are available.
   ...
   * **[!UICONTROL Deadline calculated from]:** The option you select in this drop-down list affects what options are available in the **[!UICONTROL Deadline]** field.

   * **[!UICONTROL Proof creation]:** In the **[!UICONTROL Deadline]** field, select the deadline date for the proof.

   * **[!UICONTROL Stage activation]:** In the **[!UICONTROL Deadline]** field, select the number of business days that will be added to the stage activation date to automatically set a deadline on the proof.

   * **[!UICONTROL Lock stage]:** Select when the stage can be locked.
   * **[!UICONTROL Primary decision maker]:** Select the Primary decision maker on the stage. Decision makers are available in the drop-down list only after you add reviewers to the stage.
   * **[!UICONTROL Only one decision required]:** Select this option for the review to be completed after one of the decision makers makes their decision.\

      This option is not available if you designated a user in the **[!UICONTROL Primary decision maker]** drop-down menu.

   * **[!UICONTROL Private stage]:** When this option is selected, comments and decisions are not visible to people who are not added to this stage or are not Supervisors, Administrators, or Billing Administrators in the account
...
1. (Optional) Click **[!UICONTROL New stage]**, then repeat Step 4 and Step 5 to add multiple stages to the automated workflow.
...
1. If you are adding a stage to an existing proof, go to the Proof details page, as described on [Manage Proof Details in [!DNL Workfront Proof]](../../../workfront-proof/wp-work-proofsfiles/manage-your-work/manage-proof-details.md).
1. In the **[!UICONTROL Workflow]** section, click **[!UICONTROL New stage]**.
...
1. Click **[!UICONTROL Add stage]**, then click **[!UICONTROL Done]**.
...
* **[!UICONTROL Stage name]**: Appears on the Workflow diagram and is included in the email notifications sent to reviewers.
* **[!UICONTROL Activate stage]**: For each stage of your Workflow, you can decide when it should be activated. For your first stage, the following options will be available:
...
* **[!UICONTROL Deadline]:** You can decide how the deadline should be calculated on each stage of a workflow. The options are:
...
* **[!UICONTROL Lock]:** There are a number of options that determine when a stage can be locked. The options include:
...
**[!UICONTROL Primary decision maker]**: You set the Primary decision maker on the stage. The available decision makers appear in the list only after you've added the reviewers to the stage.

>[!NOTE]
>
>If you pick a Primary decision maker, only one decision required option will no longer be available on this stage.

* **[!UICONTROL Only one decision required]**: You can enable this option on a stage. This means that the review will be completed once one of the decision makers makes their decision.
* **[!UICONTROL Privacy]:** Each stage can be made private. If a stage is private, the comments and decisions won't be visible to people who are not added to this stage or are not Supervisors, Administrators or Billing Administrators in the account. For more information, see [Automated Workflow overview](../../../review-and-approve-work/proofing/proofing-overview/automated-workflow.md) .
...
1. Click **[!UICONTROL Convert to Automated Workflow]** on the [!UICONTROL Proof details] page.
...
1. On the Proof details page, in the Workflow section, click **[!UICONTROL Add template].**
