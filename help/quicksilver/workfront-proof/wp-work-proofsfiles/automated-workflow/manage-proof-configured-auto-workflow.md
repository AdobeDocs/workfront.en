...
The diagram of your Automated [!UICONTROL Workflow] is displayed at the top of the Workflow section.

To hide the diagram

1. Click the **[!UICONTROL Hide]** button (1).
...
Hovering over a stage in the diagram will show you the progress of the stage. If the stage is not active and you have edit rights on the stage, you will be able to start the stage from the pop up using the [!UICONTROL Start stage] button. Similarly, the option to Lock an active stage will be displayed.

To find out more about the Progress bar, see&nbsp; [View the Progress and Status of a Proof in [!DNL Workfront] Proof](../../../workfront-proof/wp-work-proofsfiles/manage-your-work/view-progress-and-status-of-proof.md).

![Diagram_-_stage_summary.png](assets/diagram---stage-summary-350x214.png)

## Add a new stage

You can add a new stage to your Automated Workflow from the [!UICONTROL Proof details] page.

1. Click the **[!UICONTROL New stage]** button (1).
...
The [!UICONTROL Actions] menu (1) for each stage has the following options:
