...
description: You can adjust the page layout on the Views tab.
author: Courtney
...
* The [!UICONTROL proof actions] menu is located at the right hand side of the line (1)
...
* The [!UICONTROL proof actions] menu is located at the top right corner for each proof (1)
