...
By default, data displayed in [!UICONTROL reports&nbsp;includes] all information from your [!DNL Workfront] Proof system. You can use filters to show only information that is relevant to your needs.
