...
title: Manage Files in [!DNL Workfront] Proof
...
1. Click the down arrow to the right of&nbsp;**Views**&#x200B;in the left navigation panel, then&nbsp;click **[!UICONTROL Files]**&#x200B;in the drop-down menu.

1. Click the **More**&nbsp;button for the file, then click **[!UICONTROL View file details]** in the menu that appears.\
...
* **Share**. Share&nbsp;files with other people. [!DNL Workfront] Proof sends an email notification including a custom message and download links to the recipients.\
...
1. (Optional) Open the **[!UICONTROL Shared with]** section to list the users the file has been shared with.
   ...
   You can **Message** or **Remove** a user using the **[!UICONTROL More]** icon on the right.
