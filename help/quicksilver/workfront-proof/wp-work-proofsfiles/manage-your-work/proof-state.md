...
For information about viewing a list of all proofs in a specific state, such as&nbsp;viewing all&nbsp;Active&#x200B;**&#x200B;**&#x200B;or&nbsp;Locked proofs, see [Manage Items on the [!DNL Views] Page in [!DNL Workfront] Proof](../../../workfront-proof/wp-work-proofsfiles/manage-your-work/manage-items-on-views-page.md) in the article [Manage Items on the [!DNL Views] Page in [!DNL Workfront] Proof](../../../workfront-proof/wp-work-proofsfiles/manage-your-work/manage-items-on-views-page.md).
...
1. (Optional) To change the state, mouse over the [!UICONTROL current&nbsp;]**State**&#x200B;and click the drop-down menu, then select a new state.
