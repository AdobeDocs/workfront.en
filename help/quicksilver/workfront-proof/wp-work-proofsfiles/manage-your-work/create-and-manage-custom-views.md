...
title: Create and Manage Custom Views in [!DNL Workfront] Proof Proof
...
---
# Create and Manage Custom Views in [!DNL Workfront] Proof Proof
...
1. For more information about [!DNL views], see [Manage Items on the [!DNL Views] Page in [!DNL Workfront] Proof](../../../workfront-proof/wp-work-proofsfiles/manage-your-work/manage-items-on-views-page.md).
1. Do either of the following, depending on whether you want to create a new custom view from scratch, or create a new custom view based on an existing standard view:
   ...
   * To create a new custom view based on an existing standard view: From the drop-down menu, select the existing standard view you want to use as the basis for your new custom view. Click the **[!UICONTROL View Settings]** icon, then click **Copy** to new custom view.
...
1. In the **[!UICONTROL Details]** section, specify the following information:
   ...
   * **Items**: Select whether you want both proofs and [!UICONTROL file], [!UICONTROL proofs only], or [!UICONTROL files] only included in the view. By default, both proofs and files are included.
...
1. In the **[!UICONTROL Columns]** section, determine which columns you want to include in the custom view.
   ...
   1. You can select from the [!UICONTROL standard columns], or you can choose Custom fields and Decision Reasons to be columns in your custom view. (If you have these configured in your account, they appear under the [!UICONTROL standard list of Available columns] area.)
   1. Standard columns you can include
      ...
      <td>Pending, [!UICONTROL Changes required], [!UICONTROL Approved with changes], [!UICONTROL Approved], or Not relevant.</td>
      </tr>
      <tr>
   ...
   1. (Optional) Do either of the following to move the column to the **[!UICONTROL Selected columns]** area so that it is included in the new view:
      ...
      * Remove a column from the **[!UICONTROL Selected columns]** list, by clicking the name of the selected&nbsp;column, then clicking the **Left** arrow. Alternatively, you can double-click the name of the selected column (the column is&nbsp;moved back to the **[!UICONTROL Available columns]** list).

      * A&nbsp;column can be added only once. For example, if you move [!UICONTROL Comments] column from [!UICONTROL Available to Selected columns] list, the name of this column will disappear from [!UICONTROL Available columns] list.
...
1. Custom views are specific to the user who creates them. By default the new Custom view is visible only for its creator; however, you can choose to share your custom view by choosing one of the following options:
   ...
   * **[!UICONTROL Select users that can see this custom view]**: Select this option to make the custom view available only to specific users.
...
1. Click **Create**.
1. The&nbsp;Custom view is displayed&nbsp;and is&nbsp;available on the [!DNL Views] page. For more information about views, see [Manage Items on the [!DNL Views] Page in Workfront Proof](../../../workfront-proof/wp-work-proofsfiles/manage-your-work/manage-items-on-views-page.md).
...
1. Go to the **Views** page.\
   For more information about [!DNL views], see [Manage Items on the [!DNL Views] Page in [!DNL Workfront] Proof](../../../workfront-proof/wp-work-proofsfiles/manage-your-work/manage-items-on-views-page.md).
...
1. Click the&nbsp;**View Options** button, then click **Edit view**.\
   ...
   The [!DNL Edit Custom View] page is displayed.
...
>[!NOTE]
>
>If you edit your Custom view, the columns in [!UICONTROL Selected columns] list will arrange in an alphabetical order automatically. You will need to rearrange them if needed before updating the view.


## Copying Custom Views

The [!UICONTROL Copy view] function lets you easily make a copy of an existing custom view. This is really useful, for example, if you want to set up separate views for all your designers, with each view being the same except for the proof owner (designer).
...
1. In the [!UICONTROL Sharing] section elect the users you want to share the view with and click&nbsp;**Update view**.
...
1. The default [!UICONTROL All items] view is displayed and your deleted custom view no longer appears in the **Views** drop-down menu.
