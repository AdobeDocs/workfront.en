...
1. For a new proof, under **[!UICONTROL Proof settings]**, select **[!UICONTROL Lock proof] when all required decisions are made**.\
   Or\
   For an existing proof, under **Settings**, select **[!UICONTROL Lock the proof] when all decisions are made**.
...
>[!NOTE]
>
>* *In order for somebody to sign in to the proof (when [!UICONTROL Login required] has been enabled), they must have been added to the proof.*
>* *If [!UICONTROL Login required] is enabled, Subscriptions cannot be enabled.*
>
...
1. For a new proof, under **[!UICONTROL Workflow]**, select **[!UICONTROL Require only one decision for this] stage**.\
   Or\
   For an existing proof, under **[!UICONTROL Settings]**, select **Only one decision required**.
...
For information about decisions, see [[!UICONTROL Configure approval decision options] in Workfront Proof](../../../workfront-proof/wp-acct-admin/account-settings/configure-approval-decision-in-wp.md).
