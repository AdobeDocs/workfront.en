...
1. Click the **[!UICONTROL Folders]** tab in the left navigation sidebar.
...
1. Click **[!UICONTROL Share folder]**.
...
1. When you are ready, click **[!UICONTROL Share folder]**.
...
1. Click **[!UICONTROL Share selected items]**.\
...
1. Log in to [!DNL Workfront Proof].\
  [!DNL  Workfront Proof] displays the Folder details page. For more information, see [Manage Folders and their Contents in [!DNL Workfront Proof]](../../../workfront-proof/wp-work-proofsfiles/organize-your-work/manage-folders-and-contents.md).
...
See [Share items with a partner in [!DNL Workfront Proof]](../../../workfront-proof/wp-acct-admin/partner-accounts/share-items-partner-in-wp.md) for more information.
