...
title: Create Folders in [!DNL Workfront] Proof
...
* [Creating a sub-folder from the [!UICONTROL Account folders] page](#creating-a-sub-folder-from-the-account-folders-page)
