...
1. Open the **Tags** tab at the top of the **Personal settings** page.\
   ...
   * To create a tag, click **[!UICONTROL New tag]**, type a name for the tag, then press **Enter**.\
   ...
   * To delete a tag, click the [!UICONTROL trash can] icon at the end of the row where the tag is listed.
