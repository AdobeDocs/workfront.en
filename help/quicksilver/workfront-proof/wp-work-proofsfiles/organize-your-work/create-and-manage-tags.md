...
title: Create and Manage Tags in [!DNL Workfront Proof]
description: You can create and edit tags and apply them to your proofs and files. This is great for when you have lots of different [!DNL Workfront Proof] items, such as projects, divisions, and clients, and you want to identify and find them easily.
author: Courtney
feature: Workfront Proof, Digital Content and Documents
exl-id: eb720a1b-5136-4158-9ea0-bcb5755e1761
---
# Create and Manage Tags in [!DNL Workfront Proof]

>[!IMPORTANT]
>
>This article refers to functionality in the standalone product [!DNL Workfront] Proof. For information on proofing inside [!DNL Adobe Workfront], see [Proofing](../../../review-and-approve-work/proofing/proofing.md).

You can create and edit tags and apply them to your proofs and files. This is great for when you have lots of different [!DNL Workfront Proof] items, such as projects, divisions, and clients, and you want to identify and find them easily.
...
For more information about these profiles and permissions, see [Proof Permissions Profiles in [!DNL Workfront Proof]](../../../workfront-proof/wp-acct-admin/account-settings/proof-perm-profiles-in-wp.md).

## Creating, Editing, or Deleting a Tag in Your Account

1. Click **[!UICONTROL Settings]** > **[!UICONTROL Personal settings]**.

1. Open the **[!UICONTROL Tags]** tab at the top of the **[!UICONTROL Personal settings]** page.\
   Do one of the following:

   * To create a tag, click **[!UICONTROL New tag]**, type a name for the tag, then press **[!UICONTROL Enter]**.\

      Tag names must include at least one alphanumeric character and no more than than 30 characters.\
      To edit an existing tag, click the name of the tag, type new text, then press **[!UICONTROL Enter]**.
...
1. Open the **[!UICONTROL Tags]** tab at the top of the **[!UICONTROL Personal settings]** page.\
   The **[!UICONTROL Tags]** tab gives you the following information about your tags:
...
1. Click **[!UICONTROL Tags]** > **[!UICONTROL New tag]** just above the list, type a name for the tag, then click **[!UICONTROL Create]**.

1. Select the new tag, then click **[!UICONTROL Add tag(s)]**.
...
The tags applied to a proof or a file display on the Proof Details page and the File Details page, respectively. On this page, you can view, change, and remove tags. For more information, see [Manage Proof Details in [!DNL Workfront Proof]](../../../workfront-proof/wp-work-proofsfiles/manage-your-work/manage-proof-details.md) and [Manage Files in [!DNL Workfront Proof]](../../../workfront-proof/wp-work-proofsfiles/manage-your-work/manage-files.md).
...
1. Open the Proof Details page for a proof, as described in [Manage Proof Details in [!DNL Workfront Proof]](../../../workfront-proof/wp-work-proofsfiles/manage-your-work/manage-proof-details.md).\
   Or\
   Open the File Details page for a file, as described in [Manage Files in [!DNL Workfront Proof]](../../../workfront-proof/wp-work-proofsfiles/manage-your-work/manage-files.md).\
...
1. In the upper-right corner, click **[!UICONTROL Tags]**.\
   ![Tags_button_on_Details_page.png](assets/tags-button-on-details-page-350x116.png)

1. In the box that appears, select the tags you want to apply to the item (or deselect tags you want to remove), then click **[!UICONTROL Add tag(s)]**.
...
1. In any list view or on the Dashboard, open the **[!UICONTROL Tags]** tab in the left sidebar, then click the tag in the list of tags that appear.\
   ![Searching_by_tag.png](assets/searching-by-tag-350x209.png)\
   The tag name appears in the search field in the upper-right corner of [!DNL Workfront Proof]. You can refine your search by selecting additional tags or by typing further keywords into the search field. You can remove a tag from the search field by clicking the x icon next to the tag name.
