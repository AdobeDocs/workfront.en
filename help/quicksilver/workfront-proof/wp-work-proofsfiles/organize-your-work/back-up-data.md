...
Your data will be ready to download as a zip file. You can download the backup .zip file either from the notification email or in the [!UICONTROL account settings], as described in the following sections:
