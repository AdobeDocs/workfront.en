...
1. View the presence indicators in the upper-right corner of the proofing viewer.
   ...
   If you are using [!DNL Workfront] Proof (not the proofing functionality integrated with [!DNL Workfront_], presence indicators contain the user's Workfront Proof profile picture or, if there is no profile picture, the first and last initial if the user.
