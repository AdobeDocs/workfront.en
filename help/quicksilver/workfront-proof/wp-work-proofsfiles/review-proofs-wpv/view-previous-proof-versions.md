...
1. (Optional) To unlock the version if you want users to be able to add comments or change a decision, if you have rights to do so, click the **[!UICONTROL Unlock]** icon in the left panel, then click **[!UICONTROL Yes, unlock]**.
