...
1. On the Dashboard or any Views list, click the **[!UICONTROL More]** (three dot) menu to the far-right of the proof, then click **[!UICONTROL Share proof links]** on the dropdown arrow.
