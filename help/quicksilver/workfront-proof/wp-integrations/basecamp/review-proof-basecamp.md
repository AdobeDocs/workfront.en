...
The [!DNL Basecamp] integration with [!DNL Workfront Proof] makes it easy for you to review and approve proofs without leaving [!DNL Basecamp].

You don't even need a [!DNL Workfront Proof] login to use all of the review tools to make comments and decisions on proofs:

* In your [!DNL Basecamp] account, you'll receive a message which includes the proof for you to review (via the miniproof)
...
>[!NOTE]
>
> If you are not a user of [!DNL Workfront Proof], you can still work on the proof in [!DNL Basecamp]. All you need to do is enter your email address and screen name. You can also choose to "[!UICONTROL remember me]" so you only need to enter these details once.
...
* Link to the [!DNL Basecamp] project message to take you straight to the proof in [!DNL Basecamp] (4)\
   If non-[!DNL Basecamp] reviewers have been added to the proof, their email notification will not include the [!DNL Basecamp] link.
* Proof progress (5)
...
## Viewing the Proof via the [!DNL Basecamp] Message

When you receive an email notification about a new proof added to your [!DNL Basecamp] project:
...
1. Click **[!UICONTROL Remember me]** so you only have to input your details once.\
   Now you're ready to proceed with reviewing the proof in [!DNL Basecamp].

## Reviewing a Proof in [!DNL Basecamp]

Reviewing a proof in [!DNL Basecamp] is as easy as doing so in [!DNL Workfront Proof]. The miniproof in [!DNL Basecamp] provides you with all the tools you need to add comments, mark-ups and make decisions on the proof.

![Basecamp_message_window_with_miniproof.png](assets/basecamp-message-window-with-miniproof-350x406.png)

* Your [!DNL Basecamp] project name (1)
...
* Sidebar (7)
* User name (8)
* [!UICONTROL Comment] and [!UICONTROL Decision] buttons (9)
* Zoom tools (10)
...
* The [!UICONTROL Go to [!DNL Basecamp]] button in the top left corner of the proof. Clicking this will take you back into your [!DNL Basecamp] account (3).
