...
---
# Understand the Basecamp Integration with [!DNL Workfront] Proof
...
The [!DNL Workfront] Proof integration with Basecamp helps you significantly improve review and approval of creative assets in Basecamp by enabling online proofing functionality right inside your Basecamp account. When you create proofs in [!DNL Workfront] Proof account you can connect them to a project in Basecamp. Reviewers will be able to use [!DNL Workfront] Proof's rich commenting and markup tools and make decisions directly inside Basecamp. [!DNL Workfront] Proof helps you to speed up your creative project delivery, reduce the time you spend managing approvals and reduce the number of design revisions.
...
* Link proofs in [!DNL Workfront] Proof directly to your Basecamp projects.
* Add Basecamp team members to your [!DNL Workfront] Proof proofs with just one click.
* See all comments and replies from [!DNL Workfront] Proof inside your Basecamp project.
