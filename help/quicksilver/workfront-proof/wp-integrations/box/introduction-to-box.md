...
title: Introduction to the [!DNL Workfront Proof] and Box integration
...
---
# Introduction to the [!DNL Workfront Proof] and [!DNL Box] integration

>[!IMPORTANT]
>
>This article refers to functionality in the standalone product [!DNL Workfront Proof]. For information on proofing inside [!DNL Adobe Workfront], see [Proofing](../../../review-and-approve-work/proofing/proofing.md).

Our integration with the [!DNL Box] online file sharing and content management system allows you to create new proofs and new proof versions directly from files in your [!DNL Box] account. For information about [!DNL Box], see www.box.com.

Our folder syncing functionality lets you synchronize a [!DNL Box] folder with a folder in [!DNL Workfront Proof]. When you add a file, or a new version of a file, to synchronized folder in [!DNL Box], the file is also added to the associated folder in Workfront Proof. For more information, see [Sync [!DNL Box] Folders With [!DNL Workfront Proof]](../../../workfront-proof/wp-integrations/box/sycn-box-folder.md).
...
* Send your creative files to [!DNL Workfront Proof] directly from your [!DNL Box] account.
* Notify your review team about new proof via email containing a link to the file in [!UICONTROL Box].
* Provide your users with [!DNL Workfront Proof]'s rich markup, commenting and discussion tools.
...
1. In your [!DNL Box] account, go to the **[!UICONTROL Apps]** section.
1. In the search bar, type **[!DNL Workfront Proof] Sync**.
1. Click **[!UICONTROL [!DNL Workfront Proof] Sync]** in the search results.
