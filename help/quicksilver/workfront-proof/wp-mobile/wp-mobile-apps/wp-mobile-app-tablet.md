...
1. Enable **[!UICONTROL Keep me logged in]**&nbsp;in the sidebar menu under **Settings**:
...
Similarly to the dashboard charts in our web application, in the mobile app we display a list of proofs that were shared with you. The welcome message at the top of the page will give you the total number of the proofs and below that we break them down into *On time*, *[!UICONTROL At risk],* and *Late proofs*.
...
Another view that you may find useful is the *[!UICONTROL Recent]* view - it shows you the proofs you recently accessed in the app, so if you'd like to see the same proof again, you can easily find it on that list.
...
1. Navigate in your proof:
   ...
   * To go to a different [!UICONTROL version] of the proof, use the version drop-down menu at the top of the page.
...
There are three [!UICONTROL comment viewing] options in the app. You can switch between them by clicking on the comment button.
...
Proofing text on the go is really in the [!DNL Workfront] Proof tablet app. The text annotation tool is available in the markups toolbar after you click on the [!UICONTROL orange&nbsp;Add comment] button.
...
1. Hold your finger on the word until highlight becomes available and use the sliders to highlight the whole word or phrase you want to markup.
   ...
   |---|---|
   | **Replace** | Adds [[!UICONTROL REPLACE]] and [[!UICONTROL WITH]] into the comment box together with the text, making it easier for you to recommend replacement text. |
...
When you are working on preparing the next version of your proof, you can check off [!UICONTROL comment]s as you go. The comment is marked as resolved with a green check mark. If you need to reopen the comment, you can click on the arrow at the bottom of the comment box.

![resolving_comments.png](assets/resolving-comments-350x193.png)

If you would like to prevent other reviewers from responding to a comment thread, you can lock it. To be able to do that, you need to have edit rights on the proof. Locking the comment thread is very simple, all you have to do is tap on the [!UICONTROL padlock] icon at the bottom of the comment box.
...
The [!UICONTROL compare] mode in the tablet app allows you to easily compare two different versions of a proof or two proofs from the same folder.
...
1. To select a different proof from the same folder, use the [!UICONTROL folder browser] (the folder icon available at the top of the page).
...
1. Tap the green decision button at the top of the page.
   ...
   If you don't see the green **[!UICONTROL Finish review]** button and you think you should make a decision on the proof, your [!DNL Workfront] Proof administrator can update your proof role, as explained in [Manage Proof Roles in Workfront Proof](../../../workfront-proof/wp-work-proofsfiles/share-proofs-and-files/manage-proof-roles.md).
...
| **Settings** | You can decide to show pins and/or markups on the proof, you can also enable [!UICONTROL Keep me logged in] to prevent you from getting logged out of the app. |
