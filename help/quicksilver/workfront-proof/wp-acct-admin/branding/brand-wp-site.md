...
For information about advanced branding, which includes branding the header, menu bar, dashboard, and more, see [Brand the [!DNL Workfront Proof] site - advanced](../../../workfront-proof/wp-acct-admin/branding/brand-wp-site-advanced.md). Advanced branding is available only on Select and Premium plans
...
1. In the **[!UICONTROL Branding]** section, click **[!UICONTROL Enable]**. (1)
...
1. Click the **[!UICONTROL Settings]** tab.
1. In the **[!UICONTROL Branding]** section, click **[!UICONTROL Setup]** next to **[!UICONTROL Proof branding]**. (1)

   ![Proof_loading_page_setup.png](assets/proof-loading-page-setup-350x159.png)

1. From the drop-down menu select **[!UICONTROL Branding image]**.
   If you select **[!UICONTROL Disable]**, the [!DNL Workfront Proof] logo appears on the proof loading page

1. Click **[!UICONTROL Save]**. (3)
...
1. Select the image you want to use for branding the emails. (2)
   ...
   If you have an email branding already configured and you want to disable it, click **[!UICONTROL Clear]**. (4)
