...
1. To view a complete list of account changes, click **See complete list** in the **[!UICONTROL Usage stats]** section.
   The Activity log page displays. For more information, see [Understanding the [!DNL Workfront Proof] Activity Audit Trail](../../../workfront-proof/wp-work-proofsfiles/basic-features/activity-audit-trail.md).
