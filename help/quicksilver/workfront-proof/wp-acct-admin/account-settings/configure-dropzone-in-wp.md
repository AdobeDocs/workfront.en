...
1. Click **[!UICONTROL Settings]** > **[!UICONTROL Account Settings]**, then open the **Dropzone** tab.
...
1. Make any changes in the **[!UICONTROL Dropzone fields]** section to specify which fields display in the Proof details section of the Dropzone submission page when proofs are submitted via the Dropzone.
