...
>* If the option to [!UICONTROL require login] is enabled, Subscriptions cannot be enabled.
>



You can require login by modifying your personal proof settings, as described in [[!UICONTROL Configure Proof] Settings in Workfront Proof](../../../workfront-proof/wp-work-proofsfiles/manage-your-work/configure-proof-settings.md).
