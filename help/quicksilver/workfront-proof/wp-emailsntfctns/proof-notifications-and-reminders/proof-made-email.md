...
A [!UICONTROL Proof Made] email is sent to the proof creator only when he or she has created a proof. If a person has created a proof and made another person the Owner, only the new Owner also receives the [!UICONTROL Proof made] email. The Creator and/or Owner will not get one; they receive only the [!UICONTROL Proof Made] email. For more information about the [!UICONTROL New Proof] email, see [[!UICONTROL New proof] email](../../../workfront-proof/wp-emailsntfctns/proof-notifications-and-reminders/new-proof-email.md).

Users can disable [!UICONTROL Proof Made] emails in their profile settings, as explained below.

>[!NOTE]
>
> If the Creator or Owner of the proof has [!UICONTROL Proof Made] emails disabled by default in their personal settings, they won't receive any [!UICONTROL Proof Made] or [!UICONTROL New Proof] emails, even if the [!UICONTROL Notify people by email] box is checked on the [!UICONTROL New proof] page.
...
If you don't want this link to appear on your recipient's email, you should disable the [!UICONTROL Public sharing] settings on the proof ([!UICONTROL Download original file] and [!UICONTROL Public URL]).

## Disabling the [!UICONTROL Proof Made] Email
