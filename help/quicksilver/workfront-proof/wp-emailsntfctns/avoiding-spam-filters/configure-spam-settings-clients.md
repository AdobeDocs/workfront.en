...
Alternatively, to create an email filter for each of the two [!DNL Workfront Proof] "[!UICONTROL from]" addresses:
...
To remove any [!DNL Workfront Proof] "[!UICONTROL from]" addresses from the blocked addresses list:
