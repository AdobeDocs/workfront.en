   ...
   <table style="table-layout:auto">
    ...
    <tbody>
     ...
     <tr>
      ...
      <td><p> Add users and Task Collaborators to the Resource Pool individually.<br>Or <br>Add a large amount of users to the Resource Pool at one time. You can add one of the following entities associated with users or collection of users:
        <ul>
