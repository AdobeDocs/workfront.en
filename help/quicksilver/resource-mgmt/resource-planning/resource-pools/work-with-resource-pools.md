...
description: As a resource manager, you can manage your resources by adding users to resource pools and then adding the resource pools to projects.
author: Lisa
...
For more information about the prerequisites needed before you can start using Resource Planning, see the "Prerequisites for working in the Resource Planner" section in the article [Resource Planner overview](../../../resource-mgmt/resource-planning/get-started-resource-planner.md).
...
* We do not recommend adding all users in the system to one Resource Pools if you have a large number of users, or if you manage resources for a large number of projects at a time.
