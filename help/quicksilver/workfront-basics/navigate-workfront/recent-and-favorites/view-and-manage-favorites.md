...
1. Click the **[!UICONTROL Favorites]** icon ![Favorites icon](assets/favorites-icon.png) in the upper-right corner of any [!DNL Adobe Workfront] page.
...
1. Click the **[!DNL Favorites]** icon ![Favorites](assets/favorites-icon.png) in the upper-right corner of the page, then click **[!UICONTROL Add Current Page]**.

   ![Add current page to favorites](assets/add-current-page.png)
...
1. Click the **[!UICONTROL Favorites]** icon ![Favorites icon](assets/favorites-icon.png) in the upper-right corner of any [!DNL Workfront] page.

1. Hover over the item that you want to remove as a favorite, then click the **X** next to it.

   Or

   If you are on the page that you want to remove as a favorite, click the **[!UICONTROL Favorites]** icon ![Favorites icon](assets/remove-favorite-icon.png) next to the object name to remove it from the **Favorites** menu.
