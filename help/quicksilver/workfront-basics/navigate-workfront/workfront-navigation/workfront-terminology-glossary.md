...
<table cellspacing="15"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>&nbsp;</td> 
   <td>&nbsp;</td> 
  </tr> Form Types If you create a report or list containing all of your custom forms, you can use this field as a view or filter to see which object types are associated with each form. FTE The designated full time equivalency for users. A full-time user should have 100% FTE and part-time user should have a percentage that equals their working hours. Integrated 
 </tbody> 
</table>
