...
>[!NOTE]
>
>The options you have in the selection view **More** menu might be different depending on what your [!DNL Workfront] administrator or [!DNL Workfront] Proof administrator has set up.
...
1. To select an individual comment, tap the check box.
   ...
   To select all comments, select the **[!UICONTROL More]** menu on the top right ![More menu](assets/mobile-verticalmoremenu-20x33.png) and choose **Select All**.
...
1. To delete the selected comments, select the **[!UICONTROL More]** menu on the top right ![More menu](assets/mobile-verticalmoremenu-20x33.png) and choose **[!UICONTROL Delete]**. Then, select **Delete** on the confirmation message to permanently delete the comment.
