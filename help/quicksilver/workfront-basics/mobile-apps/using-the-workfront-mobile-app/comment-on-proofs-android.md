...
1. To add an attachment to the comment, select ![Attachment icon](assets/mobile-paper-clip-icon.png). Choose **Select a Document** or **Take a Photo**, and follow the prompts to attach the file or photo to the comment.
