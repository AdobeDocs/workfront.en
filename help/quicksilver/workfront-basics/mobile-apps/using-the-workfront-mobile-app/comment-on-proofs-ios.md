...
1. To mark the selected comments as read, select the **[!UICONTROL Mark as read]** icon ![Mark as read](assets/mobile-markread-icon-30x31.png) in the bottom toolbar.
...
1. To add an attachment to the comment, select ![[!UICONTROL Attachment] icon](assets/mobile-paper-clip-icon.png). Select **[!UICONTROL Choose From Library]**, **[!UICONTROL Take a Photo]**, or **[!UICONTROL Select a Document]**, and follow the prompts to attach the file or photo to the comment.
