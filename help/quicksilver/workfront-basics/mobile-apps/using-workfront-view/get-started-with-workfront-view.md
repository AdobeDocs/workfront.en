...
If you must complete work, you must use the [!DNL Workfront] mobile app which is available on iOS and Android phones.

## Supported devices and access levels

The [!DNL Workfront] View app is supported only for iPads.
...
Users with Requestor and External licenses cannot access [!DNL Workfront] using the [!DNL Workfront] View mobile app.
...
1. Go to the **[!DNL Workfront] View** app on your iPad.\
...
1. Specify your **[!DNL Workfront] Username**.
1. Specify your **[!DNL Workfront] Password**.
1. Specify the **[!DNL Workfront] URL** of your company.
