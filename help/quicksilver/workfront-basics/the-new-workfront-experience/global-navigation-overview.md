...
The **[!UICONTROL Main Menu]** icon ![Main Menu](assets/main-menu-icon.png) opens the [!UICONTROL Main Menu], from where you can navigate to a different area of Workfront.
