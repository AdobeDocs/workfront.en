...
1. Click the More icon ![](assets/more-icon.png) next to the pin name and select **[!UICONTROL Rename pin]**.

   ![Rename pin](assets/pin-menu.png)

1. Type the new pin name, and click **Save**.
...
1. (Optional) Choose **Move to front** to move your pin to the far right position of the pin bar. 
