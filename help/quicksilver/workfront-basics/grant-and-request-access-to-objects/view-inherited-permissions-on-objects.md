...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">Access level configurations</td> 
   <td> <p>View or higher access on the objects you want to view permissions for</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">Object permissions</td> 
   <td> <p>View or higher permissions on the objects you want to view permissions for</p> </td> 
  </tr> 
 </tbody> 
</table>
