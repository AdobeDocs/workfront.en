...
### Group similar work items together with the '[!UICONTROL Group by]' option
...
The [!UICONTROL Home] area has a permanent grouping dedicated to team requests with a direct link to the team's request page. Use this grouping to view and access requests for any of the teams you're on.

>[!NOTE]
>
>The [!UICONTROL Filter] and [!UICONTROL Sort by] options do not affect the [!UICONTROL Team Requests] grouping. This grouping is visible as long as you have work assigned to your team.
...
Keep track of work that you submitted for approval directly from [!UICONTROL Work List]. You can remind the approver about the work that needs approval. You can also recall the approval if needed.

>[!NOTE]
>
>The [!UICONTROL Filter] and [!UICONTROL Sort by] options do not affect the [!UICONTROL Approvals I've Submitted] grouping. This grouping is visible as long as you have work waiting for approval.
...
The [!UICONTROL Work List] allows you to surface and prioritize work that is important to you with the [!UICONTROL My Priority Sort by] option. You can add up to 20 items to your [!UICONTROL My Priority] list. Use the [!UICONTROL More] menu to add work items to your priority list. 
...
>[!NOTE]
>
>You can't update the [!UICONTROL Commit Date] in this area.
...
* Updating the [!UICONTROL Commit Date]
