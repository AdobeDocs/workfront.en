...
1. Click **Working On** 
   ...
   <!--
   <p>Click <strong>Requested</strong> under Issues to display issues that have been requested from you (you are assigned to them), but you have not accepted to work on yet. </p>
   -->
...
1. If the work request is still in the Ready to Start or Not Ready state, you can use the **Reassign** button in the **More** menu in the Work List.  
...
1. You can find this information on the Updates tab of the task. Make sure the option to **Show System Updates** is enabled.
1. Start new update
1. Enter the name of the recipient in the **Notify** box, then click **Update**.

1. If the work request is still in the Ready to Start or Not Ready state, you can use the **Reply** button in the **More** menu in the Work List.  
...
1. Or
1. Click the **More** menu icon ![](assets/more-icon.png) to the right of the task or issue name in the Home Work List.

1. ![](assets/more-menu-in-home-work-list-convert-to-request-remove-add-to-priority-options-nwe-350x160.png)
