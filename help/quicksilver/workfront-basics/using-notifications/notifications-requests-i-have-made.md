...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> <p><strong>A personal task I've assigned to someone else is completed</strong> </p> <p>A notification is sent out to the user who assigned a personal work request to someone else when that request is completed. </p>  <p>The subject of the instant notification email is: <em>Task Completion: &lt;Task Name></em></p> <p> <p>Note:  You cannot configure this notification for a daily digest email.</p> </p> </td> 
