...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>[!DNL Workfront Goals] <p>For information about [!DNL Workfront Goals], see <a href="../../workfront-goals/goal-management/wf-goals-overview.md" class="MCXref xref">[!DNL Adobe Workfront Goals] overview</a>.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"><strong>Access level configurations*</strong></td> 
   <td> <p>[!UICONTROL View] access to [!DNL Goals] or higher</p> <p>Note: If you still don't have access, ask your [!DNL Workfront] administrator if they set additional restrictions in your access level. For information on how a [!DNL Workfront] administrator can change your access level, see <a href="../../administration-and-setup/add-users/configure-and-grant-access/create-modify-access-levels.md" class="MCXref xref">Create or modify custom access levels</a>.</p> </td> 
  </tr> <!--
...
![Notifications preferences](assets/goals-notifications-preferences-350x114.png)
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p><strong>Fields included</strong> </p> <p><strong>*Instant notifications only</strong></p> </td> 
  </tr> 
  <tr> 
   <td><strong>Someone assigned a Result/ an Activity to me</strong></td> 
   <td> <p>The name of the person who assigned the result or activity to you</p> <p>The Period of the goal for the result or activity</p> <p>The name of the result or activity</p> <p>The <strong>[!UICONTROL Open in web app]</strong> button which opens the [!UICONTROL Goal Details] panel</p> <p>The <strong>[!UICONTROL Change Notifications Settings]</strong> button which allows you to manage your notifications.</p> </td> 
  </tr> 
  <tr> 
   <td><strong>Someone created a new personal Goal for me</strong> </td> 
   <td> <p>The name of the person who assigned the goal</p> <p>The Period of the goal</p> <p>The name of the goal</p> <p>The <strong>[!UICONTROL Open in web app]</strong> button which opens the [!UICONTROL Goal Details] panel</p> <p>The <strong>[!UICONTROL Change Notifications Settings]</strong> button which allows you to manage your notifications.</p> </td> 
  </tr> 
  <tr> 
