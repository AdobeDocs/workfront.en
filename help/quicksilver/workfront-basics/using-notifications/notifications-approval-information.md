...
<table cellspacing="15"> 
 ...
 <tbody> 
  <tr> 
   <td> <p><span class="bold">A delegated issue approval request is completed</span> </p> <p>An issue approval that you delegated to another user was approved or rejected by that user.</p> <p>The subject of the instant notification email is: <em>Issue Approval/ Rejection Made on Your Behalf by &lt;User Name&gt;</em></p> <p>The subject of the daily digest notification is:<em> Digest of Approval Information &lt;Date of daily digest&gt;</em></p> </td> 
  ...
  <tr> 
   <td> <p><span class="bold">A delegated project approval request is completed</span> </p> <p>A project approval that you delegated to another user was approved or rejected by that user.</p> <p>The subject of the instant notification email is: Project<em> Approval/ Rejection Made on Your Behalf by &lt;User Name&gt;</em></p> <p><em>The subject of the daily digest notification is: Digest of Approval Information &lt;Date of daily digest&gt;</em> </p> </td> 
   <td> Project Name<br>Portfolio Name<br>Project Reference Number<br>Name of the user who approved/ rejected the project on your behalf<br>Approval Decision<br>Project Status<br>Name of the user who requested the approval<br><span class="bold">See More Details</span> button<br>*Project Reference Number<br>*Project Name<br>*Approver Name<br>*Date of the daily digest<br></td> 
   <td><span class="bold">Daily</span> </td> 
  </tr> 
  <tr> 
   <td> <p><span class="bold">A delegated task approval request is completed</span> </p> <p>A task approval that you delegated to another user was approved or rejected by that user.</p> <p>The subject of the instant notification email is: Task<em> Approval/ Rejection Made on Your Behalf by &lt;User Name&gt;</em></p> <p>The subject of the daily digest notification is:<em> Digest of Approval Information &lt;Date of daily digest&gt;</em></p> </td> 
