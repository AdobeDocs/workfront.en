...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  --> 
  <tr> 
   <td> <p><strong>An issue I'm assigned to is completed</strong> </p> <p>A notification is sent only if the project status is [!UICONTROL Current] or [!UICONTROL Planning].</p> <p>Users with a [!UICONTROL Review] or [!UICONTROL Requestor] license do not receive a notification.</p> <p>The subject of the instant notification email is: <em>[!UICONTROL Complete]: &lt;Issue Name> on &lt;Project Name></em></p> <p><em> The subject of the daily digest notification is: [!UICONTROL Digest of Work Assigned to You] &lt;Date of daily digest> </em> </p> </td> 
