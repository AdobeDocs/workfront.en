...
title: Add a Dashboard in the Left Panel of a Workfront Object or Area
...
The following table lists all the [!DNL Workfront] areas and objects that contain sections in the left panel and which of them can be customized with a dashboard:
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td><p>View access to the object type</p> </td> 
  </tr> 
 </tbody> 
</table>
...
1. Go to one of the [!DNL Workfront] areas or objects where you can add a dashboard in the left panel.

   For more information about what areas and objects you can add dashboards to, see [[!DNL Adobe Workfront] sections](#adobe-workfront-sections).

1. Click **[!UICONTROL Add a Dashboard]** in the left panel.
...
1. (Optional) Drag and drop the sections in the order in which you would like to display them.
   ...
   The dashboards you added are available only to you.
...
Only a system or a group administrator can share dashboards with other users in a layout template. For more information about customizing the left panel with a layout template, see [Customize the left panel using a layout template](/help/quicksilver/administration-and-setup/customize-workfront/use-layout-templates/customize-left-panel.md).
