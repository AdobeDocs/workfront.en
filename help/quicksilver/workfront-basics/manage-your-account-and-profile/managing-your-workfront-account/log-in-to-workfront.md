...
1. Open a browser window, then type in the unique URL of your company, which should have the following format: **yourCompanyDomain.my.workfront.com**.
   ...
   For more information about what browsers are supported for [!DNL Workfront], see [Adobe Workfront browser requirements](../../../workfront-basics/workfront-browser-requirements.md).
...
## Log in to [!DNL Workfront] with SSO {#log-in-to-workfront-with-sso}
