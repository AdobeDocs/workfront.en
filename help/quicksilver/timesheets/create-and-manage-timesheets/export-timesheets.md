...
{{step1-to-timesheets}}
   ...
   ![Timesheets area](assets/timesheet-list-one-timesheet-selected-nwe-350x70.png)

1. (Optional) Click the **search** icon ![Search icon](assets/search-icon.png) and type a keyword and search for a speicific timesheet. For example, you can search for a timehsset time frame or owner name. 
...
1. Select the timesheets that you want to export, then click the **Export** ![Export icon](assets/export-38x15.png) icon.

   ![Click the Export icon](assets/export-timesheets.png)
