...
1. Find the document you need, and do one of the following:
   ...
   * Click the document in the list, click the **Open Summary** icon ![Open Summary icon](assets/qs-summary-in-new-toolbar-small.png) in the upper-right corner, then add a new comment, or click **Reply** to add a reply to an existing comment. For information about the Summary, see [Summary for documents overview](../../documents/managing-documents/summary-for-documents.md).
