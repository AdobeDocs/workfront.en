...
1. Open the Web Proofing Viewer or the Desktop Proofing Viewer in one of the following ways:
   ...
   * If you use Workfront Proof, click the **Go to Proof** icon for the proof in the Dashboard or a Views list ![Go to Proof](assets/go-to-proof-blue-icon.png).

1. If the left toolbar is not showing, click the&nbsp;**Menu**&nbsp;icon, located in the upper-left corner of the Web Proofing Viewer.

   ![Menu icon](assets/menu-icon-in-proofing-viewer-350x228.png)

1. In the left toolbar, click the **Settings** icon ![Settings icon](assets/settings-icon-in-pv.png).   
