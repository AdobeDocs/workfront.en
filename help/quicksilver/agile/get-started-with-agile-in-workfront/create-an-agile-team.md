   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td><p>Type a description for the team.</p> <p>The description displays on the top right of the Teams area when the team is selected. If the description is long, you can click it to display the full description in a pop-up. If you have access to edit the team settings, you can also edit the description directly in the pop-up.</p></td>
     </tr> 
    </tbody> 
   </table>
