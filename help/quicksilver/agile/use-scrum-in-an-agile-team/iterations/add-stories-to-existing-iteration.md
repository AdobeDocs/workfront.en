...
* From the backlog after the iteration is created, as described in the [[!UICONTROL Move stories from the backlog to an iteration or Kanban board]](../../../agile/work-in-an-agile-environment/manage-the-agile-backlog.md#moving-stories-from-the-backlog) section in [[!UICONTROL Manage the agile backlog]](../../../agile/work-in-an-agile-environment/manage-the-agile-backlog.md)
...
1. In the **[!UICONTROL Add Stories]** box, type the name of the iteration.
