...
The [!UICONTROL Project End Date] is used instead of the [!UICONTROL Iteration End Date] if the project start date is after the iteration start date, and the project end date is after the iteration end date.
