...
>[!NOTE]
>
>Only statuses selected in the Story Board section in the [!UICONTROL team settings] area are available on the Kanban board and in the status drop-down menu. For more information, see [Configure Kanban](../../agile/get-started-with-agile-in-workfront/configure-kanban.md)
