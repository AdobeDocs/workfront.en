...
1. For a dynamic board only, follow the setup wizard steps:
   ...
   1. Search for and select [!UICONTROL **Assignments**] to bring tasks and issues onto the board.
      ...
      >[!NOTE]
      >
      >The card limit for dynamic boards is 700 tasks and 700 issues, for a total of 1,400 cards. High numbers of cards on the board can affect the board performance. Archived cards count toward this limit.
