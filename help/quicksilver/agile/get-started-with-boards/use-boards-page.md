...
The [!UICONTROL boards] dashboard shows the list of boards that you have access to, including boards you have created and boards that you have been added to.
...
You can filter the [!UICONTROL boards] dashboard to show active boards, archived boards, or all boards.
...
>[!NOTE]
>
>Sorting the dashboard is available only via the early feature opt-in. For details, see [Early feature opt-in for [!DNL Adobe Workfront] Boards](/help/quicksilver/agile/get-started-with-boards/boards-early-feature-opt-in.md).

1. Click the **Main Menu** icon ![](assets/main-menu-icon.png) in the upper-right corner of [!DNL Adobe] Workfront, then click **Boards**.
1. To sort the list of boards, click the sort icon ![Sort icon](assets/sort-boards-icon.png). The default sort option for the page is by **Date modified**. You can also sort the page by board **Name**.
...
>[!NOTE]
>
>Searching in the dashboard is available only via the early feature opt-in. For details, see [Early feature opt-in for [!DNL Adobe Workfront] Boards](/help/quicksilver/agile/get-started-with-boards/boards-early-feature-opt-in.md).
...
1. Click the **More** menu ![More menu](assets/more-icon-spectrum.png) on the board, and select **Archive**.
   ...
   An [!UICONTROL Archive] icon ![Archive](assets/archive-icon-spectrum-25x20.png) appears on the board. You can't edit an archived board.

   Archived boards are hidden on the boards dashboard unless you apply a filter to display them. For more information, see the [[!UICONTROL Filter boards]](#filter-boards) section in this article.

1. To restore an archived board, click the **More** menu ![More menu icon](assets/more-icon-spectrum.png) on the board and select **[!UICONTROL Restore]**.
...
1. Click the **Main Menu** icon ![](assets/main-menu-icon.png) in the upper-right corner of [!DNL Adobe] Workfront, then click **Boards**.
1. Click the **More** menu ![[!UICONTROL More menu]](assets/more-icon-spectrum.png) on the board, and select **Delete**.
