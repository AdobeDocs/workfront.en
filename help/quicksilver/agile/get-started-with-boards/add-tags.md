...
title: Add tags
description: You can add tags to cards to visually show that they are similar. Then you can filter by those tags to display related cards. Tags are not shared between boards.
---
...
1. Click the **Save** icon to save the tag, or the **Cancel** icon to cancel creating the tag.

   ![](assets/boards-savecancelnewtag-350x38.png)

1. (Conditional) Repeat steps 4-6 to create additional tags.
1. Click **Done** in the top-right corner of the box.
...
1. In the **Tags** box, type the name of an existing tag and select it from the search results.  
   Or  
   Click the **Edit**icon ![Edit tag](assets/boards-edittag-30x29.png) and create a new tag in the Tag Manager. Click **Done** to return to the card. The new tag is automatically added to the card.
1. Click **Close**.
...
1. (Conditional) Click the color drop-down menu to change the tag color.
1. Click **Done**.
...
1. Click the **Main Menu** icon ![](assets/main-menu-icon.png) in the upper-right corner of Adobe Workfront, then click **Boards**.
1. Access a board. For information, see [Create or edit a board](../../agile/get-started-with-boards/create-edit-board.md).
1. Click the **More**menu next to the board name, then choose **Tag Manager**.
