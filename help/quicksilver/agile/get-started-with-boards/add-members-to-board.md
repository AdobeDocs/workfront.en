...
1. In the **Add members** box, start typing a name, then select it when it displays in the list.
   ...
   You can select an individual member or a team. In the Production environment, if you choose a team, everyone on the team is added to the board individually. In the Preview environment, if you choose a team, the team itself is added to the board.
