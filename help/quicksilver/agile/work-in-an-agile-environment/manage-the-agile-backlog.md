...
* **Kanban agile teams:** Tasks can be assigned to the agile team and added to the backlog. Users can view the backlog directly from the agile story board, as described in [[!UICONTROL Add the backlog] to the Kanban board](../../agile/use-kanban-in-an-agile-team/view-the-backlog-on-the-kanban-board.md). The team uses this backlog to prioritize and manage their work queue.
...
You can edit stories directly from the [!UICONTROL Stories] or [!UICONTROL Issues] tabs on the Backlog as you would edit any tasks or issues within a project in bulk, as described in [[!UICONTROL Edit tasks in bulk]](../../manage-work/tasks/manage-tasks/edit-tasks.md#editing-tasks-in-bulk) in [[!UICONTROL Edit] tasks](../../manage-work/tasks/manage-tasks/edit-tasks.md) and [[!UICONTROL Edit issues]](../../manage-work/issues/manage-issues/edit-issues.md#bulk-editing-issues) in [Edit issues](../../manage-work/issues/manage-issues/edit-issues.md).
...
1. Select the stories you want to move to an iteration or Kanban board, then click **[!UICONTROL More]** > **[!UICONTROL Move to]**.\
   If moving the story to a Kanban board, the [!UICONTROL Move Story to the Kanban] Board is displayed.\
...
1. Do either of the following:
   ...
   * **For Kanban teams:** In the **[!UICONTROL Select Kanban Board]** field, select your team Kanban board. (Kanban teams can have only one Kanban board.)
