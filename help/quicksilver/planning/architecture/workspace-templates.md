...
Workfront Planning comes with a set of templates to get you started with basic record types and fields when you are building your workspace. For information about creating workspaces, see [Create workspaces](/help/quicksilver/planning/architecture/create-workspaces.md). 
