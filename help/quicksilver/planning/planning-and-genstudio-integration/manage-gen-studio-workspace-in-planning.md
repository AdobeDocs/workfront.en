...
1. Click **Other workspaces** and find a workspace that has an indication that was created by the **System** and has the **GenStudio** tag on its card. 
    ...
    ![GenStudio workspace card with tag](assets/genstudio-card-with-tag-highlighted.png)
...
1. Click the **More** menu ![More menu](assets/more-menu.png) to the right of a record type name, then click one of the following:
...
1. To manage the record type views, do the following: 
   ...
   * Click the **Full screen** icon ![Open full view in full screen icon](assets/open-full-screen-icon.png) to open any view in full-screen mode. 
