---
title: User Licensing Overview for for Adobe Workfront Planning as a Standalone Product
...
# User licensing overview for Adobe Workfront Planning as a standalone product
...
For more information, see the section "Package overview" in the article [Get started with Adobe Workfront Planning as a standalone product](/help/quicksilver/planning/planning-sta/planning-only-overview.md).

## Workfront Planning access levels

Workfront Planning as a standalone product introduces two distinct access levels with the following respective license types. Each maps to a role in the system and controls what areas of the product are accessible.
...
|---|---|---|
| Access level description | Full system access — equivalent to System Administrator in Workfront | Can manage workspaces and content — equivalent to Standard license in Workfront | 
...
## User access levels and navigation

<!-- should this be moved to the Manage users in Planning article??-->

The areas in the interface available for standalone Workfront Planning users are limited to their access levels, as are their capabilities. 
...
### Planning Administrator overview
...
* Has full manage access to the system, equivalent to the System Administrator access in Workfront.
...
* Has the following areas in the Main menu: 
    ...
    * **Requests**
    * **Setup**
* Has access to a limited number of sections in the Setup area: 
    ...
    * **Customer info section**: View customer and organization details.
    * **Preferences**: Review and configure system-level preferences.

### Planning Standard overview

A user with a Planning Standard access level  has the following capabilities: 

* Can manage workspaces and their content, equivalent to the Standard license in Workfront.
* Planning Standard users can access the following areas in the Main menu:

    * **Planning**
    * **Users**: They have view-only access to users. They cannot create or edit users. 
    * **Requests**

* Have view-only access to the Users list. They cannot create or edit users.
* Can submit and manage requests.
...
>[!IMPORTANT]
>
>The Planning Contributor access level is only available when your organization upgrades from Planning as a standalone package to a Planning with a Workflow package.
...
For more information, see [Get started with Adobe Workfront Planning as a standalone product](/help/quicksilver/planning/planning-sta/planning-only-overview.md).
