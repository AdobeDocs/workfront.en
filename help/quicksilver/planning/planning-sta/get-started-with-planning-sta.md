...
* Connect Planning objects to Workfront objects
* Add existing custom fields from Workfront to Planning record types
* Automatically create Workfront projects based on Planning information
* See Planning information in Workfront's Canvas Dashboard reporting system
