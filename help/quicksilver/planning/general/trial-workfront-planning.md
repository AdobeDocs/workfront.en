...
To review and accept the legal agreement, do one of the following: 

* Before March 2, 2026, do the following: 
    ...
    1. (Conditional) If you are not a System Administrator, follow the in-app banner that contains information about the **Workfront Planning trial**, then click **Learn more**.  
        ...
        You can read more about the Workfront Planning trial and about Workfront Planning. 

* After March 2, 2026, when the trial launches, do the following:
    ...
    1. Click **Accept**, after reviewing the agreement. 
        ...
        * The Planning area is added to the Main Menu for you and all users in your system and it shows a **Trial** badge. 
        * As a System Administrator, you receive Manage access to the **Best practice workspaces** tab in the Planning area. 
        * All users in your system that are not System Administrators receive View access to the **Best practice workspaces** tab in the Planning area. 
    ...
    1. (Conditional) If you are not a System Administrator, and your System Administrator has accepted the trial agreement, follow the in-app banner that contains information about the **Workfront Planning trial** and click **Open Planning**.
        ...
        Start exploring the **Best practice workspaces** tab and share workspaces or their object with others.
