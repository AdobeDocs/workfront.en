...
* Assign users Workfront and Planning licenses and Workfront Planning permissions that would allow them to either view or create objects in Workfront Planning. 
  ...
  For more information about granting access to and enabling others to use Workfront Planning, see [Adobe Workfront Planning access overview](/help/quicksilver/planning/access/access-overview.md). 
...
For more information, see [Workfront Planning terminology overview](/help/quicksilver/planning/general/planning-terminology.md).
