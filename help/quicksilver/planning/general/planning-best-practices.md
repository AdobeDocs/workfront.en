---
title: Adobe Workfront Planning Recommendations for Implementation
...
* Removing a user from the record type's permissions still gives them at least View permissions to the workspace.
