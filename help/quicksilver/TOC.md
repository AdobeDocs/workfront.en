...
* Administration and setup {#administration-and-setup}
  ...
  * User management {#add-users}
    ...
    * How access levels work {#access-levels}
      ...
      * [Access to objects and areas by licenses](administration-and-setup/add-users/how-access-levels-work/access-to-objects-areas-license-types.md)
      ...
      * [Disable the auto-upgrade option for non-paid users](administration-and-setup/add-users/how-access-levels-work/disable-auto-upgrade.md)
    ...
    * How legacy access levels work {#legacy-access-levels}
      ...
      * [Legacy access level overview](administration-and-setup/add-users/access-levels-and-object-permissions/access-levels-overview.md)
...
* Reporting {#reporting}
  ...
  * Workfront Data Connect {#data-lake}
    ...
    * Tips, Tricks, and Troubleshooting for Data Connect{#troubleshooting-data-connect}
      * [Tips, Tricks, and Troubleshooting for Data Connect](/help/quicksilver/reports-and-dashboards/data-lake/tips-tricks-troubleshooting/tips-tricks-troubleshooting-data-connect.md)
...
* Review and approve work {#review-and-approve-work}
  ...
  * Unified approvals {#document-reviews-and-approvals}
    ...
    * Set up and manage asset and document approvals {#manage-asset-review-and-approval}
      ...
      * [Create a document approval workflow](review-and-approve-work/document-reviews-and-approvals/manage-document-approvals/create-a-document-approval.md)
      * [Add additional approvers or reviewers to a document approval workflow](review-and-approve-work/document-reviews-and-approvals/manage-document-approvals/add-additional-reviewers-or-approvers.md)
      * [Remove approvers or reviewers from a document approval workflow](review-and-approve-work/document-reviews-and-approvals/manage-document-approvals/remove-approvers-or-reviewers.md)
      * [Create an approval workflow template for documents](review-and-approve-work/document-reviews-and-approvals/manage-document-approvals/create-approval-template.md)
  ...
  * Proofing {#proofing}
    ...
    * Review proofs in Adobe Workfront {#review-proofs-in-workfront}
      ...
      * Review a proof {#review-a-proof}
        ...
        * [Review interactive content with the Adobe Workfront review tool](review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/review-proof-in-web-viewer-extension.md)
...
* Adobe Workfront Planning {#adobe-workfront-planning}
  ...
  * Manage Adobe Workfront Planning {#manage-adobe-workfront-planning}
    * [Manage users in Adobe Workfront Planning](planning/manage-planning-sta/manage-users-in-planning-sta.md)
