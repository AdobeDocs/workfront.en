...
* Administration and setup {#administration-and-setup}
  ...
  * Manage Adobe Workfront {#manage-wf}
    ...
    * Security {#security}
      ...
      * [Update SAML 2.0 metadata in your IDP when using enhanced authentication](help/quicksilver/administration-and-setup/add-users/single-sign-on/update-saml-2-metadata-ip-eauth-.md)
