...
<tr>
   ...
   <td> <p>Your Workfront or group administrator must add the Planning area in the Main Menu and the Planning section in the left panel to your layout template. For information, see <a href="../access/access-overview.md">Access overview</a>. </p>  
</td>
  </tr>
