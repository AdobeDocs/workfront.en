...
description: You can edit manage the layout of the record box and page in Adobe Workfront Planning.
hidefromtoc: yes
hide: yes
...
1. In the record box or page, click the grab icon ![](assets/grab-icon.png) to the left of a field name, then drag and drop it in a desired spot. 
