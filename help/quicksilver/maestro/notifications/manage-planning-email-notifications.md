...
1. (Conditional) After someone tags you in a comment on a record, go to the email notification that informs you of the tag and of the comment. 

    ![](assets/email-notification-example.png)

1. Click the message in the **Workfront** box. 
