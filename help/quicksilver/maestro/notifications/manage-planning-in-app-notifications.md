...
1. (Conditional) After someone tags you in a comment on a record, go to in-app **Notifications** icon ![](assets/experience-cloud-notifications-icon.png) in Adobe Experience Cloud. 
