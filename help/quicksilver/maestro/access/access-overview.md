...
All users in your organization can have access to Maestro, regardless of their access level.  
...
You must have the following to use Adobe Maestro: 
...
<tr>
   ...
   <td> <p>Your Workfront administrator must add the Maestro area in the Main Menu to your layout template.</p> 
...
There are no permissions associated with Maestro objects. 
