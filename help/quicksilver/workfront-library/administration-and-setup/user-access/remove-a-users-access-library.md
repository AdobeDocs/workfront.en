...
>[!NOTE]
>
>To determine how a user has access to [!DNL Workfront] Library, you can open the Library menu and go to **Setup** > **Access** > **Users**. In the Users area, you see a list of users and the type of access they have is listed in the Access Sources column.\
...
1. Next to the user's name, click the [!UICONTROL More] menu, then select **Remove individual access**.
...
1. In the Remove individual access dialog, click **Remove user**.
   ...
   >[!NOTE]
   >
   >If you want to restore access for an inactive user, you can locate them by clicking the Filter icon, then selecting **[!UICONTROL Deactivated users]** from the menu. After finding the [!UICONTROL Deactivated users] list, you can select **[!UICONTROL Restore user access]** from the [!UICONTROL More] Menu.
