...
title: Give users access to a [!DNL Workfront Library] portal
description: Before users can open a [!DNL Workfront Library] portal, they must be given access to the portal. As a user with Manage access or higher to a portal, you can grant users the following types of access to the portal.
...
1. (Optional) Assign a different access level to the users.
   ...
   1. Select the user or users for whom you want to change access, then click **[!UICONTROL Edit]**.

      The [!UICONTROL Edit Access] dialog box opens.
...
Users can inherit access to a portal through a [!DNL Workfront] user grouping that you've added to the portal.
