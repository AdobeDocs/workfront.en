...
As a [!DNL Workfront] Library administrator, you can transfer all of the asset in a user's My Content area to a different user.
...
1. In the [!UICONTROL Transfer ownership] dialog, click **Search recipient's name or email** and start typing the new owner's name or email, then select the name in the list that appears. After making a selection, the user's name replaces the search field.
...
1. Click the **Asset Actions&rbrack;** icon ![](assets/library-document-icon.png), then click **Transfer asset ownership&rbrack;**.
