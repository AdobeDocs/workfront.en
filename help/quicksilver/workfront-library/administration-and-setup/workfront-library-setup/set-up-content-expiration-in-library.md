...
You can configure [!DNL Workfront Library] to send an email to the content owner to alert them of the impending expiration of the content.

Expired items migrated from [!UICONTROL Workfront DAM] to [!DNL Workfront Library] remain expired.
