...
As a user with [!DNL Manager] or higher access to [!DNL Workfront Library], you can enable a filter to display hidden content to which you have [!DNL Manage] permission. Users with Viewer access to [!DNL Workfront Library] cannot view hidden content.
...
1. In the **[!UICONTROL Filter]** menu, enable the **[!UICONTROL Show Hidden]** toggle.
   ...
   You can now view hidden content. The Show Hidden filter affects only your instance of [!DNL Workfront Library] and does not make hidden items visible for other users.
