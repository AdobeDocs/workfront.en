...
1. In [!DNL Workfront], click the **Main Menu** icon !![main menu icon] (assets/main-menu-icon.png, then select **[!UICONTROL Library]** to open [!DNL Workfront] Library in a new browser tab.
