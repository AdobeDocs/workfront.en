...
1. Click in the **Select a Request Type** box, and in the drop-down list, select the request queue you want to send your request.
   ...
   The options that display on the request form depend on how the request queue is configured. For information on populating the fields on the request form, see [Creating and Submitting Workfront Requests.](/help/quicksilver/manage-work/requests/create-requests/create-submit-requests.md)
