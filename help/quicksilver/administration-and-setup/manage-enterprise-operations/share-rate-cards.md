...
title: Share a Rate Card
description: You can share a rate card with users, job roles, groups, teams, companies, and business profiles.
author: Lisa
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>View or higher access to [!UICONTROL Rate Cards]</td> 
  </tr> 
  <tr> 
   <td>Object permissions</td> 
   <td>View permissions or higher to the rate card you want to share</td> 
  </tr> 
 </tbody> 
</table>
...
1. Click the drop-down to the right of the entity name and select their permission level for this rate card:

   * View: Can view and share the rate card.
   * Manage: Can edit the rate card.
