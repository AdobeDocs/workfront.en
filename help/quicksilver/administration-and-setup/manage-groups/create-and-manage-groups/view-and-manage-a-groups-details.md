     ...
     <tr> 
      ...
      <tr data-mc-conditions="QuicksilverOrClassic.Draft mode"> 
       ...
       <td> 
        ...
        </div> <p class="preview">For information about inactive groups, see <a href="#inactive-groups" class="MCXref xref">Inactive groups</a> in this article.</p> </td> 
      </tr>
     --> 
     <tr> 
...
<h2 id="inactive-groups"><a name="Inactive"></a>Inactive groups</h2>
