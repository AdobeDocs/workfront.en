...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> <p><strong>Personalized workspaces</strong> </p> <p>Create a dynamic place to work the way you want, and pin it for easy access.</p> </td> 
   <td> <p><strong>The new Workfront experience</strong> </p> <p>Personalize your workspace by pinning pages for easy access.</p> <p>For more information about this feature in the new Adobe Workfront experience, see <a href="../../workfront-basics/the-new-workfront-experience/pin-pages.md" class="MCXref xref">Pin pages to customize your workspace in the new Adobe Workfront experience</a>.</p> <p><strong>Classic experience</strong> </p> <p>3 levels of tabs that can be difficult to navigate and require unnecessary clicks. Customization can be done only to second-level tabs.</p> </td> 
  </tr> 
  <tr> 
   <td> <p><strong>More complete breadcrumb navigation</strong> </p> <p>Connection to strategy</p> </td> 
   <td> <p><strong>The new Workfront experience</strong> </p> <p>Breadcrumbs display the full navigational hierarchy, and the experience is consistent and complete across all object types, including proofs.</p> <p>For more information, see <a href="../../workfront-basics/the-new-workfront-experience/breadcrumb-overview.md" class="MCXref xref">Breadcrumbs overview in the new Adobe Workfront experience</a>.</p> <p><strong>Classic experience</strong> </p> <p> Breadcrumbs display only the level immediately above the current object you're viewing.</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p><strong>The new Workfront experience</strong> </p> <p>Simplified multi-level navigation. Less-intrusive, quicker access to the areas and actions you use most. Users can drag to customize the order of options in the left navigation, and administrators can customize which options display.</p> <p>For more information, see <a href="../../workfront-basics/the-new-workfront-experience/simplified-left-navigation.md" class="MCXref xref">Simplified left navigation in the new Adobe Workfront experience</a>.</p> <p><strong>Classic experience</strong> </p> <p>3 levels of tabs that can be difficult to navigate and require unnecessary clicks.</p> </td> 
  </tr> 
  <tr> 
   <td> <p><strong>Summary panel</strong> </p> <p>Quick access to update your progress or collaborate on a task.</p> </td> 
   <td> <p><strong>The new Workfront experience</strong> </p> <p> Click a work item in a task or issue list to quickly open summarized information without leaving the current screen.</p> <p>For more information, see <a href="../../workfront-basics/the-new-workfront-experience/summary-overview.md" class="MCXref xref">Summary overview in the new Adobe Workfront experience</a>.</p> <p><strong>Classic experience</strong> </p> <p>Clicking a work item takes you to a new page.</p> </td> 
  </tr> 
  <tr> 
   <td> <p><strong>Standard and custom data displayed in a single location</strong> </p> <p>Personalize the layout to see detailed information about your work.</p> </td> 
