---
filename: position-fields-in-a-custom-form
user-type: administrator
product-area: system-administration
navigation-topic: create-and-manage-custom-forms
title: Position fields and widgets in a custom form
description: You can change the order of fields and widgets in a custom form.
---

# Position fieldsand widgets in a custom form

You can change the order of fieldsand widgets in a custom form.
...
1. Add custom fieldsand widgets to the form, as described in [Add a custom field to a custom form](../../../administration-and-setup/customize-workfront/create-manage-custom-forms/add-a-custom-field-to-a-custom-form.md) and [Add or edit an image widget in a custom form](../../../administration-and-setup/customize-workfront/create-manage-custom-forms/add-image-or-edit-its-properties-in-a-custom-form.md).

1. (Optional) To position fields on the same row, drag one fieldor widget next to the other until a line appears between them.
...
1. (Optional)To position a fieldor widget above or below another one, drag it above or below until a horizontal blue line appears between the items.
