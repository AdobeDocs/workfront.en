...
1. Add custom fields
   ...
   to the form, as described in [Add a custom field to a custom form](../../../administration-and-setup/customize-workfront/create-manage-custom-forms/add-a-custom-field-to-a-custom-form.md) and [Add or edit an image widget in a custom form](../../../administration-and-setup/customize-workfront/create-manage-custom-forms/add-image-or-edit-its-properties-in-a-custom-form.md).

1. (Optional) To position fields on the same row, drag one field

   <!--
   or widget
   -->

   next to the other until a line appears between them.
...
1. (Optional)To position a field
