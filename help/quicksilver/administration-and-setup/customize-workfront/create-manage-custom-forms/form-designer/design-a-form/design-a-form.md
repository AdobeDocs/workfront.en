...
>[!IMPORTANT]
>
>When you add an image or video to a custom form this way, the permissions set in the Documents area apply to the image or video when users access the form on an object.

1. Go to the file in the Documents area and generate a proof for it, as described in [Create an interactive proof for a website or other web content](/help/quicksilver/review-and-approve-work/proofing/creating-proofs-within-workfront/generate-interactive-proof-for-website-or-other-web-content.md).
1. Open the proof.
