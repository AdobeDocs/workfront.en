...
1. Click **Maximize** to open the **Calculation Editor** and build your calculation, then click **Minimize** to close it when you are finished.
   ...
   <a href="#calculated-custom-fields-in-multi-object-custom-forms" class="preview MCXref xref xrefpreview">Calculated custom fields in multi-object custom forms</a>
...
<h2 id="calculated-custom-fields-in-multi-object-custom-forms"><a name="Calculat"></a>Calculated custom fields in multi-object custom forms</h2>
