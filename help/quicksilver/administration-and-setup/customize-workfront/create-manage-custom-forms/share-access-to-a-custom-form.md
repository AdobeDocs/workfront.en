...
description: You can configure access for a custom form to control who can view, share, and edit it.
author: Lisa
...
Rather than leaving a custom form in the default sharing state (described in [Access to custom forms](#access-to-custom-forms) in this article), you can configure specific levels of access to the form for certain users, job roles, groups, teams, companies, and business profiles.

{{step-1-to-setup}}

1. In the left panel, click **Custom Forms**.
1. Select the custom form in the list, then click ![Share icon](assets/share-icon.png).

   Or

   Open a custom form or create a new custom form. Then, Click **Share** on the top right of the form designer.

1. In the sharing box, under **Grant custom form access to**, start typing the name of the user, team, job role, group, company, or business profile you want to share the custom form with, then press **Enter** when the name displays.
1. To adjust access for the user, team, job role, group, company, or business profile you just added, click the drop-down menu to the right of the name, then configure one of the following available options and any of its advanced settings:
