...
## List and edit custom forms and items added to custom forms

1. Click the **Main Menu** icon ![](assets/main-menu-icon.png) in the upper-right corner of Adobe Workfront, then click **Setup** ![](assets/gear-icon-settings.png).

1. Click **Custom Forms**.

   With the **Forms** tab selected, all of your organization's custom forms are listed, along with their descriptions, the object types associated with them, the names of the users who created them, and whether or not they are active in the system.
...
1. Click the **Fields** tab.
   ...
   This tab lists the custom fields and widgets that users in your system have added to custom forms, along with information about the type of each item, instructions and details about it, and a list of the custom forms that contain it.

   This list contains only custom form items that meet at least one of the following criteria:
   ...
   * Shared with you, with either View or Manage access
   ...
   >[!NOTE]
   >
   >Section breaks are not displayed on the Fields tab.
