...
1. Click **Set Main Menu** near the upper-right corner.
   ...
   * Boards
   * Blueprints
   * <span class="preview">Campaigns</span>

      >[!NOTE]
      >
      ><span class="preview">Campaigns are available in the Preview environment when you participate in the Campaigns beta program. The functionality described here might not be fully available yet. For more information about current available features and how to enroll, see [Campaigns beta](../../../product-announcements/betas/campaign-object-beta.md).</span>
