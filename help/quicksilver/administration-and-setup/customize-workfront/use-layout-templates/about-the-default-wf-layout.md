...
The default layout is the arrangement of the Main Menu ![Main menu icon](assets/main-menu-icon-left-nav.png), the left panel, and the views, groupings, and filters before an Adobe Workfront administrator makes any changes using a layout template.
...
### Default Main Menu for legacy license types

The following table shows the default Main Menu items and what left panel items display for each legacy license type:
