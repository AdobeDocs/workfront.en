 ...
 <tr> 
   ...
   <td> 
    <ul> 
     ...
     </td>  <td><ul><li>You must have licenses for both Workfront and GenStudio for Performance Marketing.</li><!--DELETE THIS SECTION MARCH 2026--><!--<li>Your Workfront instance must be on the Adobe Unified Experience.</li>--><li>Workfront and GenStudio for Performance Marketing must be deployed to the same IMS Org.</li></ul></td> 
