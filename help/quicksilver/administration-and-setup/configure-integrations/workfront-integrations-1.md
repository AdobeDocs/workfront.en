  ...
  <tr> 
   ...
   <td> 
    <ul> 
     ...
     <p>For information and instructions, see <a href="../workfront-integrations-and-apps/adobe-workfront-for-creative-cloud\wf-cc-install-toc.md" class="MCXref xref">Install the  [!DNL Adobe Workfront] plugin for [!DNL Creative Cloud] Applications</a></p> 
     </td>  <td>&nbsp;</td> 
   <td>&nbsp;</td> 
  </tr> 
  <tr> 
