...
description: You can connect your work with the following [!DNL Adobe Experience Manager] Assets Integrations.
feature: Digital Content and Documents, Workfront Integrations and Apps
exl-id: bc58cc77-a177-417f-a5a4-eec51e305219
---
# Configure the [!DNL Experience Manager Assets] as a [!DNL Cloud Service] integration
...
<table>
  ...
  <tr>
   ...
   <td>You must have [!DNL Experience Manager Assets] as a [!DNL Cloud Service], and you must be added to the product as a user.
   </td>
  </tr>
  <tr>
...
* You must have [!DNL Workfront] and [!DNL Adobe Experience Manager Assets] associated with your [!UICONTROL Organization ID] in the [!DNL Adobe Admin] Console. For more information see, [Platform-based administration differences ([!DNL Adobe Workfront]/[!UICONTROL Adobe Business Platform)]](/help/quicksilver/administration-and-setup/get-started-wf-administration/actions-in-admin-console.md).


## Set up the integration information

1. Click the **[!UICONTROL Main Menu]** icon  in the upper-right corner of [!DNL Adobe Workfront], then click **Se[!UICONTROL ]tup** .
1. Select **[!UICONTROL Documents]** in the left panel, then select **[!UICONTROL [!DNL Experience Manager] Integration]**.
1. Select **Add [!UICONTROL [!DNL Experience Manager] Integration]**.
1. In the **[!UICONTROL Name]** field, enter the name you want users to see when interacting with this integration in [!DNL Workfront] and [!DNL Experience Manager Assets].
1. In the **[!UICONTROL Navigation URL]** field, the system automatically populates the [!UICONTROL Navigation URL]. This URL is used to link to your organization's Experience Manager instance from the Main Menu for quick access.
1. Choose a repository from the **[!UICONTROL [!DNL Experience Manager Assets] repository]** drop-down menu. The system automatically populates any [!DNL Experience Manager] repositories associated with the [!UICONTROL Organization ID] that your user profile is assigned to.
   ![choose experience manager repository](assets/setup-information.png)

1. Click **[!UICONTROL Save]** or move on to the [[!UICONTROL Set up metadata] (Optional)](#set-up-metadata-optional) section in this article.
...
1. In the **[!UICONTROL Workfront field]** column, choose a built-in or custom [!DNL Workfront] field.

   >[!NOTE]
   >
   >You can map a single [!DNL Workfront] field to multiple [!DNL Experience Manager] Assets fields. You can't map multiple [!DNL Workfront] fields to a single [!DNL Experience Manager Assets] field.
...
1. Click [!UICONTROL Save] or move on to the [[!UICONTROL Folders]](#folders) section in this article.
...
1. In the **[!UICONTROL [!DNL Workfront] field]** column, choose a built-in or custom [!DNL Workfront] field.
...
Any [!DNL Experience Manager] fields that are mapped to [!DNL Workfront] portfolio, program, project, task, issue, and document fields update automatically when the field is changed in [!DNL Workfront].
...
1. Click [!UICONTROL Save] or move on to the [[!UICONTROL Set up linked folders] (Optional)](#set-up-linked-folders-optional) section in this article.
