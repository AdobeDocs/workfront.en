 ...
 <tbody> 
  <tr> 
   ...
   <td> 
    <ul> 
     ...
     <li> <b>View</b> <p>To fine-tune this, you can configure the ability to share projects. Click the gear icon <img src="assets/gear-icon-in-access-levels.png"> on the View button, then disable or enable the <b>Share</b> option (enabled by default).</p> </li> 
  ...
  <tr> 
   ...
   <td> 
    <ul> 
     <li> <p><b>No access</b>: Blocks all access to projects.</p> </li> 
     <li> <b>View</b> (default selection) <p>View access is limited because you can't fine-tune it to enable or disable project sharing.</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td>External User</td> 
  ...
  <tr> 
   ...
   <td> 
    <ul> 
     ...
     <li> <b>View</b> <p>To fine-tune this, you can configure the ability to share tasks. Click the gear icon <img src="assets/gear-icon-in-access-levels.png"> on the View button, then disable or enable the <b>Share</b> option (enabled by default).</p> </li> 
  ...
  <tr> 
   ...
   <td> 
    <ul> 
     ...
     <li> <b>View</b><p>To fine-tune this, you can configure the ability to share issues. Click the gear icon <img src="assets/gear-icon-in-access-levels.png"> on the View button, then disable or enable the <b>Share</b> option (enabled by default).</p> </li> 
  ...
  <tr> 
   ...
   <td> 
    <ul> 
     ...
     <li> <b>View</b> <p>To fine-tune this, you can configure the ability to share portfolios. Click the gear icon <img src="assets/gear-icon-in-access-levels.png"> on the View button, then disable or enable the <b>Share</b> option (enabled by default).</p> </li> 
  ...
  <tr> 
   ...
   <td> 
    <ul> 
     ...
     <li> <b>View</b> <p>To fine-tune this, you can configure the ability to share programs. Click the gear icon <img src="assets/gear-icon-in-access-levels.png"> on the View button, then disable or enable the <b>Share</b> option (enabled by default).</p> </li> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 
    <ul> 
     ...
     <li> <b>View</b><p>To fine-tune this, click the gear icon <img src="assets/gear-icon-in-access-levels.png"> on the <b>Edit</b> button), then disable or enable any of the following actions. Both of them are enabled by default:</p> 
      <ul> 
  ...
  <tr> 
   ...
   <td> 
    <ul> 
     <li> <p><b>No access</b>: Blocks all access to programs.</p> </li> 
     <li> <b>View</b> (default selection)<p>To fine-tune this, click the gear icon <img src="assets/gear-icon-in-access-levels.png"> on the <b>Edit</b> button, then disable or enable any of the following actions. Both of them are enabled by default:</p> 
      <ul> 
       <li> <p>View Built-In Reports</p> </li> 
       <li> <p>Share</p> </li> 
      </ul> </li> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 
    <ul> 
     <li> <b>View</b><p>To fine-tune this, you can configure the ability to share filters, views, and groupings. Click the gear icon <img src="assets/gear-icon-in-access-levels.png"> on the View button, then disable or enable the <b>Share</b> option (enabled by default).</p> </li> 
  ...
  <tr> 
   ...
   <td> 
    <ul> 
     ...
     <li> <b>View</b> <p>To fine-tune this, you can configure the ability to share documents. Click the gear icon <img src="assets/gear-icon-in-access-levels.png"> on the View button, then disable or enable the <b>Share</b> option (enabled by default).</p> </li> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 
    <ul> 
     <li> <b>View</b><p>To fine-tune this, you can configure the ability to view users' contact information. Click the gear icon <img src="assets/gear-icon-in-access-levels.png"> on the <b>View</b> button, then disable or enable the <b>View Contact Info</b> option (enabled by default).</p> </li> 
  ...
  <tr> 
   ...
   <td> 
    <ul> 
     <li> <b>View</b> (only option available)<p>To fine-tune this, you can configure the ability to view users' contact information. Click the gear icon <img src="assets/gear-icon-in-access-levels.png"> on the <b>View</b> button, then disable or enable the <b>View Contact Info</b> option (enabled by default).</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td>Reviewer</td> 
   <td> 
    <ul> 
     <li> <b>View</b> (only option available) <p>To fine-tune this, you can configure the ability to view users' contact information. Click the gear icon <img src="assets/gear-icon-in-access-levels.png"> on the <b>View</b> button, then enable or disable the <b>View Contact Info</b> option (disabled by default).</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td>Requestor</td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 
    <ul> 
     <li> <b>View</b> (only option available) <p>To fine-tune this, click the gear icon <img src="assets/gear-icon-in-access-levels.png"> on the <b>View</b> button, then disable or enable any of the following options*. Both are enabled by default.</p> 
      <ul> 
       <li> <p>View all teams</p> </li> 
  ...
  <tr> 
   ...
   <td> 
    <ul> 
     ...
     <li> <b>View</b> <p>To fine-tune this, you can configure the ability to share templates. Click the gear icon <img src="assets/gear-icon-in-access-levels.png"> on the View button, then disable or enable the <b>Share</b> option (enabled by default).</p> </li> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 
    <ul> 
     ...
     <li> <b>View</b>: <p>To fine-tune this, click the gear icon <img src="assets/gear-icon-in-access-levels.png"> on the <b>View</b> button, then disable or enable any of the following options*. Both are enabled by default.</p> 
      <ul> 
  ...
  <tr> 
   ...
   <td> 
    <ul> 
     <li> <p><b>No access</b> (default selection): Blocks all access to financial data.</p> </li> 
     <li> <b>View</b> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
