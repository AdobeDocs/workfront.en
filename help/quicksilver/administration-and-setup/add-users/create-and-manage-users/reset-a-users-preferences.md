...
author: Caroline
=======
description: As a Adobe Workfront administrator, you can reset or remove the user preference settings for any user in the Workfront system. Individual users can also reset their own user preference settings. Individual users can also reset their own user preference settings.
>>>>>>> Stashed changes
