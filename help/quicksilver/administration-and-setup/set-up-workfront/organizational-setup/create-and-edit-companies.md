...
description: You can add companies to [!DNL Workfront] and use them for financial planning, reporting purposes, to define permissions around objects, and to keep information confidential.
author: Caroline
...
When a [!DNL Workfront] administrator assigns a group to a company, the group administrators for the group gain Manage access to the company in Setup. This includes access to the [!UICONTROL Companies] page in Setup, where they can see and manage the company associated with their group.
