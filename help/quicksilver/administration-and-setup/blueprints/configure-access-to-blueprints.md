...
<!--
You can also define whether users with specific access levels can request blueprint installation or only browse the catalog.
-->
...
<!--
Define access levels After setting up the request queue, you can define whether users with specific access levels can request blueprint installation or only browse the catalog. Click the Main Menu icon in the upper-right corner of Adobe Workfront, then click Setup .
-->
