...
title: Assign Tasks
description: You can assign tasks to users, roles, teams, or Work Agents to indicate who is responsible for completing the tasks. You can assign a task to more than one resource at a time.
author: Lisa
...
1. Click **Assign to** in the **Assignments** field in the header of the task 
   ...
   ![Assignments](assets/assignments-from-task-header-0825.png)
...
| **Assignments** |Assign users, job roles, teams, or Work Agents |
...
1. To assign tasks do one of the following:
   ...
   * Click inside the **Assignments** field and start typing the name of an active user, job role, team, or Work Agent that you want to assign to the task, then click it when it displays in the list.
...
1. In the **Assignments** area, start typing the name of users, teams, roles, or Work Agents in the **Search people, roles, or teams** field provided, then click them when they display in the list
