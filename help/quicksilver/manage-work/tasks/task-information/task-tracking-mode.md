...
<li value="2"> Click the <strong>More</strong> icon <img src="assets/qs-more-icon-on-an-object.png">next to the name of the task, then click&nbsp;<strong>Edit</strong>. <p>The Edit Task dialog box opens. </p> </li>
