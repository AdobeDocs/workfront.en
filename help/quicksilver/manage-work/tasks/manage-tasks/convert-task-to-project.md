...
1. In the **Convert to Project** box, specify the following:
  ...
  * (Optional) Add **Custom Forms** to the new project.
    ...
    <!--  
    In the Preview environment, if a multi-object custom form attached to the task is configured for use with both tasks and projects, all information saved in the form is retained when you make the conversion.  
    -->
