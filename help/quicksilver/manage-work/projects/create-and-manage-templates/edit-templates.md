...
The changes you make on the template do not reflect on  projects currently using that template.

You can edit one template at a time, or you can edit templates in bulk. 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 
    <p>Contribute permissions to a template to edit it in the Template Details tab</p> 
     <p>Manage permissions to a template to edit it in the Edit Template box</p>
   </td> 
  </tr> 
 </tbody> 
</table>
...
### Template Settings {#template-settings}
   ...
   <td><p>Select this option to require the future Project Owner of the project created from this template to approve time logged on the project.</p> 
   <p>If you are using Billing Records and you select this option, only the approved hours on the project appear as available billable hours for the Billing Records. </p>
   <p>Approving time on the project is independent of approving timesheets. For more information about requiring time to be approved on a project, see <a href="../../../manage-work/projects/manage-projects/require-time-approval-for-projects.md" class="MCXref xref">Require time to be approved for a project</a>.</p>
   </td> 
   </tr> 
   <tr> 
