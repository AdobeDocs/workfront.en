...
1. Update the following information about the project:
      ...
      <li>If your organization uses both legacy Workfront and Adobe cloud storage, you can't copy tasks between projects that use different storage types. Your Workfront instance might not have both types of document storage.</li></ul> 
