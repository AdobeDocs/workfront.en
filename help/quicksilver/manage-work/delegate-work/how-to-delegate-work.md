...
>[!NOTE]
>
>Although you can be assigned to work when you have a Request license, you cannot delegate your work to others. Workfront does not recommend assigning work to Review or Request users. 
...
* Your Workfront or group administrator enabled the [!UICONTROL Allow users to delete tasks & issues with logged hours] setting in the [!UICONTROL Setup] area of your Workfront instance.
...
1. Go to the Home area, then click Edit delegation in the upper-right corner of the Work List.
...
1. Click the sorting drop-down menu to sort the list by the following criteria:
