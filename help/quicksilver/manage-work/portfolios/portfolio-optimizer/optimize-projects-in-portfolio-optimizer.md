...
You can use the [!UICONTROL Portfolio Optimizer] to prioritize your projects based on their scores and other values. The Optimizer takes into account important project information like the cost, alignment, risk and ROI to prioritize the projects according to what is more important to you.
...
1. Click the **x icon** to close the optimization categories.
   ...
   This updates the [!UICONTROL Score] values for each project in the **Score** column.
