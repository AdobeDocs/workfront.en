...
1. (Optional) Click inside the **[!UICONTROL Add custom form]** box in the upper-right corner of the Portfolio Details page to select a custom form for the portfolio and update the custom fields.
