...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <li><p>Light or higher license to edit an issue in the Issues section of a project</p></li></ul> 
    Or
   <ul><li><p>Requestor or higher</p> </li>
   <li><p>Reviewer or higher license to edit an issue in the Issues section of a project</p></li></ul> 
   </td> 
  </tr> 
  <tr> 
