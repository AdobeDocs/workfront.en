...
* **When you move issues between projects with different storage types**: You cannot copy an issue from a Workfront-storage project to an Adobe-storage project. The reverse is also true. Not all customers have both types of storage. 
