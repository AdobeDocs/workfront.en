...
You must have Manage permissions to the issue to modify the Priority of the issue.
...
<table style="table-layout:auto"> 
 ...
 <thead> 
  <tr> 
   <th>Priority Label <br>(Can be modified) </th> 
   <th>Priority Number <br>(Cannot be modified) </th> 
  </tr> 
 </thead> 
 <tbody> 
  <tr> 
