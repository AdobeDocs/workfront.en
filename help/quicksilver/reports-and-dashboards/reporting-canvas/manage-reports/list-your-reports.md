...
* A line visualization showing how the reports' views have trended over time.
  ...
  <!--
  <p style="color: #ff1493;" data-mc-conditions="QuicksilverOrClassic.Draft mode">[Show one here]</p>
  -->

When you list your reports, you can also search for reports and use tags 

<!--
<span style="color: #ff1493;" data-mc-conditions="QuicksilverOrClassic.Draft mode">[show using 16-pixel-high icon screenshot inline]</span>
-->
...
<table cellspacing="0"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td> <p>View access to the report</p> <p>Note: To see certain information about an object in a report, you may also need access to view that specific object, such as the task, project, or so forth.</p> <p>For information on requesting additional access, see <a href="../../../workfront-basics/grant-and-request-access-to-objects/request-access.md" class="MCXref xref">Request access to objects </a>.</p> </td> 
  </tr> 
 </tbody> 
</table>
