...
You can apply a filter to the dashboard that contains prompts __________
...
1. To add a prompt, follow the steps below:
    ...
    1. Click **Select field**, then specify the field you want to ________.
...
1. To add a custom prompt, follow the steps below:
    ...
    1. Enter _____ in the **Option Value** field. 
