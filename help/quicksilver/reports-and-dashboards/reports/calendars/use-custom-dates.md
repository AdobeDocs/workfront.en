     ...
     <tr>
      ...
      <td><p>Choose how you want the dates to show:</p>
       <ul>
        ...
        <li><strong>Duration (Start to End)</strong>: The calendar displays the object over a span of days.<br><p>Note: If you choose <strong>[!UICONTROL Duration]</strong>, the end date specified must be after the start date or the item won't show on the calendar.</p></li>
       </ul></td>
     </tr>
