...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>View or higher permissions to the calendar report, with access to share</p> <p>For information on requesting additional access, see <a href="../../../workfront-basics/grant-and-request-access-to-objects/request-access.md" class="MCXref xref">Request access to objects </a>.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
Sharing a calendar is similar to sharing other objects. For more information about sharing objects in Adobe Workfront, see [Overview of sharing permissions on objects](../../../workfront-basics/grant-and-request-access-to-objects/sharing-permissions-on-objects-overview.md).
...
1. Specify the permissions for each user, team, role,&nbsp;group, or company that you added in Step 3 by clicking&nbsp;the drop-down menu, then select the permission level that you want to grant:
   ...
   * **View:**&nbsp;Users can&nbsp;review and share&nbsp;the calendar.&nbsp;
     ...
     ![](assets/calendar-share-view-permissions-350x249.png)
   ...
   * **Manage:**Users&nbsp;have full access to the calendar, minus administrative&nbsp;rights which are granted at the access level, plus all View permissions.
     ...
     ![](assets/calendar-share-manage-permissions-350x241.png)
