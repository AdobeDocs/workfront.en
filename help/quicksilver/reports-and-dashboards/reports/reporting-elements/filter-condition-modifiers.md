...
For a list of built-in time frame modifiers, see the article [Filter reports by time frames](/help/quicksilver/reports-and-dashboards/reports/creating-and-managing-reports/filter-reports-time-frames.md).
