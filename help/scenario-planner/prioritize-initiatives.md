...
<ol> 
 ...
 <li value="3"> 
  <div> 
   ...
   <ul> 
    <li> <p>Click the handle to the left of one of the selected initiatives' names, then drag it up or down in the list to change the initiative's priority.</p> <p><span>Workfront</span> displays the number of selected initiatives.</p> <p> <img src="assets/multi-select-initiative-number.png"> </p> </li> 
    <li> <p>Click the <span class="bold">Prioritize</span> box at the bottom of the plan, then choose from the following options:</p> 
     ...
     </ul> <p><span>Workfront</span> immediately places the selected initiatives where you indicate and the numbers of all initiatives update accordingly. </p> </li> 
   </ul> 
  </div> </li> 
