...
<ol> 
 <li value="1"> <p> Click the <span class="bold">Main Menu</span> icon <img src="assets/main-menu-icon.png"> in the upper-right corner, then click <span class="bold"><span>Scenarios</span></span>. </p> <p> <img src="assets/scenarios-main-menu-highlighted-350x463.png" style="width: 350;height: 463;"> </p> <p>The <span>Workfront Scenario Planner</span> displays. </p> <note type="important">
   The 
   <span>Workfront Scenario Planner</span> contains the plans you created. If you need to see another user's plan, they must share the URL of that plan with you. 
  </note> </li> 
