...
# Deactivate a team {#deactivate-a-team}
...
## Deactivate a team {#deactivate-a-team-1}
...
*  The Owner field in *`Workfront Goals`*. This requires an additional license for *`Adobe Workfront Goals`*. For more information, see [Get started with Adobe Workfront Goals](getting-started-with-wf-goals.md).
