...
1. Find the `Work On It` button section near the bottom of the `<MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver"> Edit Teams</MadCap:conditionalText>` page.
