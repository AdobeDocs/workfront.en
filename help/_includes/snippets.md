...
Click the Main Menu icon in the upper-right corner of Adobe Workfront ![](assets/main-menu-icon.png), or (if available), click the Main Menu icon in the upper-left corner ![](assets/main-menu-icon-left-nav.png), then click Setup ![](assets/gear-icon-setup.png).
