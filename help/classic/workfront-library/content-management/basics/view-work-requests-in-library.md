...
For more information on work requests, see [Create and submit Workfront requests](/help/classic/manage-work/requests/create-requests/create-submit-requests.md).
