...
* Add a custom tab to any area or object in Workfront and add a dashboard to it.  
  For more information about creating custom tabs, see Create custom tabs or sections.
...
* Access the tab that it is placed on and the dashboard placed on the tab displays.  
  For more information about placing dashboards on custom tabs or layout templates, see Create custom tabs or sections.
