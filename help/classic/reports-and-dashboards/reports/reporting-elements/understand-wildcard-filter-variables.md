  ...
  <tr> 
   ...
   <td> 
    <div> 
     ...
     <p>For more information and an example, see the section <a href="../../../administration-and-setup/customize-workfront/create-manage-custom-forms/add-calculated-data-to-custom-form.md#calculat" class="MCXref xref">Add calculated data to a custom form</a> in the article <a href="../../../administration-and-setup/customize-workfront/create-manage-custom-forms/add-calculated-data-to-custom-form.md" class="MCXref xref">Add calculated data to a custom form</a>.</p> 
    </div> </td> 
  </tr> 
 </tbody> 
</table>
