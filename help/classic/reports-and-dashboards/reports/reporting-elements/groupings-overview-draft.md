...
You can create a grouping using the standard builder interface in the following ways:

* From scratch
* Modify an existing grouping
* Copy an existing grouping

For information about creating a grouping using the builder interface, see [Create groupings in Adobe Workfront](../../../reports-and-dashboards/reports/reporting-elements/create-groupings.md).
