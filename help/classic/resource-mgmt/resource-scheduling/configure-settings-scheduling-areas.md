...
When scheduling resources in the Staffing tabof a project or in the Teams Working On tab , whether Parent Tasks display or not depends on the following settings:
...
The following table outlines when the Parent Tasks display in the Staffing tabof a project or in the Teams Working On tab , and when only the subtasks display.&nbsp;

| Completion Mode of the Project |Summary Completion Mode of the Project |Type of tasks displayed in the Staffing tab&nbsp; |Type of tasks displayed in the Teams Working On tab |
|---|---|---|---|
