...
* At the team level, in the following areas of Workfront:
  ...
  * The existing resource scheduler in the Working On tabof a team.
...
* Share it with anyone that does not have access to the Peoplearea by embedding a link to it in a custom tab.&nbsp;For information, see [Share the Workload Balancer with a link](../../resource-mgmt/workload-balancer/share-link-for-workload-balancer.md)
...
<!--
Watch the following video for an overview of the Workload Balancer. Note: The Workload Balancer is available in both Adobe Workfront Classic and the new Adobe Workfront experience. The video displays the Workload Balancer in the new Adobe Workfront experience.
-->
