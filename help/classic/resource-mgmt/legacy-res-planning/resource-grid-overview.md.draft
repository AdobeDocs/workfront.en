...
(NOTE: this is linked elsewhere)
</MadCap:conditionalText>
-->

The estimated amount of work required to complete the tasks. If you select to view the hours by the **Planned** allocations, you see hours distributed evenly on the days between the Planned Start and the Planned Completion dates. The start date takes into account the time stamp of the Planned Start Date&nbsp;of the task. For example, if a task is scheduled to start at 4 PM the day of the Planned Start Date of the task, and the work day of the user ends at 5 PM, according to their schedule, only 1 planned hour is allocated to that task in the first day of the task.   
