...
description: In addition to using the available drafts that Workfront suggests to you when you enter a new request, you can also access a draft request from the Drafts tab and finish submitting it from there.
---
...
In addition to using the available drafts that Workfront suggests to you when you enter a new request, you can also access a draft request from the Drafts tab  and finish submitting it from there.
...
* Start creating a request. This saves the request as a draft automatically in the Drafts tab.
...
1. (Optional and conditional)&nbsp;At any point during entering the request, click&nbsp;**Discard** if you want to delete the draft. This deletes the draft which cannot be recovered. For more information about deleting drafts, see [Delete a request draft](../../../manage-work/requests/create-requests/delete-request-draft.md). 
