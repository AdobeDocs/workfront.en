...
1. 
   ...
   <!--
   <li value="4" data-mc-conditions="QuicksilverOrClassic.Draft mode"> To add tasks to the task list:
   <ul>
   <!--
   ...
   <!--
   <li value="5" data-mc-conditions="QuicksilverOrClassic.Draft mode"> To remove a task, select the task, then click <strong>Delete</strong>. </li>
   -->
