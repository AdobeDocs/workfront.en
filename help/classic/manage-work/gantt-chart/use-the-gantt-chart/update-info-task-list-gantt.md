...
<li value="2" data-mc-conditions="QuicksilverOrClassic.Classic"> <p>On the <strong>Tasks</strong> tab, click the <strong>Gantt chart</strong> icon.</p> <p>All changes are saved automatically when the <strong>Autosave</strong> option is enabled. It is enabled by default. </p> </li>
<li value="3">
<div>
<p data-mc-conditions="QuicksilverOrClassic.Classic">(Optional) In the <strong>Autosave</strong> drop-down menu select <strong>Manual save</strong> or <strong>Timeline Planning</strong> to save your changes manually.</p> <note type="tip">
