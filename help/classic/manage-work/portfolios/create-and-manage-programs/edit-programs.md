...
1. Do one of the following:
   ...
   * Click the name of a program to open it, then click **Program Details**.
     ...
     ![](assets/program-details-tab-overview-classic-350x405.png)
   ...
   <table cellspacing="0"> 
    ...
    <tbody> 
     <tr> 
      ...
      <td> <p>Update the name of the program.</p> <p>Tip: This is not available in the Edit Program box when you select more than one program. </p> </td> 
     </tr> 
     <tr> 
      <td role="rowheader">Description</td> 
      <td> <p>Type a description for the program to indicate what is unique about it. </p> </td> 
     </tr> 
     <tr> 
      <td role="rowheader">Program Manager</td> 
      <td> <p>Start typing the name of a user that you want to indicate as the program manager, then select it when it appears in the list. This is the person who can oversee the work defined in the projects of the program. </p> <p>Important: When you designate someone as the Program Manager, they automatically gain&nbsp;Manage permissions to the program and the projects in the program. </p> <p>&nbsp;</p> </td> 
     </tr> 
     <tr> 
      <td role="rowheader">Group</td> 
      <td> <p>Add the name of a single group if the group is associated with the program or has responsibility for completing it. </p> </td> 
     </tr> 
     <tr> 
...
1. (Conditional) In the Edit Program box, click **Comment**.
...
<tr>
<td role="rowheader">Name</td>
<td> <p>Update the name of the program. </p> <note type="tip">
...
<li value="3"> <p>Add a comment in the <strong>Post an update to the program</strong> field.</p> </li>
