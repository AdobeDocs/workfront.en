...
Depending which resource management tools you are using, you can view the following types of Budgeted Cost: Legacy Budgeted Cost: If the Planned Hours of the tasks on the project match the Legacy Budgeted Hours (in the Legacy Resource Estimates section of the Business Case), and if the task Billing Type is Role Hourly, the Legacy Budgeted Cost of the project is the same as the Planned Cost of the project. If the Planned Hours of the tasks on the project do not match the Legacy Budgeted Hours (in the Legacy Resource Estimates section of the Business Case or the Capacity Planner), and if the Billing Type of the tasks is Role Hourly, the Budgeted Cost of the project is calculated using the following formula: Legacy Budgeted Project Cost = Legacy Budgeted Labor Cost + Budgeted Expense Cost of all tasks + Budgeted Expense Cost of the project 
...
<pre>Budgeted Project Cost = Budgeted Labor Cost + Budgeted Expense Cost of all tasks + Budgeted Expense Cost of the project</pre> Note: To understand which Budgeted Cost you need to follow, you must make a decision whether you are using the legacy or the new resource management tools. For more information about the resource management tools in Workfront, see the article Difference between Legacy Resource Planning and Planning. For more information about Budgeted Cost and Legacy Budgeted Cost, see the article Calculate Budgeted Cost .For more information about the Business Case of a project, see the article Create a Business Case for a project in Adobe Workfront. For more information about Budgeted Labor Cost, see the article Understand Budgeted Labor Cost and Budgeted Hours for projects. 
...
<table border="1" cellspacing="15"> 
 ...
 <thead> 
  <tr> 
   <th> <p><span class="bold">Task Cost Type</span> </p> </th> 
...
<!--
To configure the Cost Type of an individual task: Go to the task where you want to configure the Cost Type. Click the Task Details tab, then click Finance. Click Edit Finance. In the Cost Type drop-down list, select the cost type that you want to apply to the task. Click Save.
-->
