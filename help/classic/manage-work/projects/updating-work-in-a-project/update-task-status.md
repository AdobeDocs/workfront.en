...
1. Click the **Status** drop-down menu in the task details area, and select the new status.
   ...
   ![Status_drop_down.png](assets/status-drop-down.png)

1. (Optional) To update the due date for the task, click the date under **Due on**, then select the new due date.  
   ![](assets/due-on.png)
