...
1. Go to the `Tasks` tabof the project.
...
1. Select all the tasks identified in Step 2 as created from a template, then click Delete `> Yes, Delete it`. For more information, see [Delete tasks](../../../manage-work/tasks/manage-tasks/delete-tasks.md).
