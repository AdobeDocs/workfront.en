...
* **Project Details** **tab** ****and the**Edit Project**box**:** Only the Planned Hours for the tasks on the project are taken into account. The Planned Hours for the issues on the project are not taken into account when viewing the total number of Planned Hours for the project in the Project Details  tab  or the&nbsp;Edit Project box.
...
* **Utilization tab :** The Planned Hours associated with the users assigned to the tasks and the issues on the project are taken into account when viewing the total number of Planned Hours for the project in the Utilization  tab .
...
* [The Details tab of a project, task, or issue](#the-details-tab-of-a-project-task-or-issue) 
...
The Planned Hours in the Details  tab  of a task, issue, or project are the total Planned Hours associated with the respective item.
...
The Planned Hours in a task, issue, or project report are the total Planned Hours of the respective item as they display in the Details  tab  or the Edit box of the items.
...
<p>To locate the Planned Hours value on the Details  tab  of a task: </p>
<ol>
<li value="1">Go to a task for which you want to review the Planned Hours.</li>
<li value="2"> <p data-mc-conditions="QuicksilverOrClassic.Classic">Go to the <strong>Task Details</strong> tab.</p> <p> <img src="assets/actual-hours-on-task-details-tab-350x370.png" alt="actual_hours_on_task_details_tab.png" style="width: 350;height: 370;" data-mc-conditions="QuicksilverOrClassic.Classic"> </p> </li>
<li value="3"> <p data-mc-conditions="QuicksilverOrClassic.Classic">Select the <strong>Overview</strong> subtab and notice the Planned Hours value. </p> <p>This value represents the time it would take the user assigned to the task to complete it. </p> </li>
</ol>
</div>
-->
...
<li value="2"> <p data-mc-conditions="QuicksilverOrClassic.Classic">Click <strong>Edit Task.</strong></p> <p>The Planned Hours are located in the <strong>Overview</strong> section. </p> </li>
</ol>
<p> <img src="assets/uph-350x233.png" alt="" style="width: 350;height: 233;" data-mc-conditions="QuicksilverOrClassic.Classic"> </p>
</div>
-->
...
<p>The Planned Hours in a task, issue, or project report are the total Planned Hours of the respective item as they display in the Details  tab  or the Edit box of the items. </p>
...
<ol>
<li value="1"> <p data-mc-conditions="QuicksilverOrClassic.Classic">Go to the <strong>Reporting</strong> area in Global Navigation Bar.</p> </li>
<li value="2" data-mc-conditions="QuicksilverOrClassic.Classic">Select the <strong>Reports</strong> tab.</li>
<li value="3">Click <strong>New Report</strong>, then choose <strong>Project</strong> as your object.</li>
<li value="4">Click <strong>Add Column</strong>, and start typing <strong>Planned Hours</strong> when the <strong>Show in this column</strong> drop-down field is displayed. Select the field when it appears in the list.</li>
<li value="5"> <p>Click <strong>Save + Close</strong> to save the report. </p> <p> <img src="assets/planned-hours-for-projects-report-350x123.png" alt="planned_hours_for_projects_report.png" style="width: 350;height: 123;" data-mc-conditions="QuicksilverOrClassic.Classic"> </p> <p>The Planned Hours column shows the total number of Planned Hours on each project. </p> </li>
</ol>
</div>
-->
...
<p>Workload Balancer or Scheduling areas in the following tabs:</p>
<ul>
<li>Scheduling or Workload Balancer tabs in the People area.</li>
<li>Scheduling subtab at the project level</li>
<li>Working On tab at the team level</li>
</ul>
...
<li> <p><b>Role Allocation panel</b> in the project Workload Balancer: The Planned Hours for the tasks and the issues on the project that are assigned to a job role or a user associated with a job role are taken into account in this area. For more information, see <a href="../../../manage-work/projects/planning-a-project/view-planed-hours-in-role-allocation-panel.md" class="MCXref xref">View project Planned Hours in the Role Allocation panel</a>. </p> </li>
</ul>
</div>
-->
