...
<!--
Go to a task for which you want to change the Duration Type. On the Task Details tab, click Overview>Edit Overview> Duration Type. Select Effort Driven from the drop-down menu. Click Save .
-->
