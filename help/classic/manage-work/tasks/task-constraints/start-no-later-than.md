...
<li value="4"> <p>Select <strong>Start No Later Than</strong>.</p> <p> <img src="assets/start-no-later-than-350x291.png" alt="start_no_later_than.png" style="width: 350;height: 291;" data-mc-conditions="QuicksilverOrClassic.Classic"> </p> </li>
