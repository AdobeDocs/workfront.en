...
<table cellspacing="0"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Request or higher</p> <p>Review or higher license to view issues in the Issues tabof a project.</p> </td> 
  </tr> 
  <tr> 
...
1. Open a project, task, or iteration that contains issues, then click the Issues tab.The number of open issues that you have access to view is displayed in parenthesis on the Issues tab.   
