...
<li value="3"> <p> From the <strong>Issue Actions</strong> menu, select <strong>Convert to Task.</strong> </p> <p> <img src="assets/ci7-350x433.png" alt="" style="width: 350;height: 433;" data-mc-conditions="QuicksilverOrClassic.Classic"> </p> </li>
...
<li value="8">(Optional) Attach custom forms.<br>For more information about transferring information from the custom form of the issue to that of the new task, see <a href="../../../administration-and-setup/customize-workfront/create-manage-custom-forms/transfer-custom-form-data-larger-item.md" class="MCXref xref">Transfer custom form data when converting an object</a>.<br><p><img src="assets/ci8-350x284.png" alt="" style="width: 350;height: 284;" data-mc-conditions="QuicksilverOrClassic.Classic"></p></li>
...
<li value="10"> <p>(Optional) Continue editing the task (assignments, dates) as necessary. </p> <p> <img src="assets/ci9-350x91.png" alt="" style="width: 350;height: 91;" data-mc-conditions="QuicksilverOrClassic.Classic"> </p> </li>
</ol>
</div>
-->
