...
title: Create an Adobe Workfront task in G Suite using email content
description: You can convert an external email (not generated by Adobe Workfront) to a Workfront task.
---

# Create an Adobe Workfront task in G Suite using email content
...
You can also convert an external email to an update on an existing task. For more information, see [Update an Adobe Workfront item from G Suite using email content](../../workfront-integrations-and-apps/workfront-for-g-suite/update-wf-item-using-email-content.md).
