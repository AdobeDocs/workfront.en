...
keywords: adobe,box,dropbox,gsuite,google,jira,microsoft,salesforce,sharepoint,slack,webdam,zoom,native,ootb
  ...
  <tr> 
   ...
   <td> 
    <ul> 
     ...
     <li> <p class="TableStyle-TableStyle-List-options-in-steps-BodyD-Column2-MediumGray">Connect apps and web services to Workfront</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
