...
* External users can search for users by name. They can’t access the People area in the Global Navigation Bar, so they can’t see a list of users in Workfront.
