...
For example, if you have an internal site containing special information about how your organization uses Workfront, you can link to that site from the Workfront interface.

>[!NOTE]
>
>A custom help URL added to the Workfront user interface does not affect the main Help link in the Global Navigation Bar and the context-sensitive help links throughout Workfront, which take users to the Workfront Help site.

For information about how users access both regular Help and a custom help URL that you configure in Workfront, see [Access Adobe Workfront help](../../../workfront-basics/navigate-workfront/workfront-navigation/access-workfront-help.md).
