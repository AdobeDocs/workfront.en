---
filename: configure-event-notifications-for-everyone-in-the-system
user-type: administrator
product-area: system-administration
navigation-topic: emails-administration
title: Configure event notifications for everyone in the system
description: Event notifications trigger emails to users when a certain event occurs. As an Adobe Workfront administrator or a user with a Planner access level, you can configure an event notification for all users in the system. Configuration of an event notification consists of activating or deactivating it and customizing its email subject line.
---
...
1. Select the check box to the left of the event type for which you want to enable or disable notifications, then click Activate or Deactivate.
