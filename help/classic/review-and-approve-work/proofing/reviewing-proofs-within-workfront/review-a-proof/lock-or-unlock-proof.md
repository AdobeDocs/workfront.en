...
1. Hover over the document, then click the `Open proof` link that appears.
   ...
   Or
   If you want to open a proof for an earlier version of the document, click the More icon for that version in the panel on the right, then click View proof. 
