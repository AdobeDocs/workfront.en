---
filename: assign-users-to-a-story-scrum
...
1. This option is available only when the story card is expanded.
1. ![agile_story_adduser.png](assets/agile-story-adduser-350x222.png)

1. Or
1. On an iteration, drag the user avatar from the list at the top of the page&nbsp;to the story card where you want to assign the user.
1. The user avatar list remains at the top of the page even while you scroll down the story board.
1. ![agile_story_adduser_drag.png](assets/agile-story-adduser-drag-350x186.png)
