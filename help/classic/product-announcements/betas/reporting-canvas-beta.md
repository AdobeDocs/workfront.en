...
1. Click **Save**.
1. Add the **Reporting (beta)** icon into the main layout template of each user that was selected. For more information, see Customize the Main Menu using a layout template.
