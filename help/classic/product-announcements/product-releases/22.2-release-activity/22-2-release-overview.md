...
<table> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td> <p><b>Available on these dates:</b> </p> <p>Preview release: February 10, 2022<br></p> <p>Production release:&nbsp;With the 22.2 release </p> <p><strong>Available in these environments:</strong> </p> <p>The new Adobe Workfront experience </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   ...
   <td><b>Available on these dates:</b> <p>Preview release: February 10, 2022<br></p> <p>Production release:&nbsp;With the 22.2 release </p> <p><strong>Available in these environments:</strong> </p> <p>The new Adobe Workfront experience </p> </td> 
  </tr> 
 </tbody> 
</table>
 ...
 <tbody> 
  <tr> 
   ...
   <tr data-mc-conditions="QuicksilverOrClassic.Draft mode"> 
    <td> <p><a href="../../../product-announcements/product-releases/22.2-release-activity/22-2-feb-21.md#undo" class="MCXref xref" xrefformat="{para}">Undo option for Update posts</a> <span style="color: #ff0000; font-weight: bold;">New in Preview!</span></p> <p>It is now easier to catch mistakes when posting an update. Finalizing a comment in an object's Update tab now creates a pop-up window for 7 seconds that allows you to cancel the post and return to editing--before the system timestamps it or sends any emails or in-app notifications. If you dismiss the pop-up window, leave the page, or wait 7 seconds for the window to disappear, the post is made normally.</p> </td> 
    <td><strong>Available on these dates:</strong> <p>Preview release: February 24, 2022<br></p> <p>Production release: With the 22.2 release</p> <p><strong>Available in these environments:</strong> </p> <p>The new Adobe Workfront experience </p> </td> 
   </tr>
  --> 
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Available on these dates:</strong> <p>Preview release:&nbsp;December 8, 2021<br></p> <p>Production release:&nbsp;With the 22.1 release <span style="color: #ff0000; font-weight: bold;">This feature was originally released to Production with the 22.1 release. It was temporarily removed from the Production environment on March 4, 2022. It will be re-added by mid-March. This feature is available in Preview.</span></p> <p><strong>Available in these environments:</strong> </p> <p>The new Adobe Workfront experience </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/22.2-release-activity/22-2-feb-14.md#updated" class="MCXref xref" xrefformat="{para}">Updated experience when copying and moving issues</a> </p> <p>To make your use of Workfront consistent with the new Adobe Workfront experience, we have redesigned the interface for copying and moving issues. This is currently available when copying or moving a single issue or when copying or moving issues in bulk from a list or report.</p> </td> 
   <td><strong>Available on these dates:</strong> <p>Preview release: February 18, 2022<br></p> <p>Production release: With the 22.2 release</p> <p><strong>Available in these environments:</strong> </p> <p>The new Adobe Workfront experience </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Available on these dates:</strong> <p>Preview release: February 10, 2022<br></p> <p>Production release:&nbsp;February 24, 2022</p> <p><strong>Available in these environments:</strong> </p> <p>The new Adobe Workfront experience </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Available on these dates:</strong> <p>Preview release: February 10, 2022<br></p> <p>Production release:&nbsp;TBD</p> <p><strong>Available in these environments:</strong> </p> <p>The new Adobe Workfront experience </p> <p>Adobe Workfront Classic (<a href="https://one.workfront.com/s/new-workfront-experience" target="_blank">Workfront Classic will be discontinued in March 2022</a>, followed shortly by the end-of-life date for Workfront Classic in July 2022.)</p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Available on these dates:</strong> <p>Preview release: February 10, 2022<br></p> <p>Production release:&nbsp;February 24, 2022</p> <p><strong>Available in these environments:</strong> </p> <p>The new Adobe Workfront experience </p> <p>Adobe Workfront Classic (<a href="https://one.workfront.com/s/new-workfront-experience" target="_blank">Workfront Classic will be discontinued in March 2022</a>, followed shortly by the end-of-life date for Workfront Classic in July 2022.)</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Available on these dates:</strong> <p>Preview release:&nbsp;N/A<br></p> <p>Production release:&nbsp;Early February 2022 (These enhancements were originally communicated with the 22.1 release.)</p> <p><strong>Available in these environments:</strong> </p> <p>iOS mobile app</p> <p>Android mobile app</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Available on these dates:</strong> <p>Preview release:&nbsp;Throughout the 22.2 release timeframe<br></p> <p>Production release:&nbsp;A minimum of 2 weeks after releasing to Preview</p> <p><strong>Available in these environments:</strong> </p> <p>The new Adobe Workfront experience </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/22.2-release-activity/22-2-feb-21.md#adobe" class="MCXref xref" xrefformat="{para}">Adobe Creative Cloud integrations now use OAuth2</a> <span style="color: #ff0000; font-weight: bold;">New in Preview!</span></p> <p>For greater security, and to make a more consistent experience across integrations, we've updated the Adobe Creative Cloud integrations to use OAuth2 authentication, an industry-standard way to authenticate users. Now, when your users log in, they can see the specific actions and areas that the integrations have access to, and allow access. After this, they do not need to log in as frequently.</p> </td> 
   <td><strong>Available on these dates:</strong> <p>Preview release: February 24, 2022<br></p> <p>Production release: With the 22.2 release</p> <p><strong>Available in these environments:</strong> </p> <p>The new Adobe Workfront experience </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/22.2-release-activity/22-2-feb-28.md#see" class="MCXref xref" xrefformat="{para}">See details of the Client Secret for custom OAuth2 or JWT integrations</a> <span style="color: #ff0000; font-weight: bold;">New in Preview!</span></p> <p>To provide transparency into the use of your custom OAuth2 and JWT integrations, we've made it possible for you to see details of the Client Secrets your integrations use. Now, you can see the dates that the Client Secret was created and last used. You can also add and view your own notes about the Client Secret.</p> <p>Previously, these details were unavailable.</p> </td> 
   <td><strong>Available on these dates:</strong> <p>Preview release: March 3, 2022<br></p> <p>Production release: With the 22.2 release</p> <p><strong>Available in these environments:</strong> </p> <p>The new Adobe Workfront experience </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/22.2-release-activity/22-2-feb-14.md#see" class="MCXref xref" xrefformat="{para}">See type of authentication in list of custom OAuth2 applications</a> </p> <p>Now, when you view the list of custom OAuth2 applications in your organization, you can see whether each application uses User authentication or Server authentication.</p> <p>Previously, you could see this information only by going into the edit options on each application.</p> </td> 
   <td><strong>Available on these dates:</strong> <p>Preview release: February 17, 2022<br></p> <p>Production release: With the 22.2 release</p> <p><strong>Available in these environments:</strong> </p> <p>The new Adobe Workfront experience </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   ...
   <td> <p>Preview release: February 10, 2022 <br></p> <p>Production release:&nbsp;With the 22.2 release </p> <p><strong>Available in these environments:</strong> </p> <p>The new Adobe Workfront experience </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
...
<!--
<p data-mc-conditions="QuicksilverOrClassic.Draft mode">Most new features coming to Workfront Goals release with the 21.2 release. For information about these new features now available in Preview, see <a href="https://one.workfront.com/s/document-item?bundleId=the-new-workfront-experience&topicId=Content%2FProduct_Announcements%2FProduct_releases%2FGoals_release_activity%2FGoals_21.2_release%2Fgoals-release-21-2.htm" data-mc-conditions="QuicksilverOrClassic.Classic"> Workfront Goals with the 21.2 release</a>.</p>
-->
