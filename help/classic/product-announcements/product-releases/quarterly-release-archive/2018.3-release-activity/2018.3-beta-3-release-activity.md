...
For more information, see [Try the Home area](../../../../workfront-basics/using-home/using-the-home-area/try-home-area.md). ```<iframe class="mt-media" src="assets/284742685?title=0&byline=0&portrait=0" width="640px" height="360px" frameborder="0" allowfullscreen></iframe>```
