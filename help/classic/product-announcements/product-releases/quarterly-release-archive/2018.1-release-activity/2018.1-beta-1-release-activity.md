...
For more information about using the new Home area, as well as information describing differences in functionality between My Work and Home, see [Understand the differences between My Work and Home](../../../../workfront-basics/using-home/using-the-home-area/differences-between-my-work-home.md).
