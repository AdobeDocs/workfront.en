...
For more information about using the new Home area, as well as information describing differences in functionality between My Work and Home, see [Understand the differences between My Work and Home](../../../../workfront-basics/using-home/using-the-home-area/differences-between-my-work-home.md). ```<iframe class="mt-media" src="assets/245284466?title=0&byline=0&portrait=0" width="640px" height="360px" frameborder="0" allowfullscreen></iframe>```
