...
## New Scheduling Area in a Project (Team Builder)
...
By default, the new scheduling area is used in a project. For information about accessing the Legacy Team Builder, see Work in the Legacy Team Builder in Work in the Legacy Team Builder. For more information about functionality available in the Team Scheduling area, see [Get started with Resource Scheduling](../../../../resource-mgmt/resource-scheduling/get-started-resource-scheduling.md).
...
## Resource Scheduling: Show Fewer Items&nbsp;by Default
...
## Resource Scheduling: Display Drop Indicator and Over-Allocation When Dragging Tasks and Issues
...
## Resource Scheduling: User Allocations Are No Longer Rounded to the Nearest Half Hour
...
## API Enhancement: Access User Allocations

You can now access user allocation shading via the Workfront API.

<!--
For more information, see Access Project Allocation Information via the API.
-->

## Export the Utilization Report in TSV and PDF Formats
...
User Calendar Enhancements in the My Work Area The following enhancements are available in the calendar in the My Work area: (These enhancements were previously available for users enrolled in Early Access, and then the functionality was temporarily removed; this functionality is now available in the Production environment.) Expand the calendar to view more tasks and issues. Or, you can hide the calendar so that it is no longer displayed. For more information, see the View assigned work on the My Work calendar section in View assigned work on the My Work calendar. Adjust the date range for which data is displayed on the calendar. For more information, see View assigned work on the My Work calendar in View assigned work on the My Work calendar. Tasks and issues only on projects in the status of Current are displayed on the calendar. Previously, the calendar in the My Work area showed all tasks and issues assigned to you, regardless of project status. Configure the calendar to show or hide any of the following options: Issues For more information, see the View assigned work on the My Work calendarsection in View assigned work on the My Work calendar. User allocations For more information, see the View assigned work on the My Work calendarsection in View assigned work on the My Work calendar. Show completed work For more information, see the View assigned work on the My Work calendar section in View assigned work on the My Work calendar. Layout Template Determines Whether the New or Legacy Calendar Displays in the My Work Area To configure Workfront to display the new calendar in the My Work area, enable the option to show the new calendar on a layout template. For information about using the new calendar in the My Work area, see View assigned work on the My Work calendar. 

## Proof Decision Displays in the My Work Area (Workfront)
...
## View Rich Media Proofs in Preset Resolutions (ProofHQ and Workfront)
...
## View URL to Sub-Pages in Comments on Rich Media Proofs (ProofHQ and Workfront)
...
## Determine the Availability of the HTML5 Video proofing viewer (ProofHQ and Workfront)
...
For more information about configuring this option in Workfront, see [Configure user access to Web Proofing Viewer](../../../../administration-and-setup/manage-workfront/configure-proofing/configure-a-users-proofing-access.md#configuring-whether-users-can-access-the-html5-proofing-viewer) in [Configure a user's proofing access](../../../../administration-and-setup/manage-workfront/configure-proofing/configure-a-users-proofing-access.md).
...
## Create Custom Views Based on Existing Standard Views (ProofHQ)
...
## Filter the Reporting&nbsp;Area (ProofHQ)
...
## Display Minimum and Maximum Values in Reports (ProofHQ)
...
## Type-Ahead for Mapping Attributes
...
## New Resource Budgeted Hour Field
...
## In-App Notification for Proof Approval
...
## Show User Job Role in 'Assigned To' Area on the Details Page for Tasks and Issues
