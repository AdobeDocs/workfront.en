...
<!--
<p data-mc-conditions="QuicksilverOrClassic.Classic,QuicksilverOrClassic.Draft mode">By default, the new scheduling area is used in a project.&nbsp;For information about accessing the Legacy Team Builder, see <a href="../../../../manage-work/projects/manage-projects/work-in-legacy-team-builder.md" class="MCXref xref" xrefformat="{para}">Work in the Legacy Team Builder</a> in <a href="../../../../manage-work/projects/manage-projects/work-in-legacy-team-builder.md" class="MCXref xref" xrefformat="{para}">Work in the Legacy Team Builder</a>.</p>
-->
...
## User Calendar Enhancements in the My Work Area
...
* Expand the calendar to view more tasks and issues. Or, you can hide the calendar so that it is no longer displayed.  
  For more information, see the [View assigned work on the My Work calendar](../../../../workfront-basics/using-home/my-work/view-assigned-work-on-calendar-my-work.md) section in [View assigned work on the My Work calendar](../../../../workfront-basics/using-home/my-work/view-assigned-work-on-calendar-my-work.md).

* Adjust the date range for which data is displayed on the calendar.  
  For more information, see [View assigned work on the My Work calendar](../../../../workfront-basics/using-home/my-work/view-assigned-work-on-calendar-my-work.md) in&nbsp; [View assigned work on the My Work calendar](../../../../workfront-basics/using-home/my-work/view-assigned-work-on-calendar-my-work.md).
