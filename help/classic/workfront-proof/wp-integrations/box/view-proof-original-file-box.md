...
description: If you are using the Workfront Proof - Box integration, in Box, you can view the original file used to create a proof. You can do this in two ways:
---
