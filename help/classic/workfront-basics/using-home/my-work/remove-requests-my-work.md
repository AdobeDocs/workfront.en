---
filename: remove-requests-my-work
navigation-topic: my-work
title: Remove requests from the Working On list
description: When work tasks and issues are assigned to you, they are listed on the Work Requests list under the My Work area.
---
...
1. On the far right of each item, click the drop-down menu in the upper-right corner of the item.  
   ![](assets/send-requests-back-remove-requests-from-my-list-350x82.png)
