...
* `Teams`: Tasks and issues assigned to your teams display in this area. As a Worker, you are the only Workfront user who sees the Teams area by default.
  ...
  <!--
  This area is named " People " for users with a Plan license. As a Worker, you cannot edit users, so the People tab of this area is not available to you. You can see the work assigned to your Teams, however, and this is why this tab is more accurately renamed to "Teams."
  -->
...
You can customize the areas that you see in yourGlobal Navigation Bar by removing or adding areas.
