...
![](assets/start-on-350x124.png)

![](assets/planned-start-date-350x275.png)
...
![](assets/planned-completion-date-350x140.png)

![](assets/planned-completion-date-within-settings-350x342.png)

## Entry Date

The Entry Date or Submitted On Date is the date when a project, task, or issue was created in&nbsp;Workfront.
...
![](assets/actual-start-date-350x149.png)
...
![](assets/commit-date-350x169.png)
...
![](assets/projected-completion-date-350x369.png)
...
You can log time in the project, task, or issue Updates tab or in the Hours tab . When logging time in the Hours tab , you can manually specify the Hour Entry Date and the user the hours belong to.
