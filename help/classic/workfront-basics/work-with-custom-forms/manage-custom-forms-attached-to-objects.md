...
1. Click Manage Forms, then click the X icon to the right of a form to remove it from the object.  The Manage Forms option displays only if at least one custom form is attached to the object. 
