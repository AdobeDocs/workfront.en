...
1. Go to the **Documents** area located in the Global Navigation Bar.

   Or

   Go to the **Documents** tab located on an object. 

1. Select the folder, then click **Share** in the toolbar.
