...
<ol> 
 ...
 <li value="4">Select the <span class="bold">Let people use <span>Workfront</span>'s mobile applications and the <span>Workfront</span> Outlook Add-In</span> setting to allow users to use <span>Workfront</span> with the <span>Workfront</span> mobile app or to install and use <span>Workfront</span> for Outlook.<br>This option is enabled by default.</li> 
