...
<ol> 
 ...
 <li value="6"> <p>(Optional) Set the currency&nbsp;as the base (default) currency for <em>Workfront</em>. </p> <p>This is the currency that is used as the default for all projects and reports throughout the system.</p> </li> 
