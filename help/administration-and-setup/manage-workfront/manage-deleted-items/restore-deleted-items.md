...
## Information that is recovered when you restore a project, task, or issue {#information-that-is-recovered-when-you-restore-a-project-task-or-issue}
...
*  Hours (and hour IDs)
  ...
  Whether hours are restored to the deleted item depends on the settings you chose when configuring preferences for timesheets and hours. For more information, see [Configure affect on hours when an object is deleted and restored](configure-how-hours-affected-when-obj-deleted-restored.md).
...
## Information that is not recovered when you restore a project, task, or issue {#information-that-is-not-recovered-when-you-restore-a-project-task-or-issue}
...
*  Resolving objects
  ...
  For more information about converting issues, see, [Overview of converting issues in Adobe Workfront](convert-issues.md).
...
1.  (Optional) To quickly view the restored item, follow the steps in [View restored items](view-restored-items.md).
