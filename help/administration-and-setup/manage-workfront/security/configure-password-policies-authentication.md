...
<ol> 
 ...
 <li value="3"> <p>In the <span class="bold">Password Length</span> box, enter the minimum number of characters required for a valid password.</p> <p>Workfront requires at least 6 characters.</p> </li> 
