...
<ol> 
 ...
 <li value="3"> <p>Under&nbsp;<span class="bold">Proof Defaults</span>, at the end of the&nbsp;<span class="bold"><em>Desktop Proofing Viewer</em> for Interactive <em>proofing</em></span>&nbsp;row, click&nbsp;<span class="bold">Setup</span>.</p> <p> <img src="assets/proof-defaults-350x265.png" style="width: 350;height: 265;"> <br> </p> </li> 
...
<ol> 
 ...
 <li value="4"> <p>Ensure that each user completes the installation by opening an interactive <em>proof</em> from the Documents area in <em>Workfront</em>.</p> </li> 
</ol>
...
<ol> 
 ...
 <li value="2">Open the file you have just downloaded to start the installation.&nbsp;</li> 
 <li value="3"> <p>In the security warning box that appears, click&nbsp;<span class="bold">Run</span>.</p> <p> <img src="assets/screen-shot-2018-05-02-at-10.56.55-am-350x271.png" alt="Screen_Shot_2018-05-02_at_10.56.55_AM.png" style="width: 350;height: 271;"> </p> <p>The <em>Desktop Proofing Viewer</em> installs and runs.&nbsp;</p> </li> 
 ...
 <li value="5"> <p>Ensure that each user completes the installation by opening an interactive <em>proof</em> from the Documents area in <em>Workfront</em>.</p> </li> 
</ol>
