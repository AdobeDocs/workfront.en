...
<ol data-mc-continue="false"> Click the Main Menu icon in the upper-right corner of Adobe Workfront, then click Setup . 
 ...
 <li value="5"> <p>In the <span class="bold">New Reminder Notification</span> box that appears, specify the following information.</p> 
  <table cellspacing="0"> 
   <col> 
   <col> 
   <tbody> 
    ...
    <tr> 
     ...
     <td> <p>Specify the number of hours, work days, days (calendar days), weeks, or months before or after the date in the <span class="bold">Timing</span> field.</p> <note type="note"> 
       <ul> 
 ...
 <li value="7">Attach the reminder notification to a work item, as described in <a href="../../../workfront-basics/using-notifications/attach-reminder-notification-object.md" class="MCXref xref">Attach a reminder notification to an object</a>.</li> 
</ol>
