...
# Set up reminder notifications {#set-up-reminder-notifications}
...
## Customize the reminder email {#customize-the-reminder-email}
...
For information about how to create an email template, see [Configure email templates](configure-email-templates.md).


## Create&nbsp;a reminder notification {#create-a-reminder-notification}
...
<table style="width: 100%;mc-table-style: url('../../../Resources/TableStyles/TableStyle-List-options-in-steps.css');" class="TableStyle-TableStyle-List-options-in-steps" cellspacing="0"> 
 ...
 <tbody> 
  <tr class="TableStyle-TableStyle-List-options-in-steps-Body-LightGray"> 
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyE-Column1-LightGray" role="rowheader">Reminder Notification Name</td> 
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyD-Column2-LightGray">Specify a name for the reminder notification.</td> 
  </tr> 
  <tr class="TableStyle-TableStyle-List-options-in-steps-Body-MediumGray"> 
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyE-Column1-MediumGray" role="rowheader">Qualifying Period</td> 
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyD-Column2-MediumGray"> <p>Specify the number of hours, work days, days (calendar days), weeks, or months before or after the date in the <span class="bold">Timing</span> field.</p> <p>Note:  
     <ul> 
  ...
  <tr class="TableStyle-TableStyle-List-options-in-steps-Body-MediumGray"> 
   ...
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyD-Column2-MediumGray"> <p>Select the criteria to qualify the reminder notification to be scheduled. Reminder notifications are not scheduled unless the criteria selection is met.</p> <p>The following criteria options are available, depending on the object type that you&nbsp;selected in Step 4:</p> 
    <ul> 
     ...
     <li><span class="bold">Email Template:</span>&nbsp;From the drop-down, select an email template to attach to your reminder.<br>For information on how to build an email template, refer to <a href="configure-email-templates.md" class="MCXref xref">Configure email templates</a>.</li> 
    </ul> </td> 
  </tr> 
  <tr class="TableStyle-TableStyle-List-options-in-steps-Body-LightGray"> 
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyB-Column1-LightGray" role="rowheader">Recipients</td> 
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyA-Column2-LightGray">Select the types of&nbsp;users you want to&nbsp;receive the notification. Select from various object stakeholders, such as owner, approver, or assignee.</td> 
  </tr> 
 </tbody> 
</table>
...
1. Click `Save`.
1. Attach the reminder notification to a work item, as described in [Attach a reminder notification to an object](attach-reminder-notification-object.md).




## Receive a reminder notification {#receive-a-reminder-notification}
...
For more information about receiving&nbsp;reminder notifications, see the [Reminder notifications](wf-notifications.md#reminder-notifications) section in [Adobe Workfront notifications](wf-notifications.md).


## Test reminder notification delivery {#test-reminder-notification-delivery}
