...
<ol data-mc-continue="false"> 
 ...
 <li value="6"> <p>(Optional) If you want to unlock configuration for an email notification so that <span>group administrators</span> can configure it separately for their groups, click the button <img src="assets/lock-toggle-button.png"> to the right of the notification to switch it to the unlocked position <img src="assets/unlock-toggle-button.png">.</p> <note type="note">
