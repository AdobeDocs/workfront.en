...
# Manage email invitations to new users {#manage-email-invitations-to-new-users}
...
To ensure the security of the new accounts, we recommend that you use email invitations for your new users, so they can choose their own password. Alternatively, you can also select a password for a new user when creating their account. For more information about adding new users to *`Workfront`*, see [Add users](add-users.md).
...
For information about receiving email invitations, see [Receive email invitations and create a password for Adobe Workfront](receive-email-invitations.md).
...
*   When you create a new user and you select the `Send an invite email to this person` on the `New Person` form. For more information about creating new users, see [Add users](add-users.md).
*  When you import multiple new users and you select the `Send invite emails to these people` option. For more information about importing several new users, see [Import users](import-users.md).
*  After the users are created, you can manually generate the invitations to users who have not yet registered their account with *`Workfront`*, and they have not established a *`Workfront`* password.  
  ...
  >[!NOTE]
  >
  >If you deselect the `Send an email invite to this person`&nbsp;box when you create the user, the email invitation cannot be generated manually. Resending the email invitations manually is only possible for users who have been sent the original email invitation when their account was created. For more information about creating new users, see [Add users](add-users.md).
...
1.  Click the Main Menu icon ![](assets/main-menu-icon.png) in the upper-right corner of *`Workfront`*, then click the `Users` icon ![](assets/users-icon-in-main-menu.png).
1.  Select the user who shows the `Unregistered`label `<MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver"> after</MadCap:conditionalText>` their name.
...
1.  If you are using the Production environment, click `More` > `Send Invitations`.

   Or


   If you are using the Preview environment, click the More icon ![](assets/more-icon.png), then click **Remind user to register**.
...
<table style="width: 100%;mc-table-style: url('../../../Resources/TableStyles/TableStyle-List-options-in-steps.css');margin-left: 0;margin-right: auto;" class="TableStyle-TableStyle-List-options-in-steps" cellspacing="0"> 
 ...
 <tbody> 
  <tr class="TableStyle-TableStyle-List-options-in-steps-Body-LightGray"> 
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyE-Column1-LightGray" role="rowheader"><span class="bold">Deactivate invitation links after ... days</span> </td> 
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyD-Column2-LightGray"> <p>Choose the amount of time after which the email invitations no longer contain a valid link to <span class="mc-variable WFVariables.ProdNameWF variable varname">Workfront</span>. The default amount of days is 45.</p> </td> 
  </tr> 
  <tr class="TableStyle-TableStyle-List-options-in-steps-Body-MediumGray"> 
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyB-Column1-MediumGray" role="rowheader"><span class="bold">Include a message and/ or term of service</span> </td> 
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyA-Column2-MediumGray"> <p>Select this option if you want to modify the email invitation for all new users added to <span class="mc-variable WFVariables.ProdNameWF variable varname">Workfront</span>. This does not include users with a Requestor license.</p> 
    <ul> 
     ...
     <li><span class="bold">Include a message and/or term of service for helpdesk users</span>:&nbsp;Select this option if you want to modify the email invitation for all new users added to <span class="mc-variable WFVariables.ProdNameWF variable varname">Workfront</span>&nbsp;that have a Requestor license.</li> 
     ...
     <li> <p>In the <span class="bold">Invitation Preview</span> section, you can see a preview of your email invitation. If you selected to include a customized message in your email invitation, the customized message shows in this area.</p> <p data-mc-conditions="QuicksilverOrClassic.Quicksilver"> <img src="assets/email-invitation-for-all-users-preview-qs-350x190.png" style="width: 350;height: 190;"> </p> </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
