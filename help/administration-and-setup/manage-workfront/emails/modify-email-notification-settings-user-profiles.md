...
<ol> 
 <li value="1"> <p> <draft-comment>
    <MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver">
     ...
     <img src="assets/users-icon-in-main-menu.png">. Select the users, then click 
 ...
 <li value="2">In the<draft-comment>
   <span class="bold" data-mc-conditions="QuicksilverOrClassic.Quicksilver"> Edit Person</span>
  </draft-comment><span class="bold" data-mc-conditions="QuicksilverOrClassic.Quicksilver"> Edit Person</span> box that appears, click <span class="bold">Notifications</span>.</li> 
