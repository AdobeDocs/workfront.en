...
If your organization has been upgraded to the enhanced authentication experience (not yet available for all organizations), see the information in [Update SAML 2.0 metadata in your IDP when using enhanced authentication](update-saml-2-metadata-ip-eauth .md).
...
## Use ADFS as your identity provider {#use-adfs-as-your-identity-provider}
...
For additional information about using Active Directory Federation Services (ADFS) with SAML 2.0 in *`Workfront`*, see [Configure Adobe Workfront with SAML 2.0 using ADFS](configure-workfront-saml-2-adfs.md).
