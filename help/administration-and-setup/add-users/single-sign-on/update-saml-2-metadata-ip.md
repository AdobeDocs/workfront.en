...
<ol> 
 ...
 <li value="4"> <p>Select the relying party trust that you previously configured to be used with <em>Workfront</em>, then in the right-hand panel, click<span class="bold"> Update from Federation Metadata</span>.</p> </li> 
 <li value="5"> <p>(Conditional) If this option is dimmed (which means that the relying party trust was previously configured using a metadata file), complete the following. </p> 
  <ol style="list-style-type: lower-alpha;"> 
   ...
   <li value="7">Click the <span class="bold">Monitoring</span> tab, then paste the URL that you copied from <em>Workfront</em> into the <span class="bold">Relying party's federation metadata URL</span> field.</li> 
   ...
   <li value="10">Select the relying party trust that you previously configured to be used with <em>Workfront</em>; then, in the right-hand panel, click <span class="bold">Update from Federation Metadata.</span></li> 
  </ol> </li> 
