...
<ol> 
 ...
 <li value="8">In the <span class="bold">Select Date Source</span> section, paste the metadata URL from <em>Workfront</em>.</li> 
   ...
   <table cellspacing="0"> 
    ...
    <tbody> 
     <tr> 
      ...
      <td>Specify a name for the claim rule. For example, "<em>Workfront</em>."</td> 
     </tr> 
     <tr> 
...
<ol> 
 ...
 <li value="5"> <p>Select <span class="bold">Admin Exemption</span> to allow <em>Workfront administrators</em> to log in using <em>Workfront</em> credentials with the bypass url. </p> <p>Bookmarks pointing to <i><yourdomain></i>.my.workfront.com/login bypass the redirect.</p> </li> 
