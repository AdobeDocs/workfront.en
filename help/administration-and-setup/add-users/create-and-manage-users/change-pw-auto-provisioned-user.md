...
<ol> 
 <li value="1"> <p>Determine a user's GUID user name by passing an API request, as shown in the following example:</p><pre><a href="https://domain.my.workfront.com/attask/api/v10/USER/search?fields=Username&ID=">https://<domain>.my.workfront.com/attask/api/v14.0/USER/search?fields=username&ID=<ID of User></a></pre> <p>Where <i><domain></i> is your company's domain and <i><ID of User></i> is the user's <span>Workfront</span> ID. </p> <p>You receive a response similar to the following:</p> <p> <img src="assets/getguid-350x105.png" style="width: 350;height: 105;"> </p> <p>The return for "username" is the user's GUID.</p> </li> 
