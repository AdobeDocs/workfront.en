...
| Tasks |Edit |Edit |Edit |View |View |
...
| Financial data |Edit |View (only the Finance 
...
`<MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver"> area </MadCap:conditionalText>`in Project Details) |View |No access |No access |
