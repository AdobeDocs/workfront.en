...
As an *Adobe Workfront administrator*, you can use an access level to define a user’s access to *tasks*
...
<ol> 
 ...
 <li value="2"> <p>Click the gear icon <img src="assets/gear-icon-settings.png"> on the <span class="bold">View</span> or <span class="bold">Edit</span> button to the right of <em>Tasks</em>, then select the abilities you want to grant under <b>Fine-tune your settings</b>.</p> <note type="note">
   ...
   <em>tasks</em> in their access level, but this does not restrict them from deleting 
   <em>issues</em>, which are lower-ranking than 
   <em>tasks</em>.For more information about the hierarchy of objects, see the section 
 ...
 <li value="5"> <p>When you are finished, click <draft-comment>
   ...
   </draft-comment><b data-mc-conditions="QuicksilverOrClassic.Quicksilver">Save</b>.</p> <p>After the access level is created, you can assign it to a user. For more information, see <a href="../../../administration-and-setup/add-users/create-and-manage-users/edit-a-users-profile.md" class="MCXref xref">Edit a user's profile</a>.</p> </li> 
</ol>
