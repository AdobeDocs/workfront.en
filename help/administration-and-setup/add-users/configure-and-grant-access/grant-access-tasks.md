...
<ol> 
 ...
 <li value="2"> <p>Click the gear icon <img src="assets/gear-icon-settings.png"> on the <span class="bold">View</span> or <span class="bold">Edit</span> button to the right of <span>Tasks</span>, then select the abilities you want to grant under <b>Fine-tune your settings</b>.</p> <note type="note">
   ...
   <span>tasks</span> in their access level, but this does not restrict them from deleting 
   <span>issues</span>, which are lower-ranking than 
   <span>tasks</span>.For more information about the hierarchy of objects, see the section 
