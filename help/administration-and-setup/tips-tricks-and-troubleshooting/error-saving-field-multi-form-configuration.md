...
<ol> 
 <li value="1"> <p> Click the Main Menu icon in the upper-right corner of Workfront, then click Setup > Custom Forms > Fields> apply the Field List view to find the Calculated Field you are trying to modify and make note of every Custom Form on which it is used (e.g. Form 1, Form 2, Form 3) . </p> </li> 
 ...
 <li value="9"> Click the Search icon in the upper-right corner of the screen, then click Advanced Search. </li> 
 ...
 <li value="14"> <p>Go back to your custom form and edit the calculation for the custom field you were originally trying to update. This time, <span>Workfront</span> should not encounter any more conflicts when saving the new calculation. </p> </li> 
