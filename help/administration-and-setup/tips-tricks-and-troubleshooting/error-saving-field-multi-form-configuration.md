...
<ol> 
 ...
 <li value="14"> <p>Go back to your custom form and edit the calculation for the custom field you were originally trying to update. This time, <em>Workfront</em> should not encounter any more conflicts when saving the new calculation. </p> </li> 
