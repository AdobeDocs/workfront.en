...
# Error saving custom field: "There is a slight problem. [That field] is used in a multi-form configuration ..."  {#error-saving-custom-field-there-is-a-slight-problem-that-field-is-used-in-a-multi-form-configuration}
...
1.   `<MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver"> Click the  <span class="bold">Main Menu</span> icon  <img src="assets/main-menu-icon.png"> in the upper-right corner of  <span class="mc-variable WFVariables.ProdNameWF variable varname">Workfront</span>, then click  <span class="bold">Setup</span> >  <span class="bold">Custom&nbsp;Forms</span> >  <span class="bold">Fields</span>> apply the  <span class="bold">Field List</span> view to find the Calculated Field you are trying to modify and make note of every Custom Form on which it is used (e.g. Form 1, Form 2, Form 3) . </MadCap:conditionalText>` 
...
1.  Click the `Search icon` ![](assets/search-icon.png) in the upper-right corner of the screen, then click  `Advanced Search`. 
