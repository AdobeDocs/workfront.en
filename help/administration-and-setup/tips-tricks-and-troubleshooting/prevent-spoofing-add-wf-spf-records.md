...
<ol> 
 <li value="1"> <p>Add the following SPF record to your firewall:</p> <p><em style="font-weight: bold; font-style: normal;">spf.workfront.com</em> </p> <p>This automatically adds all <em>Workfront</em> IP addresses to your allowlist on your firewall&nbsp;and allows all spam filters (that use SPF records) to validate <em>Workfront</em> servers as valid senders for&nbsp;your domain.</p> <note type="note">
