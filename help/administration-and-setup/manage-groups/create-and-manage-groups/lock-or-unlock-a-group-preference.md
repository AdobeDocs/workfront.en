...
# Lock or unlock a project, task, or issue preference for subgroups {#lock-or-unlock-a-project-task-or-issue-preference-for-subgroups}
...
For information about how a *`Workfront administrator`* can lock or unlock a preference for all groups in the system, see [Lock or unlock project preferences for all groups in the system](lock-or-unlock-project-preferences-for-groups-system.md).
...
## Lock or unlock a group project, task, or issue preference {#lock-or-unlock-a-group-project-task-or-issue-preference}
