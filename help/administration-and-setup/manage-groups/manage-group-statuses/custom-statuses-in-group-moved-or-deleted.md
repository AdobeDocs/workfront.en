  ...
  <tr> 
   ...
   <td> <p>All custom statuses inherited from the previous parent group come with the moved group and become its own custom statuses. They are no longer connected with the previous parent group.</p> 
    ...
    <div class="example" data-mc-autonum="<b>Example: </b>">
     ...
     <p>Olivia, the <span>group administrator</span> for the Marketing group, creates two statuses for the group. She names one First Review, with the key ABC, and locks it. She names the other Final Review, with the key XYZ, and doesn’t lock it.</p> 
     ...
     <p>Though First Review was locked before the move, the Product Marketing <span>group administrator</span> can edit it now because it’s no longer an inherited status controlled by the parent group it came from.</p> 
