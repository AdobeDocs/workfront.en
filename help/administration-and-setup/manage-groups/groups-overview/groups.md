...
<ul> 
 ...
 <li><span class="bold">Layout Template</span>: You can give a group's administrators permission to modify a Layout Template. For instructions, see <draft-comment>
   <a href="../../../administration-and-setup/customize-workfront/use-layout-templates/grant-admin-access-layout-template.md" class="MCXref xref" xrefformat="{para}" data-mc-conditions="QuicksilverOrClassic.Quicksilver">Grant administrative access for a layout template</a>
  </draft-comment><a href="../../../administration-and-setup/customize-workfront/use-layout-templates/grant-admin-access-layout-template.md" class="MCXref xref" xrefformat="{para}" data-mc-conditions="QuicksilverOrClassic.Quicksilver">Grant administrative access for a layout template</a>.</li> 
