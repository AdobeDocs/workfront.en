...
# Business Leader overview {#business-leader-overview}
...
As a *`group administrator`*, you can assign one user as a Business Leader for a group or a subgroup that you administer. If there are any groups above the group you manage, their administrators can also do this for your group. The same is true for *`Workfront administrators`* (for any group). For instructions, see [Create a group](create-a-group.md).


If you need general information about groups, see [Groups overview](groups.md).
...
## Using the Business Leader field in reporting {#using-the-business-leader-field-in-reporting}
