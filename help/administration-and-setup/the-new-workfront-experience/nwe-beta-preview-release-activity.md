...
`<MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Draft mode">  It was initially made available in the Preview environment on July 18, 2019. </MadCap:conditionalText>` It was made available as a beta in the Production environment on September 12, 2019.
...
<table> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <tr data-mc-conditions=""> 
    <td> <p><a href="#the2" class="MCXref xref" xrefformat="{para}">The new Workfront experience is available in Custom Refresh Sandboxes</a> </p> <p>Custom Refresh Sandboxes are updated with <em>the new Adobe Workfront experience</em>. </p> </td> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <tr data-mc-conditions=""> 
    <td> <p><a href="#adjust" class="MCXref xref" xrefformat="{para}">Adjust timeline duration in the Workload Balancer</a> </p> <p>You now have the flexibility to select how many weeks you display in the Workload Balancer: you can select from 2, 4, or 6 weeks. Previously, the number of weeks was set to 4 by default.</p> </td> 
    <td> <p>Beta Preview release: February 28, 2020</p> <p>Beta Production release: February 28, 2020</p> </td> 
   </tr>
  </draft-comment>
  <tr data-mc-conditions=""> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <tr data-mc-conditions="QuicksilverOrClassic.Draft mode"> 
    <td> <p style="color: #ff0000;">Review this - Courtney</p> <p><a href="#open" class="MCXref xref" xrefformat="{para}">Open the proofing viewer in a separate browser tab</a> </p> <p>To make it easier to review a proof and continue working, you can now open the proof in a separate browser tab in the Documents area.</p> </td> 
    <td> <p>Beta Preview release: TBD </p> <p>Beta Production release: With the 2020.1 release to Production</p> </td> 
   </tr>
  </draft-comment>
  <tr data-mc-conditions="QuicksilverOrClassic.Draft mode"> 
   <td> <p style="color: #ff0000;">Review this - Courtney</p> <p><a href="#open" class="MCXref xref" xrefformat="{para}">Open the proofing viewer in a separate browser tab</a> </p> <p>To make it easier to review a proof and continue working, you can now open the proof in a separate browser tab in the Documents area.</p> </td> 
...
<table> 
 ...
 <tbody> <draft-comment>
   <tr data-mc-conditions="QuicksilverOrClassic.Draft mode"> 
    <td> <p style="color: #ff0000;">Review this - Caroline</p> <h3>Customizable fields available on the Summary panel</h3> <p>You can now use the Layout Template to customize what users see in the Summary panel. You can add up to 16 custom fields to display. These are the same fields that are displayed in the Home area.</p> <p>Previously, the summary panel included only default information, such as the percent complete, documents, and so forth.</p> <p>For more information, see </p> </td> 
   </tr>
  </draft-comment>
  <tr data-mc-conditions="QuicksilverOrClassic.Draft mode"> 
   <td> <p style="color: #ff0000;">Review this - Caroline</p> <h3>Customizable fields available on the Summary panel</h3> <p>You can now use the Layout Template to customize what users see in the Summary panel. You can add up to 16 custom fields to display. These are the same fields that are displayed in the Home area.</p> <p>Previously, the summary panel included only default information, such as the percent complete, documents, and so forth.</p> <p>For more information, see </p> </td> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <tr data-mc-conditions=""> 
    <td> <h3><a name="Like2"></a>Like updates on the mobile app</h3> <p>Use the new Like button on the Updates tab to like a update.</p> <p>For more information, see <a href="../../workfront-basics/mobile-apps/using-the-workfront-mobile-app/workfront-for-ios.md" class="MCXref xref" xrefformat="{para}">Adobe Workfront for iOS</a> and <a href="../../workfront-basics/mobile-apps/using-the-workfront-mobile-app/workfront-for-android.md" class="MCXref xref" xrefformat="{para}">Adobe Workfront for Android</a>.</p> </td> 
   </tr>
  </draft-comment>
  <tr data-mc-conditions=""> 
   <td> <h3><a name="Like2"></a>Like updates on the mobile app</h3> <p>Use the new Like button on the Updates tab to like a update.</p> <p>For more information, see <a href="../../workfront-basics/mobile-apps/using-the-workfront-mobile-app/workfront-for-ios.md" class="MCXref xref" xrefformat="{para}">Adobe Workfront for iOS</a> and <a href="../../workfront-basics/mobile-apps/using-the-workfront-mobile-app/workfront-for-android.md" class="MCXref xref" xrefformat="{para}">Adobe Workfront for Android</a>.</p> </td> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <tr data-mc-conditions=""> 
    <td> <h3><a name="The2"></a>The new Workfront experience is available in Custom Refresh Sandboxes</h3> <p>You can now see <em>the new Adobe Workfront experience</em> when you access your Custom Refresh Sandbox. </p> </td> 
   </tr>
  </draft-comment>
  <tr data-mc-conditions=""> 
   <td> <h3><a name="The2"></a>The new Workfront experience is available in Custom Refresh Sandboxes</h3> <p>You can now see <em>the new Adobe Workfront experience</em> when you access your Custom Refresh Sandbox. </p> </td> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <tr data-mc-conditions=""> 
    <td> <h3><a name="New5"></a>New headers in Home</h3> <p>To provide a more consistent experience, the headers in Home now match those on projects, tasks, and issues. These headers bring new options, replace existing ones, and remove others.</p> <p><span class="bold">New</span> </p> <p>Now, you can do the following from Home depending on the access you have to the task or issue:</p> 
     <ul> 
      <li>Subscribe</li> 
      <li>Copy</li> 
      <li>Move</li> 
     ...
     </ul> <p><span class="bold">Removed</span> </p> <p>The following functionality has been removed from the More menu in Home:</p> 
     <ul> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <tr data-mc-conditions="QuicksilverOrClassic.Draft mode"> 
    <td> <h3><a name="Show"></a>Show daily Planned Hours for projects, tasks, and inaccessible items in the Workload Balancer</h3> <p>To help you understand how individual projects, tasks, or inaccessible items contribute to the workload of your users and to be able to make correct reassignment decisions in the Workload Balancer, we have introduced a setting that allows you to view the hourly distribution for individual projects, tasks and inaccessible items.</p> <p>For information about managing hours in the Workload Balancer, see <a href="../../resource-mgmt/workload-balancer/manage-user-allocations-workload-balancer.md" class="MCXref xref" xrefformat="{para}">Manage user allocations in the Workload Balancer</a>.</p> </td> 
   </tr>
  </draft-comment>
  <tr data-mc-conditions="QuicksilverOrClassic.Draft mode"> 
   <td> <h3><a name="Show"></a>Show daily Planned Hours for projects, tasks, and inaccessible items in the Workload Balancer</h3> <p>To help you understand how individual projects, tasks, or inaccessible items contribute to the workload of your users and to be able to make correct reassignment decisions in the Workload Balancer, we have introduced a setting that allows you to view the hourly distribution for individual projects, tasks and inaccessible items.</p> <p>For information about managing hours in the Workload Balancer, see <a href="../../resource-mgmt/workload-balancer/manage-user-allocations-workload-balancer.md" class="MCXref xref" xrefformat="{para}">Manage user allocations in the Workload Balancer</a>.</p> </td> 
   ...
   <tr data-mc-conditions="QuicksilverOrClassic.Draft mode"> 
    <td> <h3><a name="Adjust"></a>Adjust timeline duration in the Workload Balancer</h3> <p>You now have the flexibility to select how many weeks you display in the Workload Balancer: you can select from 2, 4, or 6 weeks. Previously, the number of weeks was set to 4 by default.</p> <p>For information about navigating the Workload Balancer, see <a href="../../resource-mgmt/workload-balancer/navigate-the-workload-balancer.md" class="MCXref xref" xrefformat="{para}">Navigate the Workload Balancer</a>.</p> <p><iframe class="vimeo-player_0" src="assets/394240272?" frameborder="0" allowfullscreen="1" width="560px" height="315px"></iframe> </p> <p><a href="https://vimeo.com/394240272/c21e55033f" target="_blank">View this video in full-screen mode.</a> </p> </td> 
   </tr>
  </draft-comment>
  <tr data-mc-conditions="QuicksilverOrClassic.Draft mode"> 
   <td> <h3><a name="Adjust"></a>Adjust timeline duration in the Workload Balancer</h3> <p>You now have the flexibility to select how many weeks you display in the Workload Balancer: you can select from 2, 4, or 6 weeks. Previously, the number of weeks was set to 4 by default.</p> <p>For information about navigating the Workload Balancer, see <a href="../../resource-mgmt/workload-balancer/navigate-the-workload-balancer.md" class="MCXref xref" xrefformat="{para}">Navigate the Workload Balancer</a>.</p> <p><iframe class="vimeo-player_0" src="assets/394240272?" frameborder="0" allowfullscreen="1" width="560px" height="315px"></iframe> </p> <p><a href="https://vimeo.com/394240272/c21e55033f" target="_blank">View this video in full-screen mode.</a> </p> </td> 
   ...
   <tr data-mc-conditions=""> 
    <td> <h3><a name="Improved6"></a>Improved toolbars for the new lists</h3> <p>As part of updating the look and feel of the new Workfront experience, we have redesigned the top toolbars in the following lists: projects, tasks, issues, portfolios, and programs. Some of the benefits of the new toolbar are:</p> 
     <ul> 
      ...
      <li>Managing filters, views, and groupings has been standardized for all three elements to match one another.</li> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <tr data-mc-conditions="QuicksilverOrClassic.Draft mode"> 
    <td> <h3><a name="Open"></a>Open the proofing viewer in a separate browser tab</h3> <p>To make it easier to review a proof and continue working, you can now open the proof in a separate browser tab in the Documents area.</p> <p>Right-click on the Open Proof button in the following areas to open the proofing viewer in a new tab:</p> 
     <ul> 
      <li>Document list</li> 
      <li>Details tab in the right panel</li> 
     </ul> <p>For more information about opening the proofing viewer, see .</p> </td> 
   </tr>
  </draft-comment>
  <tr data-mc-conditions="QuicksilverOrClassic.Draft mode"> 
   <td> <h3><a name="Open"></a>Open the proofing viewer in a separate browser tab</h3> <p>To make it easier to review a proof and continue working, you can now open the proof in a separate browser tab in the Documents area.</p> <p>Right-click on the Open Proof button in the following areas to open the proofing viewer in a new tab:</p> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <tr data-mc-conditions="QuicksilverOrClassic.Draft mode"> 
    <td> <p style="color: #ff0000;">Review this - Alina</p> <h3><a name="Improved4"></a>Improved navigation of all new lists with clear grouping differentiation</h3> <p>You can now see more clearly the differentiation between several layers of groupings in lists with a new color scheme. The grouping results are also outlined more clearly in a separate frame. This change has been applied to all the new lists.</p> <p>For information about creating and customizing groupings, see <a href="../../reports-and-dashboards/reports/reporting-elements/groupings-overview.md" class="MCXref xref" xrefformat="{para}">Groupings overview in Adobe Workfront</a>.</p> </td> 
   </tr>
  </draft-comment>
  <tr data-mc-conditions="QuicksilverOrClassic.Draft mode"> 
   <td> <p style="color: #ff0000;">Review this - Alina</p> <h3><a name="Improved4"></a>Improved navigation of all new lists with clear grouping differentiation</h3> <p>You can now see more clearly the differentiation between several layers of groupings in lists with a new color scheme. The grouping results are also outlined more clearly in a separate frame. This change has been applied to all the new lists.</p> <p>For information about creating and customizing groupings, see <a href="../../reports-and-dashboards/reports/reporting-elements/groupings-overview.md" class="MCXref xref" xrefformat="{para}">Groupings overview in Adobe Workfront</a>.</p> </td> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <tr data-mc-conditions=""> 
    <td> <h3><a name="Upload"></a>Upload a new version in the proofing viewer</h3> <p>Upload a new version of a proof directly inside of the Proofing viewer in Workfront.</p> <p>Previously, you had to navigate back to the Documents area to upload a new version.</p> <draft-comment>
      <p data-mc-conditions="QuicksilverOrClassic.Draft mode">For more information, see .</p>
     </draft-comment><p data-mc-conditions="QuicksilverOrClassic.Draft mode">For more information, see .</p> </td> 
   </tr>
  </draft-comment>
  <tr data-mc-conditions=""> 
   <td> <h3><a name="Upload"></a>Upload a new version in the proofing viewer</h3> <p>Upload a new version of a proof directly inside of the Proofing viewer in Workfront.</p> <p>Previously, you had to navigate back to the Documents area to upload a new version.</p> <p data-mc-conditions="QuicksilverOrClassic.Draft mode">For more information, see .</p> </td> 
  </tr> <draft-comment>
   <tr data-mc-conditions=""> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <tr data-mc-conditions=""> 
    <td> <h3><a name="Improved3"></a>Improved navigation when working with template tasks</h3> <p>To make navigation back to the template easier when working on a template task, the breadcrumb to the template is now available in the template task header.</p> <p>For information about the new object headers in the new Workfront experience, see <a href="../../workfront-basics/the-new-workfront-experience/new-object-headers.md" class="MCXref xref" xrefformat="{para}">New object headers</a>.</p> </td> 
   </tr>
  </draft-comment>
  <tr data-mc-conditions=""> 
   <td> <h3><a name="Improved3"></a>Improved navigation when working with template tasks</h3> <p>To make navigation back to the template easier when working on a template task, the breadcrumb to the template is now available in the template task header.</p> <p>For information about the new object headers in the new Workfront experience, see <a href="../../workfront-basics/the-new-workfront-experience/new-object-headers.md" class="MCXref xref" xrefformat="{para}">New object headers</a>.</p> </td> 
   ...
   <tr data-mc-conditions="QuicksilverOrClassic.Draft mode"> 
    <td> <p style="color: #ff0000;">Review this - Courtney</p> <h3>Proof viewer navigation enhancements</h3> <p>Use either of the following options to navigate back to Workfront from the proofing viewer:</p> 
     <ul> 
      <li>Close the proofing viewer: Click the X icon in the upper-right corner of the proofing window to return to the page you were on before you opened the proof.</li> 
      <li>Use breadcrumbs to return to your work after finishing a proof: Click a breadcrumb in the upper-left corner of the proofing viewer to return to any of the parent objects in Workfront.</li> 
     </ul> <p>Previously, you had to use the Back button in your browser to close the proofing viewer or return to the parent object.</p> </td> 
   </tr>
  </draft-comment>
  <tr data-mc-conditions="QuicksilverOrClassic.Draft mode"> 
   <td> <p style="color: #ff0000;">Review this - Courtney</p> <h3>Proof viewer navigation enhancements</h3> <p>Use either of the following options to navigate back to Workfront from the proofing viewer:</p> 
   ...
   <tr data-mc-conditions="QuicksilverOrClassic.Draft mode"> 
    <td> <p style="color: #ff0000;">Review this - Courtney</p> <h3>Open the proof viewer in a separate browser tab</h3> <p>To make it easier to review a proof and continue working, you can now open the proof in a separate browser tab in the Documents area.</p> <p>Right-click on the Open Proof button in the following areas to open the proofing viewer in a new tab:</p> 
     <ul> 
      <li>Document list</li> 
      <li>Details tab in the right panel</li> 
     </ul> </td> 
  ...
  <tr data-mc-conditions="QuicksilverOrClassic.Draft mode"> 
   ...
   <tr data-mc-conditions=""> 
    <td> <h3><a name="Updates2"></a>Updates on the Details page of all objects </h3> <p>We are continuing to improve the design of the new combined Details pages of all objects in the new Workfront experience. </p> <p>For information about the new Details page, see <a href="../../workfront-basics/the-new-workfront-experience/combined-pages-object-details.md" class="MCXref xref" xrefformat="{para}">Edit object details in the new Adobe Workfront experience</a>.</p> </td> 
   </tr>
  </draft-comment>
  <tr data-mc-conditions=""> 
   <td> <h3><a name="Updates2"></a>Updates on the Details page of all objects </h3> <p>We are continuing to improve the design of the new combined Details pages of all objects in the new Workfront experience. </p> <p>For information about the new Details page, see <a href="../../workfront-basics/the-new-workfront-experience/combined-pages-object-details.md" class="MCXref xref" xrefformat="{para}">Edit object details in the new Adobe Workfront experience</a>.</p> </td> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <tr data-mc-conditions=""> 
    <td> <h3><a name="New9"></a>New option for indicating how to display grouping results in lists</h3> <p>To give you more control over how you display your list results, you can now indicate whether you want the results in the grouping to be expanded or collapsed by default when displaying the list or report. This option is available within the grouping builder in a list or report. <draft-comment>
       <MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Draft mode">
         This functionality is available in all the updated lists. Items display expanded by default when accessing the list from a chart element or in a legacy list. 
       </MadCap:conditionalText>
      </draft-comment><MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Draft mode">
        This functionality is available in all the updated lists. Items display expanded by default when accessing the list from a chart element or in a legacy list. 
      </MadCap:conditionalText></p> <p>By default, the results display in an expanded list under the grouping.</p> <p>Prior to this change, the results always displayed in a collapsed list.</p> <p>For information about creating a grouping, see <a href="../../reports-and-dashboards/reports/reporting-elements/groupings-overview.md" class="MCXref xref" xrefformat="{para}">Groupings overview in Adobe Workfront</a>.</p> </td> 
   </tr>
  </draft-comment>
  <tr data-mc-conditions=""> 
   <td> <h3><a name="New9"></a>New option for indicating how to display grouping results in lists</h3> <p>To give you more control over how you display your list results, you can now indicate whether you want the results in the grouping to be expanded or collapsed by default when displaying the list or report. This option is available within the grouping builder in a list or report. <MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Draft mode">
       This functionality is available in all the updated lists. Items display expanded by default when accessing the list from a chart element or in a legacy list. 
     </MadCap:conditionalText></p> <p>By default, the results display in an expanded list under the grouping.</p> <p>Prior to this change, the results always displayed in a collapsed list.</p> <p>For information about creating a grouping, see <a href="../../reports-and-dashboards/reports/reporting-elements/groupings-overview.md" class="MCXref xref" xrefformat="{para}">Groupings overview in Adobe Workfront</a>.</p> </td> 
  </tr> <draft-comment>
   <tr data-mc-conditions=""> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <tr data-mc-conditions=""> 
    <td> <h3><a name="Indicato"></a>Indicator appears when you are about to override an existing Layout Template assignment</h3> <p>Now, when you are assigning a Layout Template, an Info icon displays next to the name of any user, job role, team, or group that already has a Layout Template assignment. This is helpful if you need to decide whether to override the existing assignment.</p> <p>For more information, see <a href="../../administration-and-setup/customize-workfront/use-layout-templates/assign-users-to-layout-template.md" class="MCXref xref" xrefformat="{para}">Assign users to a layout template</a>.</p> </td> 
   </tr>
  </draft-comment>
  <tr data-mc-conditions=""> 
   <td> <h3><a name="Indicato"></a>Indicator appears when you are about to override an existing Layout Template assignment</h3> <p>Now, when you are assigning a Layout Template, an Info icon displays next to the name of any user, job role, team, or group that already has a Layout Template assignment. This is helpful if you need to decide whether to override the existing assignment.</p> <p>For more information, see <a href="../../administration-and-setup/customize-workfront/use-layout-templates/assign-users-to-layout-template.md" class="MCXref xref" xrefformat="{para}">Assign users to a layout template</a>.</p> </td> 
...
<!--
<p data-mc-conditions="QuicksilverOrClassic.Draft mode">For a list of functionality not yet available, but soon to be available in the new Workfront experience Beta Preview environment, see <a href="../../administration-and-setup/the-new-workfront-experience/known-issues.md" class="MCXref xref" xrefformat="{para}">In development in the new Adobe Workfront experience</a>.</p>
-->

For a list of functionality not yet available, but soon to be available in the new Workfront experience Beta Preview environment, see [In development in the new Adobe Workfront experience](../../administration-and-setup/the-new-workfront-experience/known-issues.md).
...
<!--
<h3 data-mc-conditions="QuicksilverOrClassic.Draft mode">Various tabs in the User view</h3>
-->

### Various tabs in the User view

<!--
<p data-mc-conditions="QuicksilverOrClassic.Draft mode">The Working On, Work Requests, Accomplishments, and Documents tabs are no longer included in the new Workfront experience.</p>
-->
