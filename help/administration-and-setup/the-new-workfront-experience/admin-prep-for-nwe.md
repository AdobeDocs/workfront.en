...
<ol> 
 <li value="1"> <p>Switch your account to <em>the new Adobe Workfront experience</em>.</p> <p>For instructions, see <a href="../../administration-and-setup/add-users/create-and-manage-users/enroll-users-new-workfront-experience.md#switch2" class="MCXref xref">Switch your admin account to the new Adobe Workfront experience</a> in <a href="../../administration-and-setup/add-users/create-and-manage-users/enroll-users-new-workfront-experience.md" class="MCXref xref">Enroll users in the new Adobe Workfront experience</a>.</p> </li> 
 <li value="2"> <p>Explore your organization's <em>Workfront</em> instance.</p> <p>Think about what areas of <em>Workfront</em> your company uses most frequently. Explore each area thoroughly, including performing actions that your users are likely to perform.</p> <p>For example, if your organization frequently uses projects with large numbers of tasks, you should explore some of those projects. You might try opening multiple projects at once, update user assignments, or create a project from a template. Anything your users do, do with your own account.</p> <p>Consider the following areas when exploring <em>Workfront</em> :</p> 
  <ul> 
   <li> <p>Home</p> </li> 
   <li> <p>The <em>Workload Balancer</em></p> </li> 
   <li> <p>The <em>Resource Planner</em></p> </li> 
 ...
 <li value="3"> <p>Compare the performance of <em>the new Adobe Workfront experience</em> with <em>Workfront</em> Classic. </p> <note type="tip">
   Log in to 
   <em>Workfront</em> Classic as a different user in another window for easy comparison.
  </note> </li> 
</ol>
