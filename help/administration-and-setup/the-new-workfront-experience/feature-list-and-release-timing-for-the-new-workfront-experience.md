...
<table cellspacing="15"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p><span class="bold">The new Workfront experience</span> </p> <p>Breadcrumbs display the full navigational hierarchy, and the experience is consistent and complete across all object types, including proofs.</p> <p>For more information, see <a href="../../workfront-basics/the-new-workfront-experience/breadcrumb-overview.md" class="MCXref xref">Breadcrumbs overview in the new Adobe Workfront experience</a>.</p> <p><span class="bold">Classic experience</span> </p> <p> Breadcrumbs display only the level immediately above the current object you're viewing.</p> </td> 
  </tr> 
  <tr> 
   <td> <p><span class="bold">Object header</span> </p> <p>Connection to strategy</p> </td> 
   <td> <p><span class="bold">The new Workfront experience</span> </p> <p>The object header is new and consistent across all object types. This provides improved visibility of the type of object as well as a consistent location for actions.</p> <p>For more information, see <a href="../../workfront-basics/the-new-workfront-experience/new-object-headers.md" class="MCXref xref">New object headers</a>.</p> <p><span class="bold">Classic experience</span> </p> <p>When an object is selected, the information and actions in the header change depending on the object you’re viewing.</p> </td> 
  </tr> 
  <tr> 
   <td> <p><span class="bold">Simplified, customizable left navigation</span> </p> <p>An easier way to find your portfolios, make requests, and much more.</p> </td> 
   <td> <p><span class="bold">The new Workfront experience</span> </p> <p>Simplified multi-level navigation. Less-intrusive, quicker access to the areas and actions you use most. Users can drag to customize the order of options in the left navigation, and administrators can customize which options display.</p> <p>For more information, see <a href="../../workfront-basics/the-new-workfront-experience/simplified-left-navigation.md" class="MCXref xref">Simplified left navigation in the new Adobe Workfront experience</a>.</p> <p><span class="bold">Classic experience</span> </p> <p>3 levels of tabs that can be difficult to navigate and require unnecessary clicks.</p> </td> 
  </tr> 
  <tr> 
   <td> <p><span class="bold">Summary panel</span> </p> <p>Quick access to update your progress or collaborate on a task.</p> </td> 
   <td> <p><span class="bold">The new Workfront experience</span> </p> <p> Click a work item in a task or issue list to quickly open summarized information without leaving the current screen.</p> <p>For more information, see <a href="../../workfront-basics/the-new-workfront-experience/summary-overview.md" class="MCXref xref">Summary overview in the new Adobe Workfront experience</a>.</p> <p><span class="bold">Classic experience</span> </p> <p>Clicking a work item takes you to a new page.</p> </td> 
  </tr> 
  <tr> 
   <td> <p><span class="bold">Standard and custom data displayed in a single location</span> </p> <p>Personalize the layout to see detailed information about your work.</p> </td> 
   <td> <p><span class="bold">The new Workfront experience</span> </p> <p>View all information about an object on one page with a seamless design that includes both Workfront fields and custom fields in the same area.</p> <p>For more information, see <a href="../../workfront-basics/the-new-workfront-experience/combined-pages-object-details.md" class="MCXref xref">Edit object details in the new Adobe Workfront experience</a>.</p> <p><span class="bold">Classic experience</span> </p> <p>Custom data is viewed and accessed differently from standard data. For example, custom data is available in a separate tab within a task.</p> </td> 
  </tr> 
  <tr> 
