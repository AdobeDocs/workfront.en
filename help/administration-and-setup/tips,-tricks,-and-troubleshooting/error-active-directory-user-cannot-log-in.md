...
# Error: Active Directory User Cannot Log In {#error-active-directory-user-cannot-log-in}



## Problem {#problem}

A single user or only a few users are unable to Login to `Workfront`. They are receiving the following error:
