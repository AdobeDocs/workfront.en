...
# Transfer custom form data to a larger work item {#transfer-custom-form-data-to-a-larger-work-item}
...
* You can convert issues to tasks or projects. For more information, see [Overview of converting issues in Adobe Workfront](convert-issues.md).
* You can convert tasks to projects. For more information, see [Convert a task to a project](convert-task-to-project.md).
...
## Convert an issue or task and transfer custom form data {#convert-an-issue-or-task-and-transfer-custom-form-data}
