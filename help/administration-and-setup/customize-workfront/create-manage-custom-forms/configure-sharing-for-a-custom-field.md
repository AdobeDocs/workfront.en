...
# Configure sharing for a custom field {#configure-sharing-for-a-custom-field}
...
## Configure sharing for a custom field {#configure-sharing-for-a-custom-field-1}
...
1.  In the `Custom Field Access` box that displays, specify who you want to share the field with and how you want to share it:
 ...
 <tbody> 
  <tr class="TableStyle-TableStyle-List-options-in-steps-Body-LightGray"> 
   ...
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyD-Column2-LightGray"> <p>You can click <span class="bold">Advanced Settings</span> to specify whether you want the user or users to be able to use their access to add the custom field to a Custom Form or share it with other users.</p> </td> 
  </tr> 
  <tr class="TableStyle-TableStyle-List-options-in-steps-Body-MediumGray"> 
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyB-Column1-MediumGray" role="rowheader">Manage it</td> 
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyA-Column2-MediumGray"> <p>Allows access to edit the custom field and to see it in the Field Library and on the page where you build Custom Forms.</p> <p>You can click <span class="bold">Advanced Settings</span> to specify whether you want the user or users to be able to use their access to delete the custom field from the system or share it with other users.</p> </td> 
  </tr> 
 </tbody> 
</table>    
...
## Inherited access to custom fields when a custom form is shared {#inherited-access-to-custom-fields-when-a-custom-form-is-shared}
...
If you need to remove access to a field in a custom form that was shared, you need to unshare the form. For instructions, see in the section [Remove access to a custom form](share-access-to-a-custom-form.md#unshare) in the article [Share a custom form](share-access-to-a-custom-form.md).
