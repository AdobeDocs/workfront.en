...
## Moving a task or an issue to a project with a different group than that of the approval process

Drafted out until this postponed story is completed

Moving a task or an issue from a project to another might affect existing approval processes on the task or the issue depending on the groups of the two projects. The following table illustrates the scenarios that might exist: 
