...
<ol> 
 ...
 <li value="3"> <p>(Conditional) If you are creating a status for use system wide, ensure that<span class="bold"> System Statuses</span> is selected in the box in the upper-right corner.</p>  <p>Or</p> <p>If you are creating a status for a group or subgroup, start typing the name of the group in the box in the upper-right corner, then select it when it appears.</p>  </li> 
 ...
 <li value="5"> <p>If you are creating a new status, click <span class="bold">Add a New Status</span>.</p> <p>Or</p> <p>If you are editing an existing status, hover over it, then click the <span class="bold">Edit</span> icon that displays to the far-right.</p>  </li> 
  ...
  <table cellspacing="0"> 
   ...
   <tbody> 
    ...
    <tr> 
     ...
     <td> <p>(Project and Task statuses only)</p> <p>Enable this option if you want the status hidden from users. When it is disabled (the default setting), all users in the system can use the status.</p> <note type="tip">
