  ...
  <table cellspacing="0"> 
   ...
   <tbody> 
    ...
    <tr> 
     ...
     <td> <p>Decide whether this should be a default priority&nbsp;or not, by selecting the radio button.</p> <p>If a priority is designated as the <span class="bold">Default Priority</span>, it is automatically picked&nbsp;for all the projects, tasks, or issues in <span>Workfront</span>. <span class="bold">Normal</span> is the default priority for all objects in <span>Workfront</span>.</p> </td> 
    </tr> 
    <tr> 
    ...
    <tr> 
     ...
     <td> <p>Select this box if you want to hide&nbsp;the priority.<br>When you select&nbsp;the <span class="bold">Hide</span> option, the priority does not display anywhere in <span>Workfront</span> and users are not able to choose it for their projects, tasks, and issues.</p> <note type="important">
