...
<ol> 
 ...
 <li value="3"> <p>Click the down arrow <img src="assets/down-arrow-blue.png"> under <span class="bold">Select a list to customize</span>, then select the type of Workfront object for which you want to customize the Filter, View, and Grouping list controls.</p> <p> <img src="assets/select-a-list-to-customize-menu-on-pg-adobe-branding-350x161.png" style="width: 350;height: 161;"> </p> <note type="note">  
