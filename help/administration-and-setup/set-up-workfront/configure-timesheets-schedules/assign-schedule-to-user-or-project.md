...
# Assign a schedule to a user or project {#assign-a-schedule-to-a-user-or-project}



## Assign a schedule to users {#assign-a-schedule-to-users}
...
## Assign a schedule to projects {#assign-a-schedule-to-projects}
