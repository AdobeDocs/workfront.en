...
# Configure timesheet and hour preferences {#configure-timesheet-and-hour-preferences}
...
## Set timesheet and hour preferences {#set-timesheet-and-hour-preferences}
...
<table style="width: 100%;margin-left: 0;margin-right: auto;mc-table-style: url('../../../Resources/TableStyles/TableStyle-List-options-in-steps.css');" class="TableStyle-TableStyle-List-options-in-steps" cellspacing="0"> 
 ...
 <tbody> 
  ...
  <tr class="TableStyle-TableStyle-List-options-in-steps-Body-MediumGray"> 
   ...
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyD-Column2-MediumGray"> <p>Enables users to record both time and expenses in the timesheet.</p> </td> 
  </tr> 
  <tr class="TableStyle-TableStyle-List-options-in-steps-Body-LightGray"> 
  ...
  <tr class="TableStyle-TableStyle-List-options-in-steps-Body-MediumGray" data-mc-conditions=""> 
   ...
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyD-Column2-MediumGray"> <p>Restrict editing to timesheet owners and <span class="mc-variable WFVariables.AdminWF-plur variable varname">Workfront administrators</span>. When this option is disabled, timesheets can also be edited by:</p> 
    <ul> 
...
<table style="width: 100%;margin-left: 0;margin-right: auto;mc-table-style: url('../../../Resources/TableStyles/TableStyle-List-options-in-steps.css');" class="TableStyle-TableStyle-List-options-in-steps" cellspacing="0"> 
 ...
 <tbody> 
  <tr class="TableStyle-TableStyle-List-options-in-steps-Body-LightGray"> 
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyE-Column1-LightGray" role="rowheader">When deleting projects</td> 
  ...
  <tr class="TableStyle-TableStyle-List-options-in-steps-Body-MediumGray"> 
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyB-Column1-MediumGray" role="rowheader">When deleting tasks or issues</td> 
...
## Unlock timesheet and hour preferences for groups {#unlock-timesheet-and-hour-preferences-for-groups}
...
For information about how a *`group administrator`* configures timesheet and hour preferences for a group, see [Configure timesheet and hour preferences for a group](configure-timesheet-hour-preferences-group.md).
