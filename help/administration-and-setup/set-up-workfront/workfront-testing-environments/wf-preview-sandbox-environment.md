...
# The *`Adobe Workfront`* Preview Sandbox Environment {#the-adobe-workfront-preview-sandbox-environment}
...
*  The Custom Refresh Sandbox
  ...
  The Custom Refresh Sandbox is a separate testing environment which is refreshed manually by you. There is an additional cost to obtain the Custom Refresh Sandbox. For more information about the Custom Refresh Sandbox, see [The Adobe Workfront Custom Refresh Sandbox environment](wf-custom-refresh-sandbox-environment.md).




<table style="mc-table-style: url('../../../Resources/TableStyles/TableStyle-HeaderRow.css');width: 100%;" class="TableStyle-TableStyle-HeaderRow" cellspacing="15"> 
 ...
 <thead> 
  <tr class="TableStyle-TableStyle-HeaderRow-Head-Header1"> 
   ...
   <th class="TableStyle-TableStyle-HeaderRow-HeadE-Column1-Header1"> <p><span class="bold">Standard Support Package</span> </p> </th> 
   <th class="TableStyle-TableStyle-HeaderRow-HeadD-Column1-Header1"> <p><span class="bold">Plus, Preferred, and Enterprise Support Packages</span> </p> </th> 
  </tr> 
 </thead> 
 <tbody> 
  <tr class="TableStyle-TableStyle-HeaderRow-Body-LightGray"> 
   <td scope="col" class="TableStyle-TableStyle-HeaderRow-BodyE-Column1-LightGray"> <p>Preview Sandbox</p> </td> 
   <td scope="col" class="TableStyle-TableStyle-HeaderRow-BodyE-Column1-LightGray"> <p>✔</p> </td> 
   <td scope="col" class="TableStyle-TableStyle-HeaderRow-BodyD-Column1-LightGray"> <p>✔</p> </td> 
  </tr> 
  <tr class="TableStyle-TableStyle-HeaderRow-Body-MediumGray"> 
   <td scope="col" class="TableStyle-TableStyle-HeaderRow-BodyB-Column1-MediumGray"> <p>Custom Refresh Sandbox</p> </td> 
   <td scope="col" class="TableStyle-TableStyle-HeaderRow-BodyB-Column1-MediumGray"> <p> </p> </td> 
   <td scope="col" class="TableStyle-TableStyle-HeaderRow-BodyA-Column1-MediumGray"> <p>✔</p> </td> 
  </tr> 
 </tbody> 
</table>
...
#### `Accessing the Preview Sandbox for Accounts on Cluster 1,2,3, and 5`  {#accessing-the-preview-sandbox-for-accounts-on-cluster-and}
...
#### `Accessing the Preview Sandbox for Accounts on Cluster 4 (EMEA Accounts)`  {#accessing-the-preview-sandbox-for-accounts-on-cluster-emea-accounts}
...
>
>
>For more information about report deliveries for the production environment, see [Report delivery overview](set-up-report-deliveries.md).
>
>
...
For more information about Single Sign-On, see [Overview of single sign-on in Adobe Workfront](sso-in-workfront.md)


## Configuring Single Sign-On in the Preview Sandbox {#configuring-single-sign-on-in-the-preview-sandbox}
...
## Preview environment performance and availability {#preview-environment-performance-and-availability}
