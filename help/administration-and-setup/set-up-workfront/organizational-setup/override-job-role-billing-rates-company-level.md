...
<table cellspacing="0"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Administrative access to Companies if you are not a System Administrator</p> <p>Edit access to&nbsp;Financial&nbsp;Data</p> <p>Note: If you still don't have access, ask your Workfront administrator if they set additional restrictions in your access level. For information on how a Workfront administrator can modify your access level, see <a href="../../../administration-and-setup/add-users/configure-and-grant-access/create-modify-access-levels.md" class="MCXref xref">Create or modify custom access levels</a>.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<ol> 
 ...
 <li value="4">Click&nbsp;<span class="bold">Edit Company</span> in the upper-right corner.</li> 
 <li value="5"> <p>In the <span class="bold">Billing Rates</span> section, select the job role you want to edit, and enter the new billing rate for that job role in the&nbsp;<span class="bold">Company Billing Rate</span> box.</p> <p> <img src="assets/88-350x176.png" alt="" style="width: 350;height: 176;"> </p> <note type="note">
