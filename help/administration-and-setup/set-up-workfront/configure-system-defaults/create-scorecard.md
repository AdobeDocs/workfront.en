  ...
  <table cellspacing="0"> 
   ...
   <tbody> 
    ...
    <tr> 
     ...
     <td>Select this option&nbsp;to indicate that <em>Workfront</em> should subtract from the total possible points. Negative scores cannot be added to the maximum possible points of a scorecard.</td> 
    </tr> 
    <tr> 
