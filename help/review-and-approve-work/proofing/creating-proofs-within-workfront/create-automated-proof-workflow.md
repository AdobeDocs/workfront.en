...
<ol> 
 ...
 <li value="2"> <p>(Optional) If you want to use an Automated Workflow template that your <em>Workfront administrator</em> created and shared with you, click <span class="bold">Add template</span>, select the template in the box that appears, then click <span class="bold">Add template</span>.</p> <note type="note">
  ...
  <ol>
   ...
   <li value="2"><p>In the <span class="bold">Recipients</span> section for the stage, add reviewers to the stage.</p><note type="note">
     ...
     <ul>
      ...
      <li>After you add a user to a stage, you can configure settings for that user on the <em>proof</em>.</li>
