...
# Create a simple `proof` from an existing document

A simple proof does not have reviewers. You can assign them later or create an automated proof later.
...
<ol> 
 <li value="1">Go to the project, task, or issue where you want to create a new <span>proof</span>.</li> 
