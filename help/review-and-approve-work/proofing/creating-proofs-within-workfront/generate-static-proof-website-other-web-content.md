...
<ol> 
 ...
 <li value="3"> <p>(Conditional) If you are creating a new <span>proof</span>, click&nbsp;<span class="bold">Add New</span>, then click <span class="bold">Proof</span> in the menu that appears.</p> </li> 
 <li value="4">(Conditional) If you are creating a new version of an existing <span>proof</span>: 
  <ol style="list-style-type: lower-alpha;">
   <li value="1"><p>Mouse over the URL <span>proof</span>&nbsp;for which you want to create a new version, then select it by clicking in the light blue background surrounding it.</p><p><img src="assets/select-proof-by-selecting-light-blue-background-350x52.png" alt="Select_proof_by_selecting_light_blue_background.png" style="width: 350;height: 52;"><br></p></li>
 ...
 <li value="6"> <p>Click the URL you have added.</p> <p>Options for configuring the website <span>proof</span> appear.</p> <p> <img src="assets/interactive-proof-radio-btn-area-350x199.png" style="width: 350;height: 199;"> </p> </li> 
  ...
  <table cellspacing="0"> 
   ...
   <tbody> 
    <tr> 
     ...
     <td> <p>Adjust the resolution of your content when reviewers view the <span>proof</span>, allowing them to see how it appears on devices of varying sizes, such as phones, tablets, and monitors.</p> <p>If you select multiple resolutions, a separate <span>proof</span> is created for each resolution you select.</p> <note type="note">
       When a reviewer comments on the 
       <span>proof</span>, the comment includes the resolution showing when the comment was made so that other reviewers know which resolution is associated with the comment.&nbsp;
      </note> </td> 
    </tr> 
    <tr> 
   ...
   <span>proof</span> that you create.
  </note> </li> 
 <li value="9"> <p>Click <span class="bold">Done</span>.</p> <p>If you selected multiple screenshot resolutions in step 8, the list includes a set of screenshots for each resolution. You can generate these screenshots as separate <span>proofs</span> or combine them into a single <span>proof</span> (see&nbsp;<a href="../../../review-and-approve-work/proofing/creating-proofs-within-workfront/configure-proof.md#single-proof" class="MCXref xref">Single proof</a> in <a href="../../../review-and-approve-work/proofing/creating-proofs-within-workfront/configure-proof.md" class="MCXref xref">Configure a proof</a>.). We recommend that you combine them, especially if you are creating a static website <span>proof</span>.</p> <note type="note">
 ...
 <li value="10">Click <span class="bold">Create proof</span> to create a simple proof with no review process.<br>or<br>Continue by configuring an advanced <span>proof</span>: 
  <ul>
