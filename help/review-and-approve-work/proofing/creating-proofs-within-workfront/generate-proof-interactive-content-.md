...
# Create a *`proof`* for interactive content in a ZIP file {#create-a-proof-for-interactive-content-in-a-zip-file}
...
## Create a *`proof`* for interactive content in a ZIP file {#create-a-proof-for-interactive-content-in-a-zip-file-1}
