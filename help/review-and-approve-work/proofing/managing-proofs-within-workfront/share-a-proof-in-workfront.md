...
<ol> 
 <li value="1"> <p>Select the document that contains the <em>proof</em> you want to share with users.</p> <p>You can select only one document. You cannot share the link for multiple documents at the same time.</p> </li> 
 <li value="2"> <p>Click <span class="bold">Share</span> > <span class="bold">Proof Link</span>.</p> </li> 
 <li value="3">In the <span class="bold">Proof link</span> box that appears, do either of the following:</li> 
 <ul> 
...
<!--
<h3 data-mc-conditions="QuicksilverOrClassic.Draft mode"><a name="Adding"></a>Add users to a new <em>proof</em></h3>
-->
...
<li value="1">Begin the process for generating a <em>proof</em> on a document or website in <em>Workfront</em>, as described in the <a href="../../../review-and-approve-work/proofing/creating-proofs-within-workfront/generate-proof.md" class="MCXref xref">Generate a proof</a> articles.</li>
<li value="2">Configure the <em>proof</em> as described in the section <a href="../../../review-and-approve-work/proofing/creating-proofs-within-workfront/configure-proof.md#workflow" class="MCXref xref">Workflow</a> in the article <a href="../../../review-and-approve-work/proofing/creating-proofs-within-workfront/configure-proof.md" class="MCXref xref">Configure a proof</a>.</li>
</ol>
-->

1. Begin the process for generating a *proof* on a document or website in *Workfront*, as described in the [Generate a proof](../../../review-and-approve-work/proofing/creating-proofs-within-workfront/generate-proof.md) articles.

1. Configure the *proof* as described in the section [Workflow](../../../review-and-approve-work/proofing/creating-proofs-within-workfront/configure-proof.md#workflow) in the article [Configure a proof](../../../review-and-approve-work/proofing/creating-proofs-within-workfront/configure-proof.md).
