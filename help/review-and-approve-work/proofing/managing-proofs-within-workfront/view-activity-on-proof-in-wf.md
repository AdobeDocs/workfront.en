---
filename: view-activity-on-proof-in-wf
product-area: documents
navigation-topic: manage-proofs-within-workfront
title: View activity on a proof within Adobe Workfront
...
## View activity on a *proof* within *Adobe Workfront*
   ...
   <!--
   <li value="1" data-mc-conditions="QuicksilverOrClassic.Quicksilver">Hover over the Document that contains the <em>proof</em>, then select <span class="bold">Document details</span>.</li>
   -->

1. Hover over the Document that contains the *proof*, then select `Document details`.

   <!--
   <li value="2" data-mc-conditions="QuicksilverOrClassic.Quicksilver">In the left navigation menu, select <span class="bold">Proofing Activities</span>. </li>
   -->
