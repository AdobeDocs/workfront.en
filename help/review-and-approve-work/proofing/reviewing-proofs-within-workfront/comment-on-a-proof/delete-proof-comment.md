...
<ol start="3"> 
 ...
 <li value="5">Click <span class="bold">Delete</span> ><span class="bold"> Yes, delete it</span>. After a comment is deleted, the system logs an&nbsp;entry in the <em>proof</em> activity section, showing that the comment was deleted.</li> 
</ol>
