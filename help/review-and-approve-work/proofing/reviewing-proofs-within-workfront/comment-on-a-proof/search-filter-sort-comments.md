    ...
    <tr> 
     ...
     <td> 
      <ul> 
       ...
       <li><span class="bold">Current page only</span>:Displays only comments from the page you are currently viewing. The comment list refreshes when you change the visible page.&nbsp;Available only for static and interactive <span>proofs</span>.</li> 
      </ul> </td> 
    </tr> 
   </tbody> 
  </table> </li> 
  ...
  <table cellspacing="0"> 
   ...
   <tbody> 
    <tr> 
     ...
     <td>Available for all <span>proofs</span></td> 
    </tr> 
    <tr> 
    ...
    <tr> 
     ...
     <td>Available only for static <span>proofs</span>.</td> 
    </tr> 
    <tr> 
     ...
     <td>Available only for video <span>proofs</span>.</td> 
    </tr> 
    <tr> 
    ...
    <tr> 
     ...
     <td>Available only for interactive <span>proofs</span>.</td> 
    </tr> 
    <tr> 
