...
<ol start="3"> 
 ...
 <p>&nbsp;Or</p> 
 <p>&nbsp;In a video proof, hover over the point in the timeline where a comment was made, then click the numbered balloon that appears. </p> 
...
<ol start="3"> 
 <li value="3"> <p>(Conditional) If the comments area is not open, click&nbsp;<span class="bold">View comments</span>&nbsp;in the upper-right corner.</p> </li> 
 <li value="4"> <p> Click any comment to view the comment marks on the proof.</p> <note type="tip">
   Use the 
