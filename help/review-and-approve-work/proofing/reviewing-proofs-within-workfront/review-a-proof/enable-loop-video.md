...
<ol start="3"> 
 <li value="3"> <p>In the lower-right corner of the <span>proofing viewer</span>, click the <span class="bold">Settings</span> icon.</p> <p> <img src="assets/phq-viewer-video-playbackspeed--3-.png" alt="phq_viewer_video_playbackspeed__3_.png"> </p> </li> 
