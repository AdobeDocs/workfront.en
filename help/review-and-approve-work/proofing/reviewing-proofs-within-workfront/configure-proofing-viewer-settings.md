...
<!--
For comparative information about the Web Proofing Viewer and the Desktop Proofing Viewer, see Differences between the Web Proofing Viewer and the Desktop Proofing Viewer overview.
-->
...
<ol> 
 ...
 <li value="2"> <p>If the left toolbar is not showing, click the&nbsp;<span class="bold">Menu</span>&nbsp;icon, located in the upper-left corner of the <span>Web Proofing Viewer</span>.</p> <p> <img src="assets/menu-icon-in-proofing-viewer-350x228.png" style="width: 350;height: 228;"> </p> </li> 
