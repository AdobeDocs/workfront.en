...
<ol> 
 ...
 <li value="6"> <p>Click <span class="bold">Save+Close</span>.<br></p> <p>The report displays all users in <em>Workfront</em> who have a <em>proofing</em> license assigned to them.</p> </li> 
</ol>
