...
<ol> 
 ...
 <li value="2"> <p>If the left toolbar is not showing, click the&nbsp;<span class="bold">Menu</span>&nbsp;icon, located in the upper-left corner of the Web Proofing Viewer.</p> <p> <img src="assets/menu-icon-in-proofing-viewer-350x228.png" style="width: 350;height: 228;"> </img> </p> </li> 
