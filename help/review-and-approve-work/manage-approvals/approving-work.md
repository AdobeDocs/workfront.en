...
<ol> 
 ...
 <li value="3">(Optional) If a <span>proof</span> has been generated for the document, you can approve the document within the <span>proofing</span> interface, as described in <a href="#approving-a-document-from-a-proof" class="MCXref xref">Approve a document from a proof</a>.</li> 
</ol>
