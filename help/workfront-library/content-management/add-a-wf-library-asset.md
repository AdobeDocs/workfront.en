...
<ol> 
 <li value="1"> <p>In <em>Workfront</em>, navigate to the Documents tab of the object where you want to add a document from <em>Workfront Library</em>.</p> </li> 
 ...
 <li value="3"> <p>In the drop-down menu, click <span class="bold">From <em>Workfront Library</em></span>.</p> <p> <img src="assets/content-linktowf-350x383.png" style="width: 350;height: 383;"> </p> </li> 
 <li value="4"> <p>In the <span class="bold">Link External Files and Folders</span> dialog box, navigate to the document you want to add to <em>Workfront</em>, and select it.</p> </li> 
 <li value="5"> <p>Repeat Step 4 to add multiple documents to a <em>Workfront</em> object.</p> </li> 
 <li value="6"> <p>Click <span class="bold">Link</span>.</p> <p><em>Workfront</em> adds the document to the <em>Workfront</em> object. On the Documents tab for the <em>Workfront</em> object, any documents added from <em>Workfront Library</em> display the <em>Workfront</em> icon.</p> </li> 
</ol>
