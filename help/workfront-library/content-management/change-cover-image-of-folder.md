...
<ol> 
 ...
 <li value="6"> <p>&nbsp;Select the image, then click <span class="bold">Save.</span></p> <p>The new image displays on the cover of the folder.</p> <p>The cover image you select remains as the cover image, even if the asset is updated with a new version or is deleted from <span>Workfront Library</span>.</p> </li> 
</ol>
