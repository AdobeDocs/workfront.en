...
# Upload a new version of content in *`Workfront Library`* {#upload-a-new-version-of-content-in-workfront-library}

If you have Manage permissions to content, you can upload new versions. For information on managing multiple versions of content, see [Overview of content versioning in Workfront Library](content-versioning-overview.md) .
