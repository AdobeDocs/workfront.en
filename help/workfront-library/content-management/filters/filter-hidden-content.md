...
<ol> 
 ...
 <li value="3"> <p>In the <span class="bold">Filter</span> menu, enable the <span class="bold">Show Hidden</span> toggle.</p> <p> <img src="assets/show-hidden-filter-350x237.png" style="width: 350;height: 237;"> </p> <p>You can now view hidden content. The Show Hidden filter affects only your instance of Workfront Library and does not make hidden items visible for other users.</p> </li> 
</ol>
