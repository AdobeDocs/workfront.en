...
<ol> 
 ...
 <li value="2"> <p>Click the <span class="bold">Filter</span> icon.<br><img src="assets/filter-icon-location-350x102.png" style="width: 350;height: 102;"></p> <note type="tip">
 ...
 <li value="3"> <p>In the <span class="bold">Filter</span> menu, enable the <span class="bold">Show Expired</span> toggle.</p> <p> <img src="assets/show-expired-filter-350x237.png" style="width: 350;height: 237;"> </p> <p>You can now view expired content. The Show Expired filter affects only your instance of <span>Workfront Library</span> and does not make expired items visible for other users.</p> </li> 
</ol>
