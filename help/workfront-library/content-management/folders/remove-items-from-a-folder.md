...
<ol> 
 ...
 <li value="2"> <p>In the upper-left corner of Workfront Library, click the <span class="bold">Menu</span> icon.</p> <p> <img src="assets/menuicon.png"> </p> </li> 
 <li value="3"> <p>Select the area where the folder is located.</p> <p>If you have Manager or higher access to Workfront Library, you can choose Library, My Content, or Collections areas. Users with Viewer access can their Library or Collection areas.</p> </li> 
