...
<ol> 
 ...
 <li value="3"> <p>Select the area where the item you want to add is located.</p> <p>If you have Manager or higher access to Workfront Library, you can choose content from either your Library or My Content areas. Users with Viewer access can select items from their Library area.</p> </li> 
