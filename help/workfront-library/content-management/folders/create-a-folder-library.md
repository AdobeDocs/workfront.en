...
<ol> 
 ...
 <li value="6"> <p>Type a name for the folder, then press <span class="bold">Enter</span>.</p> <p>When you navigate to another area of <span>Workfront Library</span>, the newly-created folder is placed in alphabetical order with the other folders in the area.</p> </li> 
