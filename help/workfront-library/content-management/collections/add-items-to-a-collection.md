...
<ol> 
 ...
 <li value="2"> <p>Select the area where the item you want to add is located.</p> <p>If you have Manager or higher access to <span>Workfront Library</span>, you can choose content from either your Library or My Content areas. Users with Viewer access can select items from their Library area.</p> </li> 
