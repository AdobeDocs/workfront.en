...
<ol> 
 ...
 <li value="5"> <p>Click the arrow for a filter you want to apply.</p> <p>The filter opens to reveal several filter facets.</p> <note type="note">
   You cannot filter on custom text fields.
  </note> </li> 
 <li value="6"> <p>Select the facets you want to apply.</p> <p> <img src="assets/filterfacets.png"> </p> </li> 
 <li value="7"> <p>Repeat steps 5 and 6 until you have selected all the filters and facets you want to apply.</p> </li> 
 <li value="8"> <p>(Optional) To filter using keywords, click in the <span class="bold">Keywords</span> box, then select the keywords you want to filter with.</p> <p>The filtered results display.</p> </li> 
 <li value="9"> <p>(Optional) To close the Filter panel, click the <span class="bold">X</span> at the upper-right corner of the Filter panel.</p> </li> 
</ol>
