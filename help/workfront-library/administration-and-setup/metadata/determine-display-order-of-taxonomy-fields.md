...
<ol> 
 ...
 <li value="4"> <p>Locate the field you want to move, then drag the field to the desired order.</p> <p>We recommend you place taxonomy fields in a hierarchical order, with the most important fields placed at the top of the list and the fields of least importance placed at the end.</p> <note type="note">
