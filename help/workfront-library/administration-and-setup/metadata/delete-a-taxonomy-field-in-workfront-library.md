...
# Delete a taxonomy field in *`Workfront Library`* {#delete-a-taxonomy-field-in-workfront-library}
...
Only a *`Workfront Library administrator`* can delete a taxonomy field. For more information on taxonomy, see [Overview of taxonomy metadata in Workfront Library](taxonomy-metadata-overview.md).
