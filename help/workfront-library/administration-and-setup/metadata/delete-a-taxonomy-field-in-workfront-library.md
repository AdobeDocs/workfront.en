...
<ol> 
 ...
 <li value="4"> <p>Hover over the field you want to delete, then click <span class="bold">Edit</span>.</p> </li> 
 <li value="5"> <p>Click <span class="bold">Delete</span> in the lower-right corner, then click <span class="bold">Delete</span> again to confirm.</p> </li> 
</ol>
