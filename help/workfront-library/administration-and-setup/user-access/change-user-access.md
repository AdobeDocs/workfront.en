...
<ol> 
 ...
 <li value="2"> <p>In the upper-left corner of , click<em>Workfront Library</em> the <span class="bold">Menu</span> icon.</p> </li> 
 <li value="3"> <p style="font-weight: normal;">In the left panel, click <span class="bold">Setup</span>, then in the <span class="bold">Access</span> section, select the type of user grouping that you want to change access for:</p> 
  ...
  </ul> <p style="font-weight: normal;">A list of the user groupings in <em>Workfront Library</em> displays.</p> </li> 
