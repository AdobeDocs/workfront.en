...
# Configure Kanban {#configure-kanban}
...
## Configure the work in progress (WIP) limit {#configure-the-work-in-progress-wip-limit}
...
When the WIP limit is configured, you can view the WIP limit or even update it from the Kanban agile story board, as described in [Manage the work in progress (WIP) limit on the Kanban board](work-in-progress-limit-on-the-kanban-board.md).
...
## Configure stories to be automatically added from the backlog {#configure-stories-to-be-automatically-added-from-the-backlog}
...
## Configure how long cards stay on the Kanban board {#configure-how-long-cards-stay-on-the-kanban-board}
