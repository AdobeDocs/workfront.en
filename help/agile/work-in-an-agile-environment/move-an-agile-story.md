...
<ol> 
 ...
 <li value="5">Select <em>team_name</em>'s Backlog.<br>In the above example, the team name is<span class="bold">&nbsp;Development.</span></li> 
 <li value="6">Click <span class="bold">Move Story</span>.</li> 
</ol>
