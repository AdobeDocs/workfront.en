...
# Assign users to a story on the Kanban board {#assign-users-to-a-story-on-the-kanban-board}
...
## Assign users to a story on the Kanban board {#assign-users-to-a-story-on-the-kanban-board-1}
