...
# Late proof email {#late-proof-email}
...
* Any approvers who have not yet made their decision&nbsp;on the proof. For information about decisions, see [Make decisions on a proof](make-decisions-on-proof.md)
...
* Your *`Workfront administrator`* or *`Workfront Proof administrator`* can include your organization's logo in your email notifications, as explained in [Brand the Workfront Proof site](brand-wp-site.md). 
...
*  If you need to share multiple proofs with the same reviewers and you don't want them to get multiple emails, you can upload them at the same time. All of the reviewers receive one email detailing all the proofs and including a personal URL for each proof. 
  ...
  >[!NOTE]
  >
  >The Creator of the proofs receives a separate Proof made email for each of the proofs created. For more information, see [The Proof Made email](proof-made-email.md).



* If you or your reviewers don't receive an expected email notification, see&nbsp; [Configure Workfront Proof emails to avoid spam filters](configure-wp-emails-avoid-spam-filters.md).
