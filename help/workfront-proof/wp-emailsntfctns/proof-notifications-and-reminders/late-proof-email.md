...
<ul> 
 <li>Your <em>Workfront administrator</em> or <em>Workfront Proof administrator</em> can include your organization's logo in your email notifications, as explained in <a href="../../../workfront-proof/wp-acct-admin/branding/brand-wp-site.md" class="MCXref xref" xrefformat="{para}">Brand the Workfront Proof site</a>. </li> 
