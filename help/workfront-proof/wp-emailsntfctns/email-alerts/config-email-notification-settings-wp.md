...
<ol> 
 ...
 <li value="4"> <p>In the drop-down list to the right of the following two settings, select one of the options explained in the table below.</p> 
  <ul> 
   <li><span class="bold">Default email alert</span>: Affects every <span>proof</span> that is shared with you. This setting can be overridden at the <span>proof</span> level.</li> 
   ...
   <span>Workfront Proof</span> sends you a daily summary about activity on your 
   <span>proofs</span>.
  </note> 
  <table cellspacing="0"> 
   <col> 
  ...
  <table cellspacing="0"> 
   ...
   <tbody> 
    <tr> 
     ...
     <td>Specify whether you want to receive a Proof made email when you create a <span>proof</span>. For more information, see <a href="../../../workfront-proof/wp-emailsntfctns/proof-notifications-and-reminders/proof-made-email.md" class="MCXref xref">The Proof Made email</a></td> 
    </tr> 
    <tr> 
     ...
     <td> <p>Choose between HTML styled emails and Plain text emails. </p> <note type="note">
       ...
       <span>proof</span> level. However, if 
       <span>proof</span> email notifications are disabled for the whole account in Account settings, no email alerts will be sent to the collaborators even if the Disabled email alert is not selected on 
       <span>proofs</span>.
       <br>
      </note> </td> 
    </tr> 
...
<ol> 
 ...
 <li value="6">In the drop-down list to the right of the following two settings, select one of the options explained in the table below:
  <ul>
   ...
   <span>Workfront Proof</span> sends users a daily summary about activity on their 
   <span>proofs</span>.
  </note>
  <table cellspacing="0">
   <col>
 ...
 <li value="7"> <p> In the remaining <span class="bold">Default email alert settings</span>, change any of the following:</p> 
  <table cellspacing="0"> 
   ...
   <tbody> 
    <tr> 
     <td role="rowheader">Email confirmation when <span>proofs</span> are ready</td> 
     <td>Specify whether you want to receive a Proof made email when you create a <span>proof</span>. For more information, see <a href="https://support.workfront.com/hc/en-us/article">The Proof Made Email.</a></td> 
    </tr> 
    <tr> 
     <td role="rowheader"><span class="bold">Format of emails sent to me</span> </td> 
     <td> <p>Choose between HTML styled emails and Plain text emails. </p> <note type="note">
