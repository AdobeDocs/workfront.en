...
<ol> 
 <li value="1"> Log in to your <em>Workfront</em> environment. </li> 
 ...
 <li value="6"> Click the <em>Workfront Proof</em>&nbsp;icon in the Global Navigation Bar.<br><img src="assets/proof-access-proofhq-350x39.png" alt="proof_access_proofhq.png" style="width: 350;height: 39;"><br>The <em>Workfront Proof</em>&nbsp;Preview environment displays. </li> 
</ol>
