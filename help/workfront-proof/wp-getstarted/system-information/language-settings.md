...
<ol> 
 <li value="1">Go to the <span class="bold">Details</span> tab in&nbsp;<span class="bold">Account settings</span> in&nbsp;<span>Workfront Proof</span>.</li> 
...
<ol> 
 <li value="1">Go to the&nbsp;<span class="bold">Personal details</span> tab in your&nbsp;<span class="bold">Personal settings</span> in&nbsp;<span>Workfront Proof</span>.<br>For more information, see <a href="../../../workfront-proof/wp-acct-admin/account-settings/manage-wp-users.md" class="MCXref xref">Manage Workfront Proof users</a>.</li> 
