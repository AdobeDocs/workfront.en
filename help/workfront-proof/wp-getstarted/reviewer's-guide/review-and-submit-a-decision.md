...
<ol> 
 ...
 <li value="3">Add one or more markups (4) to highlight the area of the <em>proof</em> referring to - you have a variety of tools (4) to choose from.</li> 
...
<ol> 
 ...
 <li value="2">Highlight a part of a text on the <em>proof</em> (7) - your selection will be placed into the active comment box (8)</li> 
