...
<ol> 
 <li value="1">Create a <em>proof</em>, as described in <a href="../../../workfront-proof/wp-work-proofsfiles/create-proofs-and-files/generate-proofs.md" class="MCXref xref" xrefformat="{para}">Generate Proofs in Workfront Proof</a>.&nbsp;</li> 
 ...
 <li value="3">In the <span class="bold">Organize</span> section, click <span class="bold">Add <em>proof</em> to a Basecamp project</span>.&nbsp;</li> 
 ...
 <li value="5">Specify whether you want this <em>proof</em> to be private in Basecamp (option not available in New Basecamp).</li> 
 <li value="6">Select your Basecamp Classic project.</li> 
 <li value="7">Select your Basecamp Classic Message Category.</li> 
 <li value="8">Under <span class="bold">People on the project</span>, select the check boxes for the reviewers in your Basecamp Classic account that you want to add to the <em>proof</em>.<br>Reviewers appear in their default role/email alert. The selected reviewers will receive a message in Basecamp for this <em>proof</em> and also an email notification from <em>Workfront Proof</em>.<br></li> <note type="note">
   If reviewer defaults have been changed, you must refresh the Basecamp data before the new defaults will be used. To refresh the Basecamp data click the "refresh" link on the Basecamp popup in 
  <em>Workfront Proof</em>. Include your own name if you also want to receive the message in Basecamp.
 </note> 
 <li value="9">Click <span class="bold">OK</span>.</li> 
 <li value="10">Apply any other settings you require for your <em>proof</em> (as normal) and click <span class="bold">Save</span> to submit your <em>proof</em>.&nbsp;</li> 
</ol>

## Adding an Existing Proof to a Basecamp Classic Project

<ol> 
 <li value="1">In <em>Workfront Proof</em>, go to the Proof details page, as described in&nbsp;<a href="../../../workfront-proof/wp-work-proofsfiles/manage-your-work/manage-proof-details.md" class="MCXref xref" xrefformat="{para}">Manage Proof Details in Workfront Proof</a>.</li> 
 ...
 <li value="4">Click&nbsp;<span class="bold">Add <em>proof</em> to a Basecamp project</span>.</li> 
 <li value="5">In the Add to Basecamp box that appears, do the following: 
  <ol style="list-style-type: lower-alpha;">
   ...
   <li value="2">Specify whether you want this <em>proof</em> to be Private in Basecamp (option not available in New Basecamp).</li>
   <li value="3">Select your Basecamp Classic project.</li>
   <li value="4">Select your Basecamp Classic Message Category.</li>
   <li value="5">Under <span class="bold">People on the project</span>, select the check boxes for the reviewers in your Basecamp Classic account that you want to add to the <em>proof</em>. </li>
   <p>Reviewers appear in their default role/email alert. The selected reviewers receive a message in Basecamp for this <em>proof</em> and also an email notification from <em>Workfront Proof</em>.<br><note type="note">
     &nbsp;If reviewer defaults have been changed, you must refresh the Basecamp data before the new defaults will be used. To refresh the Basecamp data click the "refresh" link on the Basecamp popup in 
     <em>Workfront Proof</em>. Include your own name if you also want to receive the message in Basecamp.
    </note></p>
  </ol></li> 
