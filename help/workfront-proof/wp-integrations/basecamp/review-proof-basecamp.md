...
<ol> 
 <ol> 
  ...
  <li value="2">Find the message for your <em>proof</em> (2).<br>The message page contains the name of the <em>proof</em> (in the subject) (3) and a&nbsp;link to the full screen Proof Viewer (4).</li> 
  <p> <img src="assets/basecamp-messages-1-350x129.png" alt="Basecamp_messages_1.png" style="width: 350;height: 129;"> </p> 
  <p>If you are logged in to your <em>Workfront Proof</em> account in one of your browsers windows, you can start reviewing right away. If you cannot see your name in bottom left corner of mini<em>proof</em>:</p> 
  <li value="3">Click <span class="bold">Sign In</span> (5).</li> 
  <li value="4">Type your email address (which was used to add you to the <em>proof</em>) (6).</li> 
  <li value="5">Click <span class="bold">Next</span> and in a second box that appears, type your <em>Workfront Proof</em> password (7).<br>If you don't have a <em>Workfront Proof</em> account, type a public name to display.</li> 
  <li value="6">Click <span class="bold">Remember me</span> so you only have to input your details once.<br>Now you're ready to proceed with reviewing the <em>proof</em> in Basecamp.</li> 
 </ol> 
</ol>
