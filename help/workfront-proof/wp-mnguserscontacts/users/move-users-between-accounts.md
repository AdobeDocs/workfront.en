...
# Move Users Between Accounts using *`Workfront Proof`* {#move-users-between-accounts-using-workfront-proof}
...
## Moving Users Between Connected Accounts {#moving-users-between-connected-accounts}
...
## Items That Can't be Moved {#items-that-cant-be-moved}



###  Folders Created or Owned by the Moved User  {#folders-created-or-owned-by-the-moved-user}
...
### Sets of Versions With Different Owners {#sets-of-versions-with-different-owners}
...
Groups will need to be re-created by the moved user on their new account. For more information, see [Create Proofing Groups using Workfront Proof](create-proofing-groups.md).&nbsp;


### Custom Views {#custom-views}

Personal&nbsp;Custom views&nbsp;will need to be re-created by the moved user on their new account. For more information, see [Create and Manage Custom Views in Workfront Proof Proof](create-and-manage-custom-views.md).
...
### Actions on Comments {#actions-on-comments}
