...
# Create and Manage Custom Profiles using *`Workfront Proof`* {#create-and-manage-custom-profiles-using-workfront-proof}
...
* Files  
  For more information, see [Upload Files and Web Content to Workfront Proof](upload-files-web-content.md).

* Public Folders  
  For more information, see&nbsp; [Understand Folder Permissions in Workfront Proof](folder-permissions.md).
...
* Tags  
  For more information, see [Create and Manage Tags in Workfront Proof](create-and-manage-tags.md).
...
* Manage Decisions   
  For information, see&nbsp; [Make decisions on a proof](make-decisions-on-proof.md).
...
* Manage custom fields   
  For information, see&nbsp; [Create and manage custom fields in Workfront Proof](create-and-manage-custom-fields.md).

* Manage dropzone  
  For information, see&nbsp; [The Dropzone](dropzone.md).

* Manage advanced workflow  
  For information, see [Automated Workflow overview](automated-workflow.md)."

* Manage SSO   
  For information, see&nbsp; [Single Sign-On in Workfront Proof](single-sign-on-overview.md).

* View account history   
  For information, see&nbsp; [Understanding the Workfront Proof Activity Audit Trail](activity-audit-trail.md).

* View account backups   
  For information, see&nbsp; [Back Up Your Workfront Proof Data](back-up-data.md).
...
* Create satellite accounts  
  For information, see&nbsp; [Configure a satellite account in Workfront Proof](configure-sat-acct-in-wp.md)

* Empty trash  
  For information, see [Restore and Empty the Trash in Workfront Proof](restore-and-empty-trash.md).

* Manage permission profiles  
  For information, see&nbsp; [Proof Permissions Profiles in Workfront Proof](proof-perm-profiles-in-wp.md).
...
## Creating a New Custom Profile {#creating-a-new-custom-profile}
...
## Copying a Profile {#copying-a-profile}
