...
# *`Workfront Proof`* mobile app for tablets {#workfront-proof-mobile-app-for-tablets}
...
## Manage your workload using Dashboard views {#manage-your-workload-using-dashboard-views}
...
## Review *`proofs`* in the app {#review-proofs-in-the-app}
...
## Comment in the app {#comment-in-the-app}
...
## Manage comments in the mobile app {#manage-comments-in-the-mobile-app}
...
## Reviewing video *`proof`*s {#reviewing-video-proofs}
...
## Make decisions in the app {#make-decisions-in-the-app}
...
1.  Tap the green decision button at the top of the page.  
   ...
   If you don’t see the green `Finish review` button and you think you should make a decision on the *`proof`*, your *`Workfront Proof administrator`* can update your *`proof`* role, as explained in [Manage Proof Roles in Workfront Proof](manage-proof-roles.md).





## The *`proofing viewer`* sidebar {#the-proofing-viewer-sidebar}
