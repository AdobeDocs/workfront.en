...
# *`Workfront Proof`* mobile app {#workfront-proof-mobile-app}
...
The *`Workfront Proof`* app automatically detects what type of device you are using. If you&nbsp;would like to use the app on your tablet, see&nbsp; [Workfront Proof mobile app for tablets](wp-mobile-app-tablet.md).
...
## Review a static *`proof`* in the app {#review-a-static-proof-in-the-app}
...
## Add comments and replies {#add-comments-and-replies}
...
## Read and reply to comments {#read-and-reply-to-comments}
...
1. Do any of the following: 
    ...
    * To apply an action on a comment:     
        ...
        1. Tap `Add action` (2).  
           ...
           For more information about actions, see [Use actions on comments](use-actions-on-comments-in-viewer.md).&nbsp;
...
## Review an audio or video *`proof`* in the app {#review-an-audio-or-video-proof-in-the-app}
