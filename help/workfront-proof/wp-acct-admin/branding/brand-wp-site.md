...
<ol> 
 ...
 <li value="2"> <p>Click <span class="bold">Account Settings</span> in the upper-right corner of the Workfront Proof interface.</p> <p>For more information about the various account settings you can configure, see&nbsp;<a href="https://support.workfront.com/hc/en-us/sections/115000912147-Account-Settings">Account settings.</a></p> </li> 
...
<ol> 
 ...
 <li value="5">From the drop-down menu select <span class="bold">Branding image</span>.<br>If you select <span class="bold">Disable</span>, the Workfront Proof logo appears on the proof loading page</li> 
 ...
 <li value="9"> <p>Click <span class="bold">Save</span>.</p> <p>Your branding image now shows on the proof loading page of every proof created in your account.</p> <p> <img src="assets/proof-loading-page-setup-4-350x97.png" alt="Proof_loading_page_setup_4.png" style="width: 350;height: 97;"> </p> </li> 
</ol>
...
<ol> 
 ...
 <li value="6"> <p>Click <span class="bold">Save.</span></p> <p>The image now appears on all proof notifications emails. (3) </p> <p> <img src="assets/branding---email-notification-350x195.png" alt="Branding_-_email_notification.png" style="width: 350;height: 195;"> </p> </li> 
</ol>
