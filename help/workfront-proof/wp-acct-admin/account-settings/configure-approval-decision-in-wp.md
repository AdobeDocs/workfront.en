...
# Configure approval decision options in *`Workfront Proof`* {#configure-approval-decision-options-in-workfront-proof}
...
## Configuring Decision Settings {#configuring-decision-settings}
...
## Creating Decision Reasons {#creating-decision-reasons}
...
## Creating a Post Decision Message {#creating-a-post-decision-message}
