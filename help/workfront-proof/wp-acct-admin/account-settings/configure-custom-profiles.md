...
# Configure custom profiles in *`Workfront Proof`* {#configure-custom-profiles-in-workfront-proof}
...
Custom profiles allow you to assign granular permissions to users in your account and define the level of access and rights they have over the items in your account. For more information about custom profiles, see [Create and Manage Custom Profiles using Workfront Proof](create-and-manage-custom-profiles.md).
...
For additional information on how to customize the Profiles tab, see [Create and Manage Custom Profiles using Workfront Proof](create-and-manage-custom-profiles.md).
...
For more information on the actions you can perform on this page, see " [Create and Manage Custom Profiles using Workfront Proof](create-and-manage-custom-profiles.md).&nbsp;
