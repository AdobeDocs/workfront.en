...
<ol> 
 <li value="1">On the Dashboard or any Views list, click the <span class="bold">More</span> (three dot) menu to the far-right of the <em>proof</em>, then click <span class="bold">Share <em>proof</em> links</span> on the dropdown arrow.</li> 
 <li value="2">In the <span class="bold">Share <em>proof</em> links</span> box that appears, do any of the following: 
  <ul>
 ...
 <li value="3"> <p>Click <span class="bold">Submit</span>.<br></p> <p><em>Workfront Proof</em> sends an email with the <em>proof</em> links to the people on the share list. </p> <note type="note">
    If one of the links is disabled on the 
   <em>proof</em>, it is not visible in the email.
   <br>
  </note> </li> 
</ol>
