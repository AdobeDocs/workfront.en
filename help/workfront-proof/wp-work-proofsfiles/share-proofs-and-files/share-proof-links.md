...
<ol> 
 <li value="1">On the Dashboard or any Views list, click the <span class="bold">More</span> (three dot) menu to the far-right of the <span>proof</span>, then click <span class="bold">Share <span>proof</span> links</span> on the dropdown arrow.</li> 
 <li value="2">In the <span class="bold">Share <span>proof</span> links</span> box that appears, do any of the following: 
  <ul>
 ...
 <li value="3"> <p>Click <span class="bold">Submit</span>.<br></p> <p><span>Workfront Proof</span> sends an email with the <span>proof</span> links to the people on the share list. </p> <note type="note">
    If one of the links is disabled on the 
   <span>proof</span>, it is not visible in the email.
   <br>
  </note> </li> 
</ol>
