...
<ol> 
 <li value="1">Type the text you want to search for, then press <span class="bold">Enter</span>.<br>Note the following about search results: 
  <ul>
   ...
   <li>If you enter the name of a previous <em>proof</em> version into the search field, the most recent version of that <em>proof</em> appears in the search results.</li>
