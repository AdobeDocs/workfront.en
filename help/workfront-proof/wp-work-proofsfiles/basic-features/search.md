...
# Searching *`Workfront Proof`* {#searching-workfront-proof}
...
For information about searching for text within *`proof`* content, see [Search within a proof](search-in-a-proof.md).
