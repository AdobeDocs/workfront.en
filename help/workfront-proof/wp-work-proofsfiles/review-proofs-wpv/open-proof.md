...
# Opening a Proof in *`Workfront Proof`* {#opening-a-proof-in-workfront-proof}
...
1. Continue with one of the following articles, depending on the *`proofing`* viewer you are using.  
   ...
   To learn more about the *`proofing`* viewers, see&nbsp; [Differences between the Web Proofing Viewer and the Desktop Proofing Viewer overview](understand-differences-between-web-viewer.md).
