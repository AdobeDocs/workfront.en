...
<ol> 
 ...
 <li value="2">Open the <span class="bold">More</span> menu for the proof.<br><img src="assets/more-button-small.png"></li> 
 <li value="3">Choose <span class="bold">Copy</span> from the dropdown menu.</li> 
 <li value="4">In the <span class="bold">Copy proof</span> page that appears, specify whether you want to create the&nbsp;copy as a new version of the existing proof or as a new proof.<br>By default, the name of your copy is "Copy of [original proof name]."</li> 
 <li value="5">(Optional) To rename your copy proof, type a new&nbsp;<span class="bold">Proof name</span>.</li> 
 <li value="6">(Optional) In the <span class="bold">Share</span> section, do any of the following: 
  <ul>
   <li>Add reviewers to the proof. See <a href="../../../workfront-proof/wp-work-proofsfiles/share-proofs-and-files/share-proof.md" class="MCXref xref" xrefformat="{para}">Share a Proof in Workfront Proof</a> for more information. For information about adding groups to a proof, see&nbsp;<a href="../../../workfront-proof/wp-mnguserscontacts/groups/add-groups.md" class="MCXref xref" xrefformat="{para}">Add Groups to a Proof</a>.</li>
   <li>Assign a proof Role to a reviewer. For more information, see <a href="../../../workfront-proof/wp-work-proofsfiles/share-proofs-and-files/manage-proof-roles.md" class="MCXref xref" xrefformat="{para}">Manage Proof Roles in Workfront Proof</a>.</li>
 ...
 <li value="7">In the <span class="bold">Organize</span> section, do any of the following: 
  <ul>
   <li>Add the proof to a folder. For more information, see <a href="../../../workfront-proof/wp-work-proofsfiles/organize-your-work/create-folders.md" class="MCXref xref" xrefformat="{para}">Create Folders in Workfront Proof</a>.</li>
   ...
   <li>Apply one or more tags to the proof. For more information, see <a href="../../../workfront-proof/wp-work-proofsfiles/organize-your-work/create-and-manage-tags.md" class="MCXref xref" xrefformat="{para}">Create and Manage Tags in Workfront Proof</a>.</li>
  </ul></li> 
...
<ol> 
 <li value="1">Go to any of the <span class="bold">Views</span> pages, as described in <a href="../../../workfront-proof/wp-work-proofsfiles/manage-your-work/manage-items-on-views-page.md" class="MCXref xref" xrefformat="{para}">Manage Items on the Views Page in Workfront Proof</a>.</li> 
 <li value="2">Open the <span class="bold">More</span> menu for the proof.<br><img src="assets/more-button-small.png"></li> 
 <li value="3">Choose <span class="bold">View proof details</span>&nbsp;from the dropdown menu.</li> 
 ...
 <li value="6">In the <span class="bold">New proof</span> page that appears,&nbsp;upload a new file, then click <span class="bold">Create</span>.</li> 
</ol>
