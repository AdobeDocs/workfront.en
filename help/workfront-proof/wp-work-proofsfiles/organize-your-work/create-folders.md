...
# Create Folders in *`Workfront Proof`* {#create-folders-in-workfront-proof}
...
For information about the Folder details page, see [Manage Folders and their Contents in Workfront Proof](manage-folders-and-contents.md).
...
* Make the folder private (4) - ticking the box will make this folder private (so visible only to the people you explicitly share the folder with and the users in your account with the profiles of [Proof Permissions Profiles in Workfront Proof](proof-perm-profiles-in-wp.md), [Proof Permissions Profiles in Workfront Proof](proof-perm-profiles-in-wp.md) or [Proof Permissions Profiles in Workfront Proof](proof-perm-profiles-in-wp.md) ). Please see [Understand Folder Permissions in Workfront Proof](folder-permissions.md) to find out more about private and public folders in *`Workfront Proof`*.
...
* Set the permissions for the people you share the folder with (3). This is useful for sharing private folders with users from your account - you can decide if users with the [Proof Permissions Profiles in Workfront Proof](proof-perm-profiles-in-wp.md) profile should be allowed to create, edit and delete items in the folder.
...
&nbsp;Please also see [Share Folders in Workfront Proof](share-folders.md).
