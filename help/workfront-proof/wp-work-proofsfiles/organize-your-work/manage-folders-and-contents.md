...
# Manage Folders and their Contents in *`Workfront Proof`* {#manage-folders-and-their-contents-in-workfront-proof}
...
## Grouping Items So Reviewers Can Work On Them Together {#grouping-items-so-reviewers-can-work-on-them-together}

You can use folders to group *`proofs`* that you want reviewers to work on together. When a reviewer opens one of the *`proofs`* in the folder to launch the *`proofing`* viewer, all the other *`proofs`* in the folder are available—the reviewer can work on any *`proof`* in the folder without leaving the *`proofing`* viewer. For more information, see [Work with multiple proofs in the proofing viewer](work-with-multiple-proofs.md).


## Adding New Items to a Folder {#adding-new-items-to-a-folder}
...
For more information, see [Generate Proofs in Workfront Proof](generate-proofs.md) or [Upload Files and Web Content to Workfront Proof](upload-files-web-content.md).
...
## Adding Existing Items to a Folder {#adding-existing-items-to-a-folder}

You can add an existing file or *`proof`* to a folder.&nbsp;


For more information, see [Manage Files in Workfront Proof](manage-files.md)&nbsp;or [Manage Proof Details in Workfront Proof](manage-proof-details.md).
...
1. (Conditional) Do one of the following: 
    ...
    * If you are adding a *`proof`* to a folder, go to the Proof details page as described in [Manage Proof Details in Workfront Proof](manage-proof-details.md)
    
    * If you are adding a file to a folder, go to the File details page as described in [Manage Files in Workfront Proof](manage-files.md)."
...
## Moving Items Out of a Folder {#moving-items-out-of-a-folder}
...
1. (Conditional) Do one of the following: 
    ...
    * If you are moving a *`proof`* out of a folder, go to the Proof details page as described in [Manage Proof Details in Workfront Proof](manage-proof-details.md)   
      Or  
      If you are moving a file out of a folder, go to the File details page as described in [Manage Files in Workfront Proof](manage-files.md)."
...
## Managing A Folder and Its Items on the Folder Details Page {#managing-a-folder-and-its-items-on-the-folder-details-page}
...
>[!NOTE]
>
>&nbsp;If you are not the creator or owner of the file, the options available will depend on your user [Proof Permissions Profiles in Workfront Proof](proof-perm-profiles-in-wp.md).
...
1. (Optional)To change information associated with an item in the folder, click the `More` icon to the right of the item, then use any of the options that appear.  
    ...
    * `View *`proof`* details`or `View file details`: Opens the Proof details or File details page. For more information, see [Manage Files in Workfront Proof](manage-files.md)&nbsp;or&nbsp; [Manage Proof Details in Workfront Proof](manage-proof-details.md).
    
    * `Share`: Lets you share the file with additional people. For more information, see [Share Files in Workfront Proof](share-files.md).
    ...
    * `Download original`: Lets you download the original file. For more information, see [Download Files Stored in Workfront Proof](download-files-stored.md).
...
## Managing Sub-Folders {#managing-sub-folders}
