...
<ol> 
 <li value="1"> <p> Access your <em>Workfront Proof</em> Dashboard.<br></p> <p>For more information, see&nbsp;<a href="../../../review-and-approve-work/proofing/managing-proofs-within-workfront/access-wf-proof-in-workfront.md" class="MCXref xref">Access Workfront Proof from Adobe Workfront</a>.</p> </li> 
 <li value="2"> <p>On the <span class="bold">Dashboard,</span>&nbsp;click the&nbsp;<span class="bold">Expand&nbsp;</span>arrow next to the <em>proof</em> you want to view or change the state of.<br></p> <p> <img src="assets/screen-shot-2018-05-02-at-11.31.29-am-350x85.png" style="width: 350;height: 85;"> <br> </p> <p>The&nbsp;<span class="bold">Workflow process&nbsp;</span>section appears.<br></p> <p> <img src="assets/screen-shot-2018-05-02-at-11.33.20-am-350x226.png" style="width: 350;height: 226;"> <br> </p> </li> 
