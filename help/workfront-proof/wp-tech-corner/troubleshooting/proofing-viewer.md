...
# Troubleshooting - *`Workfront Proof`* *`proofing viewer`* {#troubleshooting-workfront-proof-proofing-viewer}
...
## Ensure&nbsp;Your Browser and Flash Player Versions are Up-to-Date {#ensure-your-browser-and-flash-player-versions-are-up-to-date}
...
### Flash Player Plugin Version {#flash-player-plugin-version}
...
## Ensure&nbsp;Your Local Flash Storage is Available {#ensure-your-local-flash-storage-is-available}
...
Please see our [Problems With Viewing Proofs - Flash Shared Objects Explained](view-proof-flash-shared-object.md)&nbsp;for the detailed instructions.


## Identify Where the&nbsp;Problem Is {#identify-where-the-problem-is}
...
## Check Mixed Content Settings {#check-mixed-content-settings}
