...
# Troubleshooting - corrupted interface font in *`proofing viewer`* on Mac {#troubleshooting-corrupted-interface-font-in-proofing-viewer-on-mac}
...
## Remove font duplicates {#remove-font-duplicates}
...
## Fix Flash font conflict {#fix-flash-font-conflict}
