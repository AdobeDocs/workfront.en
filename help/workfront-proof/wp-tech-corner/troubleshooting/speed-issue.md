...
# Speed issues in *`Workfront Proof`* {#speed-issues-in-workfront-proof}
...
## Establish which part of the system is slow {#establish-which-part-of-the-system-is-slow}
...
## Run traceroute and ping tests {#run-traceroute-and-ping-tests}
...
## Test connection speed using Speedtest.net {#test-connection-speed-using-speedtest-net}
...
## Check network tab in the browser console {#check-network-tab-in-the-browser-console}
...
## Check your connection on a different network and machine {#check-your-connection-on-a-different-network-and-machine}
