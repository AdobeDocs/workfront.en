...
<ol> 
 <li value="1">In <span>Workfront Fusion</span>, create a new scenario.</li> 
 ...
 <li value="9">In <span>Workfront Fusion</span>, paste the URL into the HTTP module's URL field.</li> 
 ...
 <li value="15">In <span>Workfront Fusion</span>, paste the copied content to the module's URL field.</li> 
