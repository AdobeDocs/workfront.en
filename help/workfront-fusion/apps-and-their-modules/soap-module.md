...
<ol> 
 <li value="1">In Workfront Fusion, create a new scenario.</li> 
 ...
 <li value="9">In Workfront Fusion, paste the URL into the HTTP module's URL field.</li> 
 ...
 <li value="15">In Workfront Fusion, paste the copied content to the module's URL field.</li> 
