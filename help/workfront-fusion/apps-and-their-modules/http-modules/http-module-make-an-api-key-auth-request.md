...
<table cellspacing="0"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>Select the key that contains your API Key authentication credentials. To add a new key, click <span class="bold">Add </span>and configure the following information:</p> 
    <ul> 
     <li> <p><![CDATA[
