...
<ol> 
 <li value="1">Click your avatar at the bottom of the left panel, then click <span class="bold">Profile</span>.</li> 
 <li value="2"> <p>Click: <span class="bold">General Options</span>, then change any of the following options:&nbsp;</p> 
  <table cellspacing="0"> 
   <col> 
   <col> 
   <tbody> 
