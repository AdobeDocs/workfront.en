...
# Create a practice integration scenario {#create-a-practice-integration-scenario}
...
## Create a practice scenario {#create-a-practice-scenario}
...
## Choose the apps and name the scenario {#choose-the-apps-and-name-the-scenario}
...
1.  Authenticate the connection in the window that displays.
   ...
   The process for authenticating a connection can vary a bit between apps. You may need to log in to the app. You will usually need to click an `Allow` button. If you need help, see [About connecting Adobe Workfront Fusion to an app or service](about-connecting-wf-fusion-to-app-or-service.md).





## Configure the first module {#configure-the-first-module}
...
1. Give the second module a name such as "Create *`Workfront`* project," then continue with [Test the scenario](#test).
...
1.  Click the execution inspector bubble above the *`Workfront`* module to see the input of information and the output, which is the ID of the project now created in *`Workfront`*
    ...
    * For general information, see [Scenario execution flow](scenario-execution-flow.md).
    * For information about processed bundles, see [Scenario execution, cycles, and phases](scenario-execution-cycles-phases.md).
...
## Finalize the scenario and test it again {#finalize-the-scenario-and-test-it-again}
...
For more information about activating scenarios, see [Activate or deactivate a scenario](activate-or-inactivate-scenario.md).


For information about schedules, see [Schedule a scenario](schedule-a-scenario.md).
