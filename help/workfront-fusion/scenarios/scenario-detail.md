...
<ol> 
 ...
 <li value="2"> <p>On the page that displays, you can review the elements listed in the table below.</p> <p> <img src="assets/scenario-detail-350x207.png" style="width: 350;height: 207;"> </p> 
  <table cellspacing="0"> 
   <col> 
   <col> 
   <tbody> 
