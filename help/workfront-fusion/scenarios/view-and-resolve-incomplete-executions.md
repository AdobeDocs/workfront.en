...
# View and resolve incomplete executions {#view-and-resolve-incomplete-executions}
...
>
>
>For more information about scenario settings, see [Scenario settings panel](scenario-settings-panel.md).
...
## View incomplete executions {#view-incomplete-executions}

If a module encounters an error during its operation, a new inco mplete execution is added to the Incomplete executions folder. Each incomplete execution contains the scenario's blueprint and all the bundles that can be mapped into the failed module. The list of incomplete executions can be opened by clicking on the Incomplete Executions tab on the scenario detail page:
...
>
>
>For more information, see [Enable data loss](scenario-settings-panel.md#enable) in [Scenario settings panel](scenario-settings-panel.md).





## Access requirements {#access-requirements-1}
...
## Resolve incomplete executions {#resolve-incomplete-executions}
...
1.  Locate the failed operation and click `Resolve`:
   ...
   ![](assets/resolve-btn-350x257.png)
...
## Options related to incomplete executions {#options-related-to-incomplete-executions}
...
For more information about these options, see [Scenario settings panel](scenario-settings-panel.md).
