...
<ol> 
 ...
 <li value="2"> <p>(Conditional) If you want the template to become public, send it to your administrator for approval by clicking Request Approval.</p> <note type="note"> 
   <ul> 
    <li> <p>Once the template is approved, it becomes public. Public templates are visible for all <span>Workfront Fusion</span>users, regardless of the organization or the team, in the Public templates tab. </p> </li> 
