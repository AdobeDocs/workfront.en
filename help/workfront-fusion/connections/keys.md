...
# Keys in *`Adobe Workfront Fusion`* {#keys-in-adobe-workfront-fusion}
...
## Using keys in *`Workfront Fusion`* {#using-keys-in-workfront-fusion}

If a module requires a public or private key, you can add it to the keychain in the [Configure a module's settings](configure-a-modules-settings.md). 


For more information on public and private keys, see [Basic terms](basic-terms.md).
