...
The Done button can automatically set the status of a task or an issue. By default, `Workfront`&nbsp;marks an issue as Resolved when an assignee clicks Done on their work item.
