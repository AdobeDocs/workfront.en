...
<table> 
 ...
 <tbody> 
  <tr> 
   <td> 
    <ul> 
     <li>See recent items: You can view up to 5 of your most recent work items accessed through <em>Workfront</em> or the Photoshop plugin.</li> 
     <li>Locate pinned items: You can access projects, tasks, issues, and documents you've pinned in <em>the new Adobe Workfront experience</em>.</li> 
