...
# Install *`Adobe Workfront`* for Salesforce {#install-adobe-workfront-for-salesforce}
...
For a general understanding about what you can expect by installing *`Workfront`* for Salesforce, see [Adobe Workfront for Salesforce overview](workfront-for-salesforce-overview.md).
...
1.  Click `Save`.  
   ...
   For information about configuring the *`Workfront`* section for users, see [Configure the Adobe Workfront section for Salesforce users](configure-wf-section-for-salesforce-users.md).
