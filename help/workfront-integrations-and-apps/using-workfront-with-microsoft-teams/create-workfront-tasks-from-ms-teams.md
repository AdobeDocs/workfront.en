...
<ol> 
 <li value="1"> <p>Log in to <span>Workfront</span> from Microsoft Teams.<br></p> <p>For information about logging in to <span>Workfront</span>, see <a href="../../workfront-integrations-and-apps/using-workfront-with-microsoft-teams/install-workfront-ms-teams.md" class="MCXref xref">Install Adobe Workfront for Microsoft Teams</a>.</p> </li> 
 <li value="2">To open a <span class="bold">New task</span> card: 
  <ul>
   <li>If you are in the <span>Workfront</span> bot chat channel, type <span class="bold">New task </span>in the conversation field to create a new task.&nbsp;</li>
   <li>If you are in a chat channel other than the <span>Workfront</span> bot chat channel: 
    <ol>
     <li value="1">Start typing <span class="bold">@workfront </span>in the conversation field, then select the <span>Workfront</span> bot channel you want.</li>
     <li value="2"><p>Continue typing&nbsp;<span class="bold">New task </span>in the conversation field to create a new task.</p><p>The New task card displays in the <span>Workfront</span> bot channel.</p><p><img src="assets/ms-teams-new-task-card-350x181.png" alt="ms_teams_new_task_card.png" style="width: 350;height: 181;"></p></li>
    </ol></li>
  </ul></li> 
 <li value="3"> In the <span>Workfront</span> bot channel, specify the following information on the New task card: 
  <ul>
 ...
 <li value="4"> <p> Click <span class="bold">Save.</span>&nbsp;<br></p> <p>The new personal task is created in <span>Workfront</span>. A Reference Number is assigned to it and visible on the new task card.<br></p> <p>For information about reference numbers, see the <a href="../../workfront-basics/navigate-workfront/workfront-navigation/understand-objects.md#understanding-reference-numbers-of-objects" class="MCXref xref">Reference Numbers of objects</a> section in the <a href="../../workfront-basics/navigate-workfront/workfront-navigation/understand-objects.md" class="MCXref xref">Understand objects in Adobe Workfront</a> article.</p> </li> 
 <li value="5">(Optional) Click <span class="bold">Edit</span> to edit the task information further.</li> 
 <li value="6">(Optional) Click <span class="bold">View in <span>Workfront</span></span> to open the task in a new tab in <span>Workfront</span> and edit the task further, move it to a project, or assign it to someone else.&nbsp;</li> 
</ol>
