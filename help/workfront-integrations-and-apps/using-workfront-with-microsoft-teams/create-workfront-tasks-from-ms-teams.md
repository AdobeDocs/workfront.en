...
# Create *`Adobe Workfront`* tasks from Microsoft Teams {#create-adobe-workfront-tasks-from-microsoft-teams}
...
For information about installing *`Workfront`* for Microsoft Teams and logging in to *`Workfront`* from Microsoft Teams, see [Install Adobe Workfront for Microsoft Teams](install-workfront-ms-teams.md).


## Create personal tasks from Microsoft Teams {#create-personal-tasks-from-microsoft-teams}
...
1.  Log in to *`Workfront`* from Microsoft Teams.  
   ...
   For information about logging in to *`Workfront`*, see [Install Adobe Workfront for Microsoft Teams](install-workfront-ms-teams.md).
...
1.   Click `Save.`&nbsp;  
   ...
   For information about reference numbers, see the [Reference Numbers of objects](understand-objects.md#understanding-reference-numbers-of-objects) section in the [Understand objects in Adobe Workfront](understand-objects.md) article.
