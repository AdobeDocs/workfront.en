...
<ol> 
 ...
 <li value="8"> <p>(Optional) Click <span class="bold">View in <span>Workfront</span></span>&nbsp;to display the task within the&nbsp;<span>Workfront</span> application in a new tab.<br></p> </li> 
 <li value="9">(Optional) Navigate back to Outlook, and select the original email.<br>At the top of the <span>Workfront</span> add-in panel, notice the confirmation with a link that the email was added to <span>Workfront</span> as a task. The link includes the date on which it was converted.<br><img src="assets/outlook-standalone-task-added-350x123.png" alt="outlook_standalone_task_added.png" style="width: 350;height: 123;"><br></li> 
</ol>
