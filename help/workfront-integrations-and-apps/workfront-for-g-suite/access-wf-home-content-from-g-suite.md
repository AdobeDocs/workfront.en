...
<ol> 
 <li value="1">Make sure you are logged in to <span>Workfront</span>.</li> 
 <li value="2">If the <span>Workfront for G Suite</span> panel is not displayed, click the&nbsp;<span>Workfront</span> icon <img src="assets/wf-lion-icon.png"> in the G Suite add-ons sidebar at the far-right of the page. </li> 
