...
<ol> 
 <li value="1"> <p> Log in to your Slack instance and log in to <span>Workfront</span> from Slack.<br></p> <p>For more information about logging in to <span>Workfront</span> from Slack, see the "Logging In to <span>Workfront</span> from Slack" section in <a href="../../workfront-integrations-and-apps/using-workfront-with-slack/access-workfront-from-slack.md" class="MCXref xref">Access Adobe Workfront from Slack</a>.</p> </li> 
 <li value="2"> <p>Navigate to a message that includes a link to a <span>Workfront</span> project.</p> <note type="note">
 ...
 <li value="3">(Optional) Click the name of the project to open it in <span>Workfront</span> in a new browser tab.&nbsp;</li> 
...
<ol> 
 <li value="1"> <p> Log in to your Slack instance and log in to <span>Workfront</span> from Slack.<br></p> <p>For more information about logging in to <span>Workfront</span> from Slack, see the "Logging In to <span>Workfront</span> from Slack" section in <a href="../../workfront-integrations-and-apps/using-workfront-with-slack/access-workfront-from-slack.md" class="MCXref xref">Access Adobe Workfront from Slack</a>.</p> </li> 
 <li value="2"> <p> Navigate to a message that includes a link to a <span>Workfront</span> task.</p> <note type="note">
 ...
 <li value="3">(Optional) Click the name of the task to open it in <span>Workfront</span> in a new browser tab.&nbsp;</li> 
...
<ol> 
 <li value="1"> <p> Log in to your Slack instance and log in to <span>Workfront</span> from Slack.<br></p> <p>For more information about logging in to <span>Workfront</span> from Slack, see the "Logging In to <span>Workfront</span> from Slack" section in <a href="../../workfront-integrations-and-apps/using-workfront-with-slack/access-workfront-from-slack.md" class="MCXref xref">Access Adobe Workfront from Slack</a>.</p> </li> 
 <li value="2"> <p> Navigate to a message that includes a link to a <span>Workfront</span> issue.</p> <note type="note">
 ...
 <li value="3">(Optional) Click the name of the issue to open it in <span>Workfront</span> in a new browser tab.&nbsp;</li> 
 <li value="4"> Consider reviewing the&nbsp;following additional information about the task: 
  <ul>
...
<ol> 
 <li value="1"> <p> Log in to your Slack instance and log in to <span>Workfront</span> from Slack.<br></p> <p>For more information about logging in to <span>Workfront</span> from Slack, see the "Logging In to <span>Workfront</span> from Slack" section in <a href="../../workfront-integrations-and-apps/using-workfront-with-slack/access-workfront-from-slack.md" class="MCXref xref">Access Adobe Workfront from Slack</a>.</p> </li> 
 <li value="2"> <p>Navigate to a message that includes a link to a <span>Workfront</span> portfolio.</p> <note type="note">
   ...
   --> <br> </p> </li> 
 <li value="3">(Optional) Click the name of the portfolio to open it in <span>Workfront</span> in a new browser tab.&nbsp;</li> 
...
<ol> 
 <li value="1"> <p> Log in to your Slack instance and log in to <span>Workfront</span> from Slack.<br></p> <p>For more information about logging in to <span>Workfront</span> from Slack, see the "Logging In to <span>Workfront</span> from Slack" section in <a href="../../workfront-integrations-and-apps/using-workfront-with-slack/access-workfront-from-slack.md" class="MCXref xref">Access Adobe Workfront from Slack</a>.</p> </li> 
 <li value="2"> <p>Navigate to a message that includes a link to a <span>Workfront</span> program.</p> <note type="note">
   ...
   --> <br> </p> </li> 
 <li value="3">(Optional) Click the name of the program to open it in <span>Workfront</span> in a new browser tab.&nbsp;</li> 
...
<ol> 
 <li value="1"> <p> Log in to your Slack instance and log in to <span>Workfront</span> from Slack.<br></p> <p>For more information about logging in to <span>Workfront</span> from Slack, see the "Logging In to <span>Workfront</span> from Slack" section in <a href="../../workfront-integrations-and-apps/using-workfront-with-slack/access-workfront-from-slack.md" class="MCXref xref">Access Adobe Workfront from Slack</a>.</p> </li> 
 <li value="2"> <p>Navigate to a message that includes a link to a <span>Workfront</span> report.</p> <note type="note">
  ...
  --> </li> 
 <li value="3">(Optional) Click the name of the report to open it in <span>Workfront</span> in a new browser tab.&nbsp;</li> 
</ol>
