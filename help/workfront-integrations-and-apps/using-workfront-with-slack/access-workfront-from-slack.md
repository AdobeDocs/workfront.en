...
# Access *`Adobe Workfront`* from Slack {#access-adobe-workfront-from-slack}
...
You or your Slack administrator must install the *`Workfront`* app in your Slack instance before you can use *`Workfront`* from Slack. For more information, see [Configure Adobe Workfront for Slack](configure-workfront-for-slack.md).
...
## Access *`Workfront`* from Slack {#access-workfront-from-slack}
...
1.  Select from the following commands:&nbsp; 
    ...
    * `<pre>/wf home</pre>`Displays buttons from which you can access lists of your tasks, issues, and approvals. Clicking one of the buttons displays the first 20 items of each list in Slack.
      ...
      For more information about managing *`Workfront`* work items from Slack, see [Manage your work and approvals from Slack](manage-your-work-and-approvals-from-slack.md).
    ...
    *     
      ...
      For more information about adding tasks to *`Workfront`* from Slack, see the "Creating Tasks from Slack" section in [Create tasks and issues from Slack](create-tasks-and-issues-from-slack.md).
    ...
    *     
      ...
      For more information about adding issues to *`Workfront`* from Slack, see the "Creating Issues from Slack" section in [Create tasks and issues from Slack](create-tasks-and-issues-from-slack.md).
    ...
    *     
      ...
      For more information about accessing your Favorites from Slack, see the [Accessing Your Favorites List from Slack](access-favorites-and-recent-items-from-slack.md#accessing-favorites) section in the [Accessing Your Favorites and Recent Items from Slack](access-favorites-and-recent-items-from-slack.md) article.
    ...
    *     
      ...
      For more information about accessing your Recent Items from Slack, see the [Accessing Your Recent Items List from Slack](access-favorites-and-recent-items-from-slack.md#accessing-recent-items) section in the [Access your favorites and recent items from Slack](access-favorites-and-recent-items-from-slack.md) article. 
    ...
    *  /    
      ...
      For more information about managing your tasks from Slack, see the "Managing Your Tasks from Slack" section in [Managing Your Work and Approvals from Slack](manage-your-work-and-approvals-from-slack.md).  
    ...
    *     
      ...
      For more information about managing your issues from Slack, see the "Managing Your Issues from Slack" section in [Managing Your Work and Approvals from Slack](manage-your-work-and-approvals-from-slack.md).
    ...
    * `<pre>/wf approvals</pre>` Displays your *`Workfront`* approvals.  
      For more information about managing your approvals from Slack, see the "Managing Your Approvals from Slack" section in [Manage your work and approvals from Slack](manage-your-work-and-approvals-from-slack.md).  
    ...
    *     
      ...
      Search for a specific keyword. You can search for the following types objects:     
        ...
        *  Company 
        *  Note &nbsp;  
          For more information about searching in Slack, see [Search for Adobe Workfront items from Slack](search-for-wf-items-from-slack.md).
...
For more information about accessing *`Workfront`* from a shared link, see [Access Adobe Workfront objects from a shared link in Slack](access-wf-objects-from-shared-linked-in-slack.md).
...
1. Deselect from the following options, to disable your settings for *`Workfront`*: 
    ...
    * In the `Notifications Settings` area, disable notifications that you want to stop receiving from *`Workfront`*.  
      For information about receiving *`Workfront`* notifications in Slack, see [Receive Adobe Workfront notifications in Slack](receive-workfront-notifications-in-slack.md).
...
## Log out of *`Workfront`* from Slack&nbsp; {#log-out-of-workfront-from-slack}
