...
<ul> 
 ...
 <li> Your Slack system administrator must allow all Slack users to install <em>Workfront</em> for Slack.<br></li> 
 <li> <p>You must have a <em>Workfront</em>license to be able to use the integrated features in <em>Workfront</em>.</p> <note type="note">
   Users with any 
   <em>Workfront</em>license type can access 
   <em>Workfront</em>from Slack. The actions that you can perform from Slack are limited to your 
   <em>Workfront</em>license and permission levels.
  </note> </li> 
</ul>
...
<ol> 
 ...
 <li value="3"> <p> Examine the access that Slack is requesting. If you agree to this access, click <b>Allow Access</b> to authorize the <em>Workfront</em> app.</p> <p> <img src="assets/integrations-access-screen-350x429.png" style="width: 350;height: 429;"> <br> </p> </li> 
</ol>
...
<ol> 
 ...
 <li value="2">Start typing <em><em>Workfront</em></em> in the search field.</li> 
 <li value="3">Press Enter.</li> 
 <li value="4">Select the <span class="bold"><em>Workfront</em></span> app.</li> 
 ...
 <li value="9">When the installation completes, you can access <em>Workfront</em> from Slack, as described in the <a href="../../workfront-integrations-and-apps/using-workfront-with-slack/access-workfront-from-slack.md#viewing-all-available-commands" class="MCXref xref">Access Workfront from Slack</a> section in <a href="../../workfront-integrations-and-apps/using-workfront-with-slack/access-workfront-from-slack.md" class="MCXref xref">Access Adobe Workfront from Slack</a>.</li> 
</ol>
