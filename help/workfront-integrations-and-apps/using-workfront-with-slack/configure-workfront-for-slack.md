...
<ul> 
 ...
 <li> Your Slack system administrator must allow all Slack users to install Workfront for Slack.<br></li> 
 <li> <p>You must have a Workfrontlicense to be able to use the integrated features in Workfront.</p> <note type="note">
...
<ol> 
 ...
 <li value="3"> <p> Examine the access that Slack is requesting. If you agree to this access, click <b>Allow Access</b> to authorize the Workfront app.</p> <p> <img src="assets/integrations-access-screen-350x429.png" style="width: 350;height: 429;"> <br> </p> </li> 
</ol>
...
<ol> 
 ...
 <li value="4">Select the <span class="bold">Workfront</span> app.</li> 
