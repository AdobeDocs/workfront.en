...
<table cellspacing="15"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>(OAuth2 Only) This is a read-only field and is generated by <em>Workfront</em>. This&nbsp;value is used to register this integration with the external document provider. Note: As described above for Authentication URL, the provider must append the “state” parameter and its value to the querystring when performing the redirect.</td> 
  </tr> 
  <tr> 
   <td>ApiKey</td> 
