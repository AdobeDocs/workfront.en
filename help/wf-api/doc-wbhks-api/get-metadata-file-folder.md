...
<table cellspacing="15"> 
 ...
 <tbody> 
  <tr> 
   <td>id</td> 
   <td> <p>The ID of file or folder, as referenced by the webhook provider. This is different than <em>Adobe Workfront</em>’s document ID. To get the metadata of the root directory, use the value ‘/’.</p> <p>Note: The maximum length for the ID is 255 characters.</p> </td> 
  </tr> 
 </tbody> 
</table>
