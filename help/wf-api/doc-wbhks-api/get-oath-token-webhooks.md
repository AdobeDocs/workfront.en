...
<table cellspacing="15">
 ...
 <tbody>
  ...
  <tr>
   <td>code</td>
   <td>depends</td>
   <td><p>The authorization code sent to <em>Adobe Workfront</em> just after the user clicks the “Grant” button. This is only required when the grant type is “authorization_code”. The authorization code should be short lived, generally expiring in 10 minutes or less.</p></td>
  </tr>
  <tr>
   <td>refresh_token</td>
   <td>depends</td>
  ...
  <tr>
   <td>client_id</td>
   <td>yes</td>
   <td>The Client ID configured in <em>Workfront</em> for this custom integration.</td>
  </tr>
  <tr>
   <td>client_secret</td>
   <td>yes</td>
   <td>&nbsp;The Client Secret configured in <em>Workfront</em> for this custom integration.</td>
  </tr>
 </tbody>
</table>
