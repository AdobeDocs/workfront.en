...
<table style="height: 192px;width: 777px;mc-table-style: url('../../Resources/TableStyles/TableStyle-HeaderRow.css');" class="TableStyle-TableStyle-HeaderRow" cellspacing="15"> 
 ...
 <tbody> 
  ...
  <tr class="TableStyle-TableStyle-HeaderRow-Body-LightGray"> 
   ...
   <td class="TableStyle-TableStyle-HeaderRow-BodyD-Column1-LightGray"> <p>Optional values to be appended to the querystring of every API call. For example, access_type=offline.</p> <p>&nbsp;</p> </td> 
  </tr> 
  <tr class="TableStyle-TableStyle-HeaderRow-Body-MediumGray"> 
  ...
  <tr class="TableStyle-TableStyle-HeaderRow-Body-MediumGray"> 
   ...
   <td class="TableStyle-TableStyle-HeaderRow-BodyD-Column1-MediumGray"> <p>(OAuth2 Only) The full API URL used to retrieve OAuth2 tokens. This is hosted by the webhook provider or external document provider</p> <p>&nbsp;</p> </td> 
  </tr> 
  <tr class="TableStyle-TableStyle-HeaderRow-Body-LightGray"> 
...
### Adding Request Headers (optional)  {#adding-request-headers-optional}
...
<table style="height: 356px;width: 700px;mc-table-style: url('../../Resources/TableStyles/TableStyle-HeaderRow.css');" class="TableStyle-TableStyle-HeaderRow" cellspacing="15"> 
 ...
 <tbody> 
  ...
  <tr class="TableStyle-TableStyle-HeaderRow-Body-MediumGray"> 
   ...
   <td class="TableStyle-TableStyle-HeaderRow-BodyD-Column1-MediumGray"> <p>The authorization code sent to <span class="mc-variable WFVariables.ProdNameWF variable varname">Workfront</span> just after the user clicks the “Grant” button. This is only required when the grant type is “authorization_code”. The authorization code should be short lived, generally expiring in 10 minutes or less.</p> </td> 
  </tr> 
  <tr class="TableStyle-TableStyle-HeaderRow-Body-LightGray"> 
...
<table style="height: 497px;width: 696px;mc-table-style: url('../../Resources/TableStyles/TableStyle-HeaderRow.css');" class="TableStyle-TableStyle-HeaderRow" cellspacing="15"> 
 <col class="TableStyle-TableStyle-HeaderRow-Column-Column1" style="width: 154px;"> 
 <col class="TableStyle-TableStyle-HeaderRow-Column-Column1"> 
 <thead> 
  <tr class="TableStyle-TableStyle-HeaderRow-Head-Header1"> 
   <th class="TableStyle-TableStyle-HeaderRow-HeadE-Column1-Header1">Name&nbsp;</th> 
 ...
 <tbody> 
  <tr class="TableStyle-TableStyle-HeaderRow-Body-LightGray"> 
   ...
   <td class="TableStyle-TableStyle-HeaderRow-BodyA-Column1-LightGray">&nbsp; <p>The ID of file or folder, as referenced by the webhook provider. This is different than <span class="mc-variable WFVariables.ProdNameWF variable varname">Workfront</span>’s document ID. To get the metadata of the root directory, use the value ‘/’.</p><p>Note: The maximum length for the ID is 255 characters.</p></td> 
  </tr> 
 </tbody> 
</table>
...
<table style="height: 238px;width: 623;mc-table-style: url('../../Resources/TableStyles/TableStyle-HeaderRow.css');" class="TableStyle-TableStyle-HeaderRow" cellspacing="15"> 
 <col class="TableStyle-TableStyle-HeaderRow-Column-Column1"> 
 <col class="TableStyle-TableStyle-HeaderRow-Column-Column1"> 
 <col class="TableStyle-TableStyle-HeaderRow-Column-Column1"> 
 <thead> 
 ...
 <tbody> 
  ...
  <tr class="TableStyle-TableStyle-HeaderRow-Body-LightGray"> 
   ...
   <td class="TableStyle-TableStyle-HeaderRow-BodyA-Column1-LightGray">&nbsp; <p>&nbsp;Indicates if this file or folder is read-only to the authenticated user.(optional)</p><p>&nbsp;</p></td> 
  </tr> 
 </tbody> 
</table>
...
### Get a list of items in a folder  {#get-a-list-of-items-in-a-folder}
...
### Get the content of a document {#get-the-content-of-a-document}
...
<table style="height: 20px;width: 667px;mc-table-style: url('../../Resources/TableStyles/TableStyle-HeaderRow.css');" class="TableStyle-TableStyle-HeaderRow" cellspacing="15"> 
 <col class="TableStyle-TableStyle-HeaderRow-Column-Column1"> 
 <col class="TableStyle-TableStyle-HeaderRow-Column-Column1"> 
 <thead> 
  <tr class="TableStyle-TableStyle-HeaderRow-Head-Header1"> 
...
### Upload a file - Part 1 of 2  {#upload-a-file-part-of}
...
<table style="height: 117px;width: 658px;mc-table-style: url('../../Resources/TableStyles/TableStyle-HeaderRow.css');" class="TableStyle-TableStyle-HeaderRow" cellspacing="15"> 
 <col class="TableStyle-TableStyle-HeaderRow-Column-Column1"> 
 <col class="TableStyle-TableStyle-HeaderRow-Column-Column1"> 
 <thead> 
  <tr class="TableStyle-TableStyle-HeaderRow-Head-Header1"> 
 ...
 <tbody> 
  <tr class="TableStyle-TableStyle-HeaderRow-Body-LightGray"> 
   <td class="TableStyle-TableStyle-HeaderRow-BodyE-Column1-LightGray">parentId&nbsp;</td> 
   <td class="TableStyle-TableStyle-HeaderRow-BodyD-Column1-LightGray">The parent folder ID, as referenced by the webhook provider.</td> 
  </tr> 
  <tr class="TableStyle-TableStyle-HeaderRow-Body-MediumGray"> 
   <td class="TableStyle-TableStyle-HeaderRow-BodyE-Column1-MediumGray">filename&nbsp;</td> 
   <td class="TableStyle-TableStyle-HeaderRow-BodyD-Column1-MediumGray">The name of the document</td> 
  </tr> 
  <tr class="TableStyle-TableStyle-HeaderRow-Body-LightGray"> 
   <td class="TableStyle-TableStyle-HeaderRow-BodyE-Column1-LightGray">documentId</td> 
   <td class="TableStyle-TableStyle-HeaderRow-BodyD-Column1-LightGray"> <p>The <span class="mc-variable WFVariables.ProdNameWF variable varname">Workfront</span> document ID (added in version 1.1)</p> <p>&nbsp;</p> </td> 
  </tr> 
  <tr class="TableStyle-TableStyle-HeaderRow-Body-MediumGray"> 
   <td class="TableStyle-TableStyle-HeaderRow-BodyB-Column1-MediumGray">documentVersionId&nbsp;</td> 
   <td class="TableStyle-TableStyle-HeaderRow-BodyA-Column1-MediumGray">The <span class="mc-variable WFVariables.ProdNameWF variable varname">Workfront</span> document version ID (added in version 1.1)</td> 
  </tr> 
 </tbody> 
</table>
...
### Upload a file - Part 2 of 2  {#upload-a-file-part-of-1}
...
<table style="height: 134px;width: 687;mc-table-style: url('../../Resources/TableStyles/TableStyle-HeaderRow.css');" class="TableStyle-TableStyle-HeaderRow" cellspacing="15"> 
 <col class="TableStyle-TableStyle-HeaderRow-Column-Column1"> 
 <col class="TableStyle-TableStyle-HeaderRow-Column-Column1"> 
 <col class="TableStyle-TableStyle-HeaderRow-Column-Column1"> 
 <thead> 
...
### Delete a Document or Folder {#delete-a-document-or-folder}
...
### Rename a Document or Folder {#rename-a-document-or-folder}
...
### Test 1: Provision the Document Webhook service for a user  {#test-provision-the-document-webhook-service-for-a-user}
...
### Test 2: Link a document into *`Workfront`* Tests the following endpoints: /files, /metadata {#test-link-a-document-into-workfront-tests-the-following-endpoints-files-metadata}
...
### Test 3: Navigate to a document in the content management system  {#test-navigate-to-a-document-in-the-content-management-system}
...
### Test 4: Navigate to a document in the content management system (with login) {#test-navigate-to-a-document-in-the-content-management-system-with-login}
...
### Test 5: Download the document from the content management system  {#test-download-the-document-from-the-content-management-system}
...
### Test 6: Search for content  {#test-search-for-content}
...
### Test 7: Send document from *`Workfront`* to content management system  {#test-send-document-from-workfront-to-content-management-system}
...
### Test 8: View Thumbnails in *`Workfront`*  {#test-view-thumbnails-in-workfront}
...
### Test 9: Get the content bytes  {#test-get-the-content-bytes}
...
### Test 10: Refresh access token (OAuth2 Webhook providers only)  {#test-refresh-access-token-oauth-webhook-providers-only}
