...
# Deactivate a User via the API {#deactivate-a-user-via-the-api}
...
To learn more about deactivating a user, see " [Deactivate a user](deactivate-a-user.md).


For information about using the Core API, see [API basics](api-basics.md).
