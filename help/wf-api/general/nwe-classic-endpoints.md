...
<table cellspacing="0"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>[Request, Review, Work, Plan] or higher</p> </td> 
  </tr> 
  <tr> 
...
<!--
Video walk-through - Leave this section drafted for now
-->

<!--
Delete this box before publishing Hyperlink the image with the Wistia link. Specify what environment it is in and
-->

<!--
View the following video to see a walk-through of [task name]. This video was recorded in [the new Workfront experience or Workfront Classic]. However, the content also applies to [the new Workfront experience or Workfront Classic].
-->
