...
# What's new in API version 14 {#whats-new-in-api-version}
...
For more information on billing records, see [Create billing records](create-billing-records.md).
...
<table style="width: 100%;mc-table-style: url('../../Resources/TableStyles/TableStyle-List-options-in-steps.css');" class="TableStyle-TableStyle-List-options-in-steps" cellspacing="0"> 
 ...
 <tbody> 
  <tr class="TableStyle-TableStyle-List-options-in-steps-Body-LightGray"> 
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyE-Column1-LightGray" role="rowheader"> <p role="rowheader">Direct Fields</p> </td> 
  ...
  <tr class="TableStyle-TableStyle-List-options-in-steps-Body-MediumGray"> 
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyE-Column1-MediumGray" role="rowheader">Reference Fields</td> 
  ...
  <tr class="TableStyle-TableStyle-List-options-in-steps-Body-LightGray"> 
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyE-Column1-LightGray" role="rowheader">Collection Fields</td> 
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyD-Column2-LightGray"> 
    <ul> 
...
<table style="width: 100%;mc-table-style: url('../../Resources/TableStyles/TableStyle-List-options-in-steps.css');" class="TableStyle-TableStyle-List-options-in-steps" cellspacing="0"> 
 ...
 <tbody> 
  <tr class="TableStyle-TableStyle-List-options-in-steps-Body-LightGray"> 
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyB-Column1-LightGray" role="rowheader">Queries</td> 
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyA-Column2-LightGray"> 
    <ul> 
     <li> <p><b>getGroupStatuses</b> </p> <p>Added. This query supports the ability to create and manage statuses for groups and subgroups. </p> <p>For more information, see <a href="_manage-group-statuses.md" class="MCXref xref">Manage group statuses</a>.</p> </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
   ...
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyA-Column2-LightGray"> 
    <ul> 
     <li> <p><b>name</b> </p> <p>Added possible value:</p> 
      ...
      </ul> <p>This parameter supports the ability to add images into work item updates. </p> <p>For more information, see <a href="update-work.md" class="MCXref xref">Update work</a>.</p> </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="width: 100%;mc-table-style: url('../../Resources/TableStyles/TableStyle-List-options-in-steps.css');" class="TableStyle-TableStyle-List-options-in-steps" cellspacing="0"> 
 ...
 <tbody> 
  <tr class="TableStyle-TableStyle-List-options-in-steps-Body-LightGray"> 
   ...
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyA-Column2-LightGray"> 
    <ul> 
     <li> <p><b>lastCallbackDate</b> </p> <p>Added. This field records the date and time of the last callback from <span class="mc-variable WFVariables.ProdNameWFP variable varname">Workfront Proof</span>, if the version is associated to a proof.</p> </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
...
For more information on tagging in updates, see [Tag others on updates](tag-others-on-updates.md).
...
<table style="width: 100%;mc-table-style: url('../../Resources/TableStyles/TableStyle-List-options-in-steps.css');" class="TableStyle-TableStyle-List-options-in-steps" cellspacing="0"> 
 ...
 <tbody> 
  <tr class="TableStyle-TableStyle-List-options-in-steps-Body-LightGray"> 
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyB-Column1-LightGray" role="rowheader">Operations</td> 
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyA-Column2-LightGray"> <p>The following operations were added to the NoteTag object:</p> 
    <ul> 
     <li> <p><b>COUNT</b> </p> </li> 
     <li> <p><b>GET</b> </p> </li> 
...
<table style="width: 100%;mc-table-style: url('../../Resources/TableStyles/TableStyle-List-options-in-steps.css');" class="TableStyle-TableStyle-List-options-in-steps" cellspacing="0"> 
 ...
 <tbody> 
  <tr class="TableStyle-TableStyle-List-options-in-steps-Body-LightGray"> 
   ...
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyA-Column2-LightGray"> 
    <ul> 
     <li> <p><b>searchByPath</b> </p> <p>Added. This action supports the ability to find requests by using the path through the request queue and topic groups.</p> <p>For more information on searching request queues by path, see <a href="create-submit-requests.md#create-requests-in-the-web-app" class="MCXref xref">Create requests and generate drafts in the Workfront web app</a> in <a href="create-submit-requests.md" class="MCXref xref">Create and submit Adobe Workfront requests</a>.</p> </li> 
    </ul> <p>&nbsp;</p> </td> 
  </tr> 
 </tbody> 
</table>
...
For information on job roles, see [Job role overview](job-role-overview.md).
...
<table style="width: 100%;mc-table-style: url('../../Resources/TableStyles/TableStyle-List-options-in-steps.css');" class="TableStyle-TableStyle-List-options-in-steps" cellspacing="0"> 
 ...
 <tbody> 
  <tr class="TableStyle-TableStyle-List-options-in-steps-Body-LightGray"> 
   ...
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyD-Column2-LightGray"> 
    <ul> 
     <li style="font-weight: bold;"> <p>groupID</p> <p style="font-weight: normal;">Added. This field was added to support the ability to associate groups with templates.</p> <p style="font-weight: normal;">For more information, see <a href="edit-templates.md" class="MCXref xref">Edit project templates</a>.</p> </li> 
    </ul> </td> 
  </tr> 
  <tr class="TableStyle-TableStyle-List-options-in-steps-Body-MediumGray"> 
   ...
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyA-Column2-MediumGray"> 
    <ul> 
     <li style="font-weight: bold;"> <p>group</p> <p style="font-weight: normal;">Added. This field was added to support the ability to associate groups with templates.</p> <p style="font-weight: normal;">For more information, see <a href="edit-templates.md" class="MCXref xref">Edit project templates</a>.</p> </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
...
For more information, see [Timesheets overview](timesheets-overview.md).
