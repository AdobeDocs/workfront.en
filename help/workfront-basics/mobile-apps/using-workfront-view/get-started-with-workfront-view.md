...
<ol> 
 <li value="1">Go to the <span class="bold"><span>Workfront</span> View</span> app on your iPad.<br><img src="assets/workfront-view-app-adobe-350x261.png" alt="workfront_view_app_Adobe.png" style="width: 350;height: 261;"></li> 
 <li value="2">(Optional) Tap <span class="bold">Try the demo</span> to take a brief demo of the app.<br>The demo shows sample projects, not the projects in your <span>Workfront</span> system.<br><img src="assets/workfront-view-demo-350x256.jpg" alt="workfront_view_demo.jpg" style="width: 350;height: 256;"></li> 
 <li value="3">Specify your <span class="bold"><span>Workfront</span> Username</span>.</li> 
 <li value="4">Specify your <span class="bold"><span>Workfront</span> Password</span>.</li> 
 <li value="5">Specify the <span class="bold"><span>Workfront</span> URL</span> of your company.<br>The URL should be in this format: <span class="wysiwyg-underline wysiwyg-color-blue" style="font-style: italic;">yourCompanyDomain.my.workfront.com</span></li> 
