...
<ol> 
 <li value="1">Tap the name of a project in the list of projects in the Workfront View app.<br>Information about the project displays in the widgets uploaded on the screen.<br>For more information about adding widgets to the Project Details view, see <a href="../../../workfront-basics/mobile-apps/using-workfront-view/update-widgets-in-workfront-view.md" class="MCXref xref">Update widgets in the Project Details view</a>.</li> 
