---
filename: glossary-workfront-terms-s-u
...
<table cellspacing="15"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td>Scenario</td> 
   <td>A scenario is comprised of a series of steps (modules) that indicate how data should be transferred and transformed between apps/services.</td> 
  </tr> 
  <tr> 
   <td>Schedule</td> 
  ...
  <tr> 
   <td> <p>Status</p> </td> 
   <td> <p>An indicator used to signal a workflow position of a work item.</p> <p>For Projects, the Status is a setting on the Project that indicates whether the Project is:</p> 
    <ul> 
     <li>Current</li> 
     <li>On Hold </li> 
     <li>Complete </li> 
    ...
    <ul> 
     ...
     <li>Reopened</li> 
    </ul> <p>For more information on Issue Statuses, see <a href="../../../administration-and-setup/customize-workfront/creating-custom-status-and-priority-labels/issue-statuses.md" class="MCXref xref">Access the list of system issue statuses</a>.</p> </td> 
  </tr> 
  <tr> 
   <td>Status Change</td> 
  ...
  <tr> 
   <td>Update Type</td> 
   <td> <p>A setting on the Project theat determines when the Project's Projected timeline will be recalcuated. Options are:</p> 
    <ul> 
