...
# Understand objects in  *`Adobe Workfront`* {#understand-objects-in-adobe-workfront}
...
For a complete list of objects in *`Workfront`*, see the [API Explorer](api-explorer.md).


## Interdependency and hierarchy of objects {#interdependency-and-hierarchy-of-objects}

Objects are linked to one another in *`Workfront`*. For example, a task or an issue can never exist independently outside of a project. Tasks and issues are examples of objects that are stored in the project object. Tasks and issues are considered child objects to projects, which are considered parent objects.
...
&#42; Goals are the objects of *`Workfront Goals`*. For information about *`Workfront Goals`*, see [Adobe Workfront Goals overview](wf-goals-overview.md). 
...
For more information about how to customize object names using a Layout Template, see [Create and manage layout templates](create-and-manage-layout-templates.md).
...
*  Activity&#42;
  ...
  &#42;Goals, results, and activities are only available if your company purchased *`Workfront Goals`*. For information about *`Workfront Goals`*, see [Adobe Workfront Goals overview](wf-goals-overview.md).
...
For more information about how you can customize object names using Layout Templates, see [Create and manage layout templates](create-and-manage-layout-templates.md).


You cannot customize the names of any other object in *`Workfront`*. For a complete list of objects in *`Workfront`*, see the [API Explorer](api-explorer.md).
...
* All `<MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver"> sections in the left panel navigation</MadCap:conditionalText>`
* All menus
...
## Implications of customizing object names {#implications-of-customizing-object-names}
...
* Your custom names for the objects are not translatable. Only the *`Workfront`* default names can be translated in the supported languages. For more information about languages that are supported in *`Workfront`*, see [Supported languages in Adobe Workfront](supported-languages-in-workfront.md). The custom object name fields support foreign characters so you can input terminology in any language.
...
## Reference Numbers of objects {#reference-numbers-of-objects}
...
For information about how to search for objects by reference number, see [Use the reference number of objects](reference-number-of-objects.md).


## Object-specific searches {#object-specific-searches}
...
For more information about running basic and advanced searches in *`Workfront`*, see [Search Adobe Workfront](search-workfront.md).


## Report on objects {#report-on-objects}
...
You can report on all objects in the database using our open API. For a complete list of all objects in the database, see [API Explorer](api-explorer.md).
...
>When using text mode in your reports, the names of the objects in text mode expressions are the standard names in *`Workfront`*, and not the customized object names. For more information about using text mode in reports, see [Text Mode overview](understand-text-mode.md).


For more information about building a report, see [Create a custom report](create-custom-report.md).  
For more information about our API, see [API Explorer](api-explorer.md).
...
* Assignment
* Backlog Work Item  
  Displays tasks or issues on the agile backlog. For more information about the agile backlog, see [Manage the agile backlog](manage-the-agile-backlog.md).
...
*  Goal 
  ...
  >[!TIP] {type="tip"}
  >
  >You cannot report on project goals that are associated with a Business Case. For information about project goals vs strategic goals, see [Glossary of Adobe Workfront terminology](workfront-terminology-glossary.md). 
...
*  Journal Entry
  ...
  You can report on tracked system updates in the Updates area of objects like tasks, projects, issues, etc. To learn more, see [Report on the Updates area](create-journal-entry-report.md).
...
* Proof Approval  
  ...
  Proof approvals are assigned in *`Workfront`* as described [Add users to a proof](share-a-proof-in-workfront.md#add) in [Share a proof within Adobe Workfront](share-a-proof-in-workfront.md).
