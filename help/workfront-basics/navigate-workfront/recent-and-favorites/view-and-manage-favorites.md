...
Click the Favorites icon in the upper-right corner of any Workfront page, then select Recents. In the Recents menu, mouse over the recent item that you want to save as a favorite, then click the star. The recent item displays in the Favorites menu. 
