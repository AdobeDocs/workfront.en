...
<ol> 
 <li value="1">Click <span class="bold">Get Started</span> in the invitation email from <em>Workfront</em>. <br>For more information about receiving an invitation email, see <a href="#receiving-email-invitations" class="MCXref xref">Receive email invitations</a>.<br><img src="assets/new-user-screen-after-clicking-get-started-on-the-invitation-350x290.png" alt="" style="width: 350;height: 290;"></li> 
 <li value="2">Specify the following information:<br><span class="bold">First Name</span>: Your first name (it should be prefilled).<br><span class="bold">Last Name</span>: Your last name (it should be prefilled).<br><span class="bold">Title</span>: Your title in your organization.<br><span class="bold">Password</span>: Choose a password to log in to <em>Workfront</em>.<br><span class="bold">Confirm Password</span>: Confirm your <em>Workfront</em> password.&nbsp;</li> 
 <li value="3">Select <span class="bold">I accept the Terms and Conditions</span>.</li> 
 <li value="4">Click <span class="bold">Log Me In</span>.<br>This completes the creation of your user account in <em>Workfront</em>.&nbsp;</li> 
</ol>
