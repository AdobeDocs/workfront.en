...
<ul> 
 ...
 <li> <p>Sharing reports, dashboards, and calendars is similar to sharing any other object in <em>Workfront</em>.</p> <p>For more information about how to share objects in <em>Workfront</em>, see <a href="../../workfront-basics/grant-and-request-access-to-objects/share-an-object.md" class="MCXref xref" xrefformat="{para}">Share an object in Adobe Workfront</a>. </p> <p>Also see the following articles to learn how to share reports, dashboards, and calendars: </p> 
  <ul> 
 ...
 <li>If a report has a prompt and you share it publicly, the users accessing the report must be logged in to <em>Workfront</em> to be able to run the report using the prompt. If they cannot log in to <em>Workfront</em>, they will see the report without the prompt applied to it.<br>For more information about limitations of sharing reports with prompts, see the section <a href="../../reports-and-dashboards/reports/creating-and-managing-reports/add-prompt-report.md#limitations-of-running-public-prompted-reports" class="MCXref xref" xrefformat="{para}">Limitations of sharing prompted reports</a> in the article <a href="../../reports-and-dashboards/reports/creating-and-managing-reports/add-prompt-report.md" class="MCXref xref" xrefformat="{para}">Add a prompt to a report</a>.</li> 
