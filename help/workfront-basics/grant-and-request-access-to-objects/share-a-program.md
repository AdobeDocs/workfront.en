...
<ul> 
 <li> <p>You can share programs individually, or you can share several of them at a time.</p> <p>For more information about sharing items in <em>Workfront</em>, see <a href="../../workfront-basics/grant-and-request-access-to-objects/share-an-object.md" class="MCXref xref">Share an object in Adobe Workfront</a>.</p> </li> 
 ...
 <li> <p>When you share a program, users inherit the same permissions to all the children objects associated with the program, by default.<br></p> <p>For more information about the hierarchy of objects in <em>Workfront</em>, see <a href="../../workfront-basics/navigate-workfront/workfront-navigation/understand-objects.md" class="MCXref xref">Understand objects in Adobe Workfront</a>.<br></p> </li> 
