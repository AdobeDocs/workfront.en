...
<ul> 
 ...
 <li> <p>When you share a portfolio, users inherit the same permissions to all the children objects associated with the portfolio, by default.<br></p> <p>For more information about the hierarchy of objects in <em>Workfront</em>, see <a href="../../workfront-basics/navigate-workfront/workfront-navigation/understand-objects.md" class="MCXref xref">Understand objects in Adobe Workfront</a>.<br></p> </li> 
