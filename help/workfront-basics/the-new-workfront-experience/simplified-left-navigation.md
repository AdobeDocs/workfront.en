...
* [Default sections for objects](#default2) 
...
| Updates |Displays . Use this area to . For more information, see . |
|---|---|
| Details |Displays . Use this area to . For more information, see . |
| Documents |Displays . Use this area to . For more information, see . |
| &nbsp; |Displays . Use this area to . For more information, see . |
...
To learn how to use the left panel for an object, see [Use the new left navigation panel](#examples).
...
<table cellspacing="0"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>Displays all Resource Pools in <em>Workfront</em>. For information about Resource Pools, see <a href="../../resource-mgmt/resource-planning/resource-pools/work-with-resource-pools.md" class="MCXref xref"> Resource pools overview in Adobe Workfront</a>.</td> 
  </tr> 
 </tbody> 
</table>
...
<ol> 
 ...
 <li value="7"> <p>(Optional) To close the left panel, click the <span class="bold">Collapse</span> icon <img src="assets/left-panel-collapse-icon.png">.</p> <note type="note">
   ...
   <em>Workfront</em> retains your preference even when you navigate to another 
   <em>Workfront</em> object. To expand the left panel again, click the 
