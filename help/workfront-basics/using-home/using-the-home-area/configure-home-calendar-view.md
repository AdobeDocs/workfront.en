...
# Configure your Home Calendar view {#configure-your-home-calendar-view}
...
To learn more about the Home Calendar, see [Home Calendar view](home-calendar-view.md).
...
## About integrating Microsoft Outlook calendars {#about-integrating-microsoft-outlook-calendars}
...
*  Events that appear in the Due bar do not appear on your Microsoft calendar unless you have dragged them from the Work List to your *`Adobe Workfront`* Calendar. For more information, see [Due bar](home-calendar-view.md#viewing-the-due-bar)&nbsp;and [Work List](home-calendar-view.md#using-the-left-panel-of-the-home-view) in [Home Calendar view](home-calendar-view.md).
...
>[!NOTE]
>
>The Outlook calendar configuration is completely separate from the Outlook Add-in (Outlook Integration or Workfront for Outlook). There's no installation required to configure the calendar, but there is an installation needed for the Outlook Add-in. For more information on the Outlook Add-in see [Set up Adobe Workfront for Outlook](set-up-workfront-for-outlook.md).





## Configure your Home Calendar view {#configure-your-home-calendar-view-1}
...
1.  In the Home Calendar view, click the `Settings` gear icon ![Calendar_Settings_gear_icon.png](assets/calendar-settings-gear-icon.png) in the upper right corner to open the `Calendar settings` panel on the right side of the window.
   ...
   If you need information about accessing the Home Calendar view, see [View the Home Calendar](view-home-calendar.md).
...
1.  Configure&nbsp;the following options:
   ...
   *`Workfront`* uses these three settings to calculate the number of hours you work in a week. This number affects the Allocation bar, which helps you track your workload against your available work hours.&nbsp;For more information, see [Allocation bar](home-calendar-view.md#understanding-the-allocation-of-time) in&nbsp;the article [Home Calendar view](home-calendar-view.md).
...
For information about using the Calendar view to manage your&nbsp;work assignments and integrated calendar events, see [Use the Home Calendar view](use-home-calendar-view.md).
