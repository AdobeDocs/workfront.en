...
<ol> 
 ...
 <li value="6">Click&nbsp;<span class="bold">Select date</span>, then select the&nbsp;date and time when the task is due.</li> 
 <li value="7">Click <span class="bold">Create</span> to save the task.<br>The task is displayed as a work request in the Home area of the user you designated.</li> 
</ol>
...
<ol> 
 ...
 <li value="4">In the <span class="bold">Assign to</span> field, begin typing the name of the user,&nbsp;team, or role who you want to assign, then click the name when it appears in the drop-down menu.</li> 
 <li value="5">Begin typing the name of the project where you want to create the task or issue, then click the name when it appears in the drop-down menu.<br><note type="important">
    The task or issue appears on the Work List only when the project Status is set to Current.
  </note></li> 
 <li value="6">(Conditional) To create an issue, select <span class="bold">Issue</span> from the <span class="bold">Add As</span> drop-down menu. By default, <span class="bold">Task</span> is selected.</li> 
 <li value="7">Click&nbsp;<span class="bold">Select date</span>, then select the&nbsp;date and time when the task is due.</li> 
 <li value="8">Click <span class="bold">Create</span> to save the task.</li> 
</ol>
