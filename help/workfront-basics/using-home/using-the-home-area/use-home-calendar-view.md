...
1. Select from the various filter options to specify the types of items you want to display. Filter options are different depending on which environment you use to access the Home Calendar.
