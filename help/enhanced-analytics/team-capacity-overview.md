...
# View the Team capacity visualization in *`Enhanced analytics`* {#view-the-team-capacity-visualization-in-enhanced-analytics}
...
## View the Team capacity visualization {#view-the-team-capacity-visualization}
...
1.  On the Resource capacity visualization, click a team to see more information.
   ...
   For more information on the Resource capacity visualization, see [View the Resource capacity visualization in Enhanced analytics](resource-capacity-overview.md).
