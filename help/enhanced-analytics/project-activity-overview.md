...
# View the Project activity visualization in *`Enhanced analytics`* {#view-the-project-activity-visualization-in-enhanced-analytics}
...
>For information on the Activity by team visualization, see [View the Activity by team visualization in Enhanced analytics](activity-by-team-overview.md).
...
## View the Project activity visualization {#view-the-project-activity-visualization}
