...
# View the Burndown visualization in *`Enhanced analytics`* {#view-the-burndown-visualization-in-enhanced-analytics}
...
For more information on these project conditions, see [Overview of Project Condition and Condition Type](project-condition-and-condition-type.md).
...
## View the Burndown visualization {#view-the-burndown-visualization}
...
1.  (Optional) Change the view from `planned hours` to **duration**.
   ...
   >For more information on duration in the *`Enhanced analytics`* area, see the "Duration view" section in [Enhanced analytics overview](enhanced-analytics-overview.md).  
