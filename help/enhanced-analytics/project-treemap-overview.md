...
# View the Project treemap visualization in *`Enhanced analytics`* {#view-the-project-treemap-visualization-in-enhanced-analytics}
...
## View the Project treemap visualization {#view-the-project-treemap-visualization}
...
1.  Hover over a project to see the project condition, as well as the number of total planned hours, the number of total completed hours, and the average number of hours spent on the project per day.
   ...
   >
   >
   >For more information on duration, see the section "Duration view" in [Enhanced analytics overview](enhanced-analytics-overview.md).
