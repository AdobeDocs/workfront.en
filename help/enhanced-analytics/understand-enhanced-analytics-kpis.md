...
# Understand *`Enhanced analytics`* KPIs {#understand-enhanced-analytics-kpis}
...
To learn how to add filters, see [Apply filters in Enhanced analytics](use-enhanced-analytics-filters.md).
...
## Projects completed on time {#projects-completed-on-time}
...
## Avg. project duration {#avg-project-duration}
...
## Avg. tasks per project {#avg-tasks-per-project}
