...
*  Display project information in a multi-row format.  
  ...
  tag to combine multiple fields under the same column header.
...
![](assets/project-multi-row-stacked-view-600x376.png)
...
1. Create a new project view. For more information on how you create a new view, see [Create and customize Views](create-customize-views.md).
