...
# View: baseline variance for Duration and Planned Work in a task View {#view-baseline-variance-for-duration-and-planned-work-in-a-task-view}
...
![baseline_variance_in_a_task_view.png](assets/baseline-variance-in-a-task-view-600x65.png)




To apply this custom view to a task list:
...
1. Click **Save View**.  
   ![](assets/view--baseline-variance-for-duration-and-planned-work-600x134.png)
