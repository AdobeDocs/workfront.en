---
filename: view-show-parent-tasks-4-levels
...
# View: show parent tasks up to 4 levels deep {#view-show-parent-tasks-up-to-levels-deep}
...
![parent_tasks_4_levels_deep.png](assets/parent-tasks-4-levels-deep-600x50.png)
