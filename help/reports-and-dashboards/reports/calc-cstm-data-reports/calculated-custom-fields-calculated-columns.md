...
# Calculated custom fields vs. calculated columns {#calculated-custom-fields-vs-calculated-columns}

When you want to aggregate several fields in *`Adobe Workfront`* and display that aggregate value in a new field, you can do so by building the following:



* A calculated custom field in a Custom Form  
  For more information about adding a calculated custom field to a Custom Form, see the section [Add a calculated field to a custom form](add-calculated-data-to-custom-form.md#creating-calculated-custom-fields) in the article [Add calculated data to a custom form](add-calculated-data-to-custom-form.md).

* A calculated column in a View  
  For more information about using calculations in a View, see the section [Use Text Mode in views](understand-common-uses-text-mode.md#using-text-mode-in-views) in the article [Overview of common uses for Text Mode](understand-common-uses-text-mode.md).
...
## When to use calculated custom fields {#when-to-use-calculated-custom-fields}
...
## Actions that trigger the update of a calculated custom field {#actions-that-trigger-the-update-of-a-calculated-custom-field}
...
## When to use Calculated Columns in a View {#when-to-use-calculated-columns-in-a-view}
...
## Examples of calculated custom fields and columns {#examples-of-calculated-custom-fields-and-columns}

For examples of calculated custom fields, see [Calculated custom data in reports](_calculated-custom-data-reports.md). 
