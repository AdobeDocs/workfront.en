...
# View: merge information from multiple columns in one shared column {#view-merge-information-from-multiple-columns-in-one-shared-column}
...
## Considerations when sharing or merging columns  {#considerations-when-sharing-or-merging-columns}
...
## Merge data from two columns without a line break {#merge-data-from-two-columns-without-a-line-break}
...
## Merge data from two columns with a line break {#merge-data-from-two-columns-with-a-line-break}
