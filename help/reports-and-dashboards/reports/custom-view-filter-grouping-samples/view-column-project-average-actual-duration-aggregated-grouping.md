...
# View and grouping: display project Actual Duration aggregated by the average in a Grouping {#view-and-grouping-display-project-actual-duration-aggregated-by-the-average-in-a-grouping}
...
## Display project Actual Duration aggregated by the average in a Grouping {#display-project-actual-duration-aggregated-by-the-average-in-a-grouping}
...
1. (Recommended)&nbsp;For best results and to see the aggregated average value of the Actual Duration, you must have a Grouping added to your project list or report.  
   For more information about creating Groupings, see the article [Groupings overview in Adobe Workfront](groupings-overview.md).
