...
# View: remove link to an object in a column {#view-remove-link-to-an-object-in-a-column}
...
## Example: Remove the link to a task from the Task Name column in a task view: {#example-remove-the-link-to-a-task-from-the-task-name-column-in-a-task-view}
...
1.  From the `View` drop-down menu, click `New View` to create a new view.
   ...
   Click `<MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver"> the  <span class="bold">Edit icon</span>  <img src="assets/edit-icon.png"></MadCap:conditionalText>` to edit an existing view, then select the view.
