...
# View: show name of parent tasks as all caps {#view-show-name-of-parent-tasks-as-all-caps}
...
## Show name of parent tasks as all caps {#show-name-of-parent-tasks-as-all-caps}
