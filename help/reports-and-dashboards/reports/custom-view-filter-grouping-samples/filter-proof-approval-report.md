...
## Filter Proof Approval report to omit previous *`proof`* versions {#filter-proof-approval-report-to-omit-previous-proof-versions-1}
...
1.  `<MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver"> Click  <span class="bold">Filters</span>, then click  <span class="bold">Add a Filter Rule</span>.</MadCap:conditionalText>` 
