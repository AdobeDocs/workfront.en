...
# View: permanently edit the width of a column {#view-permanently-edit-the-width-of-a-column}

You can temporarily modify to width of columns by dragging and dropping their margins to match the desired width. For more information, see [Modify column width and order](modify-column-width-order.md).
...
## Permanently edit the width of a column {#permanently-edit-the-width-of-a-column}
