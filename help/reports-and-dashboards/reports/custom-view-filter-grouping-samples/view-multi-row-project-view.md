...
# View: multi-row project View {#view-multi-row-project-view}
...
*  Display project information in a multi-row format.  
  ...
  tag to combine multiple fields under the same column header. To learn more about this tag, see [View: merge information from multiple columns in one shared column](view-merge-columns.md).
...
## Build a multi-row project View {#build-a-multi-row-project-view}




1. Create a new project view. For more information on how you create a new view, see [Views overview in Adobe Workfront](views-overview.md).
