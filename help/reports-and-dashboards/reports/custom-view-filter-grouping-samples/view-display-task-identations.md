---
filename: view-display-task-identations
...
# View: display task indentations in a task list {#view-display-task-indentations-in-a-task-list}
...
## Display task indentations in a column of a task list {#display-task-indentations-in-a-column-of-a-task-list}
