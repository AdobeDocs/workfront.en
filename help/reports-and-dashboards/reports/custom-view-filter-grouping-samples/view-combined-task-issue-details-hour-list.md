...
# View: combined task and issue details in an Hour list {#view-combined-task-and-issue-details-in-an-hour-list}
...
tag, see [View: merge information from multiple columns in one shared column](view-merge-columns.md).  
...
## View combined task and issue details in an Hour list {#view-combined-task-and-issue-details-in-an-hour-list-1}
