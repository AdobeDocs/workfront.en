...
# Filter: eliminate items in a list by comparing two fields {#filter-eliminate-items-in-a-list-by-comparing-two-fields}
...
## Filter items by comparing two fields {#filter-items-by-comparing-two-fields}
