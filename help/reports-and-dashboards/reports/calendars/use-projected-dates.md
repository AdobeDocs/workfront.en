...
description: A calendar report is a dynamic report that provides a visual representation of your work. You can use Projected Date fields in a calendar report for the following objects:
---
   ...
   <table cellspacing="0">
    ...
    <tbody>
     ...
     <tr>
      ...
      <td><p>Choose <span class="bold">Projected dates</span>. For more information on Projected Dates, see </p>
       <ul>
...
<ol> 
 ...
 <li value="6"> <p>In the <span class="bold">Set the Tasks/Projects/Issues labels to be the...</span>&nbsp;field, select how the objects in this calendar grouping are labeled in the calendar.<br><note type="note">
    ...
    <span>Adobe Workfront</span> displays the object name you are viewing in the calendar.
   </note></p> </li> 
