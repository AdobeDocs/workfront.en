...
# Share a calendar report {#share-a-calendar-report}
...
Sharing a calendar is similar to sharing other objects. For more information about sharing objects in *`Adobe Workfront`*, see [Overview of sharing permissions on objects in Adobe Workfront](sharing-permissions-on-objects-overview.md).
...
1. In the `Give Calendar access to` field, begin typing the name of the user, team, role, group, or company that you want to share the calendar, then click the name when it displays in the drop-down list.  
   To learn about setting permissions, see [Overview of sharing permissions on objects in Adobe Workfront](sharing-permissions-on-objects-overview.md).
...
1. (Optional) Depending on a user's role, you may be able to click `Advanced Options`, then click `Share`to allow the user to share the calendar with other users. 
   ...
   For more information about the permissions levels, see [Overview of sharing permissions on objects in Adobe Workfront](sharing-permissions-on-objects-overview.md). 
...
1. (Optional) To make the calendar available to all *`Workfront`* users, click the gear icon, then in the drop-down menu click `Make this visible system-wide` to make the object available to all *`Workfront`* users.  
...
## Share a calendar with a public link {#share-a-calendar-with-a-public-link}
...
1.  Go to the calendar you want to share.
1. Click `Calendar Actions`, then click `Get Sharable Link`.
