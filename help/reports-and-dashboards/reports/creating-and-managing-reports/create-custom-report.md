...
<!--
Basic Report Creation Program for the new Workfront experience Get started with reports in Adobe Workfront Use Adobe Workfront built-in reports Text Mode overview Edit report settings Wildcard filter variables Add a chart to a report
-->
