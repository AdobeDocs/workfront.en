...
<ol> 
 <li value="1">Go to a list of reports and select one or multiple reports, then click <span class="bold">Share</span>. <p>Or </p><p>Click the name of one report, then click <span class="bold">Report Actions ></span><span class="bold"> Sharing</span>.</p><draft-comment>
   <p data-mc-conditions="QuicksilverOrClassic.Quicksilver"><img src="assets/qs-report-actions-sharing.png"></p>
  </draft-comment><p data-mc-conditions="QuicksilverOrClassic.Quicksilver"><img src="assets/qs-report-actions-sharing.png"></p></li> 
 ...
 <li value="5"> <p>(Optional) Click the <span class="bold">Gear</span> icon <img src="assets/gear-icon-settings-with-dn-arrow.jpg"> in the upper-right corner of the sharing box, then select one of the following options:</p> 
  <ul> 
   <li> <p><span class="bold">Make this public to external users:</span> Select this option to generate a URL that can be shared with others. Anyone with the URL can access the <em>report</em>, without having an <em>Adobe Workfront</em> license.</p> <p class="warning" data-mc-autonum="<b>Warning: </b>"><span class="autonumber"><span><b>Warning: </b></span></span>We recommend that you use caution when sharing an object containing confidential information with external users. This allows them to view information without being a <em>Workfront</em> user or part of your organization. </p> <note type="note">
     If the report has a prompt and you share it publicly, the users running the report must be logged in to 
     <em>Workfront</em> to be able to run the report using the prompt. If they cannot log in to 
     <em>Workfront</em>, they will see the report without the prompt applied to it. For more information about limitations of sharing reports with prompts, see the section 
   ...
   <li> <p><span class="bold">Make this visible system-wide:</span> Select this option so that everyone in <em>Workfront</em> with access to reports can see the report.</p> <note type="note">
