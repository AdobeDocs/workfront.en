...
# Create a matrix report {#create-a-matrix-report}
...
## When to use a matrix report {#when-to-use-a-matrix-report}
...
## How data displays in a matrix report {#how-data-displays-in-a-matrix-report}
...
## Set up a matrix report {#set-up-a-matrix-report}
...
1. (Conditional) If you want to create a new Filter for this report, see [Filter and condition modifiers](filter-condition-modifiers.md) for information about the various qualifiers that you can use when building filters.
