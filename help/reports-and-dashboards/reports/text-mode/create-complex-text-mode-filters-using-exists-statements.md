...
# Create complex Text Mode filters using EXISTS statements {#create-complex-text-mode-filters-using-exists-statements}



>[!IMPORTANT] {type="important"}
>
>This article requires a thorough understanding of the *`Adobe Workfront`* API and of the text mode reporting interface. For information about the *`Workfront`* API, see [API basics](api-basics.md).  
...
## Overview of object relationships in *`Workfront`* {#overview-of-object-relationships-in-workfront}
...
For information about what objects are in *`Workfront`* and about their hierarchy and interdependency, see [Understand objects in Adobe Workfront](understand-objects.md).
...
For information about how to navigate the API Explorer and find objects, see [Using the API Explorer](using-api-explorer.md).
...
* You must use the object code of the Linking Object to connect your statements.  
  ...
  For information about the API Explorer, see the [API Explorer](https://experience.workfront.com/s/api-explorer).
...
## Create complex text mode filters that span multiple levels in the object hierarchy {#create-complex-text-mode-filters-that-span-multiple-levels-in-the-object-hierarchy}
...
1. Create a filter for the Original Object.  
   ...
   For information about creating filters, see [Filters overview in Adobe Workfront](filters-overview.md).
...
## Create complex text mode filters for missing objects {#create-complex-text-mode-filters-for-missing-objects}
...
## Examples of text mode filters that span multiple levels in the object hierarchy {#examples-of-text-mode-filters-that-span-multiple-levels-in-the-object-hierarchy}
...
### Example 1: Filter for issues by Portfolio Owner Name {#example-filter-for-issues-by-portfolio-owner-name}
...
### Example 2: Filter for missing objects: custom fields that do not appear in any custom forms {#example-filter-for-missing-objects-custom-fields-that-do-not-appear-in-any-custom-forms}
...
### Example 3: Filter for missing objects: users who did not log time for a certain period of time {#example-filter-for-missing-objects-users-who-did-not-log-time-for-a-certain-period-of-time}
...
### Example 4: Filter by multiple fields: tasks by Portfolio Owner Name and Portfolio Alignment Scorecard ID {#example-filter-by-multiple-fields-tasks-by-portfolio-owner-name-and-portfolio-alignment-scorecard-id}
