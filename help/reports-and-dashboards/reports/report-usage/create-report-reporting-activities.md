...
# Create a report on reporting activities {#create-a-report-on-reporting-activities}
...
1. (Optional) Export this report to Excel and save it on your computer.  
   For information on exporting a report, see [Export data](export-data.md).
...
1. Depending on the action you want to take, do one of the following: 
    ...
    * Update the `Run this report with the Access Rights of:` field to an active user: For more information, see [Run and deliver a report with the access rights of another user](run-deliver-report-access-rights-another-user.md).
    
    * Create a copy of the report: For more information, see [Create a copy of a report](create-copy-report.md).
    * Delete a report:&nbsp;For more information, see the [Create an exact copy of a report](create-copy-report.md#update2) section of the article [Create a copy of a report](create-copy-report.md).
    
    * Share a report:&nbsp;For more information, see [Share a report in Adobe Workfront](share-report.md).
