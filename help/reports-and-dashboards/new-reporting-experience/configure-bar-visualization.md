...
A bar visualization can help you quickly tell a story about your data by enhancing the narrative and highlighting important information using horizontal bars.
...
<ol> 
 <li value="1">Begin adding a visualization to the report, as explained in <a href="../../reports-and-dashboards/new-reporting-experience/add-or-edit-report-visualization.md" class="MCXref xref">Add or edit a visualization in a report in Reporting Canvas</a>, choosing <b>Bar</b> as the visualization type.</li> 
    ...
    <table cellspacing="0">
     ...
     <tbody>
      ...
      <tr>
       ...
       <td><p>Select the data that you want to depict along the vertical left edge, or Y axis.</p><draft-comment>
         <p data-mc-conditions="QuicksilverOrClassic.Draft mode">The same data is entered automatically for the Horizontal axis so that _____.</p>
        </draft-comment><p data-mc-conditions="QuicksilverOrClassic.Draft mode">The same data is entered automatically for the Horizontal axis so that _____.</p></td>
      </tr>
      <tr>
