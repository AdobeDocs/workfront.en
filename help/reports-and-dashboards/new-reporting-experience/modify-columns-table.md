...
<!--
<p style="color: #ff1493;" data-mc-conditions="QuicksilverOrClassic.Draft mode">Not complete because UI isn't complete</p>
-->
...
<ol> 
 ...
 <li value="2"> <p>On the table header in the report, click the <b>Edit</b> icon <img src="assets/edit-icon.png">.</p> <p> <img src="assets/edit-icon-table-header-350x71.png" style="width: 350;height: 71;"> </p> <note type="note">
   If you just created the table and haven't configured it yet, click the Edit button displayed on the table instead.
   <br style="font-weight: bold;">
  </note> </li> 
 <li value="3"> <p>(Optional) To rearrange the order of columns in a table, drag a column to a new location.</p> </li> 
 <li value="4">In the header row of the table, select the name of a column you want to modify, then do any of the following to configure the data and style of the column:
  <ul>
   <li><p>Open the <span class="bold">Data</span> tab in the right panel, then change any of the following:</p>
    <table cellspacing="0">
     ...
     <tbody>
      <draft-comment>
       <tr data-mc-conditions="">
        ...
        <td><p> If you want to aggregate (summarize) the information in a column, select the type of aggregation you want. </p><p>If you are not using groupings in the table, the aggregated value displays in the main header above the column:</p><draft-comment>
          <p style="color: #ff1493;" data-mc-conditions="QuicksilverOrClassic.Draft mode">SHOW THIS (not working yet)</p>
         </draft-comment><p style="color: #ff1493;" data-mc-conditions="QuicksilverOrClassic.Draft mode">SHOW THIS (not working yet)</p><p>If you are using groupings in the table, the aggregated value displays in the grouping headers in the column:</p><draft-comment>
         ...
         </draft-comment><p style="color: #ff1493;" data-mc-conditions="QuicksilverOrClassic.Draft mode">SHOW THIS - Like under step 7 in Reports and Dashboards/Reports/Creating and Managing Reports/create-custom-report.htm</p></td>
       </tr>
      </draft-comment>
      <tr data-mc-conditions="">
       <td role="rowheader">Aggregate based on</td>
       <td><p> If you want to aggregate (summarize) the information in a column, select the type of aggregation you want. </p><p>If you are not using groupings in the table, the aggregated value displays in the main header above the column:</p><p style="color: #ff1493;" data-mc-conditions="QuicksilverOrClassic.Draft mode">SHOW THIS (not working yet)</p><p>If you are using groupings in the table, the aggregated value displays in the grouping headers in the column:</p><p style="color: #ff1493;" data-mc-conditions="QuicksilverOrClassic.Draft mode">SHOW THIS - Like under step 7 in Reports and Dashboards/Reports/Creating and Managing Reports/create-custom-report.htm</p></td>
      </tr><draft-comment>
       <tr data-mc-conditions="">
  ...
  <li value="5" data-mc-conditions="QuicksilverOrClassic.Draft mode">(Optional) Hover over a column to display its Data and Style configurations.<draft-comment>
    <MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Draft mode">
      NOT FINISHED
    </MadCap:conditionalText>
 ...
 <li value="5" data-mc-conditions="QuicksilverOrClassic.Draft mode">(Optional) Hover over a column to display its Data and Style configurations.<MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Draft mode">
    NOT FINISHED
  </MadCap:conditionalText></li> 
 <li value="6">(Optional) To delete a column, click its name, then click the x that displays to the right of the name.</li> 
 <li value="7">Click the Go Back arrow <img src="assets/back-btn-reporting-v2.png"> in the top-left corner of the screen to see your report.</li> 
</ol>
