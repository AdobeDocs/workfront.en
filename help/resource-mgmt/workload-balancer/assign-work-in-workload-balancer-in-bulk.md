...
# Assign work in bulk using the *`Adobe Workfront`*<![CDATA[  ]]> *`Workload Balancer`* {#assign-work-in-bulk-using-the-adobe-workfront-workload-balancer}
...
## Considerations for making bulk assignments in the *`Workload Balancer`* {#considerations-for-making-bulk-assignments-in-the-workload-balancer}
...
## Assign work in bulk in the *`Workload Balancer`* {#assign-work-in-bulk-in-the-workload-balancer}
...
1.  In the `Task role assignment` field, click the drop-down arrow to choose from a list of roles. Only roles currently assigned within the specified projects are displayed. This is a required field. 
   ...
   ![](assets/bulk-assignments-workload-balancer-assign-selected-350x453.png)



1.  In the `User to assign`field, click the drop-down arrow to choose from a list of suggested users or to type another user name. Users listed in the list by default match the criteria for Smart Assignments.&nbsp;For more information, see [Smart assignments overview](smart-assignments.md).
...
1.  In the `Currently assigned user` field, click the drop-down arrow to choose from a list of users. Only users currently assigned to incomplete work items within the specified projects are displayed. This is a required field. 
   ...
   ![](assets/bulk-assignments-workload-balancer-replace-selected-350x457.png)
...
For more information about user and job role assignments, see [Overview of assigning work in the Adobe Workfront Workload Balancer](assign-work-in-workload-balancer.md). 
...
1.  In the `User to unassign` field, click the drop-down arrow to choose from a list of users. Only users currently assigned to incomplete work items within the specified projects display. This is a required field. 
   ...
   ![](assets/bulk-assignments-workload-balancer-unassign-selected-350x403.png)
   ...
   *`Workfront`* displays a note about the number of items where the currently assigned user will be unassigned. 
   ...
   ![](assets/bulk-unassign-user-confirmation-before-assigning-nwe-350x48.png)
