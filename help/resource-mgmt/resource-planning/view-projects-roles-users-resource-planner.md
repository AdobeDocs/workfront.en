...
# View projects, roles, and users using the Resource Planner {#view-projects-roles-and-users-using-the-resource-planner}
...
![](assets/rp-planner-priority-highlighted-600x318.png)
...
>[!NOTE]
>
>Job roles assigned to issues are also listed when the **Include hours from Issue** setting is enabled. For more information about enabling issue hours in the Resource Planner, see the [Settings](resource-planner-navigation.md#settings) section in the [Resource Planner navigation overview](resource-planner-navigation.md) article.   
...
![no_role_with_user___res_planner.png](assets/no-role-with-user---res-planner-600x283.png)  
...
![no_user_and_no_role___res_planner.png](assets/no-user-and-no-role---res-planner-600x222.png)
