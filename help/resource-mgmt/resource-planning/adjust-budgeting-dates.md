...
<ol> 
 <li value="1"> <p> Go to the <span>Resource Planner</span> and select <span class="bold">View by Project</span>.</p> <note type="note">
   You can use the Adjust Budgeted Dates option only when you view the 
   <span>Resource Planner</span> by project. 
  </note> </li> 
 ...
 <li value="11"> Return to the <span>Resource Planner</span> and re-enter the Budgeted Hours, FTEs, or Costs in the time frame without budgeting conflicts. </li> 
