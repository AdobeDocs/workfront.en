...
#  Share the *`Resource Planner`* user view with a link {#share-the-resource-planner-user-view-with-a-link}
...
1. (Optional) Apply filters to the *`Resource Planner`*.  
   For information about applying filters, see [Filter information in the Resource Planner](filter-resource-planner.md) .
...
1. (Optional) If you embedded the URL into a dashboard, consider adding it to a layout template or sharing it with other users who might not have access to the Resource Management area.  
   For information about adding dashboards to a layout template, see [Create and manage layout templates](create-and-manage-layout-templates.md) .   
   For information about sharing dashboards, see [Share a dashboard in Adobe Workfront](share-dashboard.md) .   
