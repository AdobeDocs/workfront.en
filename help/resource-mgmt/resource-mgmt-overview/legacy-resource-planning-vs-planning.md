...
description: Important: You can access Legacy Resource Planning tools only when using Adobe Workfront Classic. This article refers to differences between Legacy Resource Planning and Planning tools when using Adobe Workfront Classic. The Legacy Resource Planning functionality is deprecated and it will be removed from Adobe Workfront. For more information about Legacy Resource Planning, see the Legacy Resource Planning section. For information about planning resources in the new Adobe Workfront experience, see Get started with Resource Planning .
---
