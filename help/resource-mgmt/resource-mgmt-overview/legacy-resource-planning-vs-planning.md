...
# Difference between Legacy Resource Planning and Planning {#difference-between-legacy-resource-planning-and-planning}



>[!IMPORTANT] {type="important"}
>
>You can access Legacy Resource Planning tools only when using `Workfront Classic`. This article refers to differences between Legacy Resource Planning and Planning tools when using `Workfront Classic`.  The Legacy Resource Planning functionality is deprecated and it will be removed from `Workfront`.&nbsp;  
>For more information about Legacy Resource Planning, see the&nbsp;Legacy Resource Planning&nbsp;section.&nbsp;  
>For information about planning resources in `the new Workfront experience`, see [Get started with Resource Planning](get-started-resource-planning.md). 




## Overview of resource planning in  `Workfront` {#overview-of-resource-planning-in-workfront}
...
For more information about scheduling resources, see the [Resource Scheduling](_resource-scheduling-overview.md) section.&nbsp;
...
* **Planning **(recommended): you can add users to Resource Pools, add Resource Pools to your projects, and manage all&nbsp;allocations (for job roles as well as users) in the **Resource Planner**.  
  For more information about planning resources, see the&nbsp; [Resource Planning](_resource-planning-overview.md)&nbsp;section.&nbsp; 
...
## Access the Legacy Resource Planning and the Planning areas  {#access-the-legacy-resource-planning-and-the-planning-areas}




1. (Conditional) In `Workfront Classic`, go to the **People** area in the Global Navigation Bar.
...
1.   (Recommended) Select the&nbsp;**Planning** tab for configuring the current resource planning&nbsp;tools.  
   ...
   This is only possible when using `Workfront Classic`. 
...
* [Get started with the Resource Planner](get-started-resource-planner.md) 
...
For more information about budgeting resources in the Business Case, see [Budget resources in the Business Case](budget-resources-in-business-case.md).


For a complete list of the prerequisites that must be met before you can start using the tools in the Planning tab, see the [Get started with Resource Planning](get-started-resource-planning.md) section in [Get started with Resource Planning](get-started-resource-planning.md)For all information about managing your resources in the&nbsp;**Planning** tab, see the&nbsp; [Resource Planning](_resource-planning-overview.md)&nbsp;section.&nbsp;&nbsp;
...
![Legacy_resource_planning_tab.png](assets/legacy-resource-planning-tab-600x222.png)
