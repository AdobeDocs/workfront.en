...
<table cellspacing="3"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colspan="3"><em>Workload Balancer</em> feature availability</td> 
  </tr> 
  <tr> 
   <td>Available now</td> 
  ...
  <tr> 
   <td> <p>Access tool from the <draft-comment>
  ...
  <tr> 
   <td>Share the <em>Workload Balancer</em> with users with no access to the <draft-comment>
     <MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver">
      Resourcing 
     </MadCap:conditionalText>
    </draft-comment><MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver">
