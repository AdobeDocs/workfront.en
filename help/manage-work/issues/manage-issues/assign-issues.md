...
<ol> 
 ...
 <li value="6">(Optional) Select a role that the user should fulfill on the issue from the <span class="bold">Pick a role</span> drop-down menu in the <span class="bold">Assignee's Role</span> column when you assign users to issues. If you do not select a role, <span>Workfront</span> automatically selects the user's Primary&nbsp;Role. </li> 
