...
1. 
   ...
   Click the
   <span class="bold">Issue Details</span> section.
   </MadCap:conditionalText>
   -->

   `<MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver"> Click the  <span class="bold">Issue Details</span> section.</MadCap:conditionalText>`

1. 

   <!--
   <p data-mc-conditions="QuicksilverOrClassic.Quicksilver">Go to the <span class="bold">Overview</span> area of the <span class="bold">Issue Details</span> section. </p>
   -->

   Go to the `Overview` area of the `Issue Details` section. 
...
1. Click `Save` 
   ...
   `<MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver"> <span class="bold">Changes</span></MadCap:conditionalText>`.  
