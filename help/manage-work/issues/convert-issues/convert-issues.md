...
<table cellspacing="3"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td>Status</td> 
   <td>Default status selected for the group on the template. If the template is not associated with the group, the project status is set to the default status set by the <em>Workfront administrator</em> in the Project&nbsp;Preferences area of Setup. For information, see <a href="../../../administration-and-setup/set-up-workfront/configure-system-defaults/set-project-preferences.md" class="MCXref xref">Configure system-wide project preferences</a>.</td> 
  </tr> 
  <tr> 
   <td>Priority</td> 
  ...
  <tr> 
   ...
   <td>Matches the system-level default preference as determined by the <em>Workfront administrator</em> in the Setup area. For information, see <a href="../../../administration-and-setup/customize-workfront/create-manage-custom-conditions/set-custom-condition-default-projects.md" class="MCXref xref">Set a custom condition as the default for projects</a></td> 
  </tr> 
  <tr> 
   <td>Schedule From</td> 
   <td>Transfers from the template.</td> 
...
Click the
<span class="bold">Issues</span> icon on a project.
</MadCap:conditionalText>
</draft-comment><MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver">
Click the
<span class="bold">Issues</span> icon on a project.
</MadCap:conditionalText> <draft-comment>
<p data-mc-conditions="QuicksilverOrClassic.Quicksilver"> <img src="assets/qs-issues-icon-highlighted-on-project.png"> </p>
</draft-comment><p data-mc-conditions="QuicksilverOrClassic.Quicksilver"> <img src="assets/qs-issues-icon-highlighted-on-project.png"> </p> </li>
<li value="2"> <p>Click the issue to be converted to access the issue.</p> </li>
<li value="3"> <p> <draft-comment>
<MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver">
Click the
<span class="bold">More</span> menu, then click
<span class="bold">Convert to Project</span>.
</MadCap:conditionalText>
</draft-comment><MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver">
Click the
<span class="bold">More</span> menu, then click
...
<img src="assets/qs-issue-more-menu-highlighted-350x430.png" style="width: 350;height: 430;" data-mc-conditions="QuicksilverOrClassic.Quicksilver">
</draft-comment><img src="assets/qs-issue-more-menu-highlighted-350x430.png" style="width: 350;height: 430;" data-mc-conditions="QuicksilverOrClassic.Quicksilver"> </p> </li>
<li value="4"> <p>In the submenu that displays, do one of the following:</p>
<ul>
<li>Click <span class="bold">New Project</span></li>
<li>Under <span class="bold">New from Template</span>, click the name of a project template you want to use</li>
</ul> </li>
...
<li value="7"> <p>(Optional and conditional) Under <span class="bold">Options</span>, select any of the available options:</p>
<ul>
...
<li><span class="bold"><span class="bold">Allow <User Name> to have access to this project</span><br></span>If unselected, the user who entered the issue has no access to the new task.</li>
</ul> <note type="note">
<div>
...
<li value="8">(Optional) In the <span class="bold">Custom Forms</span> section, attach any custom forms.<br>For more information about transferring information from the custom form of the issue to that of the new project, see <a href="../../../administration-and-setup/customize-workfront/create-manage-custom-forms/transfer-custom-form-data-larger-item.md" class="MCXref xref">Transfer custom form data to a larger work item</a>.</li>
<li value="9"> <p>Click <span class="bold">Save Changes.</span></p> <p> <draft-comment>
<img src="assets/qs-issue-convert-to-project-before-saving-ui-350x206.png" style="width: 350;height: 206;" data-mc-conditions="QuicksilverOrClassic.Quicksilver">
</draft-comment><img src="assets/qs-issue-convert-to-project-before-saving-ui-350x206.png" style="width: 350;height: 206;" data-mc-conditions="QuicksilverOrClassic.Quicksilver"> </p> <p>The issue is now a project, if you decided to delete the original issue.<br>Or<br>The issue is now linked to the new project and it will complete when the project completes, if you decided to keep the original issue. </p> <p>Some issue fields transfer to the project. For information, see the <a href="#viewing-original-issue-information" class="MCXref xref">View original issue information on projects and tasks</a> section in this article. </p> </li>
...
<ol> 
 <li value="1"> <MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver">
   Click the 
   <span class="bold">Issues</span> icon on a project.
  </MadCap:conditionalText> <p data-mc-conditions="QuicksilverOrClassic.Quicksilver"> <img src="assets/qs-issues-icon-highlighted-on-project.png"> </p> </li> 
 <li value="2"> <p>Click the issue to be converted to access the issue.</p> </li> 
 <li value="3"> <p> <MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver">
    Click the 
    <span class="bold">More</span> menu, then click 
    <span class="bold">Convert to Project</span>.
   </MadCap:conditionalText> </p> <p> <img src="assets/qs-issue-more-menu-highlighted-350x430.png" style="width: 350;height: 430;" data-mc-conditions="QuicksilverOrClassic.Quicksilver"> </p> </li> 
 <li value="4"> <p>In the submenu that displays, do one of the following:</p> 
  <ul> 
   <li>Click <span class="bold">New Project</span></li> 
   <li>Under <span class="bold">New from Template</span>, click the name of a project template you want to use</li> 
 ...
 <li value="8">(Optional) In the <span class="bold">Custom Forms</span> section, attach any custom forms.<br>For more information about transferring information from the custom form of the issue to that of the new project, see <a href="../../../administration-and-setup/customize-workfront/create-manage-custom-forms/transfer-custom-form-data-larger-item.md" class="MCXref xref">Transfer custom form data to a larger work item</a>.</li> 
 <li value="9"> <p>Click <span class="bold">Save Changes.</span></p> <p> <img src="assets/qs-issue-convert-to-project-before-saving-ui-350x206.png" style="width: 350;height: 206;" data-mc-conditions="QuicksilverOrClassic.Quicksilver"> </p> <p>The issue is now a project, if you decided to delete the original issue.<br>Or<br>The issue is now linked to the new project and it will complete when the project completes, if you decided to keep the original issue. </p> <p>Some issue fields transfer to the project. For information, see the <a href="#viewing-original-issue-information" class="MCXref xref">View original issue information on projects and tasks</a> section in this article. </p> </li> 
 <li value="10"> <p>(Optional) Set any further project details ​(project owner, project dates) and tasks as necessary.</p> </li> 
</ol>
...
<li value="1"> <draft-comment>
<MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver">
Click the Issues icon on a project.
</MadCap:conditionalText>
</draft-comment><MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver">
Click the Issues icon on a project.
...
<MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver">
Click the
<span class="bold">More</span> menu on the issue, then
<span class="bold">Convert to Task</span>.
</MadCap:conditionalText>
</draft-comment><MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver">
Click the
<span class="bold">More</span> menu on the issue, then
...
<li value="7"> <p>(Optional and conditional) Under <span class="bold">Options</span>, select any of the following options. </p> <p>The <em>Workfront administrator</em> or <em>group administrator</em> must enable these preferences before they are visible during the conversion of issues: </p>
<ul>
...
<li> <p><span class="bold">Allow <User Name> to have access to this task</span> </p> <p>If unselected, the user who entered the issue has no access to the new task.</p> </li>
...
<li value="8">(Optional) Attach custom forms.<br>For more information about transferring information from the custom form of the issue to that of the new task, see <a href="../../../administration-and-setup/customize-workfront/create-manage-custom-forms/transfer-custom-form-data-larger-item.md" class="MCXref xref">Transfer custom form data to a larger work item</a>.<br><p>
<draft-comment>
<img src="assets/qs-issue-convert-to-task-before-saving-ui-350x206.png" style="width: 350;height: 206;" data-mc-conditions="QuicksilverOrClassic.Quicksilver">
</draft-comment><img src="assets/qs-issue-convert-to-task-before-saving-ui-350x206.png" style="width: 350;height: 206;" data-mc-conditions="QuicksilverOrClassic.Quicksilver"></p></li>
<li value="9"> <p>Click <span class="bold">Save Changes</span> when all task settings are set.</p> <p>The issue is now a task on the designated project, if you decided to delete the original issue.</p> <p>Or</p> <p>The issue is now linked to the new task on the project you chose, and it will complete once the task completes, if you decided to keep the original issue.</p> <p>Some issue fields transfer to the task. For information, see the <a href="#viewing-original-issue-information" class="MCXref xref">View original issue information on projects and tasks</a> section in this article. <br></p> </li>
