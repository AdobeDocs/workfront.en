  ...
  <table cellspacing="0"> 
   ...
   <tbody> 
    <tr> 
     ...
     <td><span>Workfront</span> calculates the BCWP using the Planned Hours of the tasks.</td> 
    </tr> 
    <tr> 
     <td role="rowheader">Cost-Based</td> 
     <td><span>Workfront</span> calculates the BCWP using the Planned Cost of the tasks.</td> 
    </tr> 
   </tbody> 
  </table> </li> 
