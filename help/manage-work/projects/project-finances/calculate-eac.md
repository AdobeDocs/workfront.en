...
1. 
   ...
   <span class="bold">Tasks Details</span> in the left panel of the project or task, depending on where you view the EAC.
   </MadCap:conditionalText>
   -->

   `<MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver">  Expand  <span class="bold">Project Details</span> or  <span class="bold">Tasks Details</span> in the left panel of the project or task, depending on where you view the EAC. </MadCap:conditionalText>` 
