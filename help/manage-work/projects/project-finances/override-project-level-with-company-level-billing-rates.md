...
1. Go to a project. 
1. Click the More menu next to the name of the project in the header, then click Edit. 
...
1. To update company rates for one or more projects, do one of the following:
  ...
  * Single project:
    ...
    1. Click the More menu next to the project name in the header, then click Recalculate Finance.
