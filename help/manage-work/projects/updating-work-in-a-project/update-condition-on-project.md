...
<ol> 
 ...
 <li value="2"> <p> <draft-comment>
    <MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver">
     Click the 
     <span class="bold">Project Details</span> section.
    </MadCap:conditionalText>
   </draft-comment><MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver">
    Click the 
    <span class="bold">Project Details</span> section.
   </MadCap:conditionalText> </p> <p> <draft-comment>
    <img src="assets/project-details-overview-edit-enabled-with-condition-shot-nwe-350x251.png" style="width: 350;height: 251;" data-mc-conditions="QuicksilverOrClassic.Quicksilver">
   </draft-comment><img src="assets/project-details-overview-edit-enabled-with-condition-shot-nwe-350x251.png" style="width: 350;height: 251;" data-mc-conditions="QuicksilverOrClassic.Quicksilver"> <br> </p> </li> 
