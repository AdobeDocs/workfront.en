...
<!--
Update the Project Owner of a project Go to the project you want to update. Click Project Details in the left panel. Click the Edit icon in the upper-right corner of the Project Details area, then click Overview. Specify the name of a user for the Project Owner field. Only active users can be specified as Project Owners. Click Save Changes.
-->
...
<!--
Update the Project Sponsor of a project Go to the Project you want to update. Click Project Details in the left panel. Click the Edit icon in the upper-right corner of the Project Details area, then click Overview. Specify the name of a user for the Project Sponsor field. Only active users can be specified as Project Sponsors. Click Save Changes.
-->
