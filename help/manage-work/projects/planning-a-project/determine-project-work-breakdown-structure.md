...
# Determine Work Breakdown Structure in a project  {#determine-work-breakdown-structure-in-a-project}
...
## Define the project deliverables {#define-the-project-deliverables}
...
* If you have not already done so, create a new project.  
  For information about creating a project, see the article [Create a project](create-project.md).

* Create tasks for all action items required to complete each outcome and deliverable.  
  For information about creating tasks, see the article [Create tasks in a project](create-tasks-in-project.md) .

* From the tasks you just created, identify which ones are major outcomes and associate them with milestones.  
  For information about creating milestone tasks, see the articles [Create a milestone path](create-milestone-path.md) and [Associate milestones with tasks](associate-milestones-with-tasks.md).

* Break down the tasks with too large a scope into subtasks. Associate them with the parent that defines your deliverable .  
  For information about creating subtasks, see the article [Create subtasks](create-subtasks.md).
...
* Identify dependency relationships between subtasks and between milestones.  
  ...
  For information about task dependencies, see the articles [Overview of task predecessors](predecessors-overview.md) and [Create a predecessor relationship on the task list](create-predecessors-on-task-list.md).
...
* Determine if at any point in the lifetime of the project, approvals and reviews are needed. Create approval processes to address this need.  
  For information about approvals, see the article [Create an approval process](create-approval-processes.md).





## Estimate work schedule and scheduling constraints {#estimate-work-schedule-and-scheduling-constraints}
...
*  Task constraints define when work on a task must begin or end. 
  ...
  For information about defining task constraints, see the article [Task Constraint overview](task-constraint-overview.md).
...
*  The Duration of a task is the timeframe available to complete a task. When estimating Duration, you may want to enter a value that takes into account the possibility of a delay. If similar projects have been completed in the past, you may have a good idea where to set this value. 
  ...
  Depending on the Duration Type of the task, you can modify the duration of a task during the lifetime of a project, but this will also affect the timeline of the project. For information about the Duration of a task, see the article [Overview of Task Duration and Duration Type](task-duration-and-duration-type.md) .
...
*  Users  
  ...
  For information about the access levels and how they define what users can do with *`Workfront`* objects, see [Access levels overview](access-levels-overview.md).

* Job Roles
* Teams


For information about assigning tasks, see the articles in the [Assign tasks](_assign-tasks.md) section.
...
For information about planning the use of your resources at a higher level, see the article [Get started with Resource Planning](get-started-resource-planning.md). 
...
For information about scheduling your resources, see the articles in the [Resource Scheduling](_resource-scheduling-overview.md) section. 


## Estimate project finances {#estimate-project-finances}
...
For information about project finances, see the section [Project finances](_project-finances-overview.md) .


## Determine approval points for the project {#determine-approval-points-for-the-project}
...
For information about building reports, see the article [Create a custom report](create-custom-report.md)


## Save the WBS of a Project as a Template {#save-the-wbs-of-a-project-as-a-template}
...
For information about saving projects as templates, see the article [Create template from project](create-template-from-project.md) .
