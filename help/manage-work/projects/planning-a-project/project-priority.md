...
<ol> 
 ...
 <li value="4"> <p>In the <span class="bold">Priority</span> field, select from the following options:</p> 
  <ul> 
   ...
   <li>Urgent</li> 
    ...
    <img src="assets/project-priority-picker-list-on-project-details-nwe-350x192.png" style="width: 350;height: 192;" data-mc-conditions="QuicksilverOrClassic.Quicksilver">
   </draft-comment><img src="assets/project-priority-picker-list-on-project-details-nwe-350x192.png" style="width: 350;height: 192;" data-mc-conditions="QuicksilverOrClassic.Quicksilver"> </p> </li> 
 <li value="5"> <p> <draft-comment>
    ...
    Click 
    <span class="bold">Save&nbsp;Changes</span>. 
   </MadCap:conditionalText></p> <p>You must communicate with other users and have an understanding what each level of priority means for the project.<br></p> </li> 
</ol>
