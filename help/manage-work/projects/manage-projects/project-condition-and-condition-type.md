...
<ul> 
 ...
 <li> <p>When allowing <span>Workfront</span> to estimate the Condition of the project automatically, we recommend that you use predecessors on your tasks so that the task progress reflects in the actual progress and the Progress Status of the project.</p> </li> 
...
<table cellspacing="15"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td><span>Workfront</span> Condition Indicator</td> 
   <td>&nbsp;</td> 
  </tr> 
  <tr> 
   <td>On Target</td> 
