...
* 
  ...
  <!--
  <p data-mc-conditions="QuicksilverOrClassic.Quicksilver"><span>If the project has tasks or issues with logged hours, the <em>Workfront</em> <span class="preview">or <em>group administrator</em></span> must allow the deletion of these tasks by configuring the Task & Issue Preferences in your <em>Workfront</em> instance for you to be able to delete the project that contains the tasks.</span> </p>
  -->
  ...
  <!--
  <p data-mc-conditions="QuicksilverOrClassic.Quicksilver"><span>For more information about enabling the deletion of tasks, issues</span><draft-comment>
  <span data-mc-conditions="QuicksilverOrClassic.Quicksilver">, or projects</span>
  </draft-comment><span data-mc-conditions="QuicksilverOrClassic.Quicksilver">, or projects</span><span> where hours are logged, see the "Deletion" section in</span> <a href="../../../administration-and-setup/set-up-workfront/configure-system-defaults/set-task-issue-preferences.md" class="MCXref xref">Configure system-wide task and issue preferences</a>.</p>
  -->
...
<ol> 
 <li value="1">Go to the project you want to delete. </li> 
 <li value="2">&nbsp;<draft-comment>
   <MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver">
    Click the 
    <span class="bold">More</span> icon 
    <img src="assets/qs-more-menu.png">.
 ...
 <li value="3"> <p>Click&nbsp;<span class="bold">Delete</span> <span class="bold">Project</span><span class="bold">.</span><br></p> </li> 
 <li value="4"> <p>Click <span class="bold">Yes,&nbsp;</span><span class="bold">Delete it</span>. &nbsp;<br></p> <p>The project is deleted and stored in the Recycle Bin for 30 days. Your <em>Workfront administrator</em> can restore it from the Recycle Bin during this time. </p> </li> 
</ol>
