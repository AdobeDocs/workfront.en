...
1. Click the Plan mode menu at the top of the list and select Manual save, then click Standard > Apply. A toolbar setting displays with options to undo, redo, and save your changes. 
...
1. Go to a project, then click the `Tasks` section. 
1. Click the Plan mode menu at the top of the list and select Manual save, then click Timeline Planning> Apply. This option is dimmed for projects with more than 2000 tasks. 
...
1. Click the Edit icon . The `Edit Tasks` dialog box opens.
