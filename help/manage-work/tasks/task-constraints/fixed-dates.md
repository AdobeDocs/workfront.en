...
# Task Constraint overview: Fixed Dates {#task-constraint-overview-fixed-dates}

You can use the Fixed Dates task constraint when you want to be specific about the exact start date and end date of your tasks. For more information about task constraints, see [Task Constraint overview](task-constraint-overview.md).



## Overview of the Fixed Dates constraint {#overview-of-the-fixed-dates-constraint}
