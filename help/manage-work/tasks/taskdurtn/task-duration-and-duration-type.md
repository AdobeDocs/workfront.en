...
You can also select the preferred option for the Duration Unit of Time from the available drop-down menu when editing a task or in the Task&nbsp;Details section.
...
<!--
<img src="assets/duration-elapsed-days-tasks-nwe-350x282.png" style="width: 350;height: 282;" data-mc-conditions="QuicksilverOrClassic.Quicksilver">
-->
