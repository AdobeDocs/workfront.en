...
# Duration Type overview: Effort Driven  {#duration-type-overview-effort-driven}

Effort Driven is a duration type that you can set for a task in *`Adobe Workfront`*.


## Overview of the Effort Driven Duration Type {#overview-of-the-effort-driven-duration-type}
...
## Overview of the Effort Driven Duration Type formula {#overview-of-the-effort-driven-duration-type-formula}
...
>[!TIP] {type="tip"}
>
>*`Workfront`* considers the Schedule for each resource assigned to the task to determine the percent of allocation for each resource for the task. For information about creating and assigning schedules to users, see [Create a schedule](create-schedules.md).
...
### Resources are allocated 100% to the task {#resources-are-allocated-to-the-task}
...
## The effect of adding more resources to a task {#the-effect-of-adding-more-resources-to-a-task}
...
<table style="width: 718px;mc-table-style: url('../../../Resources/TableStyles/TableStyle-HeaderRow.css');" border="1" cellspacing="15" cellpadding="1" class="TableStyle-TableStyle-HeaderRow"> 
 ...
 <thead> 
  <tr class="TableStyle-TableStyle-HeaderRow-Head-Header1"> 
   ...
   <th class="TableStyle-TableStyle-HeaderRow-HeadE-Column1-Header1"> <p><span class="bold">Planned Hours</span> </p> </th> 
   <th class="TableStyle-TableStyle-HeaderRow-HeadD-Column1-Header1"><span class="bold"> Planned Duration</span> </th> 
  </tr> 
 </thead> 
 <tbody> 
  <tr class="TableStyle-TableStyle-HeaderRow-Body-LightGray"> 
   ...
   <td class="TableStyle-TableStyle-HeaderRow-BodyE-Column1-LightGray"> <p>3 Days</p> </td> 
   <td class="TableStyle-TableStyle-HeaderRow-BodyE-Column1-LightGray"> <p>24 Hours</p> <p>(3 Days x 8 Hours per Work Day = 24 Planned Hours)</p> </td> 
   <td class="TableStyle-TableStyle-HeaderRow-BodyD-Column1-LightGray"> <p>3 Days</p> <p>(24 Planned Hours / 1 Assignee = 3 Days)</p> </td> 
  </tr> 
  <tr class="TableStyle-TableStyle-HeaderRow-Body-MediumGray"> 
   ...
   <td class="TableStyle-TableStyle-HeaderRow-BodyE-Column1-MediumGray"> <p>3 Days</p> </td> 
   <td class="TableStyle-TableStyle-HeaderRow-BodyE-Column1-MediumGray"> <p>24 Hours</p> <p>(3 Days x 8 Hours per Work Day = 24 Planned Hours)</p> </td> 
   <td class="TableStyle-TableStyle-HeaderRow-BodyD-Column1-MediumGray"> <p>1.5 Days</p> <p>(24 Planned Hours / 2 Assignees = 12 Hours, or 1.5 Days)</p> </td> 
  </tr> 
  <tr class="TableStyle-TableStyle-HeaderRow-Body-LightGray"> 
   ...
   <td class="TableStyle-TableStyle-HeaderRow-BodyB-Column1-LightGray"> <p>3 Days</p> </td> 
   <td class="TableStyle-TableStyle-HeaderRow-BodyB-Column1-LightGray"> <p>24 Hours</p> <p>(3 Days x 8 Hours per Work Day = 24 Planned Hours)</p> </td> 
   <td class="TableStyle-TableStyle-HeaderRow-BodyA-Column1-LightGray"> <p>1 Day</p> <p>(24 Planned Hours / 3 Assignees = 8 Hours, or 1 Day)</p> </td> 
  </tr> 
 </tbody> 
</table>
...
## Change the Duration Type of a task to Effort Driven {#change-the-duration-type-of-a-task-to-effort-driven}
