...
# Task&nbsp;dependency loop overview {#task-dependency-loop-overview}

When adding predecessor relationships to tasks you might encounter dependency loops. For information about predecessors, see [Overview of task predecessors](predecessors-overview.md). 


## Dependency loop overview {#dependency-loop-overview}
...
## Considerations about dependency loops {#considerations-about-dependency-loops}
