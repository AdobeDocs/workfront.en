...
# Overview of task Original Duration and Original Planned Hours {#overview-of-task-original-duration-and-original-planned-hours}
...
For more information about Planned Hours on tasks, see [Planned Hours overview](planned-hours.md).


For more information about task Duration, see [Overview of Task Duration and Duration Type](task-duration-and-duration-type.md).
...
## Original Planned Hours {#original-planned-hours}
