...
<!--
Set Tracking Mode for tasks To set the tracking mode: Go to the task you want to set the tracking mode for. Click the More icon next to the name of the task, then click Edit. The Edit Task dialog box opens. In the Settings section, use the Tracking Mode drop-down menu to select the Tracking Mode for the task. For more information about the tracking mode options, see the Tracking Mode options section in this article. Click Save Changes.
-->
