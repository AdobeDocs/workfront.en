...
<p>You can assign multiple resources to a task. When you assign a user to a task, <em>Workfront</em> uses the user's schedule to calculate the planned dates for the task which ultimately determine the timeline of the project. Using the schedule of the user takes into account their time off, holidays, and weekend days which are considered non-working days when task activity cannot occur. </p>
<p>When you assign multiple users to a task, your <em>Workfront administrator</em> <span>or a <em>group administrator</em></span> determines which one of the following schedules <em>Workfront</em> uses to determine the planned dates of the tasks, based on schedules: </p>
<ul>
<li> <p><span class="bold">The Primary Assignee's schedule</span>: this is the schedule associated with the user designated as the task Owner.</p> <p>For information about associating users with schedules, see <a href="../../../administration-and-setup/add-users/create-and-manage-users/edit-a-users-profile.md" class="MCXref xref">Edit a user's profile</a>.</p> </li>
<li><span class="bold">The Project's schedule</span>: this is the schedule associated with the project. For adding a schedule to a project, see <a href="../../../manage-work/projects/manage-projects/edit-projects.md" class="MCXref xref">Edit projects</a>.</li>
</ul>
...
## Considerations for multiple user assignments and using schedules
...
* `The Primary Assignee's schedule`: this is the schedule associated with the user designated as the task Owner.

  For information about associating users with schedules, see [Edit a user's profile](../../../administration-and-setup/add-users/create-and-manage-users/edit-a-users-profile.md).

* `The Project's schedule`: this is the schedule associated with the project. For adding a schedule to a project, see [Edit projects](../../../manage-work/projects/manage-projects/edit-projects.md).

For information about setting up which schedule a project uses in the case of multiple assignments, see [Configure system-wide project preferences](../../../administration-and-setup/set-up-workfront/configure-system-defaults/set-project-preferences.md).
...
<ol> 
 <li value="1">Go to a task that you want to assign.</li> 
 <li value="2"> <draft-comment>
   <p data-mc-conditions="QuicksilverOrClassic.Quicksilver">Click <span class="bold">Assign to</span> in the upper-right corner of the task header, in the <span class="bold">Assignments</span> area</p>
  </draft-comment><p data-mc-conditions="QuicksilverOrClassic.Quicksilver">Click <span class="bold">Assign to</span> in the upper-right corner of the task header, in the <span class="bold">Assignments</span> area</p> <draft-comment>
   ...
   <p data-mc-conditions="QuicksilverOrClassic.Quicksilver">Click the name of the current assignments, if the task is already assigned. </p>
  </draft-comment><p data-mc-conditions="QuicksilverOrClassic.Quicksilver">Click the name of the current assignments, if the task is already assigned. </p> <draft-comment>
 ...
 <li value="3"> <p>Do one of the following:</p> 
  <ul> 
   <li> <p>Start typing the name of a user, role, or team that you want to assign, then click it when it appears on the list.</p> <p> <draft-comment>
    ...
    <li data-mc-conditions="QuicksilverOrClassic.Quicksilver">(Conditional) Click one of the names in the <span class="bold">Suggested Assignments</span> list, if this list displays. For more information, see <a href="../../../manage-work/tasks/assign-tasks/smart-assignments.md" class="MCXref xref">Smart assignments overview</a>. </li>
   </draft-comment>
   <li data-mc-conditions="QuicksilverOrClassic.Quicksilver">(Conditional) Click one of the names in the <span class="bold">Suggested Assignments</span> list, if this list displays. For more information, see <a href="../../../manage-work/tasks/assign-tasks/smart-assignments.md" class="MCXref xref">Smart assignments overview</a>. </li> <draft-comment>
   ...
   <li data-mc-conditions="QuicksilverOrClassic.Quicksilver">Click <span class="bold">Assign to me</span> to assign it to yourself</li> <draft-comment>
    <li data-mc-conditions="QuicksilverOrClassic.Quicksilver"> <p>Click <span class="bold">Advanced</span>.</p> <p>For information about how to make advanced assignments, see <a href="../../../manage-work/tasks/assign-tasks/create-advanced-assignments.md" class="MCXref xref">Create advanced assignments</a>.</p> </li>
   </draft-comment>
   <li data-mc-conditions="QuicksilverOrClassic.Quicksilver"> <p>Click <span class="bold">Advanced</span>.</p> <p>For information about how to make advanced assignments, see <a href="../../../manage-work/tasks/assign-tasks/create-advanced-assignments.md" class="MCXref xref">Create advanced assignments</a>.</p> </li> 
  </ul> </li> 
 ...
 <li value="5"> <draft-comment>
   <p data-mc-conditions="QuicksilverOrClassic.Quicksilver">(Optional) Click the <span class="bold">X icon</span> next to the name of the assignments in the Assignments area in the header of the task to remove an assignment.</p>
  </draft-comment><p data-mc-conditions="QuicksilverOrClassic.Quicksilver">(Optional) Click the <span class="bold">X icon</span> next to the name of the assignments in the Assignments area in the header of the task to remove an assignment.</p> </li> 
</ol>
...
<ol> 
 ...
 <li value="2"> <draft-comment>
   <p data-mc-conditions="QuicksilverOrClassic.Quicksilver">(Optional) Click the <span class="bold">Plan Mode</span> icon <img src="assets/nwe-plan-mode-icon-task-list.png"> and select one of the following options:</p>
  </draft-comment><p data-mc-conditions="QuicksilverOrClassic.Quicksilver">(Optional) Click the <span class="bold">Plan Mode</span> icon <img src="assets/nwe-plan-mode-icon-task-list.png"> and select one of the following options:</p> 
  <table cellspacing="0"> 
   <col> 
   <col> 
   <tbody> 
    ...
    <tr> 
     ...
     <td>You must manually save your changes. You can revert your changes before you save them. <draft-comment>
       <MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver">
        You have the option of selecting 
        <span class="bold">Standard Manual save</span> or 
        <span class="bold">Timeline Planning</span>. 
 ...
 <li value="3"> <p>To assign tasks do one of the following:</p> 
  <ul> 
   <li> <p>Click inside the <span class="bold">Assigned To</span> or <span class="bold">Assigned</span> fields and start typing the name of an active user that you want to assign to the task, then click it when it displays in the list.</p> <draft-comment>
     <p data-mc-conditions="QuicksilverOrClassic.Quicksilver"> <img src="assets/assigned-to-field-task-list-nwe.png"> </p>
    </draft-comment><p data-mc-conditions="QuicksilverOrClassic.Quicksilver"> <img src="assets/assigned-to-field-task-list-nwe.png"> </p> </li> 
   <li> <p>Click inside the <span class="bold">Assignments</span> field and start typing the name of an active user, <span>job role</span>, or team that you want to assign to the task, then click it when it displays in the list.</p> <draft-comment>
     <p data-mc-conditions="QuicksilverOrClassic.Quicksilver"> <img src="assets/assignments-field-task-list-nwe.png"> </p>
    </draft-comment><p data-mc-conditions="QuicksilverOrClassic.Quicksilver"> <img src="assets/assignments-field-task-list-nwe.png"> </p> </li> 
  </ul> </li> 
...
<ol> 
 ...
 <li value="8">(Optional) Select a role that the user should fulfill on the task from the <span class="bold">Pick a role</span> drop-down menu in the <span class="bold">Assignee's Role</span> column when you assign users to tasks. If you do not select a role, <em>Workfront</em> automatically selects the user's Primary Role. </li> 
