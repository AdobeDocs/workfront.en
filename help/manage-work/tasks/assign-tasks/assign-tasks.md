...
<ol> 
 ...
 <li value="8">(Optional) Select a role that the user should fulfill on the task from the <span class="bold">Pick a role</span> drop-down menu in the <span class="bold">Assignee's Role</span> column when you assign users to tasks. If you do not select a role, Workfront automatically selects the user's Primary Role. </li> 
