...
<ul> 
 ...
 <li> <p>Review the document in the <em>proofing viewer</em></p> <p>For more information about <em>proofing</em>, see <a href="../../review-and-approve-work/proofing/proofing.md" class="MCXref xref">Proofing</a></p> </li> 
</ul>
...
<ol> 
 ...
 <li value="2"> <p> <draft-comment>
    <MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver">
     Click the 
     <span class="bold">Check Out</span> icon
     <img src="assets/check-out-25x23.png" style="width: 25;height: 23;">. 
    </MadCap:conditionalText>
   </draft-comment><MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver">
    Click the 
    <span class="bold">Check Out</span> icon
    <img src="assets/check-out-25x23.png" style="width: 25;height: 23;">. 
   </MadCap:conditionalText> <br><![CDATA[               ]]></p> </li> 
 <li value="3"> <p>A lock icon <img src="assets/lock-icon-locked-qs.png"> displays to the right of the document name. The document stays checked out after you log out of <em>Workfront</em>.</p> </li> 
 <p>Only the user who checked out&nbsp;the document or the <em>Workfront administrator</em> can check&nbsp;the document in.</p> 
</ol>
...
<ol> 
 ...
 <li value="2"> <p> <draft-comment>
    <MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver">
     Click the 
     <span class="bold">Check In</span> icon 
     <img src="assets/check-in-25x22.png" style="width: 25;height: 22;">.
    </MadCap:conditionalText>
   </draft-comment><MadCap:conditionalText data-mc-conditions="QuicksilverOrClassic.Quicksilver">
    Click the 
    <span class="bold">Check In</span> icon 
