...
1. 
   ...
   <!--
   <p data-mc-conditions="QuicksilverOrClassic.Quicksilver">Click <span class="bold">Add New</span>&nbsp;> <span class="bold">Paste from Clipboard</span>.</p>
   -->

   Click `Add New` > `Paste from Clipboard`.
