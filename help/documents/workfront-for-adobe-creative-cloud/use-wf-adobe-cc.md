...
# Use *`Adobe Workfront`* for Adobe Creative Cloud {#use-adobe-workfront-for-adobe-creative-cloud}
...
The following sections describe how to use the *`Workfront`* for Adobe Creative Cloud extension after you have installed it. For information about how to install the extension, see [Install Adobe Workfront for Adobe Creative Cloud](installl-wf-adobe-cc.md).
...
<table style="width: 100%;margin-left: 0;margin-right: auto;mc-table-style: url('../../Resources/TableStyles/TableStyle-List-options-in-steps.css');" class="TableStyle-TableStyle-List-options-in-steps" cellspacing="0"> 
 ...
 <tbody> 
  ...
  <tr class="TableStyle-TableStyle-List-options-in-steps-Body-MediumGray"> 
   ...
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyA-Column2-MediumGray"> <p>Edit access to the object you want to interact with.</p> <p>For information on requesting additional access, see <a href="request-access.md" class="MCXref xref">Request access to objects in Adobe Workfront</a>.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
1.  Go to the Adobe application where you want to use the *`Workfront`* extension.  
   ...
   For information about installing the extension, see [Install Adobe Workfront for Adobe Creative Cloud](installl-wf-adobe-cc.md).  
...
* Your Access Level must permit uploading documents to *`Workfront`*. For more information, see [Grant access to documents](grant-access-documents.md).

* You must have permissions to upload documents to the item where you want it. For more information, see [Overview of sharing permissions on objects in Adobe Workfront](sharing-permissions-on-objects-overview.md).
...
1.  Click `Update`.  
   ...
   For more information about notifications within *`Workfront`*, see [View and manage in-app notifications](view-and-manage-in-app-notifications.md).&nbsp;  



   For more information about receiving email notifications, see [Adobe Workfront notifications](wf-notifications.md).





## Request a document approval from an Adobe application  {#request-a-document-approval-from-an-adobe-application}
...
1.  Click `Request Approval`.  
   ...
   *`Workfront`* users who you include in the comment or add as an approver receive an in-app notification, and, depending on how *`Workfront`* is configured, might also receive an email notification.   
   ...
   For information about notifications in *`Workfront`*, see [View and manage in-app notifications](view-and-manage-in-app-notifications.md). For information about receiving email notifications, see [Adobe Workfront notifications](wf-notifications.md).
...
If your organization uses Automated Workflow templates, you can generate a *`proof`* for a document you create in an Adobe application without leaving the application. For information about generating *`proofs`*, see [Generate a proof](generate-proof.md). For information about Automated Workflow templates, see [Automated Workflow templates](automated-workflow.md#automate) in [Automated Workflow overview](automated-workflow.md).
...
1.  Select the `Workflow Template` you want people to use as they review the document.
   ...
   Your *`Workfront administrator`* sets up Automated Workflow templates, as described in [Create and manage Automated Workflow templates](create-manage-automated-workflow-templates.md). See the administrator if you have questions.
...
## Upload a new version of a *`proof`* without leaving your Adobe application {#upload-a-new-version-of-a-proof-without-leaving-your-adobe-application}
...
## Log out of *`Workfront`* for Adobe Creative Cloud {#log-out-of-workfront-for-adobe-creative-cloud}
