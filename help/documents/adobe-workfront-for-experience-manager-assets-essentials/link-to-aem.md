...
<ol> 
 <li value="1">Go to the <span class="bold">Documents</span> area in <em>Workfront</em> where you want to add the document.</li> 
 <li value="2"> <p>Select <span class="bold">Add New</span>, then select the <em>Assets Essentials</em> integration your administrator set up.</p> <note type="note">
   The 
...
<ol> 
 <li value="1"> <p>Go to the <span class="bold">Documents</span> area in <em>Workfront</em> where you want the folder.</p> </li> 
 <li value="2"> <p>Select <span class="bold">Add New</span>, then select the <em>Assets Essentials</em> integration your administrator set up.</p> <note type="note">
   The 
...
<ol> 
 ...
 <li value="3"> <p>Select <span class="bold">Add New</span> > <span class="bold">Version</span>, then select the <em>Assets Essentials</em> integration your administrator set up.</p> <note type="note">
   The 
   <em>Workfront administrator</em> can choose any name for this integration, so it might not specifically mention 
   <em>Assets Essentials</em>.
  </note> </li> 
