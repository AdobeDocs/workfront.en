...
<ol> 
 ...
 <li value="2"> <p>Select <span class="bold">Add New</span>, then select the Assets Essentials integration your administrator set up.</p> <note type="note">
...
<ol> 
 <li value="1"> <p>Go to the <span class="bold">Documents</span> area in Workfront where you want the folder.</p> </li> 
 <li value="2"> <p>Select <span class="bold">Add New</span>, then select the Assets Essentials integration your administrator set up.</p> <note type="note">
...
<ol> 
 ...
 <li value="3"> <p>Select <span class="bold">Add New</span> > <span class="bold">Version</span>, then select the Assets Essentials integration your administrator set up.</p> <note type="note">
   The Workfront administrator can choose any name for this integration, so it might not specifically mention Assets Essentials.
  </note> </li> 
