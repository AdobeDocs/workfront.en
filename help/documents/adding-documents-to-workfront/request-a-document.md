...
<ol> 
 ...
 <li value="5"> <p>Begin typing the name of the user who you are requesting the document from, then select it when it appears in the drop-down list. Only licensed <span>Adobe Workfront</span> users appear as options in the drop-down list.</p> <note type="note">
   If you have the 
