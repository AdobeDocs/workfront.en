...
# Proof a linked asset for Experience Manager Assets {#proof-a-linked-asset-for-experience-manager-assets}
...
## Manage an existing *`proof`* {#manage-an-existing-proof}
...
For more information about how to manage an existing *`proof`*, see [Manage proofs within Adobe Workfront](_manage-proofs-in-wf.md)
...
For more information about what you can do with the *`proofing`* tool, see [Review proofs within Adobe Workfront](_review-proofs-in-wf.md)
