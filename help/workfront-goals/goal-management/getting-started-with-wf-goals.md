...
# Get started with *`Adobe Workfront Goals`* {#get-started-with-adobe-workfront-goals}
...
For information about *`Workfront Goals`*, see [Adobe Workfront Goals overview](wf-goals-overview.md).
...
* [Create goals in Adobe Workfront Goals](create-goals.md) 
* [Goal alignment overview in Adobe Workfront Goals](goal-alignment-overview.md) 
...
## Guidelines for setting up *`Workfront Goals`*  {#guidelines-for-setting-up-workfront-goals}
...
* [Get started with results and activities in Adobe Workfront Goals](get-started-with-results-and-activities.md) 
