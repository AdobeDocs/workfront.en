...
# Manage goal comments in *`Adobe Workfront Goals`* {#manage-goal-comments-in-adobe-workfront-goals}
...
## Locate the Comments area  {#locate-the-comments-area}
...
You can add comments to goals in the *`Check-in`* section of *`Workfront Goals`*, as part of updating your list of goals. For information about updating goals by checking in on them, see [Check in on goals in Adobe Workfront Goals](check-in-goals.md). 
...
You can add comments to goals in the *`Pulse`* section of *`Workfront Goals`*, as part of reviewing goals that might affect yours. For information about reviewing goals in the *`Pulse`* section, see [Review goals in the Adobe Workfront Goals Pulse section](review-goals-in-pulse.md). 
