...
<ol> 
 <li value="1"> <p>Go to a goal that you want to activate. </p> <p>For example, go to the <em>Goal List</em> and click a goal. The Goal Details panel opens on the right.</p> </li> 
