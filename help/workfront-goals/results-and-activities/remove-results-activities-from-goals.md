...
<ol> 
 <li value="1"> <p> <p>Click the <span class="bold">Main Menu icon </span><img src="assets/main-menu-icon.png"> in the upper-right corner of your screen, then click <span class="bold">Goals</span>.</p> <p>This opens the <span>Workfront Goals</span> area. </p> <p>The <span>Goal List</span> displays by default. </p> </p> </li> 
...
<ol> 
 <li value="1"> <p> <p>Click the <span class="bold">Main&nbsp;Menu</span> icon <img src="assets/main-menu-icon.png"> > <span class="bold">Goals</span> in the upper-right corner of your screen.</p> <p>This opens the <span>Workfront Goals</span> area. </p> <p>The <span>Goal List</span> displays by default. </p> </p> </li> 
 <li value="2"> <p>Click the name of a goal you want to remove results and activities from. </p> <p>This opens the Goal Details panel on the right.</p> </li> 
