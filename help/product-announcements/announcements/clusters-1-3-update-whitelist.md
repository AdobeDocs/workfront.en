...
# Customers on Clusters 1, 2, and 3 must update any allowlist IP blocks to prevent the blocking of *`Adobe Workfront`* services {#customers-on-clusters-and-must-update-any-allowlist-ip-blocks-to-prevent-the-blocking-of-adobe-workfront-services}
...
Please ensure your allowlist IP blocks are updated by May 13, 2019. For more information, see [Configure your firewall](configure-your-firewall.md).
...
### Why is Workfront making this change? {#why-is-workfront-making-this-change}
...
### What actions are required by me as a *`Workfront administrator`*? {#what-actions-are-required-by-me-as-a-workfront-administrator}
...
### What can my organization expect if we do not make this change? {#what-can-my-organization-expect-if-we-do-not-make-this-change}
