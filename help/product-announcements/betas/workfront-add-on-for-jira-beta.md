...
<ol> 
 ...
 <li value="9">Select the <span class="bold">Setup</span> tab to configure which fields to synchronize between the linked Jira and <em>Workfront</em> items.<br>Consider specifying the following: 
  <ul>
