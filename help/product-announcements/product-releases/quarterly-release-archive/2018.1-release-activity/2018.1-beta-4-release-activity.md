...
For more information, see [Proof progress and status overview](view-progress-status-proof.md).
...
For more information about viewing the print summary from the document list, see [Print a proof summary within Adobe Workfront](print-proof-summary-in-wf.md).
...
For more information about budgeting hours in the Resource Planner, see [Resource Planner overview](get-started-resource-planner.md).&nbsp;
...
For more information on managing schedules, see [Create a schedule](create-schedules.md)
...
For more information about adjusting budgeted dates in the Resource Planner, see the "Adjusting Budgeting Dates" section in the [Resource Planner overview](get-started-resource-planner.md)
