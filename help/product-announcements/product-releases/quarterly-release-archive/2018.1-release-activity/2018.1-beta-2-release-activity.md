...
For more information about *`group administrators`*, see the "Understanding *`group administrators`*" section in [Create a group](create-a-group.md).
...
For more information about the user allocation chart in the Resource Planner, see [Resource Planner overview](get-started-resource-planner.md).
