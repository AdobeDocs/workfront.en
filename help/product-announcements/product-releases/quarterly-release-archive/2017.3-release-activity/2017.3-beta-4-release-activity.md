...
For more information about how Available Hours and Available FTEs are calculated for users and roles in the Resource Planner, see [Overview of calculating hours and FTE for users and roles in the Resource Planner](calculate-hours-fte-for-users-roles-resource-planner.md).
