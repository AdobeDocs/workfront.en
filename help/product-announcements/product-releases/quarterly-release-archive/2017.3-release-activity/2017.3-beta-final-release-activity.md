...
*  Include issues on the backlog&nbsp;of an agile team.
  ...
  For more information, see [Configure how dates are applied when adding work items to an iteration](configure-scrum.md#configur5)&nbsp;in [Configure Scrum](configure-scrum.md).
...
For information about enabling issues to be available on the backlog of an agile Scrum team, see&nbsp; [Configure how dates are applied when adding work items to an iteration](configure-scrum.md#configur5)&nbsp;in [Configure Scrum](configure-scrum.md).
...
For more information, see [Share a proof within Adobe Workfront](share-a-proof-in-workfront.md) in [Share a proof within Adobe Workfront](share-a-proof-in-workfront.md).
...
For more information about built-in reports, see [Use Adobe Workfront built-in reports](use-workfront-built-in-reports.md).
...
For more information about the Allocation Date, see [Glossary of Adobe Workfront terminology](workfront-terminology-glossary.md).
