...
* `<li>New user profile picture</li>` `<li>New link to the <em>Workfront</em> application (when the ProofHQ account is integrated with a <em>Workfront</em> account)</li>` `<li>Updated look and feel</li>` 
