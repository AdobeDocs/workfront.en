...
For more information about these fields, see [Glossary of Adobe Workfront terminology](workfront-terminology-glossary.md).


For more information about approval paths, how they are created and triggered, and the function they serve in approval processes, see [Create an approval process](create-approval-processes.md).
...
For more information about email notifications, see [Adobe Workfront notifications](wf-notifications.md).
