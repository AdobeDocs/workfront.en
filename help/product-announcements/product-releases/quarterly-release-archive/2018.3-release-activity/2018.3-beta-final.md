...
>[!NOTE]
>
>Some areas of the integration outlined in the following video have been modified. For the most recent information about *`Workfront`* for Microsoft Teams, see the [Adobe Workfront for Microsoft Teams](_use-workfront-with-ms-teams.md) section.
