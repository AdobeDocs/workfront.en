...
For more information, see [View and export audit logs](view-and-export-audit-logs.md).
...
*  `<li dir="ltr"> <p dir="ltr">New limits for the number of projects, roles, and users that you can display.</p> </li>` `<li dir="ltr"> <p dir="ltr">Lazy loading, for faster loading of projects and roles.</p> </li>` 
...
For information about working in lists, see [Get started with lists in Adobe Workfront](view-items-in-a-list.md).
...
For information about fields in lists and reports, see [Glossary of Adobe Workfront terminology](workfront-terminology-glossary.md).
...
For information about quick filters, see the “Applying Quick Filters to Lists” section in [Get started with lists in Adobe Workfront](view-items-in-a-list.md).
...
For information about using text mode, see&nbsp; [Overview of common uses for Text Mode](understand-common-uses-text-mode.md).
...
For more information, see [Add documents to Adobe Workfront from your file system](add-documents-from-file-system.md) in the article [Add documents to Adobe Workfront from your file system](add-documents-from-file-system.md).
...
*  `<li dir="ltr"> <p dir="ltr">My Work and Home</p> </li>` `<li dir="ltr"> <p dir="ltr">Notifications</p> </li>` `<li dir="ltr"> <p dir="ltr">Contacts</p> </li>` `<li dir="ltr"> <p dir="ltr">Approvals</p> <p dir="ltr">For information about managing your work and notifications in the mobile app see &nbsp;and .</p> <p><iframe class="mt-media" src="assets/272406121?title=0&byline=0&portrait=0" width="640px" height="360px" frameborder="0" allowfullscreen></iframe> </p> </li>` 
...
For information, see [Print a proof summary within Adobe Workfront](print-proof-summary-in-wf.md).
...
For more information, see [Share a proof within Adobe Workfront](share-a-proof-in-workfront.md) in the article [Share a proof within Adobe Workfront](share-a-proof-in-workfront.md).
...
For more information about each of these fields, see&nbsp; [Glossary of Adobe Workfront terminology](workfront-terminology-glossary.md).
...
For more information, see&nbsp; [Glossary of Adobe Workfront terminology](workfront-terminology-glossary.md).
