...
# 2018.2 Beta 4 release activity {#beta-release-activity}
...
### Configure Work in Progress (WIP) Limits for Each Column on the Kanban Board {#configure-work-in-progress-wip-limits-for-each-column-on-the-kanban-board}
...
For more information, see the section&nbsp; [Configure the work in progress (WIP) limit](configure-kanban.md#configur4)&nbsp;in the article&nbsp; [Configure Kanban](configure-kanban.md).


### Update the Work in Progress (WIP) Limit Directly from the Kanban Board {#update-the-work-in-progress-wip-limit-directly-from-the-kanban-board}
...
*  When creating a new personal task, the "To Do" button is now labeled "Personal."
  ...
  For more information, see [Create work items from the Home area](create-work-items-in-home.md) in the article [Create work items from the Home area](create-work-items-in-home.md).

* Late items are indicated as Late only after an hour past the Planned Completion Date.


For more information about the Home area, see [Use the Home area](_use-the-home-area.md).
...
For more information about downloading, installing, and using the *`Desktop Proofing Viewer`*, see [Install the Desktop Proofing Viewer for your organization](install-desktop-proofing-viewer-org.md).


For information about functionality differences between the *`Desktop Proofing Viewer`* and the browser-based *`proofing`* viewers, see [Differences between the Web Proofing Viewer and the Desktop Proofing Viewer overview](understand-differences-between-web-viewer.md).
...
For more information about exporting the Resource Planner data to Excel, see the “Export Option” section in [Resource Planner navigation overview](resource-planner-navigation.md).
...
For more information about configuring your System Preferences in *`Workfront`*, see [Configure system security preferences](configure-security-preferences.md).
...
For more information about linking documents and folders from various applications to *`Workfront`*, see [Link documents from external applications](link-documents-from-external-apps.md).
...
For more information, see [Export the Gantt Chart to PDF](export-gantt-chart-to-pdf.md).
...
For more information about pasting images from the clipboard, see [Paste images from the Clipboard](paste-image-clipboard.md).
