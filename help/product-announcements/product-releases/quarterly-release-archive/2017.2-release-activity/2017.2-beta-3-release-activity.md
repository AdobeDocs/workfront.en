...
## Restoring Items&nbsp;in Bulk from the Recycle Bin
...
## Configure How Milestones Are Displayed on the Gantt Chart
...
## Include&nbsp;the Gantt Chart Legend When Exporting to PDF
...
## User Information Is Synchronized from  `Workfront` to ProofHQ (ProofHQ and `Workfront`)
...
For more information about user synchronization from `Workfront` to ProofHQ&nbsp;, see [User synchronization between Adobe Workfront and Workfront Proof](../../../../administration-and-setup/manage-workfront/configure-proofing/user-sync-proofing.md).
...
## View Proof Approvals in the My Work Area ( `Workfront`)
...
For more information, see [View approvals in Adobe Workfront](../../../../review-and-approve-work/manage-approvals/view-approvals.md) in [View approvals in Adobe Workfront](../../../../review-and-approve-work/manage-approvals/view-approvals.md).
...
## View User Names when Addressing Proofing Approval Requests from the My Work Area ( `Workfront`)
...
## Improved `proofing viewer` for Video Proofs (ProofHQ and `Workfront`)
...
For information about how to use the new video `proofing` viewer, see&nbsp; [Review a video proof](../../../../review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-video-proof-in-proofing-viewer.md)&nbsp;
...
## View Rich Media Proofs in Alternate Resolutions (ProofHQ and `Workfront`)
...
## New Resource Pool Functionality Temporarily Removed from Preview
