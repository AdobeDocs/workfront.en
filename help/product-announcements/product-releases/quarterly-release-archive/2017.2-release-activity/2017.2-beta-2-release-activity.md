...
For more information about unsubscribing to subscription emails, see the “Opting out of Email Notification” section in [Adobe Workfront notifications](wf-notifications.md)&nbsp;
...
You access the Requester object when creating a Proof Approval report,&nbsp;as described in [Create a custom report](create-custom-report.md).
