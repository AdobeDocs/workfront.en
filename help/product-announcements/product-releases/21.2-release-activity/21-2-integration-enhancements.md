---
filename: 21-2-integration-enhancements
...
# 21.2 Integration enhancements {#integration-enhancements}
...
## Introducing Workfront for Adobe XD {#introducing-workfront-for-adobe-xd}
...
To learn more about what you can do with Workfront for Adobe XD, see [Adobe Workfront for XD](wf-adobe-xd.md).
...
## Search for folders in document integrations {#search-for-folders-in-document-integrations}
...
## Enhanced security when uploading files to Google Drive {#enhanced-security-when-uploading-files-to-google-drive}
