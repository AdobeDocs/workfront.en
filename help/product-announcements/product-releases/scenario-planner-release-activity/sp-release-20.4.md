...
For information about publishing a plan, see 

<!--
<a href="../../../scenario-planner/publish-scenarios-update-projects.md" class="MCXref xref" xrefformat="{para}" data-mc-conditions="QuicksilverOrClassic.Quicksilver">Update or create projects by publishing initiatives in the Adobe Workfront Scenario Planner</a>
-->
...
For information about sharing a plan in the *Scenario Planner*, see 

<!--
<a href="../../../scenario-planner/share-a-plan.md" class="MCXref xref" xrefformat="{para}" data-mc-conditions="QuicksilverOrClassic.Quicksilver">Share a plan in the Adobe Workfront Scenario Planner</a>
-->
