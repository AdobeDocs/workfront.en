...
# 2018.1 Beta 2 release activity {#beta-release-activity}
...
For more information about `Group Administrators`, see the "Understanding `Group Administrators`" section in [Creating and Managing Groups](Creating and Managing Groups.md).
...
For more information about configuring how information displays on the Gantt chart, see [Configure how information displays on the Gantt Chart](configure-info-on-gantt-chart.md).
...
For more information about completing budgeting project resources in the Business Case, see [Budget resources in the Business Case](budget-resources-in-business-case.md).
...
For more information about the user allocation chart in the Resource Planner, see [Get started with the Resource Planner](get-started-resource-planner.md).
...
*  After you click "Work On It" on a request, the fields associated with the issue are displayed in the right panel.
  ...
  For more information about working on requests from the Home area, see [Manage work and team requests in the Home Area](manage-work-and-team-requests-home.md) in [Manage work and team requests in the Home Area](manage-work-and-team-requests-home.md).
...
* After you mark an item as Complete, the item stays in the left panel until you select another item.  
  For information about showing completed items, see [Display items in the Work List in the Home Area](display-items-in-home-work-list.md) in [Display items in the Work List in the Home Area](display-items-in-home-work-list.md).



For more information about using the new Home area, as well as information describing differences in functionality between My Work and Home, see [Use the Home area](_use-the-home-area.md).
...
*  Thumbnails area
  ...
  For more information about using the thumbnails area, see [Review a static proof](review-a-static-proof.md) in&nbsp; [Review a static proof](review-a-static-proof.md).

*  Comments area  
  For more information about the comments area, see&nbsp; [Create and manage proof comments](create-manage-proof-comments.md).
...
For more information, see [2018.1 Beta 2 release activity](#editing-a-comment--with-id-115004149353--missing)&nbsp;in [Create and manage proof comments](create-manage-proof-comments.md).
