...
# *`Workfront Fusion`* release activity:&nbsp;Week of March 8, 2021 {#workfront-fusion-release-activity-week-of-march}
...
## Search for items in the mapping panel {#search-for-items-in-the-mapping-panel}
...
For more information on mapping, see [Map information from one module to another](map-information-between-modules.md).
