...
# *`Workfront Fusion`* release activity:&nbsp;Week of June 28, 2021 {#workfront-fusion-release-activity-week-of-june}
...
## New search module in Salesforce connector {#new-search-module-in-salesforce-connector}
...
For more information, [Salesforce modules](salesforce-modules.md).


## Event subscription filtering available in Workfront >&nbsp;Watch records module {#event-subscription-filtering-available-in-workfront-watch-records-module}
