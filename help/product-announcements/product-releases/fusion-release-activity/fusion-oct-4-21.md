...
# *`Workfront Fusion`* release activity:&nbsp;Week of October 4, 2021 {#workfront-fusion-release-activity-week-of-october}
...
## See existing event filters in Workfront > Watch Events modules {#see-existing-event-filters-in-workfront-watch-events-modules}
...
For more information, see [Event subscription filters in the Workfront > Watch Events modules](workfront-modules.md#event) in [Adobe Workfront modules](workfront-modules.md).



## Attach custom forms to Workfront objects using the Workfront > Create record and Update record modules {#attach-custom-forms-to-workfront-objects-using-the-workfront-create-record-and-update-record-modules}
...
## Use rich text in comments and custom fields created by Workfront Fusion {#use-rich-text-in-comments-and-custom-fields-created-by-workfront-fusion}
...
For more information on the Create record and Update record modules, see [Adobe Workfront modules](workfront-modules.md).


For more information on the rich text available in comments or custom fields, see [Update work](update-work.md).
