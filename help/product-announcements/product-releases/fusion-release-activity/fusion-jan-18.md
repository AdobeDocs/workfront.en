...
# *`Workfront Fusion`* release activity:&nbsp;Week of January 18, 2021 {#workfront-fusion-release-activity-week-of-january}
...
## Debug scenarios with the *`Workfront Fusion`* DevTool {#debug-scenarios-with-the-workfront-fusion-devtool}
...
For instructions, and to download the Workfront Fusion 2.0 Devtool, see [Debug scenarios with the Adobe Workfront Fusion DevTool](debug-scenarios-with-dev-tool.md).


## Azure Active Directory connector and modules now available {#azure-active-directory-connector-and-modules-now-available}
...
## Azure DevOps connector and modules now available {#azure-devops-connector-and-modules-now-available}
...
## Qualtrics connector and modules now available {#qualtrics-connector-and-modules-now-available}
...
For more information see [Qualtrics modules](qualtrics-modules.md).
