...
# *`Workfront Fusion`* release activity:&nbsp;Week of January 25, 2021 {#workfront-fusion-release-activity-week-of-january}
...
## Bynder connector and modules now available {#bynder-connector-and-modules-now-available}
...
For more information see [Bynder modules](bynder-modules.md).
