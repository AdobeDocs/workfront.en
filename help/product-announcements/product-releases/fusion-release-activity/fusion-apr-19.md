...
# *`Workfront Fusion`* release activity:&nbsp;Week of April 19, 2021 {#workfront-fusion-release-activity-week-of-april}
...
## Update to Workfront Fusion Slack connector {#update-to-workfront-fusion-slack-connector}
...
For more information, see [Slack modules](slack-modules.md).
