...
# *`Workfront Fusion`* release activity:&nbsp;Week of August 30, 2021 {#workfront-fusion-release-activity-week-of-august}
...
## Filter events that trigger the Workfront > Watch events module {#filter-events-that-trigger-the-workfront-watch-events-module}
...
For more information on event filters in the Workfront > Watch events module, see [Adobe Workfront modules](workfront-modules.md).
