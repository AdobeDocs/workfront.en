...
# *`Workfront Fusion`* release activity:&nbsp;Week of November 16, 2020 {#workfront-fusion-release-activity-week-of-november}
...
## Updates to Jira Cloud connector {#updates-to-jira-cloud-connector}
...
For more information, see [Jira Software modules](jira-software-modules.md).


## Execution ID is now available for mapping in scenarios {#execution-id-is-now-available-for-mapping-in-scenarios}
...
For more information on scenario executions, see [Scenario execution, cycles, and phases](scenario-execution-cycles-phases.md).


## Keyboard shortcuts for Workfront Fusion 2.0 scenarios {#keyboard-shortcuts-for-workfront-fusion-scenarios}
...
For more information on building Workfront Fusion 2.0 scenarios, see [Create a scenario](create-a-scenario.md).


## Updates to Office 365 Excel connector {#updates-to-office-excel-connector}
...
For more information, see [Microsoft Office 365 Excel modules](microsoft-365-excel-modules.md).


## Use OAuth 2.0 in your Workfront app connections {#use-oauth-in-your-workfront-app-connections}
