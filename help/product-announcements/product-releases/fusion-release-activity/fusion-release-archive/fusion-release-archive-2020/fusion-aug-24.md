...
# *`Workfront Fusion`* release activity:&nbsp;Week of August 24, 2020 {#workfront-fusion-release-activity-week-of-august}
...
## More easily convert objects with custom data in the Workfront “Misc Action” Module {#more-easily-convert-objects-with-custom-data-in-the-workfront-misc-action-module}
...
## Upload a document to a specific folder in the Workfront Upload Document Module. {#upload-a-document-to-a-specific-folder-in-the-workfront-upload-document-module}
...
## Hubspot CRM and modules now available {#hubspot-crm-and-modules-now-available}
