...
# *`Workfront Fusion`* release activity:&nbsp;Week of September 21, 2020 {#workfront-fusion-release-activity-week-of-september}
...
## Select input fields when using the Workfront > Update Record or Workfront > Create Record modules {#select-input-fields-when-using-the-workfront-update-record-or-workfront-create-record-modules}
...
## Updates to Workfront > Watch Fields module {#updates-to-workfront-watch-fields-module}
