...
# *`Workfront Fusion`* release activity:&nbsp;Week of September 13, 2021 {#workfront-fusion-release-activity-week-of-september}
...
## Filter and sort Workfront Fusion scenario execution history {#filter-and-sort-workfront-fusion-scenario-execution-history}
...
For more information on filtering and sorting execution history, see [View a scenario's execution history](view-scenario-execution-history.md).
...
## Help links in Fusion now lead to specific articles {#help-links-in-fusion-now-lead-to-specific-articles}
...
## Scenario execution history only shows Details button when details are available {#scenario-execution-history-only-shows-details-button-when-details-are-available}
...
## SDL Managed Translation connector timeout increased to 120 seconds {#sdl-managed-translation-connector-timeout-increased-to-seconds}
