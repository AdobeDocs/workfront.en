...
## Update to toolbar on dashboard list

The toolbar on the dashboard list now has a modern look and feel that matches other Workfront lists such as projects, tasks, and issues. This intuitive toolbar now makes it easier to add, edit, share, copy, and delete dashboards.

For more information, see Content/Reports and Dashboards/Dashboards/Creating and Managing Dashboards/_create-and-manage-dashboards.htm.
