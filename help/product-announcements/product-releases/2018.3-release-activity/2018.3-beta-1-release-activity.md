...
# 2018.3 Beta 1 release activity {#beta-release-activity}
...
For more information, see [Manage work and team requests in the Home Area](manage-work-and-team-requests-home.md).
...
For more information, see [View information in the Gantt Chart](view-info-in-gantt.md) in the article [View information in the Gantt Chart](view-info-in-gantt.md).
...
For more information about exporting the Resource Planner, see [Resource Planner display limitations](resource-planner-display-limitations.md).
...
For more information, see [Work with multiple proofs in the proofing viewer](work-with-multiple-proofs.md).
