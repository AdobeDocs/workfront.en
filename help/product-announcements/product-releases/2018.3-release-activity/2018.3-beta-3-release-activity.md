...
# 2018.3 Beta 3 release activity {#beta-release-activity}
...
For more information, see Trying the Home Area.
...
For more information, see [Prioritize Work in the Home Area](prioritize-work-in-home.md).
...
For more information, see the "Unique URL for the User View" section in [Resource Planner navigation overview](resource-planner-navigation.md).
