...
# 2018.3 Beta 4 release activity {#beta-release-activity}
...
For information about `Group Administrators`, see [Group Administrators](group-administrators.md).
...
For more information, see the [Export information from the Resource Planner](export-resource-planner.md).
...
For more information about chaining tasks in the Gantt chart, see [Create predecessor relationships by chaining tasks](create-predecessors-by-chaining-tasks.md).
...
For more information, see [Review a static proof](review-a-static-proof.md) in [Review a static proof](review-a-static-proof.md).
...
For more information, see [Review a static proof](review-a-static-proof.md).
