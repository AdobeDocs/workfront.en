...
# 21.4 Administrator enhancements {#administrator-enhancements}
...
## For administrators: See which groups are associated with an approval process {#for-administrators-see-which-groups-are-associated-with-an-approval-process}
...
For information about approval processes, see [Approval process overview](approval-process-in-workfront.md). 


For information about managing group approval processes, see [Group-level approval processes](create-and-modify-groups-approval-processes.md).


## New for administrators: Groups can configure their own timesheet and hour preferences {#new-for-administrators-groups-can-configure-their-own-timesheet-and-hour-preferences}
...
## New for Workfront administrators: Configure layout templates for auto-provisioned users in the new Workfront experience {#new-for-workfront-administrators-configure-layout-templates-for-auto-provisioned-users-in-the-new-workfront-experience}
...
For instructions on mapping user attributes, see [Map user attributes and auto-provision new users](map-user-attributes.md).


## New field displays the groups your users belong to {#new-field-displays-the-groups-your-users-belong-to}
...
For information about using reports and views, see [Create a custom report](create-custom-report.md) and [Views overview in Adobe Workfront](views-overview.md).
...
## Blueprints details page now displays an image {#blueprints-details-page-now-displays-an-image}
...
## Blueprints preferences for new issues {#blueprints-preferences-for-new-issues}
...
## New for group administrators: View and manage a group’s recently deleted and restored items {#new-for-group-administrators-view-and-manage-a-group-s-recently-deleted-and-restored-items}
...
For more information, see [View and manage a group's recently deleted items](view-manage-groups-recently-deleted-objects.md) and [View and manage a group's recently restored items](view-manage-groups-recently-restored-objects.md). 
...
## New for group administrators: Group preferences now affect group templates {#new-for-group-administrators-group-preferences-now-affect-group-templates}
...
For more information, see the section How preferences apply to templates and template tasks in the article [Create and modify a group’s project templates](create-and-modify-a-groups-templates.md).
...
## New for administrators: Find out which custom forms are using a custom field {#new-for-administrators-find-out-which-custom-forms-are-using-a-custom-field}
...
For more information, see [View all custom forms that use a particular custom field](view-all-custom-forms-that-use-a-particular-custom-field.md).
...
## New for group administrators: Lock and unlock project, task, and issue preferences for a group {#new-for-group-administrators-lock-and-unlock-project-task-and-issue-preferences-for-a-group}
...
*  After a Workfront administrator unlocks a preference at the system level, you can configure and then lock it for all subgroups below your group. Though you can still reconfigure the locked preference, administrators of lower subgroups can’t do so for their groups.
  ...
  For more information, see [Lock or unlock a project, task, or issue preference for subgroups](lock-or-unlock-a-group-preference.md).
...
*  If you are a Workfront administrator, you don’t need to go to the Groups area to configure a subgroup’s preferences. From the main Project Preferences, Tasks & Issues Preferences, or Timesheets and Hours Preferences area, you can use the search box at the top of the page to find the subgroup and configure its preferences.
  ...
  For more information, see [Configure project preferences for a group](configure-project-preferences-group.md) and [Configure task and issue preferences for a group](configure-task-issue-preferences-group.md).
...
## New for group administrators: Create and edit templates from the Groups area {#new-for-group-administrators-create-and-edit-templates-from-the-groups-area}
...
For more information, see [Create and modify a group’s project templates](create-and-modify-a-groups-templates.md).
...
## Enter and save information in one attached custom form at a time {#enter-and-save-information-in-one-attached-custom-form-at-a-time}
...
For more information, see [Edit object details in the new Adobe Workfront experience](combined-pages-object-details.md).
