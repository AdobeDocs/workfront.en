...
For more information about planning resources in the Resource Planner, see [Get started with the Resource Planner](get-started-resource-planner.md).
...
To learn more about subscribing and unsubscribing users to objects see, [Subscribe to items in Workfront](subscribe-to-items-in-workfront.md) in &nbsp; [Subscribe to items in Workfront](subscribe-to-items-in-workfront.md)
...
You can quickly view who is subscribed to a project, task, or issue by adding the Subscriber field to a Report or View. To learn more about adding a field to a report or view, see [Understand fields in lists and reports](understand-fields-lists-reports.md)
...
For more information see, [Email notifications](email-notifications.md) in&nbsp; [Email notifications](email-notifications.md).
