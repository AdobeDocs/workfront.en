...
The 2017.2 Beta Final release contains enhancements both for `Workfront administrator`s and other users:
...
* [Determine the Availability of the HTML5 Video proofing viewer (ProofHQ and Workfront)](#determine-the-availability-of-the-html5-video-proofing-viewer) 
* [Support SHA-256 certificates for SAML 2.0](#support-sha-256) 
...
* [New Scheduling Area in a Project (Team Builder)](#new-team-scheduling-area-in-a-project) 
...
* [Resource Scheduling: User Allocations Are No Longer Rounded to the Nearest Half Hour](#resource-scheduling-user-allocations-are-no-longer-rounded-to-the-nearest-tenth) 
...
* [Proof Decision Displays in the My Work Area (Workfront)](#proof-decision-displays-in-the-my-work-area) 
* [View Rich Media Proofs in Preset Resolutions (ProofHQ and Workfront)](#view-rich-media-proofs-in-preset-resolutions) 
* [View URL to Sub-Pages in Comments on Rich Media Proofs (ProofHQ and Workfront)](#view-urls-to-sub-pages-in-comments-on-rich-media-proofs) 
* [Create Custom Views Based on Existing Standard Views (ProofHQ)](#create-custom-views-based-on-existing-standard-views) 
* [Filter the Reporting Area (ProofHQ)](#filter-the-reporting-area) 
* [Display Minimum and Maximum Values in Reports (ProofHQ)](#display-minimum-and-maximum-values-in-reports) 
* [In-App Notification for Proof Approval](#in-app-notification-for-proof-approval) 
* [Mobile Improvements](#mobile-improvements) 
* [Slash Added to Filter Statements for Field Values that Contain Commas](#slash-added-to-filter-statements) 
* [Multiple Billing Rates](#multiple-billing-rates) 
* [New Resource Budgeted Hour Field](#new-resource-budgeted-hour-field) 
* [Show User Job Role in 'Assigned To' Area on the Details Page for Tasks and Issues](#show-user-job-role) 
...
By default, the new scheduling area is used in a project.&nbsp;For information about accessing the Legacy Team Builder, see Accessing the Team Builder in Working in the Team Builder.


For more information about functionality available in the Team Scheduling area, see [Get started with Resource Scheduling](get-started-resource-scheduling.md).


`<iframe class="mt-media" src="assets/222746993?title=0&byline=0&portrait=0" width="640px" height="360px" frameborder="0" allowfullscreen></iframe>`&nbsp;
...
For more information about assigning tasks and issues to users on the scheduling timeline, see [Manually assign unassigned tasks and issues in the Scheduling areas](manually-assign-items-scheduling-areas.md)&nbsp;in [Manually assign unassigned tasks and issues in the Scheduling areas](manually-assign-items-scheduling-areas.md).


`<iframe class="mt-media" src="assets/222747001?title=0&byline=0&portrait=0" width="640px" height="360px" frameborder="0" allowfullscreen></iframe>`&nbsp;
...
For more information, see Accessing Allocation Information for a Project via the API.
...
For more information about exporting the Utilization report, see [Overview of the Resource Utilization report](resource-utilization-report.md) in [Overview of the Resource Utilization report](resource-utilization-report.md).


`<iframe class="mt-media" src="assets/222746991?title=0&byline=0&portrait=0" width="640px" height="360px" frameborder="0" allowfullscreen></iframe>`&nbsp;


## User Calendar Enhancements in the My Work Area {#user-calendar-enhancements-in-the-my-work-area}

The following enhancements are available in the calendar in the My Work area: (These enhancements were previously available for users enrolled in Early Access,&nbsp;and then the functionality was temporarily removed; this functionality is&nbsp;now available in the Production environment.)



*  Expand the calendar to view more tasks and issues. Or, you can hide the calendar so that it is no longer displayed.  
  For more information, see the Hiding or Adjusting the Size of the Calendar section in Viewing Assigned Work on the My Work Calendar.
*  Adjust the date range for which data is displayed on the calendar.  
  For more information, see Adjusting the Dates Displayed on the Calendar in&nbsp;Viewing Assigned Work on the My Work Calendar.
*  Tasks and issues only on projects in the status of Current are displayed on the calendar.  
  Previously, the calendar in the My Work area showed all tasks and issues assigned to you, regardless of project status. 
* Configure the calendar to show or hide any of the following options:
*  `<li value="1"> Issues<br>For more information, see the Configuring Issues to Be Displayed on the Calendarsection in Viewing Assigned Work on the My Work Calendar.</li>` `<li value="2"> User allocations<br>For more information, see the Enabling User Allocation Indicators on the Calendarsection in Viewing Assigned Work on the My Work Calendar.</li>` `<li value="3"> Show completed work<br>For more information, see the Configuring Completed Work to Display in the My Work Calendar section in Viewing Assigned Work on the My Work Calendar.</li>` 
...
To configure `Workfront` to display the new calendar in the My Work area, enable the option to show the new calendar on a layout template.
...
`<iframe class="mt-media" src="assets/220686514?title=0&byline=0&portrait=0" width="640px" height="360px" frameborder="0" allowfullscreen></iframe>`&nbsp;
...
For more information, see "Viewing a Preset Resolution" in [Change interactive proof resolution in the proofing viewer](view-interactive-content-as-it-appears-in-device.md).


`<iframe class="mt-media" src="assets/222717197?title=0&byline=0&portrait=0" width="640px" height="360px" frameborder="0" allowfullscreen></iframe>`&nbsp;
...
## Determine the Availability of the HTML5 Video `proofing viewer` (ProofHQ and `Workfront`) {#determine-the-availability-of-the-html-video-proofing-viewer-proofhq-and-workfront}
...
For more information about configuring this option in `Workfront`, see [Configure user access to Web Proofing Viewer](configure-a-users-proofing-access.md#configuring-whether-users-can-access-the-html5-proofing-viewer) in [Configure a user's proofing access](configure-a-users-proofing-access.md).


`<iframe class="mt-media" src="assets/222717238?title=0&byline=0&portrait=0" width="640px" height="360px" frameborder="0" allowfullscreen></iframe>`&nbsp;
...
For more information, see [Creating a Custom View](create-and-manage-custom-views.md#creating) in [Create and Manage Custom Views in Workfront Proof](create-and-manage-custom-views.md).
...
For more information, see [Filtering Reports](run-reports.md#filtering-reports) in&nbsp; [Run Reports in Workfront Proof](run-reports.md).


`<iframe class="mt-media" src="assets/222717209?title=0&byline=0&portrait=0" width="640px" height="360px" frameborder="0" allowfullscreen></iframe>`&nbsp;
...
For more information, see [Viewing Reports](run-reports.md#viewing-reports) in&nbsp; [Run Reports in Workfront Proof](run-reports.md).


## Support SHA-256 certificates for SAML 2.0 {#support-sha-certificates-for-saml}
...
For more information about configuring `Workfront` with SAML 2.0, see [Configure Workfront with SAML 2.0](configure-workfront-saml-2.md)


`<iframe class="mt-media" src="assets/222847061?title=0&byline=0&portrait=0" width="640px" height="360px" frameborder="0" allowfullscreen></iframe>`&nbsp;
...
For more information about this change, see [Create and customize Filters](create-customize-filters.md).


`<iframe class="mt-media" src="assets/222717219?title=0&byline=0&portrait=0" width="640px" height="360px" frameborder="0" allowfullscreen></iframe>`&nbsp;
...
For more information about Billing Rates and Revenue, see [Overview of Billing and Revenue](billing-and-revenue-overview.md).


For more information about overriding billing rates for job roles at the project level, see [Override Job Role Billing Rates and Calculate Revenue on a project](override-role-billing-rates-and-calculate-project-revenue.md).


`<iframe class="mt-media" src="assets/222717148?title=0&byline=0&portrait=0" width="640px" height="360px" frameborder="0" allowfullscreen></iframe>`&nbsp;
...
`<iframe class="mt-media" src="assets/222847008?title=0&byline=0&portrait=0" width="640px" height="360px" frameborder="0" allowfullscreen></iframe>`&nbsp;
...
For more information about using Budgeted Hours in the Resource Planner, see [Get started with the Resource Planner](get-started-resource-planner.md).
