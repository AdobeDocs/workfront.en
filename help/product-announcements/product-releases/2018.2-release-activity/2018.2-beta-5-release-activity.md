...
# 2018.2 Beta 5 release activity {#beta-release-activity}
...
The 2018.2 Beta 5 release contains the enhancements for `Workfront administrator`s and other users:
...
For more information, see [Home Calendar view](home-calendar-view.md).
...
*  Completed items are shown for the previous 2 weeks.
  ...
  For information about viewing completed work in the Home area, see [Display items in the Work List in the Home Area](display-items-in-home-work-list.md) in the article [Display items in the Work List in the Home Area](display-items-in-home-work-list.md).
...
For more information about using the Home area, see [Use the Home area](_use-the-home-area.md).


## View User-Triggered Changes with Audit Logs {#view-user-triggered-changes-with-audit-logs}

We’ve created the following audit logs for `Workfront administrator`s to track user-triggered changes:
...
For more information, see [Manage audit logs](manage-audit-logs.md).
...
For more information, see [Manually assign unassigned tasks and issues in the Scheduling areas](manually-assign-items-scheduling-areas.md).
...
*  `<li dir="ltr" value="1"> <p dir="ltr">New limits for the number of projects, roles, and users that you can display.</p> </li>` `<li dir="ltr" value="2"> <p dir="ltr">Lazy loading, for faster loading of projects and roles.</p> </li>` 
...
For information and to understand the new limits for the Resource Planner, see [Resource Planner display limitations](resource-planner-display-limitations.md)


To participate in our current beta program and give us feedback on the functionality of the Resource Planner, see Resource Planner Performance Beta
...
For information about resizing the reordering columns in lists, see [Modify column width and order](modify-column-width-order.md).
...
For information about working in lists, see [View items in a list](view-items-in-a-list.md).
...
For information about fields in lists and reports, see [Understand fields in lists and reports](understand-fields-lists-reports.md).
...
For information about exporting data from `Workfront`, see [Export data](export-data.md).
...
For information about quick filters, see the “Applying Quick Filters to Lists” section in [View items in a list](view-items-in-a-list.md).
...
For information about how to reference a collection in a report, see [Reference collections in a report](reference-collections-report.md).


For information about using text mode, see&nbsp; [Understand common uses of Text Mode](understand-common-uses-text-mode.md).


>[!NOTE]
>
>In the following video, the sample text mode for issue collections was incorrect. The correct sample text mode is available in [Reference collections in a report](reference-collections-report.md).
...
For more information, see [Add documents to Workfront from your file system](add-documents-from-file-system.md) in the article [Add documents to Workfront from your file system](add-documents-from-file-system.md).
...
*  `<li dir="ltr" value="1"> <p dir="ltr">My Work and Home</p> </li>` `<li dir="ltr" value="2"> <p dir="ltr">Notifications</p> </li>` `<li dir="ltr" value="3"> <p dir="ltr">Contacts</p> </li>` `<li dir="ltr" value="4"> <p dir="ltr">Approvals</p> <p dir="ltr">For information about managing your work and notifications in the mobile app see &nbsp;and .</p> <p><iframe class="mt-media" src="assets/272406121?title=0&byline=0&portrait=0" width="640px" height="360px" frameborder="0" allowfullscreen></iframe> </p> </li>` 
...
For information, see [Print a proof summary within Workfront](print-proof-summary-in-wf.md).
...
For more information about configuring this markup setting, see [Configure proofing viewer settings](configure-proofing-viewer-settings.md).


For more information about using markup options when reviewing a `proof`, see [Create and manage proof comments](create-manage-proof-comments.md) in the article [Create and manage proof comments](create-manage-proof-comments.md).
...
For more information, see&nbsp; [Make decisions on a proof](make-decisions-on-proof.md)&nbsp;in the article&nbsp; [Make decisions on a proof](make-decisions-on-proof.md).
...
For more information, see [Review a proof simultaneously with multiple reviewers](review-proof-with-multiple-reviewers.md).
...
For information about configuring static and video `proofs` to open in the `Desktop Proofing Viewer`, see [Configure proofing viewer settings](configure-proofing-viewer-settings.md).
...
For information about adding custom devices, see [Configure custom devices for interactive proofs](configure-a-users-proofing-access.md#configuring-custom-devices-for-interactive-proofs) in [Configure a user's proofing access](configure-a-users-proofing-access.md)
...
For more information, see [Share a proof within Workfront](share-a-proof-in-workfront.md) in the article [Share a proof within Workfront](share-a-proof-in-workfront.md).
...
For more information about each of these fields, see&nbsp; [Understand fields in lists and reports](understand-fields-lists-reports.md).
...
For more information, see&nbsp; [Understand fields in lists and reports](understand-fields-lists-reports.md).
...
For more information, see [Copying Proofs in Workfront Proof](copy-proofs.md) in the article&nbsp; [Copying Proofs in Workfront Proof](copy-proofs.md).
