...
For information about functionality differences between the `Desktop Proofing Viewer` and the browser-based `proofing` viewers, see [Differences between the Web Proofing Viewer and the Desktop Proofing Viewer](understand-differences-between-web-viewer.md).
