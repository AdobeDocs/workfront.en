...
# 2018.2 Beta Final release activity {#beta-final-release-activity}
...
For information on configuring a POP email account, see [Use a POP email account to comment on work items](using-pop-email-reply.md).


For more information on the default mail service, see [Comment on work items using Workfront default email service](comment-work-items-wf-default-email-service.md).
...
For more information about system updates, see [System-tracked update feeds](system-tracked-update-feeds.md).
...
For more information about `Workfront` for Salesforce, see&nbsp; [Workfront for Salesforce](_workfront-for-Salesforce.md).
...
For more information about `Workfront` notifications in Slack, see [Receive Workfront notifications in Slack](receive-workfront-notifications-in-slack.md).
...
For more information about these features and to watch videos demonstrating them, see [2018.2 Beta 4 release activity](2018.2-beta-4-release-activity.md) and [2018.2 Beta 5 release activity](2018.2-beta-5-release-activity.md).
