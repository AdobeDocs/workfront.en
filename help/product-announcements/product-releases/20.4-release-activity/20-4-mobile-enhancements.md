...
# 20.4 Mobile and integration enhancements {#mobile-and-integration-enhancements}
...
## Added functionality in Microsoft Teams notifications  {#added-functionality-in-microsoft-teams-notifications}
...
## Create a task quickly in the Workfront mobile app {#create-a-task-quickly-in-the-workfront-mobile-app}
...
## Get help with Workfront mobile’s virtual assistant commands {#get-help-with-workfront-mobile-s-virtual-assistant-commands}
...
For a list of existing commands, see [Adobe Workfront mobile app virtual assistant](wf-mobile-virtual-assistant.md).
