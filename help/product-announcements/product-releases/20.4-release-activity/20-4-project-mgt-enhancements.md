...
# 20.4 Project management enhancements {#project-management-enhancements}
...
## New for administrators: Control how a custom field is shared {#new-for-administrators-control-how-a-custom-field-is-shared}
...
For more information, see [Configure sharing for a custom field](configure-sharing-for-a-custom-field.md).
...
## New for administrators: Standardized Custom Form sharing {#new-for-administrators-standardized-custom-form-sharing}
...
For more information, see [Share a custom form](share-access-to-a-custom-form.md).
...
## Export custom forms and overview information from the Details section of a project, task, or issue {#export-custom-forms-and-overview-information-from-the-details-section-of-a-project-task-or-issue}
...
## Quickly add an iteration {#quickly-add-an-iteration}
...
## New Metrics section available in projects {#new-metrics-section-available-in-projects}
...
## New for administrators: Assign a business leader to a group {#new-for-administrators-assign-a-business-leader-to-a-group}
...
For more information, see [Business Leader overview](business-leader-overview.md).
...
## New for administrators: Associate portfolios, programs, and companies with groups {#new-for-administrators-associate-portfolios-programs-and-companies-with-groups}
...
For more information, see the section “About associating a group with an object” in the article [Groups overview](groups.md). 
...
## New for administrators: Administrators for a group assigned to a company can manage the company {#new-for-administrators-administrators-for-a-group-assigned-to-a-company-can-manage-the-company}
...
For more information, see [Create and edit companies](create-and-edit-companies.md).


For information about administrative access to companies, see [Grant users administrative access to certain areas](grant-users-admin-access-certain-areas.md).
...
## Replace the Work On It button with a Start button {#replace-the-work-on-it-button-with-a-start-button}
...
For more information on configuring this option, see [Replace the Work On It button with a Start button](work-on-it-button-to-start-button.md).
...
## Allow multiple drafts for a queue topic {#allow-multiple-drafts-for-a-queue-topic}
...
## Assign a group to a team {#assign-a-group-to-a-team}
...
For more information, see [Create a team](create-a-team.md).
...
## New fields allow you to report on data for a top-level group and all its subgroups {#new-fields-allow-you-to-report-on-data-for-a-top-level-group-and-all-its-subgroups}
...
For information about using fields in lists and reports, see [Glossary of Adobe Workfront terminology](workfront-terminology-glossary.md).
...
## New option to cancel your action when discarding a request draft {#new-option-to-cancel-your-action-when-discarding-a-request-draft}
