...
# 20.4 Resource Management enhancements {#resource-management-enhancements}
...
## Plan work using Work Effort instead of Planned Hours {#plan-work-using-work-effort-instead-of-planned-hours}
...
For information about Work Effort, see [Work Effort overview](work-effort.md).
...
## Project status-based colors for work items in the Workload Balancer {#project-status-based-colors-for-work-items-in-the-workload-balancer}
...
For information about customizing the view in the Workload Balancer, see [Navigate the Workload Balancer](navigate-the-workload-balancer.md).
...
## Adjust user allocation using percentage values in the Workload Balancer {#adjust-user-allocation-using-percentage-values-in-the-workload-balancer}
...
## Show or hide completed work in the Workload Balancer {#show-or-hide-completed-work-in-the-workload-balancer}
...
For more information about adjusting settings in the Workload Balancer, see [Navigate the Workload Balancer](navigate-the-workload-balancer.md).
...
## Usability improvements in the Workload Balancer {#usability-improvements-in-the-workload-balancer}
...
For more information about navigating the Workload Balancer, see [Navigate the Workload Balancer](navigate-the-workload-balancer.md).
...
## User allocation chart in the Workload Balancer {#user-allocation-chart-in-the-workload-balancer}
...
For more information about configuring settings in the Workload Balancer, see [Navigate the Workload Balancer](navigate-the-workload-balancer.md).
...
## Visualize completed work in the Workload Balancer {#visualize-completed-work-in-the-workload-balancer}
...
For information about viewing information in the Workload Balancer, see [Navigate the Workload Balancer](navigate-the-workload-balancer.md).
...
## New Default filter for the Assigned Work area in the Workload Balancer {#new-default-filter-for-the-assigned-work-area-in-the-workload-balancer}
...
For information about using filters in the Workload Balancer, see [Manage filters in the Workload Balancer](filter-information-workload-balancer.md).
...
## New icon for switching between hours and percentage values, or allocated and remaining time in the Workload Balancer {#new-icon-for-switching-between-hours-and-percentage-values-or-allocated-and-remaining-time-in-the-workload-balancer}
...
For information about managing settings for the Workload Balancer, see [Navigate the Workload Balancer](navigate-the-workload-balancer.md).
...
## A new built-in filter for the Workload Balancer: Users on projects {#a-new-built-in-filter-for-the-workload-balancer-users-on-projects}
...
For information about using filters in the Workload Balancer, see [Filter information in the Workload Balancer](filter-information-workload-balancer.md).
