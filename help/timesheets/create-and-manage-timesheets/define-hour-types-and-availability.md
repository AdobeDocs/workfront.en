...
# Define hour types and availability for timesheets {#define-hour-types-and-availability-for-timesheets}
...
After the appropriate hour types have been configured, you can log time from multiple locations in *`Workfront`*, as described in [Log time](log-time.md).
...
<table style="width: 100%;margin-left: 0;margin-right: auto;mc-table-style: url('../../Resources/TableStyles/TableStyle-List-options-in-steps.css');" class="TableStyle-TableStyle-List-options-in-steps" cellspacing="0"> 
 ...
 <tbody> 
  ...
  <tr class="TableStyle-TableStyle-List-options-in-steps-Body-LightGray"> 
   ...
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyD-Column2-LightGray"> <p>System administrator access to define system-wide hour types and to edit all users</p> </td> 
  </tr> 
  <tr class="TableStyle-TableStyle-List-options-in-steps-Body-MediumGray"> 
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyB-Column1-MediumGray" role="rowheader">Object permissions</td> 
   <td class="TableStyle-TableStyle-List-options-in-steps-BodyA-Column2-MediumGray">Manage access on the project to define hour types on a project</td> 
  </tr> 
 </tbody> 
</table>
...
## Define availability&nbsp;at the system level {#define-availability-at-the-system-level}

The system administrator determines which project-specific hour types are made available system-wide, as described in&nbsp;the [Manage hour types](hour-types.md) section in&nbsp; [Manage hour types](hour-types.md).
...
## Define availability&nbsp;at&nbsp;the&nbsp;user level {#define-availability-at-the-user-level}
