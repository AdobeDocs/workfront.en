...
1. Set the filter options, then click  `Filter`.
   ...
   For more information, see the section [Filter timesheets](../../administration-and-setup/set-up-workfront/configure-timesheets-schedules/manage-timesheets-for-all-users.md#filtering-timesheets) in the article [Manage timesheets for all users](../../administration-and-setup/set-up-workfront/configure-timesheets-schedules/manage-timesheets-for-all-users.md).
