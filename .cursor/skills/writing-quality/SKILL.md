...
4. For detailed terminology, punctuation, and procedure rules, see [reference.md](reference.md)
...
For complete punctuation and terminology rules, see [reference.md](reference.md).
